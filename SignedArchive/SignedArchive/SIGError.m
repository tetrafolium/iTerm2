...
+ (instancetype)errorWithCode:(SIGErrorCode)code detail:(NSString *)detail {
  ...
  return [SIGError
      errorWithDomain:SIGErrorDomain
                 code:code
             userInfo:@{
               NSLocalizedDescriptionKey : [detail stringByAppendingString:@"."]
             }];
}
...
+ (instancetype)errorWrapping:(NSError *)otherError
  ...
  if (!detail) {
    return [self errorWrapping:otherError
                          code:code
                        detail:[self localizedDescriptionFcode:code]];
  }

  NSString *innerDetail =
      otherError.localizedDescription
          ?: [NSString stringWithFormat:@"%@ error code %@", otherError.domain,
                                        @(otherError.code)];
  NSString *description =
      [NSString stringWithFormat:@"%@: %@", detail, innerDetail];
...
+ (NSString *)localizedDescriptionFcode:(SIGErrorCode)code {
  ...
  case SIGErrorCodeVersionTooNew:
    return @"This file is from a newer version of this app and cannot be "
           @"loaded. Please upgrade and try again";
  case SIGErrorCodeMalformedMetadata:
    return @"Metadata chunk malformed";
  case SIGErrorCodeDeprecatedOldVersion:
    return @"This file is in an older format that is no longer supported "
           @"because its authenticity cannot be guaranteed. It cannot be "
           @"opened by this version of the app";
