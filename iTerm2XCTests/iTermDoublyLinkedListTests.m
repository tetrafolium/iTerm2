...
- (void)testPrepend {
  ...
  iTermDoublyLinkedListEntry<NSNumber *> *e1 =
      [[iTermDoublyLinkedListEntry alloc] initWithObject:@1];
  iTermDoublyLinkedListEntry<NSNumber *> *e2 =
      [[iTermDoublyLinkedListEntry alloc] initWithObject:@2];
  [dll prepend:e2];
  [dll prepend:e1];
...
- (void)testRemoveMiddle {
  ...
  iTermDoublyLinkedListEntry<NSNumber *> *e2 =
      [[iTermDoublyLinkedListEntry alloc] initWithObject:@2];
  iTermDoublyLinkedListEntry<NSNumber *> *e3 =
      [[iTermDoublyLinkedListEntry alloc] initWithObject:@3];
  [dll prepend:e3];
  [dll prepend:e2];
  [dll prepend:e1];
