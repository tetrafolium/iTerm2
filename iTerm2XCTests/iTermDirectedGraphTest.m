...
- (void)testContainsCycleEmptyGraph {
  iTermDirectedGraph<NSString *> *graph =
      [[[iTermDirectedGraph alloc] init] autorelease];
  BOOL containsCycle = [[[iTermDirectedGraphCycleDetector alloc]
      initWithDirectedGraph:graph] containsCycle];
...
- (void)testContainsCycleBig {
  iTermDirectedGraph<NSNumber *> *graph =
      [[[iTermDirectedGraph alloc] init] autorelease];
