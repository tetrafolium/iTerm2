...
@interface iTermAutomaticProfileSwitcherTest
    : XCTestCase <iTermAutomaticProfileSwitcherDelegate>
...
- (Profile *)profilePathDir1 {
  return @{
    KEY_NAME : @"path=dir1",
    KEY_GUID : @"3",
    KEY_BOUND_HOSTS : @[ @"/dir1" ]
  };
}

- (Profile *)profilePathDir1AndSubs {
  return @{
    KEY_NAME : @"path=dir1AndSubs",
    KEY_GUID : @"3",
    KEY_BOUND_HOSTS : @[ @"/dir1/*" ]
  };
}
...
- (Profile *)profileUserGeorgeHostItermPathHome {
  return @{
    KEY_NAME : @"user=george host=iterm2.com path=home",
    KEY_GUID : @"7",
...
- (Profile *)profileUserGeorgePathHome {
  return @{
    KEY_NAME : @"user=george path=home",
    KEY_GUID : @"8",
...
- (Profile *)profileUserGeorgeHostIterm {
  return @{
    KEY_NAME : @"user=george host=iterm2.com",
    KEY_GUID : @"9",
...
- (Profile *)profileHostItermPathHome {
  return @{
    KEY_NAME : @"host=iterm2.com path=home",
    KEY_GUID : @"10",
...
- (Profile *)profileHostIterm {
  return @{
    KEY_NAME : @"host=iterm2.com",
    KEY_GUID : @"11",
    KEY_BOUND_HOSTS : @[ @"iterm2.com" ]
  };
}

- (Profile *)profileUserGeorge {
  return @{
    KEY_NAME : @"user=george",
    KEY_GUID : @"12",
    KEY_BOUND_HOSTS : @[ @"george@" ]
  };
}
...
- (Profile *)profileAllPaths {
  return
      @{KEY_NAME : @"path=/*", KEY_GUID : @"15", KEY_BOUND_HOSTS : @[ @"/*" ]};
}
...
- (void)testUsernameHostnamePathOutranksUsernameHostname {
  _profile = self.profileHostA;
  _allProfiles = @[
    self.profileUserGeorgeHostItermPathHome, self.profileUserGeorgeHostIterm
  ];
  [_aps setHostname:@"iterm2.com"
           username:@"george"
               path:@"/home"
                job:@"whatever"];
  XCTAssert(
      [_profile isEqualToProfile:self.profileUserGeorgeHostItermPathHome]);
}

- (void)testUsernameHostnameOutranksUsernamePath {
  _profile = self.profileHostA;
  _allProfiles =
      @[ self.profileUserGeorgeHostIterm, self.profileUserGeorgePathHome ];
  [_aps setHostname:@"iterm2.com"
           username:@"george"
               path:@"/home"
                job:@"whatever"];
...
- (void)testHostnamePathOutranksUsernamePath {
  _profile = self.profileHostA;
  _allProfiles =
      @[ self.profileHostItermPathHome, self.profileUserGeorgePathHome ];
  [_aps setHostname:@"iterm2.com"
           username:@"george"
               path:@"/home"
                job:@"whatever"];
...
- (void)testPreferSpecificRuleEvenIfStackHasMatch {
  ...
  _allProfiles = @[ [self profileAllPaths], [self profilePathDir1AndSubs] ];
...
- (void)testWalkUpStack {
  ...
  _allProfiles = @[
    [self profileHostIterm], [self profileUserGeorgeHostIterm],
  ...
  [_aps setHostname:@"iterm2.com" username:@"george" path:@"/home" job:@"job"];
  // stack is now: iterm2.com, george@iterm2.com, george@iterm2.com:/home
  [_aps setHostname:@"iterm2.com"
           username:@"george"
               path:@"bogus path"
                job:@"job"];
  // If we didn't walk the stack all the way back up we should be on
  // george@iterm2.com
  XCTAssert([_profile isEqualToProfile:[self profileUserGeorgeHostIterm]]);
}
...
- (void)testRestoreOriginalProfileWhenNothingMatches {
  ...
  [_aps setHostname:@"iterm2.com" username:@"george" path:@"/home" job:@"job"];
  // stack is now: iterm2.com, george@iterm2.com, george@iterm2.com:/home
  [_aps setHostname:@"qwerty" username:@"uiop" path:@"asdf" job:@"job"];
...
- (void)testSaveAndRestore {
  ...
  iTermAutomaticProfileSwitcher *aps2 = [[[iTermAutomaticProfileSwitcher alloc]
      initWithDelegate:self
            savedState:state] autorelease];
  ...
  [aps2 setHostname:@"iterm2.com" username:@"george" path:@"/home" job:@"job"];
  // stack is now: iterm2.com, george@iterm2.com, george@iterm2.com:/home
  XCTAssert(
      [_profile isEqualToProfile:[self profileUserGeorgeHostItermPathHome]]);
  ...
  [aps2 setHostname:@"qwerty" username:@"uiop" path:@"asdf" job:@"job"];
...
- (void)testUserNameWithAtSign {
  Profile *profile = @{
    KEY_NAME : @"Default",
    KEY_GUID : @"200",
    KEY_BOUND_HOSTS : @[ @"hostname*" ]
  };
  _allProfiles = @[ self.profileUserGeorge, profile ];
  [_aps setHostname:@"hostname.com"
