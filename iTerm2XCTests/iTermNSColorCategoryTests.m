...
// The tolerances on these tests are much larger than I'd like. I have not found
// two reference implementations that agree with each other any more closely,
// unfortunately.
- (void)testLABFromSRGB {
  {
    iTermLABColor lab =
        iTermLABFromSRGB((iTermSRGBColor){.r = 1, .g = 0, .b = 0});
  ...
  {
    iTermLABColor lab =
        iTermLABFromSRGB((iTermSRGBColor){.r = 0.8, .g = 0.2, .b = 0.5});
  ...
  {
    iTermLABColor lab =
        iTermLABFromSRGB((iTermSRGBColor){.r = 0.9, .g = 0.8, .b = 0.9});
  ...
  {
    iTermLABColor lab =
        iTermLABFromSRGB((iTermSRGBColor){.r = 0.1, .g = 0.2, .b = 0.1});
...
// This is really a test that iTermSRGBFromLAB is an inverse of
// iTermLABFromSRGB. These are not ground-truth values because as noted above I
// can't find any.
- (void)testSRGBFromLAB {
  {
    iTermSRGBColor srgb =
        iTermSRGBFromLAB((iTermLABColor){.l = 53.23, .a = 80.10, .b = 67.22});
  ...
  {
    iTermSRGBColor srgb =
        iTermSRGBFromLAB((iTermLABColor){.l = 47.94, .a = 64.62, .b = -6.94});
  ...
  {
    iTermSRGBColor srgb =
        iTermSRGBFromLAB((iTermLABColor){.l = 84.80, .a = 13.32, .b = -9.32});
  ...
  {
    iTermSRGBColor srgb =
        iTermSRGBFromLAB((iTermLABColor){.l = 18.60, .a = -16.39, .b = 13.17});
