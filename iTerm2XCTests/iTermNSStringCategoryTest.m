...
- (void)testVimSpecialChars_NoSpecialChars {
  XCTAssert(
      [@"Foo" isEqualToString:[@"Foo" stringByExpandingVimSpecialCharacters]]);
}

- (void)testVimSpecialChars_TerminalBackslash {
  XCTAssert([@"Foo"
      isEqualToString:[@"Foo\\" stringByExpandingVimSpecialCharacters]]);
}

- (void)testVimSpecialChars_ThreeDigitOctal {
  XCTAssert([@"prefixAsuffix"
      isEqualToString:[@"prefix\\101suffix"
                          stringByExpandingVimSpecialCharacters]]);
}

- (void)testVimSpecialChars_TwoDigitOctal {
  XCTAssert([@"prefix0suffix"
      isEqualToString:[@"prefix\\60suffix"
                          stringByExpandingVimSpecialCharacters]]);
}
...
- (void)testVimSpecialChars_TwoDigitHex {
  ...
  NSString *actual =
      [@"prefix\\x41suffix" stringByExpandingVimSpecialCharacters];
  XCTAssert([expected isEqualToString:actual]);
}
...
- (void)testVimSpecialChars_OneDigitHex {
  NSString *expected = [NSString stringWithFormat:@"prefix%csuffix", 5];
  NSString *actual =
      [@"prefix\\x5suffix" stringByExpandingVimSpecialCharacters];
  XCTAssert([expected isEqualToString:actual]);
}
...
- (void)testVimSpecialChars_FourDigitUnicode {
  ...
  NSString *actual =
      [@"prefix\\u6C34suffix" stringByExpandingVimSpecialCharacters];
  XCTAssert([expected isEqualToString:actual]);
}
...
- (void)testVimSpecialChars_Backslash {
  NSString *expected = [NSString stringWithFormat:@"prefix%csuffix", '\\'];
  NSString *actual =
      [@"prefix\\\\suffix" stringByExpandingVimSpecialCharacters];
  XCTAssert([expected isEqualToString:actual]);
}
...
- (void)testVimSpecialChars_ControlKey {
  ...
  NSString *actual =
      [@"prefix\\<C-A>suffix" stringByExpandingVimSpecialCharacters];
  XCTAssert([expected isEqualToString:actual]);
}
...
- (void)testVimSpecialChars_MetaKey {
  ...
  NSString *actual =
      [@"prefix\\<M-A>suffix" stringByExpandingVimSpecialCharacters];
  XCTAssert([expected isEqualToString:actual]);
}
...
- (void)testMultiples {
  ...
  NSString *actual =
      [@"\\x41x\\x41x\\x41" stringByExpandingVimSpecialCharacters];
  XCTAssert([expected isEqualToString:actual]);
}
...
- (void)assertString:(NSString *)string
    parsesAsShellCommandTo:(NSArray *)expected {
...
- (void)testParseShellCommand {
  ...
  [self assertString:@"   foo    bar   "
      parsesAsShellCommandTo:@[ @"foo", @"bar" ]];

  // Escapes
  [self assertString:@"foo\\ bar" parsesAsShellCommandTo:@[ @"foo bar" ]];
  [self assertString:@"foo\\n bar"
      parsesAsShellCommandTo:@[ @"foo\n", @"bar" ]];
  [self assertString:@"foo\\t bar"
      parsesAsShellCommandTo:@[ @"foo\t", @"bar" ]];
  [self assertString:@"foo\\\" bar"
      parsesAsShellCommandTo:@[ @"foo\"", @"bar" ]];
  ...
  // Tildes
  [self assertString:@"~"
      parsesAsShellCommandTo:@[ [@"~" stringByExpandingTildeInPath] ]];
...
- (void)testStringByTrimmingCharset {
  XCTAssertEqualObjects(
      [@"abc" stringByTrimmingTrailingCharactersFromCharacterSet:
...
- (void)testStringByTrimmingTrailingWhitespace {
  XCTAssert(
      [[@"abc" stringByTrimmingTrailingWhitespace] isEqualToString:@"abc"]);
  XCTAssert(
      [[@"abc " stringByTrimmingTrailingWhitespace] isEqualToString:@"abc"]);
  XCTAssert(
      [[@"abc  " stringByTrimmingTrailingWhitespace] isEqualToString:@"abc"]);
  ...
  XCTAssert([[@"abc \u00a0" stringByTrimmingTrailingWhitespace]
      isEqualToString:@"abc"]);
...
- (void)testRangeOfURLInString {
  ...
  for (NSString *string in strings) {
    ...
    XCTAssert([[string substringWithRange:range]
        isEqualToString:@"http://example.com"]);
  }
  ...
  for (NSString *string in strings) {
    NSRange range = [string rangeOfURLInString];
    XCTAssert(
        [[string substringWithRange:range] isEqualToString:@"example.com"]);
  }
}

- (void)testStringByRemovingEnclosingBrackets {
  XCTAssert(
      [@"abc" isEqualToString:[@"abc" stringByRemovingEnclosingBrackets]]);
  ...
  XCTAssert(
      [@"abc" isEqualToString:[@"<[abc]>" stringByRemovingEnclosingBrackets]]);
  XCTAssert([@"<[abc>]"
      isEqualToString:[@"<[abc>]" stringByRemovingEnclosingBrackets]]);
}
...
- (void)testStringMatchesCaseInsensitiveGlobPattern {
  ...
  XCTAssertTrue([@"abc" stringMatchesGlobPattern:@"a*b*c*" caseSensitive:NO]);
  XCTAssertTrue([@"abc" stringMatchesGlobPattern:@"*a*b*c*" caseSensitive:NO]);
  XCTAssertTrue([@"abc" stringMatchesGlobPattern:@"***a****b****c****"
                                   caseSensitive:NO]);
  ...
  XCTAssertFalse([@"abc" stringMatchesGlobPattern:@"***a****b**x**c****"
                                    caseSensitive:NO]);

  // Longer string tests
  XCTAssertTrue([@"abcdefghi" stringMatchesGlobPattern:@"a*d*g*i"
                                         caseSensitive:NO]);
  XCTAssertTrue([@"abcdefghi" stringMatchesGlobPattern:@"a*d*g*"
                                         caseSensitive:NO]);
  XCTAssertFalse([@"abcdefghi" stringMatchesGlobPattern:@"a*q*g*"
                                          caseSensitive:NO]);
...
- (void)testComponentsBySplittingStringWithQuotesAndBackslashEscaping_Basic {
  ...
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"foo", @"bar" ];
  XCTAssertEqualObjects(actual, expected);
}

- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_BackslashEscapesMidlineSpace {
  NSString *s = @"foo\\ bar";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"foo bar" ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_BackslashEscapesLeadingTrailingSpace {
  NSString *s = @"\\ foo bar\\ ";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @" foo", @"bar " ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_BackslashEscapesSingleQuote {
  NSString *s = @"foo\\' bar";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"foo'", @"bar" ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_BackslashEscapesDoubleQuote {
  NSString *s = @"foo\\\" bar";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"foo\"", @"bar" ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_BackslashEscapesBackslash {
  NSString *s = @"foo\\\\ bar";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"foo\\", @"bar" ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_CustomEscapes {
  NSString *s = @"foo \\1";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{
        @'1' : @"bar"
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_QuotedCustomEscapes {
  NSString *s = @"foo \"\\1\"";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{
        @'1' : @"bar"
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_DoubleQuotesWithSpace {
  NSString *s = @"foo\" \"bar";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"foo bar" ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_DoubleQuotesWithSingleQuote {
  NSString *s = @"foo\"'\"bar";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"foo'bar" ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_DoubleQuotesWithEscapedDoubleQuote {
  NSString *s = @"foo\"\\\"\"bar";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"foo\"bar" ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_SingleQuotesWithEscapedLetter {
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_SingleQuotesWithSpace {
  NSString *s = @"foo' 'bar";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"foo bar" ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_SingleQuotesWithDoubleQuote {
  NSString *s = @"foo'\"'bar";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"foo\"bar" ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_SingleQuotesWithEscapedSingleQuote {
  NSString *s = @"foo'\\''bar'";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"foo\\bar" ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_MismatchedDoubleQuotes {
  NSString *s = @"foo\" bar";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"foo bar" ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_MismatchedSingleQuotes {
  NSString *s = @"foo' bar";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"foo bar" ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_OrphanBackslash {
  NSString *s = @"foo bar\\";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"foo", @"bar" ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_ExpandTilde {
  NSString *s = @"~/foo bar";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_MidlineTilde {
  NSString *s = @"fo~o bar";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_EscapedTilde {
  NSString *s = @"\\~/foo bar";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"~/foo", @"bar" ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_DoubleQuotedTilde {
  NSString *s = @"\"~/foo\" bar";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"~/foo", @"bar" ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_SingleQuotedTilde {
  NSString *s = @"'~/foo' bar";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"~/foo", @"bar" ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_TrimSpace {
  NSString *s = @"  foo   bar  ";
  NSArray<NSString *> *actual =
      [s componentsBySplittingStringWithQuotesAndBackslashEscaping:@{}];
  NSArray<NSString *> *expected = @[ @"foo", @"bar" ];
...
- (void)
    testComponentsBySplittingStringWithQuotesAndBackslashEscaping_BackslashInQuotes {
...
- (void)testEnumerateSwiftySubstrings_Literal {
  ...
  NSMutableArray<iTermTuple<NSString *, NSNumber *> *> *actual =
      [NSMutableArray array];
  [s enumerateSwiftySubstrings:^(NSUInteger index, NSString *substring,
                                 BOOL isLiteral, BOOL *stop) {
    [actual addObject:[iTermTuple tupleWithObject:substring
                                        andObject:@(isLiteral)]];
  }];
  XCTAssertEqualObjects(actual, expected);
}
...
- (void)testEnumerateSwiftySubstrings_ExpressionContainingNestedExpression {
  ...
  NSArray<iTermTuple<NSString *, NSNumber *> *> *expected =
      @[ [iTermTuple tupleWithObject:@"foo(\"bar\(inner(x,y))\")"
                           andObject:@NO] ];
  NSMutableArray<iTermTuple<NSString *, NSNumber *> *> *actual =
      [NSMutableArray array];
  [s enumerateSwiftySubstrings:^(NSUInteger index, NSString *substring,
...
- (void)
    testEnumerateSwiftySubstrings_ExpressionContainingNestedExpressionWithString {
  NSString *s = @"\\(foo(\"bar\(inner(\"innerstring\",y))\"))";
  NSArray<iTermTuple<NSString *, NSNumber *> *> *expected =
      @[ [iTermTuple tupleWithObject:@"foo(\"bar\(inner(\"innerstring\",y))\")"
                           andObject:@NO] ];
  NSMutableArray<iTermTuple<NSString *, NSNumber *> *> *actual =
      [NSMutableArray array];
  [s enumerateSwiftySubstrings:^(NSUInteger index, NSString *substring,
...
- (void)testReplaceControlCharactersWithCaretLetter_JustAControlCharacter {
  NSString *actual = [[NSString stringWithFormat:@"%c", 1]
...
- (void)testReplaceControlCharactersWithCaretLetter_Backspace {
  NSString *actual = [[NSString stringWithFormat:@"%c", 0x7f]
      stringByReplacingControlCharactersWithCaretLetter];
  XCTAssertEqualObjects(actual, @"^?");
}

- (void)testReplaceControlCharactersWithCaretLetter_JustTwoControlCharacters {
  NSString *actual = [[NSString stringWithFormat:@"%c%c", 1, 2]
      stringByReplacingControlCharactersWithCaretLetter];
  XCTAssertEqualObjects(actual, @"^A^B");
}

- (void)
    testReplaceControlCharactersWithCaretLetter_MixOfRegularAndControlCharacters {
  NSString *actual = [[NSString stringWithFormat:@"12%c34%c56", 1, 2]
      stringByReplacingControlCharactersWithCaretLetter];
