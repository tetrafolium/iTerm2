...
- (void)testBasic {
  ...
  iTermProcessInfo *info3 = [collection addProcessWithProcessID:3
                                                parentProcessID:2];
  [info3 privateSetIsForegroundJob:YES];

  // ? -> x -> y+
  [collection addProcessWithProcessID:10 parentProcessID:9];
  [[collection addProcessWithProcessID:11
                       parentProcessID:10] privateSetIsForegroundJob:YES];
...
- (void)inCollection:(iTermProcessCollection *)collection
  ...
  iTermProcessInfo *info = [collection addProcessWithProcessID:pid
...
- (void)testMultipleChildren {
  ...
  [self inCollection:collection
      addProcessWithProcessID:a
              parentProcessID:0
              isForegroundJob:NO];
  [self inCollection:collection
      addProcessWithProcessID:b
              parentProcessID:a
              isForegroundJob:NO];
  [self inCollection:collection
      addProcessWithProcessID:c
              parentProcessID:a
              isForegroundJob:NO];
  [self inCollection:collection
      addProcessWithProcessID:d
              parentProcessID:c
              isForegroundJob:YES];
  [self inCollection:collection
      addProcessWithProcessID:e
              parentProcessID:a
              isForegroundJob:NO];
  [self inCollection:collection
      addProcessWithProcessID:f
              parentProcessID:e
              isForegroundJob:NO];
  [self inCollection:collection
      addProcessWithProcessID:g
              parentProcessID:f
              isForegroundJob:YES];
...
- (void)testCycle {
  ...
  XCTAssertNil(actual, @"failed to find cycle in collection %@",
               collection.treeString);
