...
- (void)testFulfillFollowedByThen {
  iTermPromise<NSNumber *> *promise =
      [iTermPromise promise:^(id<iTermPromiseSeal> seal) {
        [seal fulfill:@123];
      }];
...
- (void)testFulfillFollowedByChain {
  iTermPromise<NSNumber *> *promise1 =
      [iTermPromise promise:^(id<iTermPromiseSeal> seal) {
        [seal fulfill:@123];
      }];
  __block int count = 0;
...
- (void)testChainFollowedByFulfill {
  ...
  __block int count = 0;
  iTermPromise<NSNumber *> *promise2 =
      [promise1 then:^(NSNumber *_Nonnull value) {
        XCTAssertEqualObjects(value, @123);
        count++;
      }];
  iTermPromise<NSNumber *> *promise3 = [promise2 then:^(NSNumber *value) {
