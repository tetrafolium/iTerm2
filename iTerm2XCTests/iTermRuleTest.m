...
@implementation iTermRuleTest {
  ...
  iTermRule
      *_usernameWildcardActualPath; // username@service*.*.hostname.com:path
  ...
  iTermRule *
      _usernameWildcardActualPathJob; // username@service*.*.hostname.com:path&job
...
- (void)setUp {
  ...
  _usernameWildcardStartPath =
      [iTermRule ruleWithString:@"username@*hostname:/path"];
  _usernameWildcardEndPath =
      [iTermRule ruleWithString:@"username@hostname*:/path"];
  _usernameWildcardStartEndPath =
      [iTermRule ruleWithString:@"username@*hostname*:/path"];
  _usernameWildcardMiddlePath =
      [iTermRule ruleWithString:@"username@host*name:/path"];
  _usernameWildcardAllPath =
      [iTermRule ruleWithString:@"username@*host*name*:/path"];
  _usernameWildcardActualPath =
      [iTermRule ruleWithString:@"username@service*.*.hostname.com:/path"];
  ...
  _usernameHostnamePathJob =
      [iTermRule ruleWithString:@"username@hostname:/path&job"];
  ...
  _usernameWildcardMiddlePathJob =
      [iTermRule ruleWithString:@"username@host*name:/path&job"];
  _usernameWildcardAllPathJob =
      [iTermRule ruleWithString:@"username@*host*name*:/path&job"];
  _usernameWildcardActualPathJob =
      [iTermRule ruleWithString:@"username@service*.*.hostname.com:/path&job"];
...
- (NSArray *)matchingRulesSortedByScoreWithHostname:(NSString *)hostname
  ...
  return [matching
      sortedArrayUsingComparator:^NSComparisonResult(id obj1, id obj2) {
        int score1 = [obj1 scoreForHostname:hostname
                                   username:username
                                       path:path
                                        job:job];
        int score2 = [obj2 scoreForHostname:hostname
                                   username:username
                                       path:path
                                        job:job];
  ...
  NSArray *rules = [self matchingRulesSortedByScoreWithHostname:@"hostname"
                                                       username:@"username"
                                                           path:@"/path"
                                                            job:@"x"];
  NSArray *expected = @[
    _usernameHostnamePath, _usernameHostname, _usernameWildcardStartPath,
    _usernameWildcardEndPath, _usernameWildcardStartEndPath,
    _usernameWildcardMiddlePath, _usernameWildcardAllPath, _hostnamePath,
    _hostname, _usernamePath, _username, _path
  ];
...
- (void)testUsernameWildcardPath {
  NSArray *rules = [self matchingRulesSortedByScoreWithHostname:@"x"
                                                       username:@"username"
                                                           path:@"/path"
                                                            job:@"x"];
  NSArray *expected = @[ _usernamePath, _username, _path ];
  XCTAssertEqualObjects(rules, expected);
}

- (void)testUsernameWildcardStartPath {
  NSArray *rules =
      [self matchingRulesSortedByScoreWithHostname:@"service01.hostname"
                                          username:@"username"
                                              path:@"/path"
                                               job:@"x"];
  NSArray *expected = @[
    _usernameWildcardStartPath, _usernameWildcardStartEndPath,
    _usernameWildcardAllPath, _usernamePath, _username, _path
  ];
  XCTAssertEqualObjects(rules, expected);
}
...
- (void)testUsernameWildcardStartEndPath {
  NSArray *rules =
      [self matchingRulesSortedByScoreWithHostname:@"service01.hostname.com"
                                          username:@"username"
                                              path:@"/path"
                                               job:@"x"];
  NSArray *expected = @[
    _usernameWildcardStartEndPath, _usernameWildcardAllPath, _usernamePath,
    _username, _path
  ];
  XCTAssertEqualObjects(rules, expected);
}
...
- (void)testUsernameWildcardActualPath {
  NSArray *rules = [self
      matchingRulesSortedByScoreWithHostname:@"service01.prod.hostname.com"
                                    username:@"username"
                                        path:@"/path"
                                         job:@"x"];
  NSArray *expected = @[
    _usernameWildcardActualPath, _usernameWildcardStartEndPath,
    _usernameWildcardAllPath, _usernamePath, _username, _path
  ];
  XCTAssertEqualObjects(rules, expected);
}
...
- (void)testHostnamePath {
  NSArray *rules = [self matchingRulesSortedByScoreWithHostname:@"hostname"
                                                       username:@"x"
                                                           path:@"/path"
                                                            job:@"x"];
  NSArray *expected = @[ _hostnamePath, _hostname, _path ];
  XCTAssertEqualObjects(rules, expected);
}
...
- (void)testHostnameJob {
  NSArray *rules = [self matchingRulesSortedByScoreWithHostname:@"hostname"
                                                       username:@"x"
                                                           path:@"x"
                                                            job:@"job"];
  NSArray *expected = @[ _hostnameJob, _hostname, _job ];
  XCTAssertEqualObjects(rules, expected);
}
  ...
  NSArray *rules = [self matchingRulesSortedByScoreWithHostname:@"hostname"
                                                       username:@"username"
                                                           path:@"x"
                                                            job:@"job"];
  NSArray *expected = @[
    _usernameHostnameJob, _hostnameJob, _usernameHostname, _hostname,
    _usernameJob, _job, _username
  ];
  XCTAssertEqualObjects(rules, expected);
}
      ...
      [self matchingRulesSortedByScoreWithHostname:@"service01.hostname"
                                          username:@"username"
                                              path:@"/path"
                                               job:@"job"];
  NSArray *expected = @[
    _usernameWildcardStartPathJob, _usernameWildcardStartEndPathJob,
    _usernameWildcardAllPathJob, _usernameWildcardStartPath,
    _usernameWildcardStartEndPath, _usernameWildcardAllPath, _usernamePathJob,
    _usernameJob, _pathJob, _job, _usernamePath, _username, _path
  ];
  XCTAssertEqualObjects(rules, expected);
}
  ...
  NSArray *rules = [self matchingRulesSortedByScoreWithHostname:@"hostname.com"
                                                       username:@"username"
                                                           path:@"/path"
                                                            job:@"job"];
  NSArray *expected = @[
    _usernameWildcardEndPathJob, _usernameWildcardStartEndPathJob,
    _usernameWildcardAllPathJob, _usernameWildcardEndPath,
    _usernameWildcardStartEndPath, _usernameWildcardAllPath, _usernamePathJob,
    _usernameJob, _pathJob, _job, _usernamePath, _username, _path
  ];
  XCTAssertEqualObjects(rules, expected);
      ...
      [self matchingRulesSortedByScoreWithHostname:@"service01.hostname.com"
                                          username:@"username"
                                              path:@"/path"
                                               job:@"job"];
  NSArray *expected = @[
    _usernameWildcardStartEndPathJob, _usernameWildcardAllPathJob,
    _usernameWildcardStartEndPath, _usernameWildcardAllPath, _usernamePathJob,
    _usernameJob, _pathJob, _job, _usernamePath, _username, _path
  ];
  XCTAssertEqualObjects(rules, expected);
