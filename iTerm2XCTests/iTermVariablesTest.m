...
- (void)testWriteThenRead {
  iTermVariables *vars = [[[iTermVariables alloc]
...
- (void)testReferenceProducesValue {
  ...
  iTermVariableReference *ref =
      [[[iTermVariableReference alloc] initWithPath:@"v"
...
- (void)testChangeOfIntermediate {
  iTermVariables *tab = [[[iTermVariables alloc]
      initWithContext:iTermVariablesSuggestionContextTab
                owner:self] autorelease];
  iTermVariableScope *tabScope =
      [[[iTermVariableScope alloc] init] autorelease];
  [tabScope addVariables:tab toScopeNamed:nil];

  iTermVariables *session1 = [[[iTermVariables alloc]
      initWithContext:iTermVariablesSuggestionContextSession
                owner:self] autorelease];
  iTermVariableScope *session1Scope =
      [[[iTermVariableScope alloc] init] autorelease];
  [session1Scope addVariables:session1 toScopeNamed:nil];

  iTermVariables *session2 = [[[iTermVariables alloc]
      initWithContext:iTermVariablesSuggestionContextSession
                owner:self] autorelease];
  iTermVariableScope *session2Scope =
      [[[iTermVariableScope alloc] init] autorelease];
  ...
  iTermVariableReference *ref =
      [[[iTermVariableReference alloc] initWithPath:@"currentSession.n"
...
- (void)testShadow {
  ...
  iTermVariables *vars2 = [[[iTermVariables alloc]
      initWithContext:iTermVariablesSuggestionContextSession
                owner:self] autorelease];
