...
- (void)assertEntriesInInterval:(Interval *)interval
                          equal:(NSArray *)expectedObjects {
...
- (void)testOneEntry {
  ...
  [self assertEntriesInInterval:MakeInterval(0, 100) equal:@[]];
  [self assertEntriesInInterval:MakeInterval(150, 1000) equal:@[]];
  [self assertEntriesInInterval:MakeInterval(100, 1) equal:@[ obj1_ ]];
  [self assertEntriesInInterval:MakeInterval(125, 1) equal:@[ obj1_ ]];
  [self assertEntriesInInterval:MakeInterval(149, 1) equal:@[ obj1_ ]];
}
