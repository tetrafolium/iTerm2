...
- (void)testEmptyContents {
  ...
  iTermSyntheticConfParser *parser =
      [[iTermTestableSyntheticConfParser alloc] initPrivate];
...
static NSString *const sValidContents =
    @"# create an empty directory named \"foo\" at / which may be mounted "
    @"over\n"
    @"foo\n"
    @"\n"
    @"# create a symbolic link named \"bar\" at / which points to\n"
    @"# \"System/Volumes/Data/bar\", a writeable location at the root of the "
    @"data volume\n"
...
- (void)testIgnoreBadInput {
  NSString *badInput = @"one\ttwo\tthree\n"
                       @"\tx\n"
                       @"y\t";
...
- (void)testSubstituteExactRoot {
  ...
  XCTAssertEqualObjects(
      @"/baz",
      [parser pathByReplacingPrefixWithSyntheticRoot:@"/Users/me/baz"]);
  XCTAssertEqualObjects(
      @"/bar",
      [parser
          pathByReplacingPrefixWithSyntheticRoot:@"/System/Volumes/Data/bar"]);
}
...
- (void)testSubstitutePathPrefix {
  ...
  XCTAssertEqualObjects(
      @"/baz/foo",
      [parser pathByReplacingPrefixWithSyntheticRoot:@"/Users/me/baz/foo"]);
}
...
- (void)testDoNotSubstituteNonPathPrefix {
  ...
  XCTAssertEqualObjects(
      @"/bazX", [parser pathByReplacingPrefixWithSyntheticRoot:@"/bazX"]);
}
