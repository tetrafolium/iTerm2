...
- (BOOL)fileIsLocal:(NSString *)filename
  ...
  NSMutableArray *networkPaths =
      [[_networkMountPoints mutableCopy] autorelease];
...
- (void)setUp {
  ...
  _semanticHistoryController =
      [[[TestSemanticHistoryController alloc] init] autorelease];
...
- (void)testGetFullPathFindsExistingFileAtAbsolutePath {
  ...
  NSString *actual =
      [_semanticHistoryController cleanedUpPathFromPath:kFilename
                                                 suffix:nil
...
- (void)testGetFullPathFindsExistingFileAtRelativePath {
  ...
  [_semanticHistoryController.fakeFileManager.files
      addObject:kAbsoluteFilename];
  NSString *actual =
      [_semanticHistoryController cleanedUpPathFromPath:kRelativeFilename
                                                 suffix:nil
                                       workingDirectory:kWorkingDirectory
                                    extractedLineNumber:&lineNumber
                                           columnNumber:&columnNumber];
...
- (void)testGetFullPathStripsDelimiters {
  for (NSString *delimiters in
    ...
    NSString *columnNumber = nil;
    static NSString *const kFilename = @"/path/to/file";
    NSString *kFilenameWithParens =
        [NSString stringWithFormat:@"%C%@%C", [delimiters characterAtIndex:0],
                                   kFilename, [delimiters characterAtIndex:1]];
    static NSString *const kWorkingDirectory = @"/working/directory";
    [_semanticHistoryController.fakeFileManager.files addObject:kFilename];
    NSString *actual =
        [_semanticHistoryController cleanedUpPathFromPath:kFilenameWithParens
                                                   suffix:nil
                                         workingDirectory:kWorkingDirectory
                                      extractedLineNumber:&lineNumber
                                             columnNumber:&columnNumber];
...
- (void)testGetFullPathStripsTrailingPunctuation {
  for (NSString *punctuation in @[ @".", @")", @",", @":" ]) {
    ...
    static NSString *const kFilename = @"/path/to/file";
    NSString *kFilenameWithParens =
        [kFilename stringByAppendingString:punctuation];
    static NSString *const kWorkingDirectory = @"/working/directory";
    [_semanticHistoryController.fakeFileManager.files addObject:kFilename];
    NSString *actual =
        [_semanticHistoryController cleanedUpPathFromPath:kFilenameWithParens
...
- (void)testGetFullPathExtractsLineNumber {
  ...
  static NSString *const kFilename = @"/path/to/file";
  static NSString *const kWorkingDirectory = @"/working/directory";
  NSString *kFilenameWithLineNumber =
      [kFilename stringByAppendingString:@":123"];
  [_semanticHistoryController.fakeFileManager.files addObject:kFilename];
  NSString *actual =
      [_semanticHistoryController cleanedUpPathFromPath:kFilenameWithLineNumber
                                                 suffix:nil
                                       workingDirectory:kWorkingDirectory
                                    extractedLineNumber:&lineNumber
                                           columnNumber:&columnNumber];
...
- (void)testGetFullPathExtractsLineNumberAndIgnoresColumn {
  ...
  static NSString *const kWorkingDirectory = @"/working/directory";
  NSString *kFilenameWithLineNumber =
      [kFilename stringByAppendingString:@":123:456"];
  [_semanticHistoryController.fakeFileManager.files addObject:kFilename];
  NSString *actual =
      [_semanticHistoryController cleanedUpPathFromPath:kFilenameWithLineNumber
                                                 suffix:nil
...
- (void)
    testGetFullPathExtractsAlternateLineNumberAndColumnSyntax_NoSpaceAfterComma {
  NSString *lineNumber = nil;
  NSString *columnNumber = nil;
  static NSString *const kFilename = @"/path/to/file";
  static NSString *const kWorkingDirectory = @"/working/directory";
...
- (void)testGetFullPathExtractsVeryVerboseLineNumberAndColumnSyntax {
  ...
  static NSString *const kWorkingDirectory = @"/working/directory";
  [_semanticHistoryController.fakeFileManager.files addObject:kFilename];
  NSString *actual = [_semanticHistoryController
      cleanedUpPathFromPath:kFilename
...
- (void)
    testGetFullPathExtractsParenthesesLineNumberAndColumnSyntax_NoSpaceAfterComma {
  NSString *lineNumber = nil;
  NSString *columnNumber = nil;
  static NSString *const kFilename = @"/path/to/file";
  static NSString *const kWorkingDirectory = @"/working/directory";
...
- (void)testGetFullPathWithParensAndTrailingPunctuationExtractsLineNumber {
  ...
  static NSString *const kWorkingDirectory = @"/working/directory";
  NSString *kFilenameWithLineNumber =
      [NSString stringWithFormat:@"(%@:123.)", kFilename];
  [_semanticHistoryController.fakeFileManager.files addObject:kFilename];
  NSString *actual =
      [_semanticHistoryController cleanedUpPathFromPath:kFilenameWithLineNumber
                                                 suffix:nil
...
- (void)testGetFullPathStandardizesDot {
  ...
  [_semanticHistoryController.fakeFileManager.files
      addObject:kAbsoluteFilename];
  [_semanticHistoryController.fakeFileManager.files
      addObject:@"/working/directory/./path/to/file"];
  NSString *actual =
      [_semanticHistoryController cleanedUpPathFromPath:kRelativeFilename
                                                 suffix:nil
                                       workingDirectory:kWorkingDirectory
...
- (void)testGetFullPathStandardizesDotDot {
  ...
  [_semanticHistoryController.fakeFileManager.files
      addObject:kAbsoluteFilename];
  [_semanticHistoryController.fakeFileManager.files
      addObject:@"/working/directory/blah/../path/to/file"];
  NSString *actual =
      [_semanticHistoryController cleanedUpPathFromPath:kRelativeFilename
                                                 suffix:nil
                                       workingDirectory:kWorkingDirectory
...
- (void)testGetFullPathStripsLeadingASlash {
  ...
  [_semanticHistoryController.fakeFileManager.files
      addObject:kAbsoluteFilename];
  NSString *actual = [_semanticHistoryController
      cleanedUpPathFromPath:[@"a/" stringByAppendingString:kRelativeFilename]
                     suffix:nil
           workingDirectory:kWorkingDirectory
        extractedLineNumber:&lineNumber
               columnNumber:&columnNumber];
...
- (void)testGetFullPathStripsLeadingBSlash {
  ...
  [_semanticHistoryController.fakeFileManager.files
      addObject:kAbsoluteFilename];
  NSString *actual = [_semanticHistoryController
      cleanedUpPathFromPath:[@"b/" stringByAppendingString:kRelativeFilename]
                     suffix:nil
           workingDirectory:kWorkingDirectory
        extractedLineNumber:&lineNumber
               columnNumber:&columnNumber];
...
- (void)testGetFullPathRejectsNetworkPaths {
  ...
  [_semanticHistoryController.fakeFileManager.networkMountPoints
      addObject:@"/working"];
...
- (void)testRandomStuffAfterFileNameNotIdentifiedAsPartOfFile {
  static NSString *const kRelativeFilename = @"path/to/file";
  static NSString *const kWorkingDirectory = @"/working/directory";
  static NSString *const possibleFilePart1 =
      @"path/to/file:12:34: blah blah blah";
  static NSString *const possibleFilePart2 = @"raz boom bah";
  [_semanticHistoryController.fakeFileManager.files
      addObject:kWorkingDirectory];
  NSString *kAbsoluteFilename =
      [kWorkingDirectory stringByAppendingPathComponent:kRelativeFilename];
  [_semanticHistoryController.fakeFileManager.files
      addObject:kAbsoluteFilename];
  int prefixChars;
  int suffixChars;
  NSString *filename = [_semanticHistoryController
...
- (void)testOpenPathRawAction {
  ...
  BOOL opened = [self openPath:[_semanticHistoryController
                                   cleanedUpPathFromPath:kStringThatIsNotAPath
                                                  suffix:nil
                                        workingDirectory:@"/"
                                     extractedLineNumber:&lineNumber
                                            columnNumber:&columnNumber]
                 ...
                 substitutions:@{
                   kSemanticHistoryPathSubstitutionKey : [kStringThatIsNotAPath
  ...
  NSString *expectedScript =
      @"Prefix\\ X\\ Suffix:1;;Prefix;Suffix;/tmp;User Variable";
...
- (void)testOpenPathRunsCommandActionForExistingFile {
  ...
  [_semanticHistoryController.fakeFileManager.files
      addObject:kExistingFileAbsolutePath];
  NSString *lineNumber, *columnNumber;
  BOOL opened =
      [self openPath:[_semanticHistoryController
                         cleanedUpPathFromPath:kExistingFileAbsolutePath
                                        suffix:nil
                              workingDirectory:@"/"
                           extractedLineNumber:&lineNumber
                                  columnNumber:&columnNumber]
  ...
  XCTAssert(opened);
  XCTAssert(
      [kCommand isEqualToString:_semanticHistoryController.scriptArguments[1]]);
}
...
- (void)testOpenPathOpensFileForDirectoryWithURLAction {
  ...
  NSString *lineNumber, *columnNumber;
  BOOL opened = [self openPath:[_semanticHistoryController
                                   cleanedUpPathFromPath:kDirectory
                                                  suffix:nil
                                        workingDirectory:@"/"
                                     extractedLineNumber:&lineNumber
                                            columnNumber:&columnNumber]
...
- (void)testOpenPathOpensURLWithProperSubstitutions {
  _semanticHistoryController.prefs = @{
    ...
    kSemanticHistoryTextKey :
        @"http://foo/"
        @"?pwd=\\1&line=\\2&prefix=\\3&suffix=\\4&dir=\\5&uservar=\\(test)"
  };
  ...
  BOOL opened = [self openPath:[_semanticHistoryController
                 ...
                 orRawFilename:kStringThatIsNotAPath
                 substitutions:@{
                   kSemanticHistoryPrefixSubstitutionKey : @"The Prefix",
  ...
  XCTAssert(opened);
  NSURL *expectedURL =
      [NSURL URLWithString:@"http://foo/?pwd=/"
                           @"The%20Path&line=1&prefix=The%20Prefix&suffix=The%"
                           @"20Suffix&dir=/&uservar=User%20Variable"];
...
- (void)testOpenPathOpensTextFileInEditorWhenEditorIsDefaultApp {
  ...
  NSString *expectedUrlString = [NSString
      stringWithFormat:@"mvim://open?url=file:%%2F%%2F%@",
  ...
  XCTAssert([_semanticHistoryController.openedEditor
      isEqualToString:kMacVimIdentifier]);
}

// Open a file with a line number in the default app, which happens to be
// MacVim.
- (void)testOpenPathOpensTextFileInDefaultAppWithLineNumber {
  _semanticHistoryController.prefs =
      @{kSemanticHistoryActionKey : kSemanticHistoryBestEditorAction};
  NSString *kExistingFileAbsolutePath = @"/file/that/exists";
  NSString *fileWithLineNumber =
      [kExistingFileAbsolutePath stringByAppendingString:@":12"];
  [_semanticHistoryController.fakeFileManager.files
      addObject:kExistingFileAbsolutePath];
  _semanticHistoryController.defaultAppIsEditor = YES;
  _semanticHistoryController.bundleIdForDefaultApp =
      kMacVimIdentifier; // Act like macvim is the default for this kind of file

  NSString *lineNumber, *columnNumber;
  BOOL opened = [self openPath:[_semanticHistoryController
                                   cleanedUpPathFromPath:fileWithLineNumber
                                                  suffix:nil
                                        workingDirectory:@"/"
                                     extractedLineNumber:&lineNumber
                                            columnNumber:&columnNumber]
  ...
  NSString *expectedUrlString =
      @"mvim://open?url=file:///file/that/exists&line=12";
  XCTAssertEqualObjects(_semanticHistoryController.openedURL,
                        [NSURL URLWithString:expectedUrlString]);
...
- (void)testOpenPathOpensTextFileAtomEditor {
  ...
  NSString *lineNumber, *columnNumber;
  BOOL opened = [self openPath:[_semanticHistoryController
                                   cleanedUpPathFromPath:
                                       kExistingFileAbsolutePathWithLineNumber
                                                  suffix:nil
                                        workingDirectory:@"/"
                                     extractedLineNumber:&lineNumber
                                            columnNumber:&columnNumber]
  ...
  XCTAssert(opened);
  XCTAssert(
      [kAtomIdentifier isEqualToString:_semanticHistoryController.launchedApp]);
  XCTAssert([kExistingFileAbsolutePathWithLineNumber
      isEqualToString:_semanticHistoryController.launchedAppArg]);
}
...
- (void)testOpenPathOpensTextFileAtomEditorWhenDefaultAppForThisFile {
  ...
  _semanticHistoryController.defaultAppIsEditor = NO;
  _semanticHistoryController.bundleIdForDefaultApp =
      kAtomIdentifier; // Act like Atom is the default app for this file
  NSString *lineNumber, *columnNumber;
  BOOL opened = [self openPath:[_semanticHistoryController
                                   cleanedUpPathFromPath:
                                       kExistingFileAbsolutePathWithLineNumber
...
- (void)testOpenPathOpensTextFileVSCodeEditor {
  ...
  NSString *kExistingFileAbsolutePath = @"/file/that/exists";
  NSString *kExistingFileAbsolutePathWithLineNumber =
      [kExistingFileAbsolutePath stringByAppendingString:@":12:11"];
  [_semanticHistoryController.fakeFileManager.files
      addObject:kExistingFileAbsolutePath];
  _semanticHistoryController.defaultAppIsEditor = NO;
  NSString *lineNumber, *columnNumber;
  BOOL opened = [self openPath:[_semanticHistoryController
                 ...
                 substitutions:@{
                  ...
                  columnNumber:columnNumber];
  XCTAssert(opened);
  XCTAssert([kVSCodeIdentifier
      isEqualToString:_semanticHistoryController.launchedApp]);
  XCTAssert([kExistingFileAbsolutePathWithLineNumber
      isEqualToString:_semanticHistoryController.launchedAppArg]);
}
...
- (void)testOpenPathOpensTextFileVSCodeEditorWhenDefaultAppForThisFile {
  ...
  _semanticHistoryController.defaultAppIsEditor = NO;
  _semanticHistoryController.bundleIdForDefaultApp =
      kVSCodeIdentifier; // Act like VSCode is the default app for this file
  NSString *lineNumber, *columnNumber;
  BOOL opened = [self openPath:[_semanticHistoryController
                                   cleanedUpPathFromPath:
                                       kExistingFileAbsolutePathWithLineNumber
...
- (void)testOpenPathOpensTextFileSublimeText2Editor {
  ...
  BOOL opened = [self openPath:[_semanticHistoryController
                 ...
                 substitutions:@{
                  ...
                  columnNumber:columnNumber];
  XCTAssert(opened);
  XCTAssert([kSublimeText2Identifier
      isEqualToString:_semanticHistoryController.launchedApp]);
  XCTAssert([kExistingFileAbsolutePathWithLineNumber
      isEqualToString:_semanticHistoryController.launchedAppArg]);
}
...
- (void)testOpenPathOpensTextFileSublimeText4Editor {
  ...
  BOOL opened = [self openPath:[_semanticHistoryController
                 ...
                 substitutions:@{
                  ...
                  columnNumber:columnNumber];
  XCTAssert(opened);
  XCTAssert([kSublimeText4Identifier
      isEqualToString:_semanticHistoryController.launchedApp]);
  XCTAssert([kExistingFileAbsolutePathWithLineNumber
      isEqualToString:_semanticHistoryController.launchedAppArg]);
}
...
- (void)testOpenPathOpensTextFileSublimeText3Editor {
  ...
  BOOL opened = [self openPath:[_semanticHistoryController
                 ...
                 substitutions:@{
                  ...
                  columnNumber:columnNumber];
  XCTAssert(opened);
  XCTAssert([kSublimeText3Identifier
      isEqualToString:_semanticHistoryController.launchedApp]);
  XCTAssert([kExistingFileAbsolutePathWithLineNumber
      isEqualToString:_semanticHistoryController.launchedAppArg]);
}
...
- (void)openTextFileInEditorWithIdentifier:(NSString *)editorId
  ...
  NSString *urlString = [NSString
      stringWithFormat:@"%@://open?url=file://%@&line=%@", expectedScheme,
                       [kExistingFileAbsolutePath
                           stringByAddingPercentEncodingWithAllowedCharacters:
                               [NSCharacterSet URLPathAllowedCharacterSet]],
                       [kLineNumber substringFromIndex:1]];
...
- (void)testOpenPathOpensTextFileInMacVim {
  [self openTextFileInEditorWithIdentifier:kMacVimIdentifier
                            expectedScheme:@"mvim"];
}

- (void)testOpenPathOpensTextFileInTextMate {
  [self openTextFileInEditorWithIdentifier:kTextmateIdentifier
                            expectedScheme:@"txmt"];
}

- (void)testOpenPathOpensTextFileInBBEdit {
  // Sadly, BBEdit uses textmate's scheme. This is intentional.
  [self openTextFileInEditorWithIdentifier:kBBEditIdentifier
                            expectedScheme:@"txmt"];
}

// Note there is no test for textmate 2 because it is not directly selectable
// from the menu and it uses the same scheme as textmate, even though its
...
- (void)testPathOfExistingFile_Local {
  ...
  NSString *kFilename =
      [kWorkingDirectory stringByAppendingPathComponent:kRelativeFilename];
  [_semanticHistoryController.fakeFileManager.files addObject:kFilename];
  [_semanticHistoryController.fakeFileManager.directories
      addObject:kWorkingDirectory];
  NSString *path = [_semanticHistoryController
      pathOfExistingFileFoundWithPrefix:@"one two three four five six "
...
// This test simulates what happens if you select a full line (including hard
// eol) and do Open Selection. The prefix will end in whitespace (maybe) and a
// newline. This test uses whitespace trimming.
- (void)testPathOfExistingFileIgnoringLeadingAndTrailingWhitespaceAndNewlines {
  ...
  [_semanticHistoryController.fakeFileManager.directories
      addObject:kWorkingDirectory];
  NSString *path = [_semanticHistoryController
      pathOfExistingFileFoundWithPrefix:@"five six seven eight \r\n"
                                 suffix:@""
                       workingDirectory:kWorkingDirectory
                   charsTakenFromPrefix:&numCharsFromPrefix
                   charsTakenFromSuffix:&numCharsFromSuffix
...
- (void)testPathOfExistingFileSupportsLineNumberAndColumnNumberInParens {
  ...
  [_semanticHistoryController.fakeFileManager.directories
      addObject:kWorkingDirectory];
  NSString *path = [_semanticHistoryController
      pathOfExistingFileFoundWithPrefix:@"file.txt(10"
                                 suffix:@", 10)"
                       workingDirectory:kWorkingDirectory
                   charsTakenFromPrefix:&numCharsFromPrefix
                   charsTakenFromSuffix:&numCharsFromSuffix
...
- (void)testPathOfExistingFileFindsColumnAndLineNumber {
  ...
  [_semanticHistoryController.fakeFileManager.directories
      addObject:kWorkingDirectory];
  NSString *path = [_semanticHistoryController
      pathOfExistingFileFoundWithPrefix:@"file.txt"
                                 suffix:@"(10, 10)"
                       workingDirectory:kWorkingDirectory
                   charsTakenFromPrefix:&numCharsFromPrefix
                   charsTakenFromSuffix:&numCharsFromSuffix
...
- (void)
    testPathOfExistingFileSupportsLineNumberAndColumnNumberAndParensAndNonspaceSeparators {
  int numCharsFromPrefix;
  int numCharsFromSuffix;
  NSString *kWorkingDirectory = @"/directory";
  NSString *kRelativeFilename = @"five.six\tseven eight";
...
- (void)testLeadingWhitespaceIgnoredWithoutTrimming {
  ...
  [_semanticHistoryController.fakeFileManager.directories
      addObject:kWorkingDirectory];
  NSString *path = [_semanticHistoryController
      pathOfExistingFileFoundWithPrefix:@"     "
                                 suffix:@"  test.txt"
                       workingDirectory:kWorkingDirectory
                   charsTakenFromPrefix:&numCharsFromPrefix
                   charsTakenFromSuffix:&numCharsFromSuffix
...
- (void)testColonTextAfterLineNumber {
  ...
  [_semanticHistoryController.fakeFileManager.directories
      addObject:kWorkingDirectory];
  NSString *path = [_semanticHistoryController
      pathOfExistingFileFoundWithPrefix:@"file"
                                 suffix:@".rb:7:in `new`"
                       workingDirectory:kWorkingDirectory
                   charsTakenFromPrefix:&numCharsFromPrefix
                   charsTakenFromSuffix:&numCharsFromSuffix
  ...
  NSString *columnNumber = nil;
  NSString *actual =
      [_semanticHistoryController cleanedUpPathFromPath:path
                                                 suffix:nil
                                       workingDirectory:kWorkingDirectory
                                    extractedLineNumber:&lineNumber
                                           columnNumber:&columnNumber];
...
- (void)testIssue7760 {
  ...
  [_semanticHistoryController.fakeFileManager.files
      addObject:@"/Users/kolbrich/Projects/quill/tmp/"
                @"failure-sandbox_spec-246-screenshot.png"];
  [_semanticHistoryController.fakeFileManager.directories
      addObject:@"/Users/kolbrich/Projects/quill"];

  BOOL opened = [self openPath:@"/Users/kolbrich/Projects/quill/tmp/"
                               @"failure-sandbox_spec-246-screenshot.png"
                 orRawFilename:@"/Users/kolbrich/Projects/quill/tmp/"
                               @"failure-sandbox_spec-246-screenshot.png"
                 substitutions:@{
                   kSemanticHistoryPathSubstitutionKey :
                       @"/Users/kolbrich/Projects/quill/tmp/"
                       @"failure-sandbox_spec-246-screenshot.png",
                   kSemanticHistoryPrefixSubstitutionKey :
                       @"Saving\\ screenshot\\ to\\ "
                       @"/Users/kolbrich/Projects/quill/tmp/failure-",
                   kSemanticHistorySuffixSubstitutionKey :
                       @"sandbox_spec-246-screenshot.png\\",
                   kSemanticHistoryWorkingDirectorySubstitutionKey :
                       @"/Users/kolbrich/Projects/quill",
                   kSemanticHistoryLineNumberKey : @"",
                   kSemanticHistoryColumnNumberKey : @""
                 }
                    lineNumber:@""
  ...
  XCTAssert(opened);
  NSString *expectedScript =
      @"/bin/bash -l -c \"cd /Users/kolbrich/Projects/quill && env "
      @"/usr/local/bin/atom "
      @"/Users/kolbrich/Projects/quill/tmp/"
      @"failure-sandbox_spec-246-screenshot.png:2\"";
  NSString *actualScript = _semanticHistoryController.scriptArguments[1];
  XCTAssertEqualObjects(expectedScript, actualScript);
}
