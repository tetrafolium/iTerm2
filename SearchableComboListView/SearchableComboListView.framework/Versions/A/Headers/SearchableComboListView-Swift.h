...
#pragma clang attribute push(                                                  \
    __attribute__((external_source_symbol(                                     \
        language = "Swift", defined_in = "SearchableComboListView",            \
...
@property(nonatomic, weak)
    id<iTermSearchableComboViewDelegate> _Nullable delegate;
- (nullable instancetype)initWithCoder:(NSCoder *_Nonnull)coder
    SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithGroups:
    (NSArray<iTermSearchableComboViewGroup *> *_Nonnull)groups
...
- (nonnull instancetype)initWithFrame:(NSRect)buttonFrame
                            pullsDown:(BOOL)flag SWIFT_UNAVAILABLE;
...
@protocol iTermSearchableComboViewDelegate
- (void)searchableComboView:(iTermSearchableComboView *_Nonnull)view
              didSelectItem:
                  (iTermSearchableComboViewItem *_Nullable)didSelectItem;
@end
...
- (nonnull instancetype)
    initWithLabel:(NSString *_Nonnull)label
            items:(NSArray<iTermSearchableComboViewItem *> *_Nonnull)items
    OBJC_DESIGNATED_INITIALIZER;
