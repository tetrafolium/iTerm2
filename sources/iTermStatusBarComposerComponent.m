...
@interface iTermStatusBarComposerComponent () <
    iTermsStatusBarComposerViewControllerDelegate>
@end
...
- (iTermsStatusBarComposerViewController *)viewController {
  if (!_viewController) {
    _viewController = [[iTermsStatusBarComposerViewController alloc]
        initWithNibName:@"iTermsStatusBarComposerViewController"
...
- (nullable NSImage *)statusBarComponentIcon {
  return [NSImage it_cacheableImageNamed:@"StatusBarIconComposer"
                                forClass:[self class]];
}
...
- (NSArray<NSString *> *)statusBarComposerSuggestions:
  ...
  NSArray<NSString *> *commands = [[[[self.session commandUses]
      mapWithBlock:^id(iTermCommandHistoryCommandUseMO *anObject) {
