...
// The table contains 256 values that map a reference value to a color value in
// this channel.
...
// Builds and keeps a cache of built models that map colors in a black-on-white
// reference glyph to the colors used in a glyph with an arbitrary foreground
// and background color. Thanks to this mapping, we only need black-on-white
// textures with subpixel antialiasing and the GPU can color them in the
// fragment shader.
