...
typedef enum iTermVertexInputIndex {
  ...
  iTermVertexInputIndexDefaultBackgroundColorInfo, // Points at
...
typedef enum {
  ...
  iTermFragmentInputIndexTextureDimensions =
      2, // Points at iTermTextureDimensions
  iTermFragmentBufferIndexIndicatorAlpha =
      3, // Points at a single float giving alpha value
  iTermFragmentBufferIndexFullScreenFlashColor = 4, // Points at a float4
  iTermFragmentInputIndexAlpha =
      5, // float4 pointer. Used by transparent windows on 10.14
  iTermFragmentInputIndexColor =
      6, // float4. Gives color for letterboxes/pillarboxes
...
typedef enum {
  ...
  iTermMetalGlyphAttributesUnderlineDouble =
      2, // Rendered as a single with a dashed under it. Used for underlined
         // text with hyperlink.
  iTermMetalGlyphAttributesUnderlineDashedSingle = 3,
  iTermMetalGlyphAttributesUnderlineCurly = 4,

  iTermMetalGlyphAttributesUnderlineStrikethrough =
      iTermMetalGlyphAttributesUnderlineStrikethroughFlag,
  iTermMetalGlyphAttributesUnderlineStrikethroughAndSingle =
      iTermMetalGlyphAttributesUnderlineStrikethroughFlag + 1,
  iTermMetalGlyphAttributesUnderlineStrikethroughAndDouble =
      iTermMetalGlyphAttributesUnderlineStrikethroughFlag + 2,
  iTermMetalGlyphAttributesUnderlineStrikethroughAndDashedSingle =
      iTermMetalGlyphAttributesUnderlineStrikethroughFlag + 3,
  iTermMetalGlyphAttributesUnderlineStrikethroughAndCurly =
      iTermMetalGlyphAttributesUnderlineStrikethroughFlag + 4,
} iTermMetalGlyphAttributesUnderline;

typedef struct {
  vector_float4
      defaultBackgroundColor; // Emulates the iTermBackgroundColorView.
} iTermMetalBackgroundColorInfo;
...
typedef struct iTermTextPIU {
  ...
  // What kind of underline to draw. The offset is provided in
