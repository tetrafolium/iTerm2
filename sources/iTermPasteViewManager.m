...
@interface iTermPasteViewManager () <iTermStatusBarProgressComponentDelegate,
...
- (int)remainingLength {
  return _component ? _component.remainingLength
                    : _dropDownViewController.remainingLength;
}
...
- (void)showInStatusBar:(iTermStatusBarViewController *)statusBar {
  ...
  _component = [[iTermStatusBarProgressComponent alloc]
...
- (void)showDropDownInView:(NSView *)superview {
  _dropDownViewController =
      [[PasteViewController alloc] initWithContext:_pasteContext
                                            length:_bufferLength
                                              mini:NO];
  _dropDownViewController.delegate = self;
  _dropDownViewController.view.frame =
      NSMakeRect(20,
