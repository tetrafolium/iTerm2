...
- (id)plistValue {
  NSDictionary *first =
      self.firstObject ? @{iTermTupleValueKey : self.firstObject} : @{};
  NSDictionary *second =
      self.secondObject ? @{iTermTupleValueKey : self.secondObject} : @{};
  return @[ first, second ];
}
...
- (BOOL)isEqual:(id)object {
  ...
  return ((_firstObject == other->_firstObject ||
           [_firstObject isEqual:other->_firstObject]) &&
          (_secondObject == other->_secondObject ||
           [_secondObject isEqual:other->_secondObject]));
}
...
- (NSUInteger)hash {
  return iTermMikeAshHash([_firstObject hash], [_secondObject hash]);
}
...
+ (instancetype)tripleWithObject:(id)firstObject
                       andObject:(id)secondObject
                          object:(id)thirdObject {
  iTermTriple *triple = [super tupleWithObject:firstObject
                                     andObject:secondObject];
...
- (id)plistValue {
  ...
  NSDictionary *second =
      self.secondObject ? @{iTermTupleValueKey : self.secondObject} : @{};
  NSDictionary *third =
      self.thirdObject ? @{iTermTupleValueKey : self.thirdObject} : @{};
...
- (BOOL)isEqual:(id)object {
  ...
  return (_thirdObject == other->_thirdObject ||
          [_thirdObject isEqual:other->_thirdObject]);
}
...
- (NSUInteger)hash {
  return iTermCombineHash([super hash], [_thirdObject hash]);
}
