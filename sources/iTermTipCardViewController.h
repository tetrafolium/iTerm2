...
@property(nonatomic, readonly)
    iTermTipCardActionButton *currentlySelectedButton;
...
// The shortcut is merely an indicator. It's up to the caller to register a
// hotkey and handle it.
- (iTermTipCardActionButton *)addActionWithTitle:(NSString *)title
...
// Returns the size that fits the passed-in size. Really only looks at the
// width.
- (NSSize)sizeThatFits:(NSSize)size;

// Creates Core Animation animations for a change of card height.
// |block| is responsible for animating the window or superview's frame and is
// called in the completion block.
