...
// A non-cryptographic hash for content addressed triggers (helpful for letting
// serialized data reference a trigger).
...
// Index of represented object (usually a NSNumber tag, but could be something
// else)
- (NSInteger)indexForObject:(id)object;
// Represented object (usually a NSNumber tag, but could be something else) at
// an index.
