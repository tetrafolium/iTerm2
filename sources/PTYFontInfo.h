...
// renderBold and renderItalic are inout parameters. Pass in whether you want
// bold/italic and the resulting value is whether it should be rendered as fake
// bold/italic.
...
// Returns a new autoreleased PTYFontInfo with a bold and italic version of this
// font (or nil if none is available).
