...
- (NSImage *)statusBarComponentIcon {
  return [NSImage it_cacheableImageNamed:@"StatusBarIconSnippet"
                                forClass:[self class]];
}
...
- (NSString *)statusBarComponentDetailedDescription {
  return @"When clicked, opens a menu of snippets. Snippets are saved text "
         @"strings that can be pasted quickly.";
}
...
- (void)openMenuWithView:(NSView *)view {
  ...
  iTermSnippetsMenuController *menuController =
      [[iTermSnippetsMenuController alloc] init];
  menuController.menu = menu;

  [menu addItem:[NSMenuItem separatorItem]];

  NSMenuItem *item = [[NSMenuItem alloc] initWithTitle:@"Edit Snippets…"
