...
static NSString *const iTermStatusBarSpringComponentSpringConstantKey =
    @"iTermStatusBarSpringComponentSpringConstantKey";
static NSString *const iTermStatusBarSpringComponentSizeMultipleKey =
...
+ (instancetype)springComponentWithCompressionResistance:
  ...
  NSDictionary *knobs = @{
    iTermStatusBarSpringComponentSpringConstantKey : @(compressionResistance)
  };
  NSDictionary *configuration =
      @{iTermStatusBarComponentConfigurationKeyKnobValues : knobs};
  return
      [[iTermStatusBarSpringComponent alloc] initWithConfiguration:configuration
                                                             scope:nil];
}
...
- (NSView *)statusBarComponentView {
  if (!_view) {
    _view = [[NSView alloc]
        initWithFrame:NSMakeRect(0, 0, self.statusBarComponentMinimumWidth, 0)];
...
- (NSArray<iTermStatusBarComponentKnob *> *)statusBarComponentKnobs {
  ...
  switch (self.advancedConfiguration.layoutAlgorithm) {
  case iTermStatusBarLayoutAlgorithmSettingTightlyPacked:
    springConstantKnob = [[iTermStatusBarComponentKnob alloc]
        initWithLabelText:@"Compression Resistance:"
  ...
  case iTermStatusBarLayoutAlgorithmSettingStable:
    springConstantKnob = [[iTermStatusBarComponentKnob alloc]
        initWithLabelText:@"Size Multiple:"
                     type:iTermStatusBarComponentKnobTypeDouble
              placeholder:@""
             defaultValue:@1
