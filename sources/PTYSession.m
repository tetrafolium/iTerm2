...
static NSString *const PTYSessionDidRepairSavedArrangement =
    @"PTYSessionDidRepairSavedArrangement";

NSString *const PTYSessionCreatedNotification =
    @"PTYSessionCreatedNotification";
NSString *const PTYSessionTerminatedNotification =
    @"PTYSessionTerminatedNotification";
NSString *const PTYSessionRevivedNotification =
    @"PTYSessionRevivedNotification";
NSString *const iTermSessionWillTerminateNotification =
    @"iTermSessionDidTerminate";

NSString *const kPTYSessionTmuxFontDidChange = @"kPTYSessionTmuxFontDidChange";
NSString *const kPTYSessionCapturedOutputDidChange =
    @"kPTYSessionCapturedOutputDidChange";
static NSString *const kSuppressAnnoyingBellOffer =
    @"NoSyncSuppressAnnyoingBellOffer";
static NSString *const kSilenceAnnoyingBellAutomatically =
    @"NoSyncSilenceAnnoyingBellAutomatically";

static NSString *const kTurnOffMouseReportingOnHostChangeUserDefaultsKey =
    @"NoSyncTurnOffMouseReportingOnHostChange";
static NSString *const kTurnOffFocusReportingOnHostChangeUserDefaultsKey =
    @"NoSyncTurnOffFocusReportingOnHostChange";

static NSString
    *const kTurnOffMouseReportingOnHostChangeAnnouncementIdentifier =
        @"TurnOffMouseReportingOnHostChange";
static NSString
    *const kTurnOffFocusReportingOnHostChangeAnnouncementIdentifier =
        @"TurnOffFocusReportingOnHostChange";
...
static NSString *const __attribute__((unused))
SESSION_ARRANGEMENT_BOOKMARK_NAME_DEPRECATED = @"Bookmark Name";
static NSString *const SESSION_ARRANGEMENT_WORKING_DIRECTORY =
    @"Working Directory";
...
static NSString *const SESSION_ARRANGEMENT_TMUX_ALT_HISTORY =
    @"Tmux AltHistory";
...
static NSString *const SESSION_ARRANGEMENT_TMUX_GATEWAY_SESSION_NAME =
    @"Tmux Gateway Session Name";
static NSString *const SESSION_ARRANGEMENT_TMUX_DCS_ID = @"Tmux DCS ID";
static NSString *const SESSION_ARRANGEMENT_TMUX_GATEWAY_SESSION_ID =
    @"Tmux Gateway Session ID";
static NSString *const SESSION_ARRANGEMENT_NAME_CONTROLLER_STATE =
    @"Name Controller State";
static NSString *const __attribute__((unused))
DEPRECATED_SESSION_ARRANGEMENT_DEFAULT_NAME_DEPRECATED =
    @"Session Default Name"; // manually set name
static NSString *const __attribute__((unused))
DEPRECATED_SESSION_ARRANGEMENT_WINDOW_TITLE_DEPRECATED =
    @"Session Window Title"; // server-set window name
static NSString *const __attribute__((unused))
DEPRECATED_SESSION_ARRANGEMENT_NAME_DEPRECATED =
    @"Session Name"; // server-set "icon" (tab) name
static NSString *const SESSION_ARRANGEMENT_GUID =
    @"Session GUID"; // A truly unique ID.
static NSString *const SESSION_ARRANGEMENT_LIVE_SESSION =
    @"Live Session"; // If zoomed, this gives the "live" session's arrangement.
static NSString *const SESSION_ARRANGEMENT_SUBSTITUTIONS =
    @"Substitutions"; // Dictionary for $$VAR$$ substitutions
static NSString *const SESSION_UNIQUE_ID =
    @"Session Unique ID"; // DEPRECATED. A string used for restoring
                          // soft-terminated sessions for arrangements that
                          // predate the introduction of the GUID.
static NSString *const SESSION_ARRANGEMENT_SERVER_PID =
    @"Server PID"; // PID for server process for restoration. Only for
                   // monoserver.
// Not static because the ARC category uses it.
NSString *const SESSION_ARRANGEMENT_SERVER_DICT =
    @"Server Dict"; // NSDictionary. Describes server connection. Only for
                    // multiserver.
// TODO: Make server report the TTY to us since orphans will end up with a nil
// tty.
static NSString *const SESSION_ARRANGEMENT_TTY =
    @"TTY"; // TTY name. Used when using restoration to connect to a restored
            // server.
static NSString *const SESSION_ARRANGEMENT_VARIABLES =
    @"Variables"; // _variables
static NSString *const SESSION_ARRANGEMENT_COMMAND_RANGE =
    @"Command Range"; // VT100GridCoordRange
...
static NSString
    *const SESSION_ARRANGEMENT_SHELL_INTEGRATION_EVER_USED_DEPRECATED =
        @"Shell Integration Ever Used"; // BOOL
static NSString *const SESSION_ARRANGEMENT_SHOULD_EXPECT_PROMPT_MARKS =
    @"Should Expect Prompt Marks"; // BOOL
...
static NSString *const SESSION_ARRANGEMENT_ALERT_ON_NEXT_MARK =
    @"Alert on Next Mark"; // BOOL
static NSString *const SESSION_ARRANGEMENT_COMMANDS =
    @"Commands"; // Array of strings
static NSString *const SESSION_ARRANGEMENT_DIRECTORIES =
    @"Directories"; // Array of strings
static NSString *const SESSION_ARRANGEMENT_HOSTS =
    @"Hosts"; // Array of VT100RemoteHost
static NSString *const SESSION_ARRANGEMENT_CURSOR_GUIDE =
    @"Cursor Guide"; // BOOL
static NSString *const SESSION_ARRANGEMENT_LAST_DIRECTORY =
    @"Last Directory"; // NSString
static NSString *const SESSION_ARRANGEMENT_LAST_LOCAL_DIRECTORY =
    @"Last Local Directory"; // NSString
static NSString *const
    SESSION_ARRANGEMENT_LAST_DIRECTORY_IS_UNSUITABLE_FOR_OLD_PWD_DEPRECATED =
        @"Last Directory Is Remote"; // BOOL
static NSString *const SESSION_ARRANGEMENT_SELECTION =
    @"Selection"; // Dictionary for iTermSelection.
static NSString *const SESSION_ARRANGEMENT_APS =
    @"Automatic Profile Switching"; // Dictionary of APS state.

static NSString *const SESSION_ARRANGEMENT_PROGRAM =
    @"Program"; // Dictionary. See kProgram constants below.
static NSString *const SESSION_ARRANGEMENT_ENVIRONMENT =
    @"Environment"; // Dictionary of environment vars program was run in
static NSString *const SESSION_ARRANGEMENT_KEYLABELS =
    @"Key Labels"; // Dictionary string -> string
static NSString *const SESSION_ARRANGEMENT_KEYLABELS_STACK =
    @"Key Labels Stack"; // Array of encoded iTermKeyLables dicts
static NSString *const SESSION_ARRANGEMENT_IS_UTF_8 =
    @"Is UTF-8"; // TTY is in utf-8 mode
static NSString *const SESSION_ARRANGEMENT_HOTKEY =
    @"Session Hotkey"; // NSDictionary iTermShortcut dictionaryValue
static NSString *const SESSION_ARRANGEMENT_FONT_OVERRIDES =
    @"Font Overrides"; // Not saved; just used internally when creating a new
                       // tmux session.
static NSString *const SESSION_ARRANGEMENT_SHORT_LIVED_SINGLE_USE =
    @"Short Lived Single Use"; // BOOL
...
static NSString *const SESSION_ARRANGEMENT_AUTOLOG_FILENAME =
    @"AutoLog File Name"; // NSString. New as of 12/4/19
static NSString *const SESSION_ARRANGEMENT_REUSABLE_COOKIE =
    @"Reusable Cookie"; // NSString.
static NSString *const SESSION_ARRANGEMENT_OVERRIDDEN_FIELDS =
    @"Overridden Fields"; // NSArray<NSString *>

// Keys for dictionary in SESSION_ARRANGEMENT_PROGRAM
static NSString *const kProgramType =
    @"Type"; // Value will be one of the kProgramTypeXxx constants.
static NSString *const kProgramCommand =
    @"Command"; // For kProgramTypeCommand: value is command to run.
static NSString *const kCustomShell = @"Custom Shell";

// Values for kProgramType
static NSString *const kProgramTypeShellLauncher =
    @"Shell Launcher"; // Use iTerm2 --launch_shell
static NSString *const kProgramTypeCommand =
    @"Command"; // Use command in kProgramCommand
...
// Grace period to avoid failing to write anti-idle code when timer runs just
// before when the code should be sent.
...
@interface PTYSession () <
    iTermAutomaticProfileSwitcherDelegate, iTermBackgroundDrawingHelperDelegate,
    iTermBadgeLabelDelegate, iTermCoprocessDelegate,
    iTermCopyModeHandlerDelegate, iTermComposerManagerDelegate,
    iTermHotKeyNavigableSession, iTermIntervalTreeObserver, iTermLogging,
    iTermMetaFrustrationDetector, iTermMetalGlueDelegate,
    iTermModifyOtherKeysMapperDelegate, iTermNaggingControllerDelegate,
    iTermObject, iTermPasteHelperDelegate, iTermSessionNameControllerDelegate,
    iTermSessionViewDelegate, iTermStandardKeyMapperDelegate,
    iTermStatusBarViewControllerDelegate, iTermTermkeyKeyMapperDelegate,
    iTermTmuxControllerSession, iTermUpdateCadenceControllerDelegate,
...
// Time since reference date when last output was received. New output in a
// brief period after the session is resized is ignored to avoid making the
// spinner spin due to resizing.
...
@property(nonatomic, retain) VT100RemoteHost
...
@property(nonatomic, retain)
    iTermAutomaticProfileSwitcher *automaticProfileSwitcher;
...
@implementation PTYSession {
  ...
  // A view that wraps the textview. It is the scrollview's document. This
  // exists to provide a top margin above the textview.
  TextViewWrapper *_wrapper;

  // Anti-idle timer that sends a character every so often to the host.
  NSTimer *_antiIdleTimer;

  // The bookmark the session was originally created with so those settings can
  ...
  // that have been customized. Changes in the original profile will be copied
  // over to profile except for these keys.
  NSMutableSet *_overriddenFields;

  // A digital video recorder for this session that implements the instant
  // replay feature. These are non-null while showing instant replay.
  DVR *_dvr;
  DVRDecoder *_dvrDecoder;

  // Set only if this is not a live session (we are showing instant replay). Is
  // a pointer to the hidden live session while looking at the past.
  ...
  // If not nil, we're aggregating text to append to a pasteboard. The
  // pasteboard will be updated when this is set to nil.
  ...
  // The tmux rename-window command is only sent when the name field resigns
  // first responder. This tracks if a tmux client's name has changed but the
  // tmux server has not been informed yet.
  BOOL _tmuxTitleOutOfSync;
  PTYSessionTmuxMode _tmuxMode;
  BOOL _tmuxWindowClosingByClientRequest;
  // This is the write end of a pipe for tmux clients. The read end is in
  // TaskNotifier.
  ...
  // The last time at which a partial-line trigger check occurred. This keeps us
  // from wasting CPU checking long lines over and over.
  ...
  // Tokens get queued when a shell enters the paused state. If it gets
  // unpaused, then these are executed before any others.
  ...
  // Synthetic sessions are used for "zoom in" and DVR, and their closing cannot
  // be undone.
  BOOL _synthetic;
  ...
  NSMutableDictionary<id, ITMNotificationRequest *>
      *_keyboardFilterSubscriptions;
  ...
  // Used by auto-hide. We can't auto hide the tmux gateway session until at
  // least one window has been opened.
  ...
  // When this is true, changing the font size does not cause the window size to
  // change.
  BOOL _windowAdjustmentDisabled;
  NSSize _badgeLabelSizeFraction;

  // To debug a problem where a session is divorced but its guid is not in the
  // sessions instance profile model.
  ...
  // If nonnil, gives the GUID of the session from the arrangement that created
  // it. Often this will differ from its real GUID. It only serves to find the
  // session in the arrangement to make repairs.
...
+ (NSMapTable<NSString *, PTYSession *> *)sessionMap {
  ...
  dispatch_once(&onceToken, ^{
    NSPointerFunctionsOptions weakWeak =
...
- (instancetype)initSynthetic:(BOOL)synthetic {
  ...
  if (self) {
    ...
    _adaptiveFrameRateThroughputThreshold =
    ...
    // Experimentally, this is enough to keep the queue primed but not
    // overwhelmed.
    // TODO: How do slower machines fare?
    static const int kMaxOutstandingExecuteCalls = 4;
    _executionSemaphore =
        dispatch_semaphore_create(kMaxOutstandingExecuteCalls);
    ...
    // Allocate a guid. If we end up restoring from a session during startup
    // this will be replaced.
    _guid = [[NSString uuid] retain];
    [[PTYSession sessionMap] setObject:self forKey:_guid];

    _variables = [[iTermVariables alloc]
        initWithContext:iTermVariablesSuggestionContextSession
                  owner:self];
    // Alias for legacy paths
    [self.variablesScope setValue:_variables
                 forVariableNamed:@"session"
                             weak:YES];
    _userVariables = [[iTermVariables alloc]
    ...
    [self.variablesScope setValue:[@(_autoLogId) stringValue]
                 forVariableNamed:iTermVariableKeySessionAutoLogID];
    [self.variablesScope setValue:_guid
                 forVariableNamed:iTermVariableKeySessionID];
    [self.variablesScope setValue:@""
                 forVariableNamed:iTermVariableKeySessionSelection];
    [self.variablesScope setValue:@0
                 forVariableNamed:iTermVariableKeySessionSelectionLength];
    _variables.primaryKey = iTermVariableKeySessionID;
    _jobPidRef = [[iTermVariableReference alloc]
        initWithPath:iTermVariableKeySessionJobPid
    ...
    _autoNameSwiftyString = [[iTermSwiftyString alloc]
          initWithScope:self.variablesScope
             sourcePath:iTermVariableKeySessionAutoNameFormat
        destinationPath:iTermVariableKeySessionAutoName];
    _autoNameSwiftyString.observer =
        ^NSString *(NSString *_Nonnull newValue, NSError *error) {
    ...
    _lastOrCurrentlyRunningCommandAbsRange =
    ...
    _automaticProfileSwitcher =
        [[iTermAutomaticProfileSwitcher alloc] initWithDelegate:self];
    _throughputEstimator =
        [[iTermThroughputEstimator alloc] initWithHistoryOfDuration:5.0 / 30.0
                                                   secondsPerBucket:1 / 30.0];
    _cadenceController = [[iTermUpdateCadenceController alloc]
        initWithThroughputEstimator:_throughputEstimator];
    ...
    iTermStandardKeyMapper *standardKeyMapper =
        [[iTermStandardKeyMapper alloc] init];
    ...
    [[iTermFindPasteboard sharedInstance]
        addObserver:self
              block:^(NSString *_Nonnull newValue) {
    ...
    if (!synthetic) {
      [[NSNotificationCenter defaultCenter]
          postNotificationName:PTYSessionCreatedNotification
                        object:self];
    }
  }
  return self;
...
- (void)iterm_dealloc {
  ...
  [self stopTailFind]; // This frees the substring in the tail find context, if
                       // needed.
  _shell.delegate = nil;
...
- (NSString *)description {
  return [NSString stringWithFormat:@"<%@: %p %dx%d metal=%@ id=%@>",
                                    [self class], self, [_screen width],
                                    [_screen height], @(self.useMetal), _guid];
}
...
- (void)didFinishInitialization {
  ...
  if ([self.variablesScope
          valueForVariableName:iTermVariableKeySessionUsername] == nil) {
    [self.variablesScope setValue:NSUserName()
                 forVariableNamed:iTermVariableKeySessionUsername];
  }
  if ([self.variablesScope
          valueForVariableName:iTermVariableKeySessionHostname] == nil) {
    NSString *const name = [NSHost fullyQualifiedDomainName];
    if ([self.variablesScope
            valueForVariableName:iTermVariableKeySessionHostname] == nil) {
      [self.variablesScope setValue:name
                   forVariableNamed:iTermVariableKeySessionHostname];
    }
  }
}
...
- (void)appendLinesMatchingQuery:(NSString *)query
                     fromSession:(PTYSession *)source {
  [_screen appendLinesMatchingQuery:query
                               from:source.screen
                               mode:self.textview.findContext.mode];
}

- (void)appendLinesInRange:(NSRange)rangeOfLines
               fromSession:(PTYSession *)source {
...
+ (void)drawArrangementPreview:(NSDictionary *)arrangement frame:(NSRect)frame {
  Profile *theBookmark = [[ProfileModel sharedInstance]
      bookmarkWithGuid:arrangement[SESSION_ARRANGEMENT_BOOKMARK][KEY_GUID]];
  if (!theBookmark) {
    theBookmark = [arrangement objectForKey:SESSION_ARRANGEMENT_BOOKMARK];
  }
  //    [self setForegroundColor:[ITAddressBookMgr decodeColor:[aDict
  //    objectForKey:KEY_FOREGROUND_COLOR]]];
  [[ITAddressBookMgr
      decodeColor:[theBookmark objectForKey:KEY_BACKGROUND_COLOR]] set];
  NSRectFill(frame);
}

- (void)setSizeFromArrangement:(NSDictionary *)arrangement {
  [self setSize:VT100GridSizeMake(
                    [[arrangement objectForKey:SESSION_ARRANGEMENT_COLUMNS]
                        intValue],
                    [[arrangement objectForKey:SESSION_ARRANGEMENT_ROWS]
                        intValue])];
}
...
+ (NSDictionary *)repairedArrangement:(NSDictionary *)arrangement
  ...
  if ([arrangement[SESSION_ARRANGEMENT_BOOKMARK][KEY_GUID]
          isEqualToString:badGuid]) {
...
+ (NSDictionary *)repairedArrangement:(NSDictionary *)arrangement
  ...
  if ([arrangement[SESSION_ARRANGEMENT_GUID] isEqualToString:guid]) {
    return [arrangement
        dictionaryBySettingObject:replacementOldCWD
...
+ (void)
    finishInitializingArrangementOriginatedSession:(PTYSession *)aSession
  ...
  // This is done after divorce out of paranoia, since it will modify the
  // profile.
  ...
  if (shortcutDictionary) {
    [[iTermSessionHotkeyController sharedInstance]
        setShortcut:[iTermShortcut shortcutWithDictionary:shortcutDictionary]
         forSession:aSession];
    [aSession setSessionSpecificProfileValues:@{
      KEY_SESSION_HOTKEY : shortcutDictionary
    }];
  }

  NSArray *history =
      [arrangement objectForKey:SESSION_ARRANGEMENT_TMUX_HISTORY];
  if (history) {
  ...
  [aSession.nameController
      restoreNameFromStateDictionary:
          arrangement[SESSION_ARRANGEMENT_NAME_CONTROLLER_STATE]];
  if (arrangement[SESSION_ARRANGEMENT_VARIABLES]) {
    ...
    for (id key in variables) {
      ...
      if ([[aSession.variablesScope valueForVariableName:key]
              isKindOfClass:[iTermVariables class]]) {
        // Don't replace nonterminals.
        continue;
      }
      if (!attachedToServer &&
          [key isEqualToString:iTermVariableKeySessionTTY]) {
        // When starting a new session, don't restore the tty. We *do* want to
        // restore it when attaching to a session restoration server, though. We
        // have a reasonable believe that it's the same process and therefore
        // the same TTY.
        continue;
      }
  ...
  if (!didRestoreContents) {
    if (arrangement
            [SESSION_ARRANGEMENT_SHELL_INTEGRATION_EVER_USED_DEPRECATED]) {
      // Legacy migration path
      const BOOL shellIntegrationEverUsed = [arrangement
              [SESSION_ARRANGEMENT_SHELL_INTEGRATION_EVER_USED_DEPRECATED]
          boolValue];
      ...
      aSession->_shouldExpectPromptMarks =
          [arrangement[SESSION_ARRANGEMENT_SHOULD_EXPECT_PROMPT_MARKS]
              boolValue];
      aSession->_shouldExpectCurrentDirUpdates =
          [arrangement[SESSION_ARRANGEMENT_SHOULD_EXPECT_CURRENT_DIR_UPDATES]
              boolValue];
    }
  }

  aSession->_workingDirectoryPollerDisabled =
      [arrangement[SESSION_ARRANGEMENT_WORKING_DIRECTORY_POLLER_DISABLED]
          boolValue] ||
      aSession->_shouldExpectCurrentDirUpdates;
  if (arrangement[SESSION_ARRANGEMENT_COMMANDS]) {
    [aSession.commands
        addObjectsFromArray:arrangement[SESSION_ARRANGEMENT_COMMANDS]];
    [aSession trimCommandsIfNeeded];
  }
  if (arrangement[SESSION_ARRANGEMENT_DIRECTORIES]) {
    [aSession.directories
        addObjectsFromArray:arrangement[SESSION_ARRANGEMENT_DIRECTORIES]];
  ...
  if (arrangement[SESSION_ARRANGEMENT_HOSTS]) {
    for (NSDictionary *host in arrangement[SESSION_ARRANGEMENT_HOSTS]) {
      VT100RemoteHost *remoteHost =
          [[[VT100RemoteHost alloc] initWithDictionary:host] autorelease];
      if (remoteHost) {
  ...
  if (arrangement[SESSION_ARRANGEMENT_APS]) {
    aSession.automaticProfileSwitcher = [[iTermAutomaticProfileSwitcher alloc]
        initWithDelegate:aSession
              savedState:arrangement[SESSION_ARRANGEMENT_APS]];
  }
  aSession.cursorTypeOverride =
      arrangement[SESSION_ARRANGEMENT_CURSOR_TYPE_OVERRIDE];
  if (didRestoreContents && attachedToServer) {
    ...
    if (interval) {
      VT100GridRange gridRange =
          [aSession.screen lineNumberRangeOfInterval:interval];
      aSession->_lastPromptLine =
          gridRange.location + aSession.screen.totalScrollbackOverflow;
    }

    if (arrangement[SESSION_ARRANGEMENT_COMMAND_RANGE]) {
      aSession->_commandRange =
          [arrangement[SESSION_ARRANGEMENT_COMMAND_RANGE] gridCoordRange];
    }
    if (arrangement[SESSION_ARRANGEMENT_ALERT_ON_NEXT_MARK]) {
      aSession->_alertOnNextMark =
          [arrangement[SESSION_ARRANGEMENT_ALERT_ON_NEXT_MARK] boolValue];
    }
    if (arrangement[SESSION_ARRANGEMENT_CURSOR_GUIDE]) {
      aSession.textview.highlightCursorLine =
          [arrangement[SESSION_ARRANGEMENT_CURSOR_GUIDE] boolValue];
    }
    ...
    if (arrangement[SESSION_ARRANGEMENT_LAST_DIRECTORY]) {
      ...
      aSession->_lastDirectory =
          [arrangement[SESSION_ARRANGEMENT_LAST_DIRECTORY] copy];
      const BOOL isRemote = [arrangement
              [SESSION_ARRANGEMENT_LAST_DIRECTORY_IS_UNSUITABLE_FOR_OLD_PWD_DEPRECATED]
          boolValue];
      if (!isRemote) {
    ...
    if (arrangement[SESSION_ARRANGEMENT_LAST_LOCAL_DIRECTORY]) {
      aSession.lastLocalDirectory =
          arrangement[SESSION_ARRANGEMENT_LAST_LOCAL_DIRECTORY];
    }
  }
  ...
  if (liveArrangement) {
    SessionView *liveView =
        [[[SessionView alloc] initWithFrame:sessionView.frame] autorelease];
    if (@available(macOS 10.11, *)) {
  ...
  if (shouldEnterTmuxMode) {
    ...
    [aSession.tmuxController
        sessionChangedTo:arrangement
                             [SESSION_ARRANGEMENT_TMUX_GATEWAY_SESSION_NAME]
               sessionId:
                   [arrangement[SESSION_ARRANGEMENT_TMUX_GATEWAY_SESSION_ID]
                       intValue]];
  }
  if (missingProfile) {
    NSDictionary *arrangementProfile =
        arrangement[SESSION_ARRANGEMENT_BOOKMARK];
    if (arrangementProfile) {
      [aSession.naggingController
          arrangementWithName:arrangementName
  ...
  NSString *path = [aSession.screen
      workingDirectoryOnLine:aSession.screen.numberOfScrollbackLines +
                             aSession.screen.cursorY - 1];
  [aSession.variablesScope setValue:path
                   forVariableNamed:iTermVariableKeySessionPath];
...
+ (PTYSession *)sessionFromArrangement:(NSDictionary *)arrangement
  ...
  if (!theBookmark) {
    NSString *originalGuid =
        arrangement[SESSION_ARRANGEMENT_BOOKMARK][KEY_ORIGINAL_GUID];
  ...
  aSession->_savedGridSize = VT100GridSizeMake(
      MAX(1, [arrangement[SESSION_ARRANGEMENT_COLUMNS] intValue]),
  ...
  NSDictionary<NSString *, NSString *> *overrides =
      arrangement[SESSION_ARRANGEMENT_FONT_OVERRIDES];
  if (overrides) {
    NSMutableDictionary *temp = [[theBookmark mutableCopy] autorelease];
    [overrides enumerateKeysAndObjectsUsingBlock:^(NSString *_Nonnull key,
  ...
  if ([arrangement objectForKey:SESSION_ARRANGEMENT_TMUX_PANE]) {
    ...
    NSDictionary *tabColorDict =
        [ITAddressBookMgr encodeColor:[NSColor colorFromHexString:colorString]];
    if (tabColorDict) {
      // We're restoring a tmux arrangement that specifies a tab color.
      if (![iTermProfilePreferences boolForKey:KEY_USE_TAB_COLOR
                                     inProfile:theBookmark] ||
          ![[ITAddressBookMgr
              decodeColor:[iTermProfilePreferences objectForKey:KEY_TAB_COLOR
                                                      inProfile:theBookmark]]
              isEqual:tabColorDict]) {
        // The tmux profile does not specify a tab color or it specifies a
        // different one. Override it and divorce.
        theBookmark = [theBookmark dictionaryBySettingObject:tabColorDict
                                                      forKey:KEY_TAB_COLOR];
        theBookmark = [theBookmark dictionaryBySettingObject:@YES
                                                      forKey:KEY_USE_TAB_COLOR];
        needDivorce = YES;
        [keysToPreserveInCaseOfDivorce
            addObjectsFromArray:@[ KEY_TAB_COLOR, KEY_USE_TAB_COLOR ]];
      }
    } else if ([colorString isEqualToString:iTermTmuxTabColorNone] &&
               [iTermProfilePreferences boolForKey:KEY_USE_TAB_COLOR
                                         inProfile:theBookmark]) {
      // There was no tab color but the tmux profile specifies one. Disable it
      // and divorce.
      theBookmark = [theBookmark dictionaryBySettingObject:@NO
                                                    forKey:KEY_USE_TAB_COLOR];
      [keysToPreserveInCaseOfDivorce
          addObjectsFromArray:@[ KEY_USE_TAB_COLOR ]];
      needDivorce = YES;
    }
  }
  if (needDivorce) {
    // Keep it from stepping on an existing session with the same guid. Assign a
    // fresh GUID. Set the ORIGINAL_GUID to an existing guid from which this
    // profile originated if possible.
    NSString *originalGuid = nil;
    NSString *recordedGuid =
        arrangement[SESSION_ARRANGEMENT_BOOKMARK][KEY_GUID];
    NSString *recordedOriginalGuid =
        arrangement[SESSION_ARRANGEMENT_BOOKMARK][KEY_ORIGINAL_GUID];
    if ([[ProfileModel sharedInstance] bookmarkWithGuid:recordedGuid]) {
      originalGuid = recordedGuid;
    } else if ([[ProfileModel sharedInstance]
                   bookmarkWithGuid:recordedOriginalGuid]) {
      originalGuid = recordedOriginalGuid;
    }
    if (originalGuid) {
      theBookmark = [theBookmark dictionaryBySettingObject:originalGuid
                                                    forKey:KEY_ORIGINAL_GUID];
    }
    theBookmark =
        [theBookmark dictionaryBySettingObject:[ProfileModel freshGuid]
                                        forKey:KEY_GUID];
    if ([NSArray castFrom:arrangement[SESSION_ARRANGEMENT_OVERRIDDEN_FIELDS]]) {
      DLog(@"Have overridden fields %@",
           arrangement[SESSION_ARRANGEMENT_OVERRIDDEN_FIELDS]);
      ...
      Profile *underlyingProfile =
          [[ProfileModel sharedInstance] bookmarkWithGuid:originalGuid];
      NSArray<NSString *> *overriddenFields =
          arrangement[SESSION_ARRANGEMENT_OVERRIDDEN_FIELDS];

      if (underlyingProfile) {
        DLog(@"Underlying profile %@ exists", originalGuid);
        MutableProfile *replacement =
            [[underlyingProfile mutableCopy] autorelease];
        [keysToPreserveInCaseOfDivorce
            unionSet:[NSSet setWithArray:overriddenFields]];
  ...
  [[aSession screen]
      setUnlimitedScrollback:[[theBookmark
                                 objectForKey:KEY_UNLIMITED_SCROLLBACK]
                                 boolValue]];
  [[aSession screen]
      setMaxScrollbackLines:[[theBookmark objectForKey:KEY_SCROLLBACK_LINES]
                                intValue]];

  // set our preferences
  [aSession setProfile:theBookmark];

  [aSession setScreenSize:[sessionView frame]
                   parent:[delegate realParentWindow]];
  NSDictionary *state =
      [arrangement objectForKey:SESSION_ARRANGEMENT_TMUX_STATE];
  if (state) {
    // For tmux tabs, get the size from the arrangement instead of the
    // containing view because it helps things to line up correctly.
  ...
  if ([arrangement[SESSION_ARRANGEMENT_PROGRAM]
    ...
    if ([dict[kProgramType] isEqualToString:kProgramTypeShellLauncher]) {
      ...
      aSession.program = [ITAddressBookMgr
          shellLauncherCommandWithCustomShell:dict[kCustomShell]];
  ...
  aSession.shortLivedSingleUse =
      [arrangement[SESSION_ARRANGEMENT_SHORT_LIVED_SINGLE_USE] boolValue];
  aSession.hostnameToShell =
      [[arrangement[SESSION_ARRANGEMENT_HOSTNAME_TO_SHELL] mutableCopy]
          autorelease];
  ...
  // setContentsFromLineBufferDictionary:includeRestorationBanner:reattached:
  ...
  if (arrangement[SESSION_ARRANGEMENT_REUSABLE_COOKIE]) {
    [[iTermWebSocketCookieJar sharedInstance]
        addCookie:arrangement[SESSION_ARRANGEMENT_REUSABLE_COOKIE]];
  }
  NSNumber *tmuxPaneNumber =
      [arrangement objectForKey:SESSION_ARRANGEMENT_TMUX_PANE];
  NSString *tmuxDCSIdentifier = nil;
  BOOL shouldEnterTmuxMode = NO;
  NSDictionary *contents = arrangement[SESSION_ARRANGEMENT_CONTENTS];
  BOOL restoreContents = !tmuxPaneNumber && contents &&
  ...
  if (!tmuxPaneNumber) {
    ...
    if ([iTermAdvancedSettingsModel runJobsInServers]) {
      ...
      if ([NSNumber castFrom:arrangement[SESSION_ARRANGEMENT_SERVER_PID]]) {
        ...
        pid_t serverPid =
            [arrangement[SESSION_ARRANGEMENT_SERVER_PID] intValue];
        DLog(@"Try to attach to pid %d", (int)serverPid);
        // serverPid might be -1 if the user turned on session restoration and
        // then quit.
        if (serverPid != -1 &&
            [aSession
                tryToAttachToServerWithProcessId:serverPid
                                             tty:arrangement
                                                     [SESSION_ARRANGEMENT_TTY]]) {
          DLog(@"Success!");
          didAttach = YES;
        }
      } else if ([iTermMultiServerJobManager available] &&
                 [NSDictionary
                     castFrom:arrangement[SESSION_ARRANGEMENT_SERVER_DICT]]) {
        ...
        if (partialAttachments) {
          ...
          if (partial &&
              [aSession tryToFinishAttachingToMultiserverWithPartialAttachment:
                            partial]) {
            DLog(@"Finished attaching to multiserver!");
            didAttach = YES;
          }
        } else if ([aSession tryToAttachToMultiserverWithRestorationIdentifier:
                                 serverDict]) {
      ...
      if (didAttach) {
        if ([arrangement[SESSION_ARRANGEMENT_IS_TMUX_GATEWAY] boolValue]) {
          ...
          // Before attaching to the server we can put the parser into "tmux
          // recovery mode".
          [aSession.terminal.parser
              startTmuxRecoveryModeWithID:
                  arrangement[SESSION_ARRANGEMENT_TMUX_DCS_ID]];
        }

        runCommand = NO;
        attachedToServer = YES;
        shouldEnterTmuxMode = (
            [arrangement[SESSION_ARRANGEMENT_IS_TMUX_GATEWAY] boolValue] &&
    ...
    // Older versions won't be able to associate saved state with windows from a
    // saved arrangement.
    if (arrangement[SESSION_ARRANGEMENT_GUID]) {
      ...
      if (guid && gRegisteredSessionContents[guid]) {
        ...
        // There was a registered session with this guid. This session was
        // created by restoring a saved arrangement and there is saved content
        // registered.
        contents = gRegisteredSessionContents[guid];
        aSession.guid = guid;
        DLog(@"Assign guid %@ to session %@ which will have its contents "
             @"restored from registered contents",
             guid, aSession);
      } else if ([[iTermController sharedInstance] startingUp] ||
                 arrangement[SESSION_ARRANGEMENT_CONTENTS]) {
        // If startingUp is set, then the session is being restored from the
        // default arrangement, per user preference. If contents are present,
        // then system window restoration is bringing back a session.
        aSession.guid = guid;
        DLog(@"iTerm2 is starting up or has contents. Assign guid %@ to "
             @"session %@ (session is loaded from saved arrangement. No "
             @"content registered.)",
             guid, aSession);
      }
    }
    ...
    if (restoreContents) {
      ...
      // NOTE: THE SCREEN SIZE IS NOW OUT OF SYNC WITH THE VIEW SIZE. IT MUST BE
      // FIXED!
    }
    if (arrangement[SESSION_ARRANGEMENT_KEYLABELS]) {
      // restoreKeyLabels wants the cursor position to be set so do it after
      // restoring contents.
      [aSession restoreKeyLabels:
                    [NSDictionary
                        castFrom:arrangement[SESSION_ARRANGEMENT_KEYLABELS]]
      ...
      if (labels) {
        ...
        aSession->_keyLabelsStack = [[labels mapWithBlock:^id(id anObject) {
          return [[[iTermKeyLabels alloc] initWithDictionary:anObject]
              autorelease];
        }] mutableCopy];
      }
    }
    ...
    if (runCommand) {
      ...
      //
      // When restoring a window arrangement with contents and a nonempty saved
      // directory, always use the saved working directory, even if that
      // contravenes the default setting for the profile.
      ...
      if (haveSavedProgramData) {
        // This is the normal case; the else clause is for legacy saved
        // arrangements.
        environmentArg = aSession.environment ?: @{};
        commandArg = aSession.program;
        if (oldCWD &&
            [aSession.program
                isEqualToString:[ITAddressBookMgr standardLoginCommand]]) {
          // Create a login session that drops you in the old directory instead
          // of using login -fp "$USER". This lets saved arrangements properly
          // restore the working directory when the profile specifies the home
          // directory.
          commandArg = [ITAddressBookMgr
              shellLauncherCommandWithCustomShell:aSession.customShell];
        }
      ...
      runCommandBlock = ^(iTermSessionCreationCompletionBlock completion) {
        ...
        iTermSessionAttachOrLaunchRequest *launchRequest =
            [iTermSessionAttachOrLaunchRequest
                launchRequestWithSession:aSession
                     ...
                     hasServerConnection:NO
                        ...
                        windowController:(PseudoTerminal *)
                                             aSession.delegate.realParentWindow
                                   ready:nil
                              completion:completion];
        iTermSessionFactory *factory =
            [[[iTermSessionFactory alloc] init] autorelease];
    ...
    // Is a tmux pane
    // NOTE: There used to be code here that used state[@"title"] but AFAICT
    // that didn't exist.
    [aSession setTmuxPane:[tmuxPaneNumber intValue]];
  }

  if (arrangement[SESSION_ARRANGEMENT_SELECTION]) {
    [aSession.textview.selection
         setFromDictionaryValue:arrangement[SESSION_ARRANGEMENT_SELECTION]
...
- (iTermLoggingHelper *)loggingHelper {
  ...
  _logging =
      [[iTermLoggingHelper alloc] initWithRawLogger:_shell
                                        plainLogger:self
                                        profileGUID:self.profile[KEY_GUID]];
  return _logging;
}

// WARNING: This leaves the screen with the wrong size! Call -restoreInitialSize
// afterwards.
...
- (BOOL)setScreenSize:(NSRect)aRect
               parent:(id<WindowControllerInterface>)parent {
  ...
  if (!_view) {
    self.view = [[[SessionView alloc]
        initWithFrame:NSMakeRect(0, 0, aRect.size.width, aRect.size.height)]
        autorelease];
    if (@available(macOS 10.11, *)) {
  ...
  _wrapper = [[TextViewWrapper alloc]
      initWithFrame:NSMakeRect(0, 0, aSize.width, aSize.height)];

  _textview = [[PTYTextView alloc]
      initWithFrame:NSMakeRect(0,
                               [iTermPreferences
                                   intForKey:kPreferenceKeyTopBottomMargins],
  ...
  [_textview setFont:[ITAddressBookMgr
                         fontWithDesc:[_profile objectForKey:KEY_NORMAL_FONT]]
           nonAsciiFont:[ITAddressBookMgr
                            fontWithDesc:[_profile
                                             objectForKey:KEY_NON_ASCII_FONT]]
      horizontalSpacing:[[_profile objectForKey:KEY_HORIZONTAL_SPACING]
                            doubleValue]
        verticalSpacing:[[_profile objectForKey:KEY_VERTICAL_SPACING]
                            doubleValue]];
  [self setTransparency:[[_profile objectForKey:KEY_TRANSPARENCY] floatValue]];
  [self
      setTransparencyAffectsOnlyDefaultBackgroundColor:
          [[_profile objectForKey:
  ...
  [self.variablesScope setValue:_shell.tty
               forVariableNamed:iTermVariableKeySessionTTY];
  ...
  NSSize contentSize = [PTYScrollView
      ...
      horizontalScrollerClass:nil
        verticalScrollerClass:parent.scrollbarShouldBeVisible
                                  ? [[_view.scrollview verticalScroller] class]
                                  : nil
  ...
  [_wrapper release];
  [_view.scrollview
      setDocumentCursor:[iTermMouseCursor
...
- (BOOL)tryToAttachToMultiserverWithRestorationIdentifier:
    (NSDictionary *)restorationIdentifier {
  const iTermJobManagerAttachResults results = [_shell
      tryToAttachToMultiserverWithRestorationIdentifier:restorationIdentifier];
...
- (void)setSize:(VT100GridSize)size {
  ...
  DLog(@"Before, range of visible lines is %@",
       VT100GridRangeDescription(_textview.rangeOfVisibleLines));
  ...
  if (!_tailFindTimer && [_delegate sessionBelongsToVisibleTab]) {
    [self beginTailFind];
  }
  if (@available(macOS 10.11, *)) {
    [self updateMetalDriver];
...
- (Profile *)profileForSplit {
  if ([iTermAdvancedSettingsModel useDivorcedProfileToSplit]) {
    if (self.isDivorced) {
      // NOTE: This counts on splitVertically:before:profile:targetSession:
      // rewriting the GUID.
      return self.profile;
    }
  }

  // Get the profile this session was originally created with. But look it up
  // from its GUID because it might have changed since it was copied into
  // originalProfile when the profile was first created.
  Profile *result = nil;
  Profile *originalProfile = [self originalProfile];
  if (originalProfile && originalProfile[KEY_GUID]) {
    result = [[ProfileModel sharedInstance]
        bookmarkWithGuid:originalProfile[KEY_GUID]];
  }
  ...
  // I don't think that'll ever fail, but to be safe try using the original
  // profile.
  if (!result) {
    result = originalProfile;
  }

  // I really don't think this'll ever happen, but there's always a default
...
- (NSArray<iTermTuple<NSString *, NSString *> *> *)childJobNameTuples {
  ...
  iTermProcessInfo *info =
      [[iTermProcessCache sharedInstance] processInfoForPid:thePid];
  if (!info) {
    return @[];
  }
  ...
  NSArray<iTermProcessInfo *> *allInfos =
      [info descendantsSkippingLevels:levelsToSkip];
...
- (iTermPromptOnCloseReason *)promptOnCloseReason {
  ...
  case PROMPT_EX_JOBS: {
    ...
    if (self.isTmuxClient) {
      DLog(@"is tmux client");
      return [iTermPromptOnCloseReason
          tmuxClientsAlwaysPromptBecauseJobsAreNotExposed];
    }
    ...
    DLog(@"jobs that don't require prompting: %@",
         jobsThatDontRequirePrompting);
    for (iTermTuple<NSString *, NSString *> *childNameTuple in
         [self childJobNameTuples]) {
      DLog(@"Check child %@", childNameTuple);
      if ([jobsThatDontRequirePrompting
              indexOfObject:childNameTuple.firstObject] == NSNotFound &&
          [jobsThatDontRequirePrompting
              indexOfObject:childNameTuple.secondObject] == NSNotFound) {
    ...
    if (blockingJobs.count > 0) {
      ...
      return [iTermPromptOnCloseReason profile:_profile
                                 blockedByJobs:blockingJobs];
    } else {
...
- (NSSet<NSString *> *)jobsToIgnore {
  ...
  return [NSSet setWithArray:[[_profile objectForKey:KEY_JOBS] ?: @[
                ] arrayByAddingObjectsFromArray:builtInJobsToIgnore]];
}
...
- (BOOL)hasNontrivialJob {
  ...
  [rootInfo enumerateTree:^(iTermProcessInfo *info, BOOL *stop) {
    ...
    DLog(@"Process with name %@ and command line %@ is nontrivial", info.name,
         info.commandLine);
    result = YES;
    *stop = YES;
  }];
...
- (NSString *)sessionId {
  return [NSString
      stringWithFormat:@"w%dt%dp%lu:%@", [[_delegate realParentWindow] number],
                       _delegate.tabNumberForItermSessionId,
                       [_delegate sessionPaneNumber:self], self.guid];
}

- (void)didMoveSession {
  // TODO: Is it really desirable to update this? It'll get out of sync with the
  // environment variable & autolog filename.
...
- (void)profileNameDidChangeTo:(NSString *)name {
  NSString *autoNameFormat =
      [self.variablesScope
          valueForVariableName:iTermVariableKeySessionAutoNameFormat]
          ?: name;
  const BOOL isChangeToLocalName =
      (self.isDivorced && [_overriddenFields containsObject:KEY_NAME]);
  const BOOL haveAutoNameFormatOverride =
      ([self.variablesScope
           valueForVariableName:iTermVariableKeySessionIconName] != nil ||
       [self.variablesScope
           valueForVariableName:iTermVariableKeySessionTriggerName] != nil);
  if (isChangeToLocalName || !haveAutoNameFormatOverride) {
    // Profile name changed, local name not overridden, and no icon/trigger name
    // to take precedence.
    autoNameFormat = name;
  }
  ...
  if (![_overriddenFields containsObject:KEY_NAME]) {
    ...
    profileName = [[ProfileModel sharedInstance]
        bookmarkWithGuid:_profile[KEY_ORIGINAL_GUID]][KEY_NAME];
    if (!profileName) {
      // Not sure how this would happen
      profileName = [self.variablesScope
          valueForVariableName:iTermVariableKeySessionProfileName];
    }
  }
  [self.variablesScope setValuesFromDictionary:@{
...
- (void)computeEnvironmentForNewJobFromEnvironment:(NSDictionary *)environment
                                     substitutions:(NSDictionary *)substitutions
                                        completion:(void (^)(NSDictionary *env))
                                                       completion {
  ...
  if ([iTermAdvancedSettingsModel setCookie]) {
    self.cookie =
        [[iTermWebSocketCookieJar sharedInstance] randomStringForCookie];
  ...
  if ([iTermAdvancedSettingsModel shouldSetLCTerminal]) {
    ...
    env[@"LC_TERMINAL_VERSION"] = [[[NSBundle mainBundle] infoDictionary]
        objectForKey:@"CFBundleShortVersionString"];
  }
  if (env[PWD_ENVNAME] == nil) {
    // Set "PWD"
    env[PWD_ENVNAME] = [PWD_ENVVALUE stringByExpandingTildeInPath];
    DLog(@"env[%@] was nil. Set it to home directory: %@", PWD_ENVNAME,
         env[PWD_ENVNAME]);
  }
  ...
  env[@"TERM_PROGRAM_VERSION"] = [[[NSBundle mainBundle] infoDictionary]
      objectForKey:@"CFBundleShortVersionString"];
  ...
  if (_profile[KEY_NAME]) {
    env[@"ITERM_PROFILE"] =
        [_profile[KEY_NAME] stringByPerformingSubstitutions:substitutions];
  }
  completion(env);
}

- (void)arrangementWithName:(NSString *)arrangementName
                  hasBadPWD:(NSString *)pwd {
...
- (void)startProgram:(NSString *)command
  ...
  DLog(@"startProgram:%@ environment:%@ isUTF8:%@ substitutions:%@", command,
       environment, @(isUTF8), substitutions);
  ...
  [self
      computeArgvForCommand:command
              substitutions:substitutions
                 completion:^(NSArray<NSString *> *argv) {
                   DLog(@"argv=%@", argv);
                   [self computeEnvironmentForNewJobFromEnvironment:environment
                                                                        ?: @{}
                       substitutions:substitutions
                       completion:^(NSDictionary *env) {
                         [self fetchAutoLogFilenameWithCompletion:^(
                                   NSString *_Nonnull autoLogFilename) {
                           [_logging stop];
                           ...
                           [[self loggingHelper]
                               ...
                               plainText:[iTermProfilePreferences
                                             boolForKey:KEY_PLAIN_TEXT_LOGGING
                                              inProfile:self.profile]
                                  append:nil];
                           if (env[PWD_ENVNAME] && arrangementName &&
                               _arrangementGUID) {
                             __weak __typeof(self) weakSelf = self;
...
- (void)setParentScope:(iTermVariableScope *)parentScope {
  ...
  assert(parentScope != scope); // I'm almost sure this is impossible because
                                // how could you be your own parent?

  // Remove existing variable (this is just paranoia! it shouldn't do anything)
  [self.variablesScope setValue:nil
               forVariableNamed:iTermVariableKeySessionParent];
  ...
  [parentScope.frames
      enumerateObjectsUsingBlock:^(
          iTermTuple<NSString *, iTermVariables *> *_Nonnull tuple,
          NSUInteger idx, BOOL *_Nonnull stop) {
        if (tuple.firstObject) {
          return;
        }
        variables = tuple.secondObject;
        [scope addVariables:tuple.secondObject
               toScopeNamed:iTermVariableKeySessionParent];
        *stop = YES;
      }];

  // Find non-root frames (e.g., tab) and add their variables as nonterminals to
  // parentSession (becoming, e.g., parentSession.tab)
  [parentScope.frames
      enumerateObjectsUsingBlock:^(
          iTermTuple<NSString *, iTermVariables *> *_Nonnull tuple,
          NSUInteger idx, BOOL *_Nonnull stop) {
        ...
        [variables setValue:tuple.secondObject
            forVariableNamed:tuple.firstObject];
      }];
}
...
- (void)sendInitialText {
  ...
  iTermExpressionEvaluator *evaluator = [[[iTermExpressionEvaluator alloc]
      initWithStrictInterpolatedString:initialText
  ...
  [evaluator
      evaluateWithTimeout:5
               completion:^(iTermExpressionEvaluator *_Nonnull evaluator) {
                 ...
                 if (!string) {
                   DLog(@"Evaluation of %@ returned %@", initialText,
                        evaluator.value);
                   return;
                 }
...
- (void)_maybeWarnAboutShortLivedSessions {
  ...
  if (_tmuxMode == TMUX_CLIENT &&
      (_tmuxController.detached || _tmuxController.detaching)) {
    return;
  }
  if ([[NSDate date] timeIntervalSinceDate:_creationDate] <
      [iTermAdvancedSettingsModel shortLivedSessionDuration]) {
    ...
    NSString *theKey = [NSString
        stringWithFormat:@"NeverWarnAboutShortLivedSessions_%@", guid];
    NSString *theTitle = [NSString
        stringWithFormat:
...
- (iTermRestorableSession *)restorableSession {
  iTermRestorableSession *restorableSession =
      [[[iTermRestorableSession alloc] init] autorelease];
...
// Request that the session close. It may or may not be undoable. Only undoable
// terminations support "restart", which is done by first calling revive and
// then replaceTerminatedShellWithNewInstance.
- (void)terminate {
  ...
  _tmuxController = nil;
  [self.variablesScope setValue:nil
               forVariableNamed:iTermVariableKeySessionTmuxClientName];
  [self.variablesScope setValue:nil
               forVariableNamed:iTermVariableKeySessionTmuxPaneTitle];
  ...
  if (undoable) {
    // TODO: executeTokens:bytesHandled: should queue up tokens to avoid a race
    // condition.
  ...
  [[NSNotificationCenter defaultCenter]
      postNotificationName:iTermSessionWillTerminateNotification
                    object:self];
...
- (void)makeTerminationUndoable {
  ...
  [self performSelector:@selector(hardStop)
             ...
             afterDelay:[iTermProfilePreferences intForKey:KEY_UNDO_TIMEOUT
                                                 inProfile:_profile]];
  // The analyzer complains that _view is leaked here, but the delayed perform
  // to -hardStop above releases it. If it is canceled by -revive, then -revive
  // autoreleases the view.
  [[iTermController sharedInstance]
      addRestorableSession:[self restorableSession]];
}

// Not undoable. Kill the process. However, you can replace the terminated shell
// after this.
- (void)hardStop {
  ...
  [[NSNotificationCenter defaultCenter]
      postNotificationName:PTYSessionTerminatedNotification
                    object:self];
}
...
- (BOOL)revive {
  if (_shell.paused) {
    ...
    NSDictionary *shortcutDictionary =
        [iTermProfilePreferences objectForKey:KEY_SESSION_HOTKEY
                                    inProfile:self.profile];
    iTermShortcut *shortcut =
        [iTermShortcut shortcutWithDictionary:shortcutDictionary];
    [[iTermSessionHotkeyController sharedInstance] setShortcut:shortcut
                                                    forSession:self];

    [_view autorelease]; // This balances a retain in -terminate prior to
                         // calling -makeTerminationUndoable
    [[NSNotificationCenter defaultCenter]
        postNotificationName:PTYSessionRevivedNotification
                      object:self];
    return YES;
  } else {
    return NO;
...
- (void)writeTaskImpl:(NSString *)string
  ...
  const NSStringEncoding encoding =
      forceEncoding ? optionalEncoding : _terminal.encoding;
  if (gDebugLogging) {
    NSArray *stack = [NSThread callStackSymbols];
    DLog(@"writeTaskImpl session=%@ encoding=%@ forceEncoding=%@ "
         @"canBroadcast=%@: called from %@",
  ...
  if (canBroadcast && _terminal.sendReceiveMode && !self.isTmuxClient &&
      !self.isTmuxGateway) {
    // Local echo. Only for broadcastable text to avoid printing passwords from
    // the password manager.
    [_screen
        appendStringAtCursor:[string
                                 stringByMakingControlCharactersToPrintable]];
  }
  // check if we want to send this input to all the sessions
  if (canBroadcast &&
      [[_delegate realParentWindow] broadcastInputToSession:self]) {
    ...
    if (canBroadcast) {
      // It happens that canBroadcast coincides with explicit user input. This
      // is less than beautiful here, but in that case we want to turn off the
      // bell and scroll to the bottom.
      [self setBell:NO];
...
// Convert the string to the requested encoding. If the string is a lone
// surrogate, deal with it by saving the high surrogate and then combining it
// with a subsequent low surrogate.
- (NSData *)dataForInputString:(NSString *)string
  ...
  if (IsHighSurrogate(c)) {
    ...
    DLog(@"Detected low surrogate 0x%x with pending high surrogate 0x%x",
         (int)c, (int)_shell.pendingHighSurrogate);
...
- (void)writeTaskNoBroadcast:(NSString *)string
               ...
               forceEncoding:(BOOL)forceEncoding {
  if (self.tmuxMode == TMUX_CLIENT) {
    // tmux doesn't allow us to abuse the encoding, so this can cause the wrong
    // thing to be sent (e.g., in mouse reporting).
...
- (void)setTmuxController:(TmuxController *)tmuxController {
  ...
  NSDictionary<NSString *, NSString *> *dict =
      [tmuxController userVarsForPane:self.tmuxPane];
...
- (void)handleKeypressInTmuxGateway:(NSEvent *)event {
  const unichar unicode =
      [event.characters length] > 0 ? [event.characters characterAtIndex:0] : 0;
...
- (void)handleCharacterPressedInTmuxGateway:(unichar)unicode {
  if (unicode == 27) {
    ...
    [self printTmuxMessage:[NSString stringWithFormat:@"tmux logging %@",
                                                      (_tmuxGateway.tmuxLogging
                                                           ? @"on"
                                                           : @"off")]];
  } else if (unicode == 'C') {
    ...
    NSTextField *tmuxCommand = [[[NSTextField alloc]
    ...
    if ([alert runModal] == NSAlertFirstButtonReturn &&
        [[tmuxCommand stringValue] length]) {
      [self printTmuxMessage:[NSString
                                 stringWithFormat:@"Run command \"%@\"",
                                                  [tmuxCommand stringValue]]];
...
- (void)writeLatin1EncodedData:(NSData *)data broadcastAllowed:(BOOL)broadcast {
  // `data` contains raw bytes we want to pass through. I believe Latin-1 is the
  // only encoding that won't perform any transformation when converting from
  // data to string. This is needed because sometimes the user wants to send
  // particular bytes regardless of the encoding (e.g., the "send hex codes"
  // keybinding action, or certain mouse reporting modes that abuse encodings).
...
// If forceEncoding is YES then optionalEncoding will be used regardless of the
// session's preferred encoding. If it is NO then the preferred encoding is
// used. This is necessary because this method might send the string off to the
// window to get broadcast to other sessions which might have different
// encodings.
- (void)writeTask:(NSString *)string
         encoding:(NSStringEncoding)optionalEncoding
    forceEncoding:(BOOL)forceEncoding {
...
// This is run in PTYTask's thread. It parses the input here and then queues an
// async task to run in the main thread to execute the parsed tokens.
- (void)threadedReadTask:(char *)buffer length:(int)length {
  ...
  // This limits the number of outstanding execution blocks to prevent the main
  // thread from getting bogged down.
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    // Unblock the background thread; if it's ready, it can send the main thread
    // more tokens now.
...
- (void)executeTokens:(const CVector *)vector bytesHandled:(int)length {
  ...
  if (_shell.paused || _copyModeHandler.enabled) {
    // Session was closed or is not accepting new tokens because it's in copy
    // mode. These can be handled later (unclose or exit copy mode), so queue
    // them up.
    for (int i = 0; i < n; i++) {
  ...
  for (int i = 0; i < n; i++) {
    ...
    DLog(@"Execute token %@ cursor=(%d, %d)", token, _screen.cursorX - 1,
         _screen.cursorY - 1);
    [_terminal executeToken:token];
  }
...
- (BOOL)haveResizedRecently {
  ...
  return [NSDate timeIntervalSinceReferenceDate] <
         _lastResize + kGracePeriodAfterResize;
}

- (void)finishedHandlingNewOutputOfLength:(int)length {
  DLog(@"Session %@ (%@) is processing", self,
       _nameController.presentationSessionTitle);
  if (![self haveResizedRecently]) {
    _lastOutputIgnoringOutputAfterResizing =
  ...
  if (self.shell.pid > 0 ||
      [[[self variablesScope] valueForVariableName:@"jobName"] length] > 0) {
...
- (void)checkTriggers {
  ...
  iTermStringLine *stringLine =
      [_screen stringLineAsStringAtAbsoluteLineNumber:_triggerLineNumber
...
- (void)checkPartialLineTriggers {
  ...
  if (now - _lastPartialLineTriggerCheck <
      kMinimumPartialLineTriggerCheckInterval) {
    return;
  }
...
- (void)checkTriggersOnPartialLine:(BOOL)partial
  ...
  for (iTermExpectation *expectation in
       [[_expect.expectations copy] autorelease]) {
    NSArray<NSString *> *capture = [stringLine.stringValue
        captureComponentsMatchedByRegex:expectation.regex];
    if (capture.count) {
      [expectation didMatchWithCaptureGroups:capture];
    }
  }

  // If a trigger changes the current profile then _triggers gets released and
  // we should stop processing triggers. This can happen with automatic profile
  // switching.
...
- (void)appendStringToTriggerLine:(NSString *)s {
  if (_triggerLineNumber == -1) {
    _triggerLineNumber = _screen.numberOfScrollbackLines + _screen.cursorY - 1 +
                         _screen.totalScrollbackOverflow;
  }

  // We used to build up the string so you could write triggers that included
  // bells. That doesn't really make sense, especially in the new model, but
  // it's so useful to be able to customize the bell that I'll add this special
  // case.
  if ([s isEqualToString:@"\a"]) {
    iTermStringLine *stringLine = [iTermStringLine stringLineWithString:s];
    [self checkTriggersOnPartialLine:YES
                          stringLine:stringLine
                          lineNumber:_triggerLineNumber];
  }
}
...
- (void)appendBrokenPipeMessage:(NSString *)unpaddedMessage {
  NSString *const message =
      [NSString stringWithFormat:@" %@ ", unpaddedMessage];
  ...
  [_terminal
      setForeground24BitColor:[NSColor colorWithCalibratedRed:70.0 / 255.0
                                                        green:83.0 / 255.0
                                                         blue:246.0 / 255.0
                                                        alpha:1]];
  [_terminal setBackgroundColor:ALTSEM_DEFAULT alternateSemantics:YES];
  ...
  [_terminal setForegroundColor:savedFgColor.foregroundColor
             alternateSemantics:savedFgColor.foregroundColorMode ==
                                ColorModeAlternate];
  [_terminal setBackgroundColor:savedBgColor.backgroundColor
             alternateSemantics:savedBgColor.backgroundColorMode ==
                                ColorModeAlternate];
}
...
- (void)tmuxClientWrite:(NSData *)data {
  ...
  NSString *string =
      [[[NSString alloc] initWithData:data encoding:self.encoding] autorelease];
  [self writeTask:string];
}

- (void)threadedTaskBrokenPipe {
  DLog(@"threaded task broken pipe");
  // Put the call to brokenPipe in the same queue as executeTokens:bytesHandled:
  // to avoid a race.
  dispatch_async(dispatch_get_main_queue(), ^{
    [self brokenPipe];
  });
...
- (void)taskDiedImmediately {
  // Let initial creation finish, then report the broken pipe. This happens if
  // the file descriptor server dies immediately.
  [self performSelector:@selector(brokenPipe) withObject:nil afterDelay:0];
}

- (void)taskDidChangeTTY:(PTYTask *)task {
  [self.variablesScope setValue:task.tty
               forVariableNamed:iTermVariableKeySessionTTY];
}
...
- (void)cleanUpAfterBrokenPipe {
  ...
  [[NSNotificationCenter defaultCenter]
      postNotificationName:PTYSessionTerminatedNotification
                    object:self];
  [[NSNotificationCenter defaultCenter]
      postNotificationName:kCurrentSessionDidChange
                    object:nil];
  [_delegate updateLabelAttributes];
}

// Called when the file descriptor closes. If -terminate was already called this
// does nothing. Otherwise, you can call replaceTerminatedShellWithNewInstance
// after this to restart the session.
- (void)brokenPipe {
  ...
  if ([self shouldPostUserNotification] &&
      [iTermProfilePreferences boolForKey:KEY_SEND_SESSION_ENDED_ALERT
                                inProfile:self.profile]) {
    [[iTermNotificationController sharedInstance]
                 notify:@"Session Ended"
        withDescription:
            [NSString
                stringWithFormat:@"Session \"%@\" in tab #%d just terminated.",
                                 [self name], [_delegate tabNumber]]];
  }
  ...
  if (_shortLivedSingleUse) {
    ...
    // restart is not respected here because it doesn't make sense and would
    // make for an awful bug.
  ...
  case iTermSessionEndActionRestart:
    if ([self isRestartable]) {
      [self
          performSelector:@selector(maybeReplaceTerminatedShellWithNewInstance)
               withObject:nil
               afterDelay:1];
      return;
    }
...
- (void)maybeReplaceTerminatedShellWithNewInstance {
  // The check for screen.terminal is because after -terminate is called, it is
  // no longer safe to replace the terminated shell with a new instance unless
  // you first do -revive. When the terminal is nil you can't write text to the
  // screen.
...
// NOTE: Not safe to call this after -terminate, unless you first call -revive.
// It *is* safe to call this after -brokenPipe, provided -terminate wasn't
// already called.
  ...
  [self startProgram:_program
       ...
       substitutions:_substitutions
         arrangement:nil
          completion:nil];
  [_naggingController willRecycleSession];
  DLog(@"  replaceTerminatedShellWithNewInstance: return with terminal=%@",
       _screen.terminal);
}

- (NSSize)idealScrollViewSizeWithStyle:(NSScrollerStyle)scrollerStyle {
  NSSize innerSize = NSMakeSize(
      [_screen width] * [_textview charWidth] +
          [iTermPreferences intForKey:kPreferenceKeySideMargins] * 2,
      [_screen height] * [_textview lineHeight] +
          [iTermPreferences intForKey:kPreferenceKeyTopBottomMargins] * 2);
  BOOL hasScrollbar = [[_delegate realParentWindow] scrollbarShouldBeVisible];
  NSSize outerSize = [PTYScrollView
      frameSizeForContentSize:innerSize
      horizontalScrollerClass:nil
...
- (iTermKeyBindingAction *)_keyBindingActionForEvent:(NSEvent *)event {
  ...
  iTermKeyBindingAction *action = [iTermKeyMappings
      actionForKeystroke:[iTermKeystroke withEvent:event]
...
+ (BOOL)_recursiveSelectMenuWithSelector:(SEL)selector inMenu:(NSMenu *)menu {
  for (NSMenuItem *item in [menu itemArray]) {
    ...
    if ([item hasSubmenu]) {
      if ([PTYSession _recursiveSelectMenuWithSelector:selector
                                                inMenu:[item submenu]]) {
        return YES;
      }
...
+ (BOOL)_recursiveSelectMenuItemWithTitle:(NSString *)title
  ...
  for (NSMenuItem *item in [menu itemArray]) {
    ...
    if ([item hasSubmenu]) {
      if ([PTYSession _recursiveSelectMenuItemWithTitle:title
                                             identifier:identifier
                                                 inMenu:[item submenu]]) {
        return YES;
      }
    }
    if ([ITAddressBookMgr shortcutIdentifier:identifier
                                       title:title
                                 matchesItem:item]) {
      if (item.hasSubmenu) {
        return YES;
...
+ (void)selectMenuItemWithSelector:(SEL)theSelector {
  if (![self _recursiveSelectMenuWithSelector:theSelector
                                       inMenu:[NSApp mainMenu]]) {
    DLog(@"Beep: failed to find menu item with selector %@",
...
+ (void)selectMenuItem:(NSString *)theName {
  ...
  if (![self _recursiveSelectMenuItemWithTitle:title
                                    identifier:identifier
                                        inMenu:[NSApp mainMenu]]) {
    DLog(@"Beep: failed to find menu item with title %@ and identifier %@",
         title, identifier);
    NSBeep();
  }
}
...
- (void)moveUp:(id)sender {
  [self writeLatin1EncodedData:[_terminal.output keyArrowUp:0]
              broadcastAllowed:YES];
}

- (void)moveDown:(id)sender {
  [self writeLatin1EncodedData:[_terminal.output keyArrowDown:0]
              broadcastAllowed:YES];
}

- (void)moveLeft:(id)sender {
  [self writeLatin1EncodedData:[_terminal.output keyArrowLeft:0]
              broadcastAllowed:YES];
}

- (void)moveRight:(id)sender {
  [self writeLatin1EncodedData:[_terminal.output keyArrowRight:0]
              broadcastAllowed:YES];
}

- (void)pageUp:(id)sender {
  [self writeLatin1EncodedData:[_terminal.output keyPageUp:0]
              broadcastAllowed:YES];
}

- (void)pageDown:(id)sender {
  [self writeLatin1EncodedData:[_terminal.output keyPageDown:0]
              broadcastAllowed:YES];
}
...
- (void)deleteBackward:(id)sender {
  ...
  [self writeLatin1EncodedData:[NSData dataWithBytes:&p length:1]
              broadcastAllowed:YES];
}
...
- (BOOL)shouldPostUserNotification {
  ...
  BOOL windowIsObscured = ([[iTermController sharedInstance]
      terminalIsObscured:_delegate.realParentWindow]);
...
- (void)openSelection {
  iTermSemanticHistoryController *semanticHistoryController =
      _textview.semanticHistoryController;
  ...
  // TODO: Figure out if this is a remote host and download/open if that's the
  // case.
  ...
  // NOTE: The synchronous API is used here because this is a user-initiated
  // action. We don't want things to change out from under us. It's ok to block
  // the UI while waiting for disk access to complete.
  NSString *rawFilename = [semanticHistoryController
      pathOfExistingFileFoundWithPrefix:selection
                                 suffix:@""
  ...
  if (rawFilename && ![[rawFilename stringByReplacingOccurrencesOfString:@"//"
    ...
    NSString *cleanedup =
        [semanticHistoryController cleanedUpPathFromPath:rawFilename
                                                  suffix:nil
                                        workingDirectory:workingDirectory
...
- (void)tryOpenStringAsURL:(NSString *)selection {
  ...
  NSURL *url = [NSURL
      URLWithUserSuppliedString:[selection
  ...
  if (flag != _bell) {
    ...
    if (_bell) {
      if ([_textview keyIsARepeat] == NO && [self shouldPostUserNotification] &&
          [iTermProfilePreferences boolForKey:KEY_SEND_BELL_ALERT
                                    inProfile:self.profile]) {
        [[iTermNotificationController sharedInstance]
                     notify:@"Bell"
            withDescription:
                [NSString stringWithFormat:@"Session %@ #%d just rang a bell!",
                                           [self name], [_delegate tabNumber]]
...
- (NSString *)ansiColorsMatchingForeground:(NSDictionary *)fg
  ...
  for (int i = 0; i < 16; ++i) {
    ...
    if ([fgColor
            isEqual:[ITAddressBookMgr decodeColor:[aDict objectForKey:key]]]) {
      fgNum = i;
    }
    if ([bgColor
            isEqual:[ITAddressBookMgr decodeColor:[aDict objectForKey:key]]]) {
...
- (void)loadInitialColorTable {
  ...
  _textview.highlightCursorLine =
      [iTermProfilePreferences boolForKey:KEY_USE_CURSOR_GUIDE
                                inProfile:_profile];
}
...
- (void)setColorsFromPresetNamed:(NSString *)presetName {
  ...
  for (NSString *colorName in [ProfileModel colorKeys]) {
    iTermColorDictionary *colorDict =
        [settings iterm_presetColorWithName:colorName];
    if (colorDict) {
...
- (void)sharedProfileDidChange {
  NSDictionary *updatedProfile = [[ProfileModel sharedInstance]
      bookmarkWithGuid:_originalProfile[KEY_GUID]];
  if (!updatedProfile) {
    return;
  }
  if (!self.isDivorced) {
  ...
  NSMutableDictionary *temp =
      [NSMutableDictionary dictionaryWithDictionary:_profile];
  ...
  for (NSString *key in keys) {
    ...
    if ([_overriddenFields containsObject:key]) {
      ...
      if (!originalValue) {
        DLog(@"Unset %@ in session because it was removed from shared profile",
             key);
        [temp removeObjectForKey:key];
      } else {
        if (![originalValue isEqual:temp[key]]) {
          DLog(@"Update session for key %@ from %@ -> %@", key, temp[key],
               originalValue);
        }
  ...
  // For fields that are no longer overridden because the shared profile took on
  // the same value as the sessions profile, remove those keys from
  // overriddenFields.
  for (NSString *key in noLongerOverriddenFields) {
    DLog(@"%p: %@ is no longer overridden because shared profile now matches "
         @"session profile value of %@",
         self, key, temp[key]);
    [_overriddenFields removeObject:key];
  }
  DLog(@"After shared profile change overridden keys are: %@",
       _overriddenFields);
...
- (void)sessionProfileDidChange {
  ...
  for (NSString *aKey in keys) {
    ...
    if (!isEqual && !isOverridden) {
      DLog(@"%p: %@ is now overridden because %@ != %@", self, aKey,
           newSessionValue, sharedValue);
      [_overriddenFields addObject:aKey];
    } else if (isEqual && isOverridden) {
      DLog(@"%p: %@ is no longer overridden because %@ == %@", self, aKey,
           newSessionValue, sharedValue);
      [_overriddenFields removeObject:aKey];
    }
  }
  DLog(@"After session profile change overridden keys are: %@",
       _overriddenFields);
  [self setPreferencesFromAddressBookEntry:updatedProfile];
  [self setProfile:updatedProfile];
  [[NSNotificationCenter defaultCenter]
      postNotificationName:kSessionProfileDidChange
...
- (BOOL)reloadProfile {
  ...
  BOOL didChange = NO;
  NSDictionary *sharedProfile = [[ProfileModel sharedInstance]
      bookmarkWithGuid:_originalProfile[KEY_GUID]];
...
- (void)setPreferencesFromAddressBookEntry:(NSDictionary *)aePrefs {
  ...
  if ([self isTmuxClient] &&
      ![_profile[KEY_NAME] isEqualToString:aePrefs[KEY_NAME]]) {
    _tmuxTitleOutOfSync = YES;
  }

  BOOL useUnderline =
      [iTermProfilePreferences boolForKey:KEY_USE_UNDERLINE_COLOR
                                inProfile:aDict];
  ...
  self.cursorGuideColor = [[iTermProfilePreferences
      objectForKey:KEY_CURSOR_GUIDE_COLOR
  ...
  for (i = 0; i < 16; i++) {
    NSString *profileKey =
        [NSString stringWithFormat:KEYTEMPLATE_ANSI_X_COLOR, i];
    NSColor *theColor = [ITAddressBookMgr decodeColor:aDict[profileKey]];
    [_colorMap setColor:theColor forKey:kColorMap8bitBase + i];
  }

  [self setSmartCursorColor:[iTermProfilePreferences
                                boolForKey:KEY_SMART_CURSOR_COLOR
                                 inProfile:aDict]];

  [self setMinimumContrast:[iTermProfilePreferences
                               floatForKey:KEY_MINIMUM_CONTRAST
                                 inProfile:aDict]];
  ...
  [self
      setBackgroundImageMode:[iTermProfilePreferences
                                 unsignedIntegerForKey:KEY_BACKGROUND_IMAGE_MODE
                                             inProfile:aDict]];

  // Color scheme
  // ansiColorsMatchingForeground:andBackground:inBookmark does an equality
  // comparison, so iTermProfilePreferences is not used here.
  [self setColorFgBgVariable:
            [self ansiColorsMatchingForeground:aDict[KEY_FOREGROUND_COLOR]
                                 andBackground:aDict[KEY_BACKGROUND_COLOR]
                                    inBookmark:aDict]];

  // transparency
  [self setTransparency:[iTermProfilePreferences floatForKey:KEY_TRANSPARENCY
                                                   inProfile:aDict]];
  [self
      setTransparencyAffectsOnlyDefaultBackgroundColor:
          [iTermProfilePreferences
              floatForKey:KEY_TRANSPARENCY_AFFECTS_ONLY_DEFAULT_BACKGROUND_COLOR
                inProfile:aDict]];

  // bold
  [self setUseBoldFont:[iTermProfilePreferences boolForKey:KEY_USE_BOLD_FONT
                                                 inProfile:aDict]];
  self.thinStrokes = [iTermProfilePreferences intForKey:KEY_THIN_STROKES
                                              inProfile:aDict];

  self.asciiLigatures = [iTermProfilePreferences boolForKey:KEY_ASCII_LIGATURES
                                                  inProfile:aDict];
  self.nonAsciiLigatures =
      [iTermProfilePreferences boolForKey:KEY_NON_ASCII_LIGATURES
                                inProfile:aDict];

  [_textview
      setUseBoldColor:[iTermProfilePreferences boolForKey:KEY_USE_BOLD_COLOR
                                                inProfile:aDict]
  ...
  [self setUseItalicFont:[iTermProfilePreferences boolForKey:KEY_USE_ITALIC_FONT
                                                   inProfile:aDict]];

  // Set up the rest of the preferences
  [_screen setAudibleBell:![iTermProfilePreferences boolForKey:KEY_SILENCE_BELL
                                                     inProfile:aDict]];
  [_screen
      setShowBellIndicator:[iTermProfilePreferences boolForKey:KEY_VISUAL_BELL
                                                     inProfile:aDict]];
  [_screen setFlashBell:[iTermProfilePreferences boolForKey:KEY_FLASHING_BELL
                                                  inProfile:aDict]];
  [_screen
      setPostUserNotifications:[iTermProfilePreferences
                                   boolForKey:KEY_BOOKMARK_USER_NOTIFICATIONS
                                    inProfile:aDict]];
  [_textview
      setBlinkAllowed:[iTermProfilePreferences boolForKey:KEY_BLINK_ALLOWED
                                                inProfile:aDict]];
  [_screen
      setCursorBlinks:[iTermProfilePreferences boolForKey:KEY_BLINKING_CURSOR
                                                inProfile:aDict]];
  [_textview
      setBlinkingCursor:[iTermProfilePreferences boolForKey:KEY_BLINKING_CURSOR
                                                  inProfile:aDict]];
  [_textview
      setCursorType:_cursorTypeOverride
                        ? _cursorTypeOverride.integerValue
                        : [iTermProfilePreferences intForKey:KEY_CURSOR_TYPE
                                                   inProfile:aDict]];
  ...
  _triggerParametersUseInterpolatedStrings =
      [iTermProfilePreferences boolForKey:KEY_TRIGGERS_USE_INTERPOLATED_STRINGS
                                inProfile:aDict];
  ...
  [_textview setUseNonAsciiFont:[iTermProfilePreferences
                                    boolForKey:KEY_USE_NONASCII_FONT
                                     inProfile:aDict]];
  [_textview
      setAntiAlias:[iTermProfilePreferences boolForKey:KEY_ASCII_ANTI_ALIASED
                                             inProfile:aDict]
          nonAscii:[iTermProfilePreferences boolForKey:KEY_NONASCII_ANTI_ALIASED
                                             inProfile:aDict]];
  [_textview setUseNativePowerlineGlyphs:[iTermProfilePreferences
                                             boolForKey:KEY_POWERLINE
                                              inProfile:aDict]];
  [self setEncoding:[iTermProfilePreferences
                        unsignedIntegerForKey:KEY_CHARACTER_ENCODING
                                    inProfile:aDict]];
  [self setTermVariable:[iTermProfilePreferences stringForKey:KEY_TERMINAL_TYPE
                                                    inProfile:aDict]];
  [_terminal setAnswerBackString:[iTermProfilePreferences
                                     stringForKey:KEY_ANSWERBACK_STRING
                                        inProfile:aDict]];
  [self setAntiIdleCode:[iTermProfilePreferences intForKey:KEY_IDLE_CODE
                                                 inProfile:aDict]];
  [self setAntiIdlePeriod:[iTermProfilePreferences doubleForKey:KEY_IDLE_PERIOD
                                                      inProfile:aDict]];
  [self setAntiIdle:[iTermProfilePreferences boolForKey:KEY_SEND_CODE_WHEN_IDLE
                                              inProfile:aDict]];
  self.endAction =
      [iTermProfilePreferences unsignedIntegerForKey:KEY_SESSION_END_ACTION
                                           inProfile:aDict];
  _screen.normalization =
      [iTermProfilePreferences integerForKey:KEY_UNICODE_NORMALIZATION
                                   inProfile:aDict];
  [self setTreatAmbiguousWidthAsDoubleWidth:
            [iTermProfilePreferences boolForKey:KEY_AMBIGUOUS_DOUBLE_WIDTH
                                      inProfile:aDict]];
  [self setXtermMouseReporting:[iTermProfilePreferences
                                   boolForKey:KEY_XTERM_MOUSE_REPORTING
                                    inProfile:aDict]];
  [self setXtermMouseReportingAllowMouseWheel:
            [iTermProfilePreferences
                boolForKey:KEY_XTERM_MOUSE_REPORTING_ALLOW_MOUSE_WHEEL
                 inProfile:aDict]];
  [self setXtermMouseReportingAllowClicksAndDrags:
            [iTermProfilePreferences
                boolForKey:KEY_XTERM_MOUSE_REPORTING_ALLOW_CLICKS_AND_DRAGS
                 inProfile:aDict]];
  [self setUnicodeVersion:[iTermProfilePreferences
                              integerForKey:KEY_UNICODE_VERSION
                                  inProfile:aDict]];
  [_terminal setDisableSmcupRmcup:[iTermProfilePreferences
                                      boolForKey:KEY_DISABLE_SMCUP_RMCUP
                                       inProfile:aDict]];
  [_screen setAllowTitleReporting:[iTermProfilePreferences
                                      boolForKey:KEY_ALLOW_TITLE_REPORTING
                                       inProfile:aDict]];
  const BOOL didAllowPasteBracketing = _terminal.allowPasteBracketing;
  [_terminal setAllowPasteBracketing:[iTermProfilePreferences
                                         boolForKey:KEY_ALLOW_PASTE_BRACKETING
                                          inProfile:aDict]];
  ...
  [_terminal setAllowKeypadMode:[iTermProfilePreferences
                                    boolForKey:KEY_APPLICATION_KEYPAD_ALLOWED
                                     inProfile:aDict]];
  [_screen setUnlimitedScrollback:[iTermProfilePreferences
                                      boolForKey:KEY_UNLIMITED_SCROLLBACK
                                       inProfile:aDict]];
  [_screen setMaxScrollbackLines:[iTermProfilePreferences
                                     intForKey:KEY_SCROLLBACK_LINES
                                     inProfile:aDict]];
  if ([iTermProfilePreferences boolForKey:KEY_SHOW_STATUS_BAR
                                inProfile:aDict]) {
    NSDictionary *layout =
        [iTermProfilePreferences objectForKey:KEY_STATUS_BAR_LAYOUT
                                    inProfile:aDict];
    NSDictionary *existing = _statusBarViewController.layout.dictionaryValue;
    if (![NSObject object:existing isEqualToObject:layout]) {
      iTermStatusBarLayout *newLayout = [[[iTermStatusBarLayout alloc]
          initWithDictionary:layout
                       scope:self.variablesScope] autorelease];
      if (![NSObject object:existing
              isEqualToObject:newLayout.dictionaryValue]) {
        [_statusBarViewController release];
        if (newLayout) {
          _statusBarViewController = [[iTermStatusBarViewController alloc]
              initWithLayout:newLayout
  ...
  _tmuxStatusBarMonitor.active =
      [iTermProfilePreferences boolForKey:KEY_SHOW_STATUS_BAR inProfile:aDict];
  _screen.appendToScrollbackWithStatusBar =
      [iTermProfilePreferences boolForKey:KEY_SCROLLBACK_WITH_STATUS_BAR
                                inProfile:aDict];
  [_badgeFontName release];
  _badgeFontName = [[iTermProfilePreferences stringForKey:KEY_BADGE_FONT
                                                inProfile:aDict] copy];

  self.badgeFormat = [iTermProfilePreferences stringForKey:KEY_BADGE_FORMAT
                                                 inProfile:aDict];
  _badgeLabelSizeFraction =
      NSMakeSize([iTermProfilePreferences floatForKey:KEY_BADGE_MAX_WIDTH
                                            inProfile:aDict],
                 [iTermProfilePreferences floatForKey:KEY_BADGE_MAX_HEIGHT
                                            inProfile:aDict]);
  ...
  [self setFont:[ITAddressBookMgr fontWithDesc:aDict[KEY_NORMAL_FONT]]
           nonAsciiFont:[ITAddressBookMgr
                            fontWithDesc:aDict[KEY_NON_ASCII_FONT]]
      horizontalSpacing:[iTermProfilePreferences
                            floatForKey:KEY_HORIZONTAL_SPACING
                              inProfile:aDict]
        verticalSpacing:[iTermProfilePreferences
                            floatForKey:KEY_VERTICAL_SPACING
                              inProfile:aDict]];
  [_screen
      setSaveToScrollbackInAlternateScreen:
          [iTermProfilePreferences boolForKey:KEY_SCROLLBACK_IN_ALTERNATE_SCREEN
                                    inProfile:aDict]];

  NSDictionary *shortcutDictionary =
      [iTermProfilePreferences objectForKey:KEY_SESSION_HOTKEY inProfile:aDict];
  iTermShortcut *shortcut =
      [iTermShortcut shortcutWithDictionary:shortcutDictionary];
  [[iTermSessionHotkeyController sharedInstance] setShortcut:shortcut
                                                  forSession:self];
  ...
  const int modifyOtherKeysTerminalSetting =
      _terminal.sendModifiers[4].intValue;
  if (modifyOtherKeysTerminalSetting == -1) {
    const BOOL profileWantsTickit =
        [iTermProfilePreferences boolForKey:KEY_USE_LIBTICKIT_PROTOCOL
                                  inProfile:aDict];
    self.keyMappingMode = profileWantsTickit ? iTermKeyMappingModeCSIu
                                             : iTermKeyMappingModeStandard;
  }

  if (self.isTmuxClient) {
    NSDictionary *tabColorDict =
        [iTermProfilePreferences objectForKey:KEY_TAB_COLOR inProfile:aDict];
    if (![iTermProfilePreferences boolForKey:KEY_USE_TAB_COLOR
                                   inProfile:aDict]) {
      tabColorDict = nil;
    }
    NSColor *tabColor = [ITAddressBookMgr decodeColor:tabColorDict];
    [self.tmuxController setTabColorString:tabColor ? [tabColor hexString]
                                                    : iTermTmuxTabColorNone
                             forWindowPane:self.tmuxPane];
  }
  [self.delegate
      sessionDidChangeGraphic:self
...
- (BOOL)checkForCyclesInSwiftyStrings {
  iTermSwiftyStringGraph *graph =
      [[[iTermSwiftyStringGraph alloc] init] autorelease];
...
- (void)updateBadgeLabel:(NSString *)newValue {
  ...
  [self.variablesScope setValue:newValue
               forVariableNamed:iTermVariableKeySessionBadge];
}
...
// You're processing if data was read off the socket in the last
// "idleTimeSeconds".
- (BOOL)isProcessing {
  NSTimeInterval now = [NSDate timeIntervalSinceReferenceDate];
...
- (NSString *)name {
  return [self.variablesScope valueForVariableName:iTermVariableKeySessionName]
             ?: [self.variablesScope
                    valueForVariableName:iTermVariableKeySessionProfileName]
                    ?: @"Untitled";
}
...
- (void)setWindowTitle:(NSString *)title {
  [self.variablesScope setValue:title
...
- (BOOL)shouldShowTabGraphicForProfile:(Profile *)profile {
  const iTermProfileIcon icon =
      [iTermProfilePreferences unsignedIntegerForKey:KEY_ICON
                                           inProfile:profile];
...
- (NSImage *)tabGraphicForProfile:(Profile *)profile {
  ...
  case iTermProfileIconAutomatic:
    [_graphicSource
        updateImageForProcessID:self.shell.pid
...
- (NSImage *)customIconImageForProfile:(Profile *)profile {
  ...
  NSString *path = [iTermProfilePreferences stringForKey:KEY_ICON_PATH
                                               inProfile:profile];
  BOOL flipped = YES;
  if (@available(macOS 10.15, *)) {
    flipped = NO;
  }
  return [_customIcon imageAtPath:path
                           ofSize:NSMakeSize(16, 16)
                          flipped:flipped];
}
...
- (void)popIconTitle {
  ...
  [self setIconName:theName
                        ?: [iTermProfilePreferences stringForKey:KEY_NAME
                                                       inProfile:self.profile]];
}
...
- (void)setBackgroundImagePath:(NSString *)imageFilePath {
  if ([imageFilePath length]) {
    ...
    self.backgroundImage = [[[NSImage alloc]
        initWithContentsOfFile:_backgroundImagePath] autorelease];
  } else {
...
- (CGFloat)effectiveBlend {
  ...
  if ([iTermPreferences boolForKey:kPreferenceKeyPerPaneBackgroundImage]) {
    ...
    // I don't have a background image so inherit the blend setting of the
    // active session.
...
- (void)useTransparencyDidChange {
  // The view does not like getting replaced during the spin of the runloop
  // during which it is created.
...
- (void)setAntiIdle:(BOOL)set {
  ...
  if (set) {
    _antiIdleTimer =
        [NSTimer scheduledTimerWithTimeInterval:_antiIdlePeriod
...
- (void)setUnicodeVersion:(NSInteger)version {
  ...
  [[NSNotificationCenter defaultCenter]
      postNotificationName:iTermUnicodeVersionDidChangeNotification
                    object:nil];
}
...
- (void)logStart {
  iTermSavePanel *savePanel =
      [iTermSavePanel showWithOptions:kSavePanelOptionAppendOrReplace |
                                      kSavePanelOptionLogPlainTextAccessory
                           identifier:@"StartSessionLog"
                     initialDirectory:NSHomeDirectory()
                      defaultFilename:@""];
  if (savePanel.path) {
    BOOL shouldAppend =
        (savePanel.replaceOrAppend == kSavePanelReplaceOrAppendSelectionAppend);
...
- (void)setProfile:(Profile *)newProfile {
  ...
  if (originalGuid) {
    ...
    // See bug 2632.
    // It is also taken when you "new tab with same profile" and that profile is
    // divorced.
    Profile *possibleOriginalProfile =
        [[ProfileModel sharedInstance] bookmarkWithGuid:originalGuid];
...
- (NSString *)programType {
  if ([self.program
          isEqualToString:[ITAddressBookMgr shellLauncherCommandWithCustomShell:
                                                self.customShell]]) {
...
- (BOOL)encodeArrangementWithContents:(BOOL)includeContents
  ...
  if ([programType isEqualToString:kProgramTypeCustomShell]) {
    // The shell launcher command could change from run to run (e.g., if you
    // move iTerm2). I don't want to use a magic string, so setting program to
    // an empty dict.
    assert(self.customShell.length);
    NSDictionary *dict = @{kProgramType : kProgramTypeCustomShell};
    dict = [dict dictionaryBySettingObject:self.customShell
                                    forKey:kCustomShell];
    ...
    result[SESSION_ARRANGEMENT_PROGRAM] = dict;
             ...
             self.program) {
    result[SESSION_ARRANGEMENT_PROGRAM] =
        @{kProgramType : kProgramTypeCommand, kProgramCommand : self.program};
  }
  result[SESSION_ARRANGEMENT_KEYLABELS] = _keyLabels ?: @{};
  result[SESSION_ARRANGEMENT_KEYLABELS_STACK] =
      [_keyLabelsStack mapWithBlock:^id(iTermKeyLabels *anObject) {
  ...
  result[SESSION_ARRANGEMENT_SHORT_LIVED_SINGLE_USE] =
      @(self.shortLivedSingleUse);
  if (self.hostnameToShell) {
    result[SESSION_ARRANGEMENT_HOSTNAME_TO_SHELL] =
        [[self.hostnameToShell copy] autorelease];
  }

  NSDictionary *shortcutDictionary =
      [[[iTermSessionHotkeyController sharedInstance] shortcutForSession:self]
          dictionaryValue];
  if (shortcutDictionary) {
    result[SESSION_ARRANGEMENT_HOTKEY] = shortcutDictionary;
  }

  result[SESSION_ARRANGEMENT_NAME_CONTROLLER_STATE] =
      [_nameController stateDictionary];
  if (includeContents) {
    __block int numberOfLinesDropped = 0;
    [result encodeDictionaryWithKey:SESSION_ARRANGEMENT_CONTENTS
                         generation:iTermGenerationAlwaysEncode
                              block:^BOOL(
                                  id<iTermEncoderAdapter> _Nonnull encoder) {
                                return [_screen
                                    encodeContents:encoder
    ...
    if (self.lastDirectory) {
      DLog(@"Saving arrangement for %@ with lastDirectory of %@", self,
           self.lastDirectory);
      result[SESSION_ARRANGEMENT_LAST_DIRECTORY] = self.lastDirectory;
    }
    if (self.lastLocalDirectory) {
      result[SESSION_ARRANGEMENT_LAST_LOCAL_DIRECTORY] =
          self.lastLocalDirectory;
    }
    result[SESSION_ARRANGEMENT_SELECTION] = [self.textview.selection
        dictionaryValueWithYOffset:-numberOfLinesDropped
  ...
  if (_liveSession && includeContents && !_dvr) {
    [result
        encodeDictionaryWithKey:SESSION_ARRANGEMENT_LIVE_SESSION
                     generation:iTermGenerationAlwaysEncode
                          block:^BOOL(
                              id<iTermEncoderAdapter> _Nonnull encoder) {
                            return [_liveSession
                                encodeArrangementWithContents:includeContents
                                                      encoder:encoder];
                          }];
  }
  if (includeContents && !self.isTmuxClient) {
    // These values are used for restoring sessions after a crash. It's only
    // saved when contents are included since saved window arrangements have no
    // business knowing the process id.
    if ([iTermAdvancedSettingsModel runJobsInServers] &&
  ...
  if (_overriddenFields.count > 0) {
    result[SESSION_ARRANGEMENT_OVERRIDDEN_FIELDS] =
        _overriddenFields.allObjects;
  }
  if (self.tmuxMode == TMUX_GATEWAY && self.tmuxController.sessionName) {
    result[SESSION_ARRANGEMENT_IS_TMUX_GATEWAY] = @YES;
    result[SESSION_ARRANGEMENT_TMUX_GATEWAY_SESSION_ID] =
        @(self.tmuxController.sessionId);
    result[SESSION_ARRANGEMENT_TMUX_GATEWAY_SESSION_NAME] =
        self.tmuxController.sessionName;
  ...
  result[SESSION_ARRANGEMENT_SHOULD_EXPECT_PROMPT_MARKS] =
      @(_shouldExpectPromptMarks);
  result[SESSION_ARRANGEMENT_SHOULD_EXPECT_CURRENT_DIR_UPDATES] =
      @(_shouldExpectCurrentDirUpdates);
  result[SESSION_ARRANGEMENT_WORKING_DIRECTORY_POLLER_DISABLED] =
      @(_workingDirectoryPollerDisabled);
  result[SESSION_ARRANGEMENT_COMMANDS] = _commands;
  result[SESSION_ARRANGEMENT_DIRECTORIES] = _directories;
  // If this is slow, it could be encoded more efficiently by using
  // encodeArrayWithKey:... but that would require coming up with a good unique
  // identifier.
...
+ (NSDictionary *)arrangementFromTmuxParsedLayout:(NSDictionary *)parseNode
  ...
  [result setObject:[parseNode objectForKey:kLayoutDictWidthKey]
             forKey:SESSION_ARRANGEMENT_COLUMNS];
  [result setObject:[parseNode objectForKey:kLayoutDictHeightKey]
             forKey:SESSION_ARRANGEMENT_ROWS];
  ...
  [result setObject:[parseNode objectForKey:kLayoutDictWindowPaneKey]
             forKey:SESSION_ARRANGEMENT_TMUX_PANE];
...
+ (NSString *)initialWorkingDirectoryFromArrangement:
...
- (BOOL)shouldUpdateTitles:(NSTimeInterval)now {
  ...
  if ([[iTermProcessCache sharedInstance] processIsDirty:_shell.pid]) {
    DLog(@"Update title immediately because process %@ is dirty",
         @(_shell.pid));
    return YES;
  }
  ...
  const NSTimeInterval deadline =
      _titleDirty ? dirtyTitlePeriod : pollingTitlePeriod;
...
- (void)updateDisplayBecause:(NSString *)reason {
  ...
  if (@available(macOS 10.11, *)) {
    if (_useMetal && _updateCount % 10 == 0) {
      iTermPreciseTimerSaveLog(
          [NSString stringWithFormat:@"%@: updateDisplay interval",
                                     _view.driver.identifier],
  ...
  if ([_delegate sessionIsActiveInTab:self]) {
    ...
    [self setCurrentForegroundJobProcessInfo:[_shell
                                                 cachedProcessInfoIfAvailable]];
  ...
  const BOOL transientTitle =
      _delegate.realParentWindow.isShowingTransientTitle;
  const BOOL animationPlaying = _textview.getAndResetDrawingAnimatedImageFlag;

  // Even if "active" isn't changing we need the side effect of setActive: that
  // updates the cadence since we might have just become idle.
...
- (void)updateTitles {
  ...
  __weak __typeof(self) weakSelf = self;
  [_shell fetchProcessInfoForCurrentJobWithCompletion:^(
              iTermProcessInfo *processInfo) {
    [weakSelf updateTitleWithProcessInfo:processInfo];
  }];
}

- (void)updateTitleWithProcessInfo:(iTermProcessInfo *)processInfo {
  DLog(@"%@ Job for pid %@ is %@, pid=%@", self, @(_shell.pid),
       processInfo.name, @(processInfo.processID));
  [self setCurrentForegroundJobProcessInfo:processInfo];

  if ([_delegate sessionBelongsToVisibleTab]) {
    // Revert to the permanent tab title.
    DLog(@"Session asking to set window title. Parent window is %@",
         [_delegate parentWindow]);
...
- (void)setCurrentForegroundJobProcessInfo:(iTermProcessInfo *)processInfo {
  ...
  // This is a gross hack but I haven't found a nicer way to do it yet. When
  // exec fails (or takes enough time that we happen to poll it before exec
  // finishes) then the job name is "iTermServer" as inherited from the parent.
  // This avoids showing it in the UI.
  if ([name isEqualToString:@"iTermServer"] &&
      ![[self.program lastPathComponent] isEqualToString:name]) {
    name = self.program.lastPathComponent;
    processTitle = name;
  }
  [self.variablesScope setValue:name
               forVariableNamed:iTermVariableKeySessionJob];
  [self.variablesScope setValue:processTitle
               forVariableNamed:iTermVariableKeySessionProcessTitle];
  [self.variablesScope setValue:processInfo.commandLine
               forVariableNamed:iTermVariableKeySessionCommandLine];
  [self.variablesScope setValue:@(processInfo.processID)
               forVariableNamed:iTermVariableKeySessionJobPid];
...
- (void)setActive:(BOOL)active {
  DLog(@"setActive:%@ timerRunning=%@ updateTimer.isValue=%@ lastTimeout=%f "
       @"session=%@",
       @(active), @(_timerRunning), @(_cadenceController.updateTimerIsValid),
       _lastTimeout, self);
  _active = active;
...
- (void)doAntiIdle {
  ...
  if (![self isTmuxGateway] &&
      now >= _lastInput + _antiIdlePeriod - kAntiIdleGracePeriod) {
...
- (void)setFont:(NSFont *)font
  ...
  if ([_textview.font isEqualTo:font] &&
    ...
    // If you change some attribute of a profile that causes sessions to reload
    // their profiles with the kReloadAllProfiles notification, then each
    // profile will call this in turn, and it may be a no-op for all of them. If
    // each calls -[PseudoTerminal fitWindowToTab:_delegate] and different tabs
    // come up with slightly different ideal sizes (e.g., because they have
    // different split pane layouts) then the window may shrink by a few pixels
    // for each session.
    return;
  }
  ...
  [_delegate sessionDidChangeFontSize:self
                         adjustWindow:!_windowAdjustmentDisabled];
  DLog(@"After:\n%@", [window.contentView iterm_recursiveDescription]);
  DLog(@"Window frame: %@", window);
}
...
- (void)profileSessionNameDidEndEditing:(NSNotification *)notification {
  ...
  if (_tmuxTitleOutOfSync && [self isTmuxClient] &&
      [theGuid isEqualToString:_profile[KEY_GUID]]) {
    Profile *profile =
        [[ProfileModel sessionsInstance] bookmarkWithGuid:theGuid];
...
- (void)savedArrangementWasRepaired:(NSNotification *)notification {
  if ([notification.object
          isEqual:_naggingController.missingSavedArrangementProfileGUID]) {
    Profile *newProfile = notification.userInfo[@"new profile"];
    [self setIsDivorced:NO
             withDecree:@"Saved arrangement was repaired. Set divorced to NO."];
...
// Metal is disabled when any note anywhere is visible because compositing
// NSViews over Metal is a horror and besides these are subviews of PTYTextView
// and I really don't want to invest any more in this little-used feature.
...
- (void)synchronizeTmuxFonts:(NSNotification *)notification {
  if (!_exited && [self isTmuxClient]) {
    ...
    if (controller == _tmuxController &&
        (!controller.variableWindowSize ||
         tmuxWindow.intValue == self.delegate.tmuxWindow)) {
      [_textview setFont:font
               nonAsciiFont:nonAsciiFont
  ...
  if (!fontChangeNotificationInProgress) {
    ...
    [[NSNotificationCenter defaultCenter]
        postNotificationName:kTmuxFontChanged
                      object:@[
                        _textview.font, _textview.nonAsciiFontEvenIfNotUsed,
    ...
    [[NSNotificationCenter defaultCenter]
        postNotificationName:kPTYSessionTmuxFontDidChange
                      object:self];
  }
}
...
- (void)changeFontSizeDirection:(int)dir {
  ...
  if (dir) {
    ...
    nonAsciiFont =
        [self fontWithRelativeSize:dir
                              from:_textview.nonAsciiFontEvenIfNotUsed];
    ...
    nonAsciiFont = [ITAddressBookMgr
        fontWithDesc:[abEntry objectForKey:KEY_NON_ASCII_FONT]];
...
- (BOOL)profileValuesDifferFromCurrentProfile:(NSDictionary *)newValues {
  for (NSString *key in newValues) {
    if ([key isEqualToString:KEY_GUID] ||
        [key isEqualToString:KEY_ORIGINAL_GUID]) {
      continue;
    }
...
// Missing values are replaced with their defaults. If everything matches
// excluding deprecated keys then the profiles are equivalent.
- (BOOL)profile:(Profile *)profile1
    isEffectivelyEqualToProfile:(Profile *)profile2 {
...
- (void)setSessionSpecificProfileValues:(NSDictionary *)newValues {
  ...
  // Consider the possibility that newValues exactly matches an existing shared
  // profile or is a modified copy of a shared profile.
  NSString *const newGuid = newValues[KEY_GUID];
  if (newGuid) {
    Profile *const existingProfile =
        [[ProfileModel sharedInstance] bookmarkWithGuid:newGuid];
    if (existingProfile) {
      ...
      // Are we done?
      if ([self profile:existingProfile
              isEffectivelyEqualToProfile:newValues]) {
        DLog(@"Effectively equivalent to existing profile");
        // Since you switched to a shared profile that is an exact match, we're
        // done.
        return;
      }

      // No. Divorce and modify. This takes care of making everything right,
      // such as setting the original profile guid.
  ...
  // Build a copy of the current dictionary, replacing values with those
  // provided in newValues.
  NSMutableDictionary *temp =
      [NSMutableDictionary dictionaryWithDictionary:_profile];
  for (NSString *key in newValues) {
    if ([key isEqualToString:KEY_GUID] ||
...
// TBH I'm not 100% sure this is correct. Don't use it for anything critical
// until this whole mess has been burned to the ground and rebuilt.
...
- (void)inheritDivorceFrom:(PTYSession *)parent decree:(NSString *)decree {
  ...
  DLog(@"%@: Set overridden fields from %@: %@", self, parent,
       _overriddenFields);
}
...
- (void)setIsDivorced:(BOOL)isDivorced withDecree:(NSString *)decree {
  ...
  [self setDivorceDecree:
            [NSString
                stringWithFormat:@"isDivorced=%@ Decree=%@ guid=%@ Stack:\n%@",
                                 @(isDivorced), decree, guid,
...
- (NSString *)divorceAddressBookEntryFromPreferences {
  ...
  if (self.isDivorced) {
    ITAssertWithMessage(
        ...
        @"I am divorced with guid %@ but the sessions instance has no such "
        @"guid. Log:\n%@\n\nModel log:\n%@\nEnd.",
        guid, _divorceDecree,
        [[[[ProfileModel sessionsInstance] debugHistoryForGuid:guid]
  ...
  DIVORCE_LOG(@"Set profile %@ divorced, add to sessions instance",
              bookmark[KEY_GUID]);
  ...
  DIVORCE_LOG(@"Allocating a new guid for this profile. The new guid is %@",
              guid);
  [[ProfileModel sessionsInstance] addGuidToDebug:guid];
...
- (void)setCurrentMarkOrNotePosition:(Interval *)currentMarkOrNotePosition {
  ...
  ITBetaAssert(currentMarkOrNotePosition.limit >= 0,
               @"Negative limit in current mark or note %@",
...
- (NSImage *)snapshotCenteredOn:(VT100GridAbsCoord)coord size:(NSSize)size {
  ...
  VT100GridCoord relativeCoord =
      VT100GridCoordMake(coord.x, coord.y - _screen.totalScrollbackOverflow);
  NSPoint centerPoint = [_textview pointForCoord:relativeCoord];
  NSRect rect = NSMakeRect(
      MIN(MAX(0, centerPoint.x - size.width / 2), NSWidth(_textview.bounds)),
...
+ (CGContextRef)onePixelContext {
  ...
  if (context == NULL) {
    context = CGBitmapContextCreate(
        NULL, 1, 1, 8, 1 * 4, [self metalColorSpace],
...
- (void)setMetalContextSize:(CGSize)size {
  ...
  CGSize scaledSize =
      CGSizeMake(size.width * scale * radius, size.height * scale * radius);
  if (_metalContext) {
    if (CGSizeEqualToSize(
            scaledSize, CGSizeMake(CGBitmapContextGetWidth(_metalContext),
  ...
  _metalContext = CGBitmapContextCreate(
      NULL, scaledSize.width, scaledSize.height, 8,
  ...
  for (PseudoTerminal *term in [[iTermController sharedInstance] terminals]) {
    for (PTYSession *session in term.allSessions) {
      if (session.view.metalView.device != nil) {
        ...
        DLog(@"Found another session %p with a metal device, "
             @"usingIntegratedGPU=%@",
             session, @(result));
        return result;
      }
...
- (BOOL)metalAllowed:(out iTermMetalUnavailableReason *)reason {
  ...
  // Use window occlusion because of issue 9174 but only for integrated GPUs
  // because of issue 9044.
  if ([self usingIntegratedGPU] &&
      [_delegate.realParentWindow.ptyWindow approximateFractionOccluded] >
          0.5) {
    if (reason) {
  ...
  if ([PTYNoteViewController anyNoteVisible]) {
    // When metal is enabled the note's superview (PTYTextView) has alphaValue=0
  ...
  if (@available(macOS 10.14, *)) {
    ...
    // Mojave fixed compositing of views over MTKView and removed subpixel
    // antialiasing making blending of text easier.
    ...
    // Metal's not allowed when other views are composited over the metal view
    // because that just doesn't seem to work, even if you use
    // presentsWithTransaction (even if it did work, it requires presenting the
    // drawable on the main thread which defeats the purpose of the metal
    // renderer).
    //
    // Perhaps some day transparency and ligatures will be supported.
    const BOOL nativeFullScreen =
        !!(self.view.window.styleMask & NSWindowStyleMaskFullScreen);
    const BOOL untitled = self.view.window && !(self.view.window.styleMask &
                                                NSWindowStyleMaskTitled);
    const BOOL hasSquareCorners = untitled || nativeFullScreen;
    const BOOL marginsOk =
        ([iTermPreferences intForKey:kPreferenceKeyTopBottomMargins] >= 2 &&
         [iTermPreferences intForKey:kPreferenceKeySideMargins] >=
             1); // Smaller margins break rounded window corners
...
- (BOOL)canProduceMetalFramecap {
  if (@available(macOS 10.11, *)) {
    return _useMetal && _view.metalView.alphaValue == 1 && _wrapper.useMetal &&
...
- (BOOL)metalViewSizeIsLegal NS_AVAILABLE_MAC(10_11) {
  ...
  // When closing a session I once got an insane height that caused an
  // assertion.
  const CGFloat maxScale = 2;
  return size.width > 0 && size.width < (8192 / maxScale) && size.height > 0 &&
         size.height < (8192 / maxScale);
}
...
- (BOOL)ligaturesEnabledInEitherFont {
  ...
  if ([iTermProfilePreferences boolForKey:KEY_USE_NONASCII_FONT
                                inProfile:self.profile] &&
      [iTermProfilePreferences boolForKey:KEY_NON_ASCII_LIGATURES
                                inProfile:self.profile]) {
    return YES;
...
- (void)setUseMetal:(BOOL)useMetal {
  if (@available(macOS 10.11, *)) {
    ...
    _useMetal = useMetal;
    // The metalview's alpha will initially be 0. Once it has drawn a frame
    // we'll swap what is visible.
        ...
        drawAsynchronouslyInView:_view.metalView
                      completion:^(BOOL ok) {
                        if (!_useMetal || _exited) {
                          DLog(@"Finished async draw but metal off/exited for "
                               @"%@",
                               self);
                          return;
                        }
                        ...
                        if (!ok) {
                          ...
                          // Wait 10ms to avoid burning CPU if it failed because
                          // it's slow to draw the first frame.
                          dispatch_after(
...
- (void)showMetalViewImmediately {
  if (!_useMetal) {
    DLog(@"Declining to show metal view immediately in %@ because useMetal is "
         @"NO",
         self);
    return;
  }
  if (_view.metalView.bounds.size.width == 0 ||
      _view.metalView.bounds.size.height == 0) {
    DLog(@"Declining to show metal view immediately in %@ because the view's "
         @"size is %@",
         self, NSStringFromSize(_view.metalView.bounds.size));
    return;
  }
  if (_textview == nil) {
    DLog(@"Declining to show metal view immediately in %@ because the textview "
         @"is nil",
         self);
    return;
  }
  if (_textview.dataSource == nil) {
    DLog(@"Declining to show metal view immediately in %@ because the "
         @"textview's datasource is nil",
         self);
    return;
  }
  if (_screen.width == 0 || _screen.height == 0) {
    DLog(@"Declining to show metal view immediately in %@ because the screen's "
         @"size is %@x%@. Screen is %@",
...
- (void)setUseMetal:(BOOL)useMetal
         dataSource:(id<iTermMetalDriverDataSource>)dataSource
    NS_AVAILABLE_MAC(10_11) {
...
- (void)updateMetalDriver NS_AVAILABLE_MAC(10_11) {
  ...
  NSRect rect = [iTermCharacterSource
      boundingRectForCharactersInRange:NSMakeRange(32, 127 - 32)
  ...
  if (rect.origin.y < 0) {
    ...
    // It rides *very* low in its box. The lineheight that PTYFontInfo
    // calculates is actually too small to contain the glyphs (it uses a weird
    // algorithm that was discovered "organically"). There are gobs of empty
    // pixels at the top, so we shift all its ASCII glyphs a bit so they'll fit.
    // Non-ASCII characters may take multiple parts and so can properly extend
    // beyond their cell, so we only need to think about ASCII. In other words,
    // this hack shifts the character up *in the texture* to make better use of
    // space without using a larger glyph size.
    //
    // In a monochrome world, this is still necessary because even though glyph
    // size and cell size are no longer required to be the same, part of the
    // glyph will be drawn outside its bounds and get clipped in the texture.
  ...
  if (iTermTextIsMonochrome() && rect.origin.x < 0) {
    ...
    // There is a subtle difference, though! The monochrome code path assumes
    // that glyphs are left-aligned in their glyphSize-sized chunk of the
    // texture. Setting the asciiOffset here causes them to all be rendered a
    // few pixels to the right so that this assumption will be true. The quad is
    // then shifted left by a corresponding amount when rendering so it ends up
    // drawn in the right place.
    //
    // When doing subpixel antialiasing, this is not an issue because it deals
    // with multipart ASCII glyphs differently. It splits them into pieces and
    // draws them as separate instances.
    //
    // Changing the assumption that glyphs are left-aligned would be very
    // complex, and I can't afford to add more risk right now. This is less than
    // beautiful, but it's quite safe.
    asciiOffset.width = -floor(rect.origin.x * scale);
  }
  if (iTermTextIsMonochrome()) {
    // Mojave can use a glyph size larger than cell size because compositing is
    // trivial without subpixel AA.
  ...
  if (!_metalContext) {
    DLog(@"%p Failed to allocate metal context. Disable metal and try again in "
         @"1 second.",
         self);
  ...
  [_view.driver setCellSize:cellSize
      cellSizeWithoutSpacing:CGSizeMake(_textview.charWidthWithoutSpacing,
                                        _textview.charHeightWithoutSpacing)
                   glyphSize:glyphSize
...
- (void)retryMetalAfterContextAllocationFailure {
  DLog(@"%p It's been one second since trying to allocate a metal context "
       @"failed. Try again.",
       self);
  if (!_errorCreatingMetalContext) {
  ...
  if (_metalContext) {
    ...
    DLog(@"Failed to allocate context again. A retry should have been "
         @"scheduled.");
  }
}
...
- (void)addCapturedOutput:(CapturedOutput *)capturedOutput {
  ...
  [[NSNotificationCenter defaultCenter]
      postNotificationName:kPTYSessionCapturedOutputDidChange
                    object:nil];
}
...
- (void)enterPassword:(NSString *)password {
  _echoProbe.delegate = self;
  [_echoProbe beginProbeWithBackspace:[self backspaceData] password:password];
}
...
- (NSImage *)dragImage {
  ...
  NSImage *dragImage =
      [[[NSImage alloc] initWithSize:[image size]] autorelease];
  [dragImage lockFocus];
...
- (void)setFocused:(BOOL)focused {
  if (focused != _focused) {
    ...
    if ([_terminal reportFocus]) {
      [self writeLatin1EncodedData:[_terminal.output reportFocusGained:focused]
                  broadcastAllowed:NO];
    }
...
- (BOOL)wantsContentChangedNotification {
  ...
  return (!_tailFindTimer && !_view.findViewIsHidden &&
...
- (NSString *)preferredTmuxClientName {
  ...
  if (remoteHost) {
    return [NSString
        stringWithFormat:@"%@@%@", remoteHost.username, remoteHost.hostname];
  } else {
...
- (void)setTmuxMode:(PTYSessionTmuxMode)tmuxMode {
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    [self.variablesScope setValue:name
                 forVariableNamed:iTermVariableKeySessionTmuxRole];
  });
}
...
- (void)setUpTmuxPipe {
  ...
  if (pipe(fds) < 0) {
    NSString *message = [NSString
        stringWithFormat:@"Failed to create pipe: %s", strerror(errno)];
    DLog(@"%@", message);
    [_screen appendStringAtCursor:message];
...
- (void)loadTmuxProcessID {
  ...
  NSString *command =
      [NSString stringWithFormat:@"display-message -t '%%%@' -p '#{pane_pid}'",
                                 @(self.tmuxPane)];
...
- (void)didFetchTmuxPid:(NSString *)pidString {
  if (pidString && self.tmuxMode == TMUX_CLIENT &&
      _tmuxController.serverIsLocal) {
...
- (void)replaceWorkingDirectoryPollerWithTmuxWorkingDirectoryPoller {
  ...
  _pwdPoller = [[iTermWorkingDirectoryPoller alloc]
      initWithTmuxGateway:_tmuxController.gateway
                    scope:self.variablesScope
               windowPane:self.tmuxPane];
  _pwdPoller.delegate = self;
  [_pwdPoller poll];
...
- (void)installTmuxStatusBarMonitor {
  ...
  if (_tmuxController.gateway.minimumServerVersion.doubleValue >= 2.9) {
    // Just use the built-in status bar for older versions of tmux because they
    // don't support ${T:xxx} or ${E:xxx}
    _tmuxStatusBarMonitor = [[iTermTmuxStatusBarMonitor alloc]
        initWithGateway:_tmuxController.gateway
                  scope:self.variablesScope];
    _tmuxStatusBarMonitor.active =
        [iTermProfilePreferences boolForKey:KEY_SHOW_STATUS_BAR
                                  inProfile:self.profile];
    if ([iTermPreferences boolForKey:kPreferenceKeyUseTmuxStatusBar] ||
        [iTermStatusBarLayout
            shouldOverrideLayout:self.profile[KEY_STATUS_BAR_LAYOUT]]) {
      [self setSessionSpecificProfileValues:@{
        KEY_STATUS_BAR_LAYOUT : [[iTermStatusBarLayout
            tmuxLayoutWithController:_tmuxController
                               scope:nil
...
- (void)installTmuxTitleMonitor {
  ...
  __weak __typeof(self) weakSelf = self;
  _tmuxTitleMonitor = [[iTermTmuxOptionMonitor alloc]
           initWithGateway:_tmuxController.gateway
                     scope:self.variablesScope
...
- (void)setTitleFromTmuxTitleMonitor:(NSString *)title {
  if (title) {
    [self
        setSessionSpecificProfileValues:@{KEY_TMUX_PANE_TITLE : title ?: @""}];
...
- (void)startTmuxMode:(NSString *)dcsID {
  ...
  _tmuxController =
      [[TmuxController alloc] initWithGateway:_tmuxGateway
                                   clientName:preferredTmuxClientName
                                      profile:profile
                                 profileModel:model];

  [self.variablesScope setValue:_tmuxController.clientName
               forVariableNamed:iTermVariableKeySessionTmuxClientName];
  ...
  // command line.
  //
  // Tmux always prints something when you first attach. It's a notification, a
  // response, or an error. The options I've considered are:
  //
...
- (void)setTmuxPane:(int)windowPane {
  [self.variablesScope setValue:@(windowPane)
               forVariableNamed:iTermVariableKeySessionTmuxWindowPane];
...
- (int)tmuxPane {
  return [[self.variablesScope
      valueForVariableName:iTermVariableKeySessionTmuxWindowPane] intValue];
}
...
- (BOOL)isCompatibleWith:(PTYSession *)otherSession {
  if (self.tmuxMode != TMUX_CLIENT && otherSession.tmuxMode != TMUX_CLIENT) {
    ...
    return YES;
             ...
             otherSession.tmuxMode == TMUX_CLIENT) {
...
- (VT100GridCoordRange)smartSelectionRangeAt:(VT100GridCoord)coord {
  if (coord.x < 0 || coord.y < 0 || coord.x >= _screen.width ||
      coord.y >= _screen.height) {
  ...
  [_textview smartSelectAtX:coord.x
           ...
           ignoringNewlines:NO
             actionRequired:NO
            respectDividers:NO];
  return [_textview rangeByTrimmingNullsFromRange:range.coordRange
                                       trimSpaces:YES];
}

- (void)addNoteAtCursor {
  PTYNoteViewController *note =
      [[[PTYNoteViewController alloc] init] autorelease];
...
- (void)addNoteWithText:(NSString *)text
        inAbsoluteRange:(VT100GridAbsCoordRange)absRange {
  VT100GridCoordRange range = VT100GridCoordRangeFromAbsCoordRange(
      absRange, _screen.totalScrollbackOverflow);
  if (range.start.x < 0) {
    return;
  }
  PTYNoteViewController *note =
...
- (void)textViewToggleAnnotations {
  VT100GridCoordRange range = VT100GridCoordRangeMake(
      0, 0, _screen.width, _screen.height + [_screen numberOfScrollbackLines]);
...
- (void)highlightMarkOrNote:(id<IntervalTreeObject>)obj {
  if ([obj isKindOfClass:[iTermMark class]]) {
    ...
    [_textview
        highlightMarkOnLine:VT100GridRangeMax([_screen
                                lineNumberRangeOfInterval:obj.entry.interval])
...
- (void)previousMarkOrNote:(BOOL)annotationsOnly {
  ...
  if (self.currentMarkOrNotePosition == nil) {
    ...
    if (!objects.count) {
      objects =
          annotationsOnly ? [_screen lastAnnotations] : [_screen lastMarks];
      if (objects.count) {
  ...
  if (objects.count) {
    ...
    VT100GridRange range =
        [_screen lineNumberRangeOfInterval:self.currentMarkOrNotePosition];
...
- (void)nextMarkOrNote:(BOOL)annotationsOnly {
  ...
  if (self.currentMarkOrNotePosition == nil) {
    objects =
        annotationsOnly ? [_screen firstAnnotations] : [_screen firstMarks];
  } else {
    if (annotationsOnly) {
...
- (void)scrollToMark:(id<iTermMark>)mark {
  if ([_screen containsMark:mark]) {
    VT100GridRange range =
        [_screen lineNumberRangeOfInterval:mark.entry.interval];
    [_textview scrollLineNumberRangeIntoView:range];
...
- (void)setCurrentHost:(VT100RemoteHost *)remoteHost {
  ...
  [self.variablesScope setValue:remoteHost.hostname
               forVariableNamed:iTermVariableKeySessionHostname];
  [self.variablesScope setValue:remoteHost.username
               forVariableNamed:iTermVariableKeySessionUsername];
...
- (VT100RemoteHost *)currentHost {
  if (!_currentHost) {
    // This is used when a session gets restored since _currentHost doesn't get
    // persisted (and perhaps other edge cases I haven't found--it used to be
    // done every time before the _currentHost ivar existed).
    _currentHost = [[_screen remoteHostOnLine:[_screen numberOfLines]] retain];
    if (_currentHost) {
      [self.variablesScope setValue:_currentHost.hostname
                   forVariableNamed:iTermVariableKeySessionHostname];
      [self.variablesScope setValue:_currentHost.username
                   forVariableNamed:iTermVariableKeySessionUsername];
    }
  }
  return _currentHost;
  ...
  if (_hideAfterTmuxWindowOpens) {
    ...
    if (![[NSUserDefaults standardUserDefaults] boolForKey:kAutoBurialKey]) {
      [[iTermNotificationController sharedInstance]
          ...
          withDescription:@"It can be restored by detaching from tmux, or from "
                          @"the Sessions > Buried Sessions menu."];
...
- (BOOL)tmuxUpdateLayoutForWindow:(int)windowId
                           ...
                           zoomed:(NSNumber *)zoomed
                             only:(BOOL)only {
  DLog(@"tmuxUpdateLayoutForWindow:%@ layout:%@ zoomed:%@ only:%@", @(windowId),
       layout, zoomed, @(only));
...
- (void)tmuxWindowAddedWithId:(int)windowId {
  if (![_tmuxController window:windowId]) {
    [_tmuxController
        openWindowWithId:windowId
             intentional:NO
                 profile:[_tmuxController
                             profileForWindow:self.delegate.tmuxWindow]];
  }
...
- (void)tmuxWindowRenamedWithId:(int)windowId to:(NSString *)newName {
  PTYSession *representativeSession =
      [[_tmuxController sessionsInWindow:windowId] firstObject];
...
- (void)tmuxInitialCommandDidCompleteSuccessfully {
  ...
  [_tmuxController guessVersion]; // NOTE: This kicks off more stuff that
                                  // depends on knowing the version number.
}

- (void)tmuxInitialCommandDidFailWithError:(NSString *)error {
  // Let the user know what went wrong.
  [self printTmuxMessage:[NSString
                             stringWithFormat:@"tmux failed with error: “%@”",
                                              error]];
}
...
- (void)tmuxGatewayDidTimeOut {
  ...
  alert.informativeText =
      @"Tmux is not responding. Would you like to force detach?";
...
- (void)tmuxActiveWindowPaneDidChangeInWindow:(int)windowID
                                 toWindowPane:(int)paneID {
  [_tmuxController activeWindowPaneDidChangeInWindow:windowID
                                        toWindowPane:paneID];
}
...
- (BOOL)tmuxGatewayShouldForceDetach {
  ...
  alert.messageText = @"Force Detach?";
  alert.informativeText =
      @"A previous detach request has not yet been honored. Force detach?";
  [alert addButtonWithTitle:@"OK"];
  [alert addButtonWithTitle:@"Cancel"];
  NSWindow *window = self.view.window;
  NSInteger button;
...
- (void)tmuxHostDisconnected:(NSString *)dcsID {
  ...
  if ([iTermPreferences boolForKey:kPreferenceKeyAutoHideTmuxClientSession] &&
      [[[iTermBuriedSessions sharedInstance] buriedSessions]
          containsObject:self]) {
    // Do this before detaching because it may be the only tab in a hotkey
    // window. If all the tabs close the window is destroyed and it breaks the
    // reference from iTermProfileHotkey. See issue 7384.
    [[iTermBuriedSessions sharedInstance] restoreSession:self];
  }
...
- (void)tmuxCannotSendCharactersInSupplementaryPlanes:(NSString *)string
...
- (void)handleTmuxData:(NSData *)data {
  ...
  // Send the bytes from %output in to the write end of a pipe. The data will
  // come out iTermTmuxJobManager.fd, which TaskRegister selects on. The purpose
  // of this pipe is to let tmux provide backpressure to the pty. In the old
  // days, this would call -threadedReadTask: on the tmux queue.
  // threadedReadTask: is meant to be called on the TaskNotifier queue and it
  // will block if there are too many tokens outstanding. That is an effective
  // mechanism to provide backpressure. By dispatching onto the tmuxQueue,
  // infinite data could be buffered by GCD, breaking the backpressure
  // mechanism. It is unfortunate that all tmux data must make two passes
  // through TaskNotifier (once as `%output blah blah` and a second time as
  // `blah blah`) but the alternative is unbounded latency. We still do the
  // write on tmuxQueue because we don't want to block the main queue. GCD can
  // still buffer here, but it's OK because TaskNotifier has a chance to get its
  // queue blocked when it reads the data. That limits the rate that this can
  // write, since it can only write after a %output is read.
...
- (void)setTmuxPaused:(BOOL)paused
    allowAutomaticUnpause:(BOOL)allowAutomaticUnpause {
  ...
  if (paused) {
    ...
    if (allowAutomaticUnpause &&
        [iTermPreferences boolForKey:kPreferenceKeyTmuxUnpauseAutomatically]) {
      __weak __typeof(self) weakSelf = self;
      dispatch_after(
          dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1 * NSEC_PER_SEC)),
          dispatch_get_main_queue(), ^{
...
- (void)showTmuxPausedAnnouncement:(BOOL)notification {
  ...
  [self dismissAnnouncementWithIdentifier:
            PTYSessionAnnouncementIdentifierTmuxPaused];
  __weak __typeof(self) weakSelf = self;
  ...
  [self dismissAnnouncementWithIdentifier:
            PTYSessionAnnouncementIdentifierTmuxPaused];
  [self removeAnnouncementWithIdentifier:
            PTYSessionAnnouncementIdentifierTmuxPaused];
  [self queueAnnouncement:announcement
               identifier:PTYSessionAnnouncementIdentifierTmuxPaused];
}
...
- (void)setTmuxState:(NSDictionary *)state {
  ...
  NSData *pendingOutput =
      [state objectForKey:kTmuxWindowOpenerStatePendingOutput];
  if (pendingOutput && [pendingOutput length]) {
    [self.terminal.parser putStreamData:pendingOutput.bytes
                                 length:pendingOutput.length];
  }
  [[self terminal]
      setInsertMode:[[state objectForKey:kStateDictInsertMode] boolValue]];
  [[self terminal]
      setCursorMode:[[state objectForKey:kStateDictKCursorMode] boolValue]];
  [[self terminal]
      setKeypadMode:[[state objectForKey:kStateDictKKeypadMode] boolValue]];
  ...
  [[self terminal]
      setMouseFormat:[[state objectForKey:kStateDictMouseUTF8Mode] boolValue]
...
- (VT100GridSize)tmuxClientSize {
  if (!_delegate) {
    DLog(@"No delegate so use saved grid size %@",
         VT100GridSizeDescription(_savedGridSize));
    return _savedGridSize;
  }
  DLog(@"Get size from delegate %@, controller tmuxController %@, window %@",
       _delegate, _tmuxController, @(self.delegate.tmuxWindow));
  return [_delegate
      sessionTmuxSizeWithProfile:[_tmuxController
                                     profileForWindow:self.delegate
                                                          .tmuxWindow]];
}

- (NSInteger)tmuxNumberOfLinesOfScrollbackHistory {
  Profile *profile =
      [_tmuxController profileForWindow:self.delegate.tmuxWindow];
  if ([iTermPreferences useTmuxProfile]) {
    profile = [[ProfileModel sharedInstance] tmuxProfile];
  }
...
- (void)tmuxDoubleAttachForSessionGUID:(NSString *)sessionGUID {
  ...
  TmuxController *controller = [[TmuxControllerRegistry sharedInstance]
      tmuxControllerWithSessionGUID:sessionGUID];
  if (!controller) {
    actions = @[ @"OK" ];
  }
  ...
  PTYSession *aSession = [[controller.clientSessions
      sortedArrayUsingComparator:^NSComparisonResult(PTYSession *s1,
                                                     PTYSession *s2) {
...
- (NSString *)encodingName {
  ...
  NSString *ianaEncoding =
      (NSString *)CFStringConvertEncodingToIANACharSetName(cfEncoding);
  ...
  if (!lowerCaseEncodings) {
    NSString *plistFile = [[NSBundle bundleForClass:[self class]]
        pathForResource:@"EncodingsWithLowerCase"
                 ofType:@"plist"];
    lowerCaseEncodings = [NSDictionary dictionaryWithContentsOfFile:plistFile];
    [lowerCaseEncodings retain];
  }
  if ([ianaEncoding
          rangeOfCharacterFromSet:[NSCharacterSet lowercaseLetterCharacterSet]]
          .length) {
  ...
  if (ianaEncoding != nil) {
    ...
    NSMutableString *encoding =
        [[[NSMutableString alloc] initWithString:ianaEncoding] autorelease];
    [encoding replaceOccurrencesOfString:@"ISO-"
                              withString:@"ISO"
                                 options:0
                                   range:NSMakeRange(0, [encoding length])];
    [encoding replaceOccurrencesOfString:@"EUC-"
                              withString:@"euc"
                                 options:0
                                   range:NSMakeRange(0, [encoding length])];
...
- (BOOL)event:(NSEvent *)event matchesPattern:(ITMKeystrokePattern *)pattern {
  ...
  for (NSString *charactersIgnoringModifiers in pattern
           .charactersIgnoringModifiersArray) {
    if ([event.charactersIgnoringModifiers
            isEqualToString:charactersIgnoringModifiers]) {
      return YES;
    }
  }
  return NO;
...
- (BOOL)keystrokeIsFilteredByMonitor:(NSEvent *)event {
  for (NSString *identifier in _keyboardFilterSubscriptions) {
    ...
    for (ITMKeystrokePattern *pattern in request.keystrokeFilterRequest
             .patternsToIgnoreArray) {
      if ([self event:event matchesPattern:pattern]) {
        return YES;
      }
    }
    // Prior to 1.17, the filter monitor used keystrokeMonitorRequest instead of
    // keystrokeFilterRequest.
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    for (ITMKeystrokePattern *pattern in request.keystrokeMonitorRequest
             .patternsToIgnoreArray) {
...
- (BOOL)shouldAcceptKeyDownEvent:(NSEvent *)event {
  ...
  if (accept) {
    ...
    if ((event.it_modifierFlags & NSEventModifierFlagControl) &&
      ...
      if (self.terminal.receivingFile) {
        // Offer to abort download if you press ^c while downloading an inline
        // file
  ...
  if (self.isTmuxClient && _tmuxPaused) {
    // This ignores the monitor filter and subscriptions because it might be the
    // only way to unpause.
    [self setTmuxPaused:NO allowAutomaticUnpause:YES];
    return NO;
  }
  if (_keystrokeSubscriptions.count) {
    ITMKeystrokeNotification *keystrokeNotification =
        [[[ITMKeystrokeNotification alloc] init] autorelease];
    ...
    ITMNotification *notification =
        [[[ITMNotification alloc] init] autorelease];
    notification.keystrokeNotification = keystrokeNotification;

    [_keystrokeSubscriptions
        enumerateKeysAndObjectsUsingBlock:^(
            id _Nonnull key, ITMNotificationRequest *_Nonnull obj,
            BOOL *_Nonnull stop) {
...
+ (void)reportFunctionCallError:(NSError *)error
  ...
  NSString *message =
      [NSString stringWithFormat:@"Error running “%@”:\n%@", invocation,
  ...
  iTermWarningSelection selection = [iTermWarning
      showWarningWithTitle:message
               ...
               silenceable:kiTermWarningTypeTemporarilySilenceable
                   heading:[NSString
                               stringWithFormat:@"%@ Function Call Failed",
                                                origin]
                    window:window];
...
- (void)applyAction:(iTermAction *)action {
  ...
  [self performKeyBindingAction:[iTermKeyBindingAction
...
+ (BOOL)performKeyBindingAction:(iTermKeyBindingAction *)action
                          event:(NSEvent *)event {
  if (!action) {
    return NO;
  }
  ...
  case KEY_ACTION_NEW_WINDOW_WITH_PROFILE: {
    Profile *profile =
        [[ProfileModel sharedInstance] bookmarkWithGuid:action.parameter];
    [iTermSessionLauncher launchBookmark:profile
                              inTerminal:nil
                      respectTabbingMode:NO
                              completion:nil];
...
- (void)performKeyBindingAction:(iTermKeyBindingAction *)action
                          event:(NSEvent *)event {
  if (!action) {
    return;
  }
  ...
  case KEY_ACTION_MOVE_TAB_RIGHT:
    ...
    break;
  case KEY_ACTION_NEXT_MRU_TAB:
    [[[_delegate parentWindow] tabView]
        cycleKeyDownWithModifiers:[event it_modifierFlags]
                         forwards:YES];
    break;
  case KEY_ACTION_PREVIOUS_MRU_TAB:
    [[[_delegate parentWindow] tabView]
  ...
  case KEY_ACTION_SPLIT_HORIZONTALLY_WITH_PROFILE: {
    ...
    [[_delegate realParentWindow]
        asyncSplitVertically:NO
                      before:NO
                     profile:profile
  ...
  case KEY_ACTION_LOAD_COLOR_PRESET: {
    ...
    // Try to update the backing profile if possible, which may undivorce you.
    // The original profile may not exist so this could do nothing.
    ProfileModel *model = [ProfileModel sharedInstance];
    Profile *profile;
    if (self.isDivorced) {
      profile = [[ProfileModel sharedInstance]
          bookmarkWithGuid:_profile[KEY_ORIGINAL_GUID]];
    } else {
      profile = self.profile;
    }
    if (profile) {
  ...
  case KEY_ACTION_FIND_REGEX:
    [_view.findDriver
        closeViewAndDoTemporarySearchForString:action.parameter
                                          mode:iTermFindModeCaseSensitiveRegex];
    break;

  case KEY_FIND_AGAIN_DOWN:
    // The UI exposes this as "find down" so it doesn't respect
    // swapFindNextPrevious
    [self searchNext];
    break;

  case KEY_FIND_AGAIN_UP:
    // The UI exposes this as "find up" so it doesn't respect
    // swapFindNextPrevious
    [self searchPrevious];
    break;
  ...
  case KEY_ACTION_TOGGLE_HOTKEY_WINDOW_PINNING: {
    DLog(@"Toggle pinning");
    BOOL autoHid = [iTermProfilePreferences boolForKey:KEY_HOTKEY_AUTOHIDE
                                             inProfile:self.profile];
    DLog(@"Getting profile with guid %@ from originalProfile %p",
         self.originalProfile[KEY_GUID], self.originalProfile);
    Profile *profile = [[ProfileModel sharedInstance]
        bookmarkWithGuid:self.originalProfile[KEY_GUID]];
    if (profile) {
  ...
  case KEY_ACTION_MOVE_END_OF_SELECTION_RIGHT:
    [_textview
        moveSelectionEndpoint:kPTYTextViewSelectionEndpointEnd
  ...
  case KEY_ACTION_MOVE_START_OF_SELECTION_RIGHT:
    [_textview
        moveSelectionEndpoint:kPTYTextViewSelectionEndpointStart
                  inDirection:kPTYTextViewSelectionExtensionDirectionRight
                           by:[action.parameter integerValue]];
    break;
...
- (BOOL)eventNeedsMitigation:(NSEvent *)event {
  ...
  const int64_t keyboardType =
      CGEventGetIntegerValueField(event.CGEvent, kCGKeyboardEventKeyboardType);
...
- (void)showVisualIndicatorForEvent:(NSEvent *)event {
  ...
  [self retain];
  dispatch_after(
      dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1 / 15.0 * NSEC_PER_SEC)),
      dispatch_get_main_queue(), ^{
...
- (void)textViewSelectionDidChangeToTruncatedString:(NSString *)maybeSelection {
  // Assign a maximum of maximumBytesToProvideToPythonAPI characters to the
  // "selection" iTerm Variable
  //
  // The "selectionLength" iTerm variable contains the full length of the
  // original selection; not the restricted length assigned to the "selection"
  // iTerm Variable
  DLog(@"textViewSelectionDidChangeToTruncatedString: %@", maybeSelection);

  NSString *selection = maybeSelection ?: @"";
  const int maxLength =
      [iTermAdvancedSettingsModel maximumBytesToProvideToPythonAPI];
  [self.variablesScope
              setValue:[selection
                           substringToIndex:MIN(maxLength, selection.length)]
      forVariableNamed:iTermVariableKeySessionSelection];
  [self.variablesScope setValue:@(selection.length)
               forVariableNamed:iTermVariableKeySessionSelectionLength];
}
...
- (void)logKeystroke:(NSEvent *)event {
  const unichar unicode =
      event.characters.length > 0 ? [event.characters characterAtIndex:0] : 0;
  DLog(@"event:%@ (%llx+%x)[%@][%@]:%x(%c) <%lu>", event,
       (unsigned long long)event.it_modifierFlags, event.keyCode,
...
- (BOOL)maybeHandleZoomedKeyEvent:(NSEvent *)event {
  ...
  // The zoomOut: IBAction doesn't get performed by shortcut, I guess because
  // Esc is not a valid shortcut. So we do it here.
...
- (BOOL)unzoomIfPossible {
  ...
  DLog(@"Unzooming");
  [[_delegate realParentWindow]
      replaceSyntheticActiveSessionWithLiveSessionIfNeeded];
  return YES;
}
...
- (BOOL)maybeHandleKeyBindingActionForKeyEvent:(NSEvent *)event {
  ...
  iTermKeyBindingAction *action =
      [iTermKeyMappings actionForKeystroke:keystroke
...
- (NSData *)backspaceData {
  iTermKeyBindingAction *action = [iTermKeyMappings
      actionForKeystroke:[iTermKeystroke backspace]
             keyMappings:[[self profile] objectForKey:KEY_KEYBOARD_MAP]];
  if (!action) {
    const char del = 0x7f;
  ...
  case KEY_ACTION_VIM_TEXT:
    return [[action.parameter stringByExpandingVimSpecialCharacters]
        dataUsingEncoding:self.encoding];

  case KEY_ACTION_ESCAPE_SEQUENCE:
    return [[@"\e" stringByAppendingString:action.parameter]
        dataUsingEncoding:self.encoding];
...
- (int)rightOptionKey {
  NSNumber *rightOptPref =
      [[self profile] objectForKey:KEY_RIGHT_OPTION_KEY_SENDS];
  if (rightOptPref == nil) {
...
- (BOOL)applicationKeypadAllowed {
  return
      [[[self profile] objectForKey:KEY_APPLICATION_KEYPAD_ALLOWED] boolValue];
}
...
- (void)menuForEvent:(NSEvent *)theEvent menu:(NSMenu *)theMenu {
  ...
  if ([_delegate realParentWindow] &&
      [[_delegate realParentWindow]
          respondsToSelector:@selector(menuForEvent:menu:)]) {
...
- (void)pasteString:(NSString *)theString flags:(PTYSessionPasteFlags)flags {
  ...
  DLog(@"pasteString:flags: length=%@ flags=%@", @([theString length]),
       @(flags));
...
// Pastes the current string in the clipboard. Uses the sender's tag to get
// flags.
- (void)paste:(id)sender {
  ...
  [self pasteString:[PTYSession pasteboardString]
              flags:[sender isKindOfClass:NSMenuItem.class] ? [sender tag] : 0];
}
...
// - SessionView will draw it for an area below the scroll view when the cell
// size doesn't evenly divide its size.
// - TextViewWrapper will draw it for a few pixels above the scrollview in the
// VMARGIN. This combines drawing into these different views in a consistent
// way. It also draws the dotted border when there is a maximized pane.
//
...
// blendDefaultBackground: If set, the default background color will be blended
// over the background image. If there is no image and this flag is set then the
// background color is drawn instead. This way SessionView and TextViewWrapper
// don't have to worry about whether a background image is present.
  ...
  if ([iTermPreferences boolForKey:kPreferenceKeyPerPaneBackgroundImage]) {
    ...
    [_backgroundDrawingHelper
        drawBackgroundImageInView:view
                        container:self.view
                        dirtyRect:dirtyRect
           visibleRectInContainer:NSMakeRect(0, 0, contentRect.size.width,
                                             contentRect.size.height)
           blendDefaultBackground:blendDefaultBackground
                             flip:NO];
  } else {
    NSView *container = [self.delegate sessionContainerView:self];
    NSRect clippedDirtyRect = NSIntersectionRect(
        dirtyRect, view.enclosingScrollView.documentVisibleRect);
    ;
    if (@available(macOS 10.14, *)) {
    } else {
      if (view == self.view) {
    ...
    NSRect windowVisibleRect =
        [self.view insetRect:container.bounds
                           flipped:YES
            includeBottomStatusBar:
                ![iTermPreferences
                    boolForKey:kPreferenceKeySeparateStatusBarsPerPane]];
...
- (CGRect)textViewRelativeFrame {
  ...
  if (@available(macOS 10.14, *)) {
    ...
    viewRect =
        [self.view.metalView.superview convertRect:self.view.metalView.frame
                                            toView:container];
    containerBounds = container.bounds;
    // Flip it
    viewRect.origin.y =
        containerBounds.size.height - viewRect.origin.y - viewRect.size.height;
  } else {
    NSView *container = [self.delegate sessionContainerView:self];
    const NSRect sessionViewFrameInContainer =
        [container convertRect:self.view.bounds fromView:self.view];
    viewRect = [self.view insetRect:sessionViewFrameInContainer
                            flipped:YES
             includeBottomStatusBar:YES];
    BOOL includeBottomStatusBar = YES;
    if (@available(macOS 10.14, *)) {
      includeBottomStatusBar = ![iTermPreferences
          boolForKey:kPreferenceKeySeparateStatusBarsPerPane];
    }
...
- (NSColor *)processedBackgroundColor {
  ...
  return
      [_colorMap processedBackgroundColorForBackgroundColor:unprocessedColor];
}

- (void)textViewPostTabContentsChangedNotification {
  [[NSNotificationCenter defaultCenter]
      postNotificationName:@"iTermTabContentsChanged"
                    object:self
                  userInfo:nil];
}
...
- (void)textViewDidFindDirtyRects {
  if (_updateSubscriptions.count) {
    ...
    notification.screenUpdateNotification =
        [[[ITMScreenUpdateNotification alloc] init] autorelease];
...
// This uses the local directory because it is the last desperate gasp of URL
// action file finding.
- (void)textViewGetCurrentWorkingDirectoryWithCompletion:
    (void (^)(NSString *workingDirectory))completion {
  [self asyncCurrentLocalWorkingDirectory:completion];
}

// NOTE: This will not fetch the current directory if it's not already known to
// avoid blocking the main thread. Don't use this unless you have to be
// synchronous. Use asyncGetCurrentLocatioNWithCompletion instead.
...
- (void)asyncGetCurrentLocationWithCompletion:(void (^)(NSURL *url))completion {
  // NOTE: Use local directory here because this becomes the proxy icon, and
  // it's basically useless when given a remote directory.
  __weak __typeof(self) weakSelf = self;
...
- (void)updateLocalDirectoryWithCompletion:(void (^)(NSString *pwd))completion {
  ...
  [_shell getWorkingDirectoryWithCompletion:^(NSString *pwd) {
    // Don't call setLastDirectory:remote:pushed: because we don't want to
    // update the path variable if the session is ssh'ed somewhere.
    DLog(@"getWorkingDirectoryWithCompletion for %@ finished with %@", weakSelf,
         pwd);
...
- (BOOL)textViewShouldPlaceCursorAt:(VT100GridCoord)coord
                         verticalOk:(BOOL *)verticalOk {
  if (coord.y < _screen.numberOfLines - _screen.height || coord.x < 0 ||
      coord.x >= _screen.width || coord.y >= _screen.numberOfLines) {
  ...
  if (_commandRange.start.x < 0) {
    if (_terminal.softAlternateScreenMode) {
      ...
      *verticalOk = YES;
      ...
      // Possibly at a command prompt without shell integration or in some other
      // command line app that may be using readline. No vertical movement.
      *verticalOk = NO;
      return YES;
    }
  } else {
    // At the command prompt. Ok to move to any char within current command, but
    // no up or down arrows please.
    NSComparisonResult order =
        VT100GridCoordOrder(VT100GridCoordRangeMin(_commandRange), coord);
    *verticalOk = NO;
...
- (BOOL)textViewShouldDrawFilledInCursor {
  // If the auto-command history popup is open for this session, the filled-in
  // cursor should be drawn even though the textview isn't in the key window.
  return [self textViewIsActiveSession] &&
         [[_delegate realParentWindow] autoCommandHistoryIsOpenForSession:self];
}
...
- (void)textViewSplitVertically:(BOOL)vertically
                withProfileGuid:(NSString *)guid {
  Profile *profile;
  if (guid) {
...
- (void)textViewPasteSpecialWithStringConfiguration:(NSString *)configuration
  ...
  NSString *string = fromSelection
                         ? [[iTermController sharedInstance] lastSelection]
...
- (BOOL)textViewReportMouseEvent:(NSEventType)eventType
  ...
  case NSEventTypeMouseMoved:
    ...
    if (!VT100GridCoordEquals(coord, _lastReportedCoord)) {
      _lastReportedCoord = coord;
      [self
          writeLatin1EncodedData:[_terminal.output mouseMotion:MOUSE_BUTTON_NONE
                                                 withModifiers:modifiers
                                                            at:coord]
                broadcastAllowed:NO];
      return YES;
  ...
  case NSEventTypeOtherMouseDragged:
    ...
    if ((_reportingMouseDown || allowDragBeforeMouseDown) &&
      ...
      // Fall through
      case MOUSE_REPORTING_NORMAL:
        // Don't do selection when mouse reporting during a drag, even if the
        // drag is not reported (the clicks are).
        return YES;
    ...
    case MOUSE_REPORTING_ALL_MOTION:
      ...
      if (deltaY != 0) {
        ...
        if ([iTermAdvancedSettingsModel proportionalScrollWheelReporting]) {
          // Cap number of reported scroll events at 32 to prevent runaway
          // redraws. This is a mostly theoretical concern and the number can
          // grow if it doesn't seem to be a problem.
          steps = MIN(32, fabs(deltaY));
        } else {
          steps = 1;
        }
        if (steps == 1 &&
            [iTermAdvancedSettingsModel doubleReportScrollWheel]) {
          ...
          // "Mouse wheel events and server_client_assume_paste--the perfect
          // storm of bugs?".
          steps = 2;
        }
...
- (VT100GridAbsCoordRange)textViewRangeOfLastCommandOutput {
  ...
  if (![[iTermShellHistoryController sharedInstance]
          commandHistoryHasEverBeenUsed]) {
    ...
    iTermTextExtractor *extractor =
        [iTermTextExtractor textExtractorWithDataSource:_screen];
    long long absCursorY = _screen.cursorY - 1 +
                           _screen.numberOfScrollbackLines +
                           _screen.totalScrollbackOverflow;

    if (self.isAtShellPrompt || _screen.startOfRunningCommandOutput.x == -1 ||
        (absCursorY == _screen.startOfRunningCommandOutput.y &&
         _screen.cursorX == 1)) {
      DLog(@"Returning cached range.");
      return [extractor
          rangeByTrimmingWhitespaceFromRange:_screen.lastCommandOutputRange
                                     leading:NO
                                    trailing:
      ...
      VT100GridAbsCoordRange range =
          VT100GridAbsCoordRangeMake(_screen.startOfRunningCommandOutput.x,
                                     _screen.startOfRunningCommandOutput.y,
                                     _screen.cursorX - 1, absCursorY);
      return [extractor
          rangeByTrimmingWhitespaceFromRange:range
                                     leading:NO
                                    trailing:
                                        iTermTextExtractorTrimTrailingWhitespaceOneLine];
    }
...
- (VT100GridAbsCoordRange)textViewRangeOfCurrentCommand {
  ...
  if (![[iTermShellHistoryController sharedInstance]
    ...
    if (self.isAtShellPrompt) {
      range = VT100GridAbsCoordRangeMake(
          _commandRange.start.x,
...
- (BOOL)textViewCanSelectOutputOfLastCommand {
  // Return YES if command history has never been used so we can show the
  // informational message.
  return (![[iTermShellHistoryController sharedInstance]
              commandHistoryHasEverBeenUsed] ||
...
- (BOOL)textViewCanSelectCurrentCommand {
  ...
  return (![[iTermShellHistoryController sharedInstance]
          ...
          (_lastOrCurrentlyRunningCommandAbsRange.start.x >= 0 &&
           // It cannot select when the currently running command is lost due to
           // scrollback overflow.
           _lastOrCurrentlyRunningCommandAbsRange.start.y >=
               _screen.totalScrollbackOverflow));
}
...
- (NSColor *)textViewBadgeColor {
  return [[iTermProfilePreferences objectForKey:KEY_BADGE_COLOR
                                      inProfile:_profile] colorValue];
}
...
- (iTermVariableScope<iTermSessionScope> *)variablesScope {
  if (_variablesScope == nil) {
    _variablesScope =
        [iTermVariableScope newSessionScopeWithVariables:self.variables];
  }
...
- (BOOL)textViewShouldShowMarkIndicators {
  return [iTermProfilePreferences boolForKey:KEY_SHOW_MARK_INDICATORS
                                   inProfile:_profile];
}

- (void)textViewThinksUserIsTryingToSendArrowKeysWithScrollWheel:
    (BOOL)isTrying {
...
- (BOOL)textViewResizeFrameIfNeeded {
  ...
  if (fabs(desiredHeight - NSHeight(frame)) >= 0.5) {
    ...
    frame.size.height =
        desiredHeight +
        [iTermPreferences
            intForKey:kPreferenceKeyTopBottomMargins]; // The wrapper is always
                                                       // larger by VMARGIN.
...
- (void)textViewDidRefresh {
  ...
  iTermTextExtractor *textExtractor =
      [[[iTermTextExtractor alloc] initWithDataSource:_screen] autorelease];
  NSString *word = [textExtractor
      fastWordAt:VT100GridCoordMake(_screen.cursorX - 1,
                                    _screen.cursorY +
                                        _screen.numberOfScrollbackLines - 1)];
...
- (void)textViewNeedsDisplayInRect:(NSRect)rect {
  if (@available(macOS 10.11, *)) {
    NSRect visibleRect = NSIntersectionRect(
        rect, _textview.enclosingScrollView.documentVisibleRect);
...
- (BOOL)textViewShouldDrawRect {
  if (@available(macOS 10.11, *)) {
    // In issue 8843 we see that sometimes the background color can get out of
    // sync. I can't figure it out. This patches the problem until I can collect
    // more info.
...
// NOTE: Make sure to update both the context menu and the main menu when
// modifying these.
...
- (void)updateUseCSIuMode {
  const BOOL profileSetting =
      [iTermProfilePreferences boolForKey:KEY_USE_LIBTICKIT_PROTOCOL
                                inProfile:self.profile];
  self.keyMappingMode =
      profileSetting ? iTermKeyMappingModeCSIu : iTermKeyMappingModeStandard;
}
...
- (CGFloat)textViewBadgeTopMargin {
  return [iTermProfilePreferences floatForKey:KEY_BADGE_TOP_MARGIN
                                    inProfile:self.profile];
}

- (CGFloat)textViewBadgeRightMargin {
  return [iTermProfilePreferences floatForKey:KEY_BADGE_RIGHT_MARGIN
                                    inProfile:self.profile];
}
...
- (void)textViewContextMenuInvocation:(NSString *)invocation
  ...
  [PTYSession
      reportFunctionCallError:error
                forInvocation:invocation
                       origin:[NSString
                                  stringWithFormat:@"Menu Item “%@”", title]
                       window:self.view.window];
}

- (void)textViewAddTrigger:(NSString *)text {
  __weak __typeof(self) weakSelf = self;
  iTermColorSuggester *cs = [[[iTermColorSuggester alloc]
      initWithDefaultTextColor:[_colorMap colorForKey:kColorMapForeground]
        defaultBackgroundColor:[_colorMap colorForKey:kColorMapBackground]
             minimumDifference:0.25
                          seed:[text hash]] autorelease];
  [iTermAddTriggerViewController
           addTriggerForText:text
                      window:self.view.window
         interpolatedStrings:
             [self.profile[KEY_TRIGGERS_USE_INTERPOLATED_STRINGS] boolValue]
      ...
      defaultBackgroundColor:cs.suggestedBackgroundColor
                  completion:^(NSDictionary *_Nonnull dict,
                    ...
                    [weakSelf addTriggerDictionary:dict
                                     updateProfile:updateProfile];
                  }];
}

- (void)addTriggerDictionary:(NSDictionary *)dict
               updateProfile:(BOOL)updateProfile {
  if (!updateProfile || !self.isDivorced ||
      [_overriddenFields containsObject:KEY_TRIGGERS]) {
    NSMutableArray<NSDictionary *> *triggers =
        [[self.profile[KEY_TRIGGERS] ?: @[] mutableCopy] autorelease];
  ...
  profile[KEY_TRIGGERS] =
      [profile[KEY_TRIGGERS] ?: @[] arrayByAddingObject:dict];
  [[ProfileModel sharedInstance] setBookmark:profile
...
- (NSString *)userShell {
  return [ITAddressBookMgr customShellForProfile:self.profile]
             ?: [iTermOpenDirectory userShell] ?: @"/bin/bash";
}
...
- (void)uploadFiles:(NSArray *)localFilenames
             toPath:(SCPPath *)destinationPath {
  ...
  for (NSString *file in localFilenames) {
    ...
    scpFile.path.path =
        [destinationPath.path stringByAppendingPathComponent:filename];
...
- (NSString *)localeForLanguage:(NSString *)languageCode
  ...
  DLog(@"localeForLanguage:country: languageCode=%@, countryCode=%@",
...
- (NSArray<NSString *> *)languageCodesUpToAndIncludingFirstTwoLetterCode:
    (NSArray<NSString *> *)allCodes {
  NSInteger lastIndexToInclude = [allCodes
      indexOfObjectPassingTest:^BOOL(NSString *_Nonnull obj, NSUInteger idx,
                                     BOOL *_Nonnull stop) {
        return obj.length <= 2;
      }];
...
- (NSString *)valueForLanguageEnvironmentVariable {
  ...
  NSArray<NSString *> *languageCodes =
      [self languageCodesUpToAndIncludingFirstTwoLetterCode:
                [self preferredLanguageCodesByRemovingCountry]];
  ...
  if (countryCode) {
    languagePlusCountryCodes =
        [languageCodes mapWithBlock:^id(NSString *language) {
          return [self localeForLanguage:language country:countryCode];
        }];
  }
  DLog(@"Country code is %@. Combos are %@", countryCode,
       languagePlusCountryCodes);

  NSString *encoding = [self encodingName];
  NSArray<NSString *> *languageCountryEncoding = @[];
  if (encoding) {
    languageCountryEncoding =
        [languagePlusCountryCodes mapWithBlock:^id(NSString *languageCountry) {
          return
              [NSString stringWithFormat:@"%@.%@", languageCountry, encoding];
        }];
  }
  DLog(@"Encoding is %@. Combos are %@", encoding, languageCountryEncoding);

  NSArray<NSString *> *candidates =
      [@[ languageCountryEncoding, languagePlusCountryCodes, languageCodes ]
          flattenedArray];
...
- (void)continueTailFind {
  ...
  BOOL more;
  more = [_screen continueFindAllResults:results inContext:_tailFindContext];
...
- (void)sessionContentsChanged:(NSNotification *)notification {
  if (!_tailFindTimer && [notification object] == self &&
...
- (void)printTmuxMessage:(NSString *)message {
  ...
  screen_char_t savedFgColor = [_terminal foregroundColorCode];
  screen_char_t savedBgColor = [_terminal backgroundColorCode];
  [_terminal setForegroundColor:ALTSEM_DEFAULT alternateSemantics:YES];
  [_terminal setBackgroundColor:ALTSEM_DEFAULT alternateSemantics:YES];
  [_screen appendStringAtCursor:message];
  [_screen crlf];
  [_terminal setForegroundColor:savedFgColor.foregroundColor
...
- (void)screenUpdateDisplay:(BOOL)redraw {
  [self updateDisplayBecause:
            [NSString stringWithFormat:@"screen requested update redraw=%@",
                                       @(redraw)]];
  if (redraw) {
    [_textview setNeedsDisplay:YES];
  }
...
- (void)screenSizeDidChangeWithNewTopLineAt:(int)newTop {
  if ([(PTYScroller *)([_view.scrollview verticalScroller]) userScroll] &&
      newTop >= 0) {
    const VT100GridRange range =
        VT100GridRangeMake(newTop, _textview.rangeOfVisibleLines.length);
    [_textview scrollLineNumberRangeIntoView:range];
  } else {
    [_textview scrollEnd];
  }
...
- (void)screenDidAppendStringToCurrentLine:(NSString *)string
  ...
  if (plainText && _logging.enabled && _logging.plainText &&
      !self.isTmuxGateway) {
...
- (void)screenDidAppendAsciiDataToCurrentLine:(AsciiData *)asciiData {
  if ([_triggers count] || _expect.expectations.count) {
    NSString *string =
        [[[NSString alloc] initWithBytes:asciiData->buffer
...
- (void)screenResetCursorTypeAndBlink {
  self.cursorTypeOverride = nil;
  self.textview.blinkingCursor =
      [iTermProfilePreferences boolForKey:KEY_BLINKING_CURSOR
                                inProfile:self.profile];
}
...
- (void)screenSetWindowTitle:(NSString *)title {
  // The window name doesn't normally serve as an interpolated string, but just
  // to be extra safe break up \(.
...
- (NSString *)screenIconTitle {
  return
      [self.variablesScope valueForVariableName:iTermVariableKeySessionIconName]
          ?: [self.variablesScope
                 valueForVariableName:iTermVariableKeySessionName];
}

- (void)screenSetIconName:(NSString *)theName {
  DLog(@"screenSetIconName:%@", theName);
  // Put a zero-width space in between \ and ( to avoid interpolated strings
  // coming from the server.
  theName = [theName stringByReplacingOccurrencesOfString:@"\\("
                                               withString:@"\\\u200B("];
  [self setIconName:theName];
  [self enableSessionNameTitleComponentIfPossible];
}
...
- (void)enableSessionNameTitleComponentIfPossible {
  // Turn on the session name component so the icon/trigger name will be
  // visible.
  iTermTitleComponents components =
  ...
  [self
      setSessionSpecificProfileValues:@{KEY_TITLE_COMPONENTS : @(components)}];
}
...
- (NSSize)screenSize {
  return [[[[[_delegate parentWindow] currentSession] view] scrollview]
             documentVisibleRect]
      .size;
}
...
- (int)screenWindowIndex {
  return [[iTermController sharedInstance]
      indexOfTerminal:(PseudoTerminal *)[_delegate realParentWindow]];
}
...
- (void)reveal {
  ...
  if ([[[iTermBuriedSessions sharedInstance] buriedSessions]
          containsObject:self]) {
    DLog(@"disinter");
    [[iTermBuriedSessions sharedInstance] restoreSession:self];
  }
  NSWindowController<iTermWindowController> *terminal =
      [_delegate realParentWindow];
  iTermController *controller = [iTermController sharedInstance];
  BOOL okToActivateApp = YES;
  if ([terminal isHotKeyWindow]) {
    DLog(@"Showing hotkey window");
    iTermProfileHotKey *hotKey = [[iTermHotKeyController sharedInstance]
        profileHotKeyForWindowController:(PseudoTerminal *)terminal];
    [[iTermHotKeyController sharedInstance] showWindowForProfileHotKey:hotKey
                                                                   url:nil];
    okToActivateApp =
        (hotKey.hotkeyWindowType != iTermHotkeyWindowTypeFloatingPanel);
  } else {
...
- (id)markAddedAtLine:(int)line ofClass:(Class)markClass {
  ...
  [_lastMark release];
  _lastMark = [[_screen
      addMarkStartingAtAbsoluteLine:[_screen totalScrollbackOverflow] + line
                            oneLine:YES
                            ofClass:markClass] retain];
  self.currentMarkOrNotePosition = _lastMark.entry.interval;
  if (self.alertOnNextMark) {
    NSString *action =
        [iTermApplication.sharedApplication delegate].markAlertAction;
    if ([action isEqualToString:kMarkAlertActionPostNotification]) {
      [[iTermNotificationController sharedInstance]
                   notify:@"Mark Set"
          withDescription:
              [NSString stringWithFormat:@"Session %@ #%d had a mark set.",
                                         [self name], [_delegate tabNumber]]
              windowIndex:[self screenWindowIndex]
                 tabIndex:[self screenTabIndex]
                viewIndex:[self screenViewIndex]
...
- (void)screenPromptDidStartAtLine:(int)line {
  DLog(@"FinalTerm: prompt started on line %d. Add a mark there. Save it as "
       @"lastPromptLine.",
       line);
  ...
  mark.promptRange =
      VT100GridAbsCoordRangeMake(0, _lastPromptLine, 0, _lastPromptLine);
...
- (void)triggerDidDetectStartOfPromptAt:(VT100GridAbsCoord)coord {
  ...
  if (_fakePromptDetectedAbsLine == -2) {
    // Infer the end of the preceding command. Set a return status of 0 since we
...
- (void)didInferEndOfCommand {
  ...
  coord.x = 0;
  coord.y = _screen.currentGrid.cursor.y + _screen.numberOfScrollbackLines +
            _screen.totalScrollbackOverflow;
  if (_screen.cursorX > 1) {
    // End of command was detected before the newline came in. This is the
    // normal case.
    coord.y += 1;
  }
...
- (void)screenPromptDidEndAtLine:(int)line {
  ...
  mark.promptRange = VT100GridAbsCoordRangeMake(mark.promptRange.start.x,
                                                mark.promptRange.end.y, x, y);
  mark.commandRange = VT100GridAbsCoordRangeMake(x, y, x, y);
  [_promptSubscriptions
      enumerateKeysAndObjectsUsingBlock:^(id _Nonnull key,
                                          ITMNotificationRequest *_Nonnull obj,
                                          BOOL *_Nonnull stop) {
        if (obj.argumentsOneOfCase ==
                ITMNotificationRequest_Arguments_OneOfCase_GPBUnsetOneOfCase ||
            [obj.promptMonitorRequest.modesArray
                it_contains:ITMPromptMonitorMode_Prompt]) {
          ITMNotification *notification =
              [[[ITMNotification alloc] init] autorelease];
          notification.promptNotification =
              [[[ITMPromptNotification alloc] init] autorelease];
...
- (VT100ScreenMark *)screenAddMarkOnLine:(int)line {
  return (VT100ScreenMark *)[self markAddedAtLine:line
...
- (void)screenSaveScrollPosition {
  ...
  [_lastMark release];
  _lastMark =
      [[_screen addMarkStartingAtAbsoluteLine:[_textview absoluteScrollPosition]
                                      oneLine:NO
...
- (VT100ScreenMark *)markAddedAtCursorOfClass:(Class)theClass {
  return [self
      markAddedAtLine:[_screen numberOfScrollbackLines] + _screen.cursorY - 1
              ofClass:theClass];
}
...
- (void)screenStealFocus {
  ...
  const iTermWarningSelection selection = [iTermWarning
      showWarningWithTitle:
          @"A control sequence attempted to activate a session. Allow it?"
                   actions:@[ @"Allow", @"Deny" ]
                 accessory:nil
                identifier:identifier
               silenceable:kiTermWarningTypePermanentlySilenceable
...
- (void)setProfile:(NSDictionary *)newProfile
  ...
  DLog(@"Set profile to\n%@", newProfile);
  // Force triggers to be checked. We may be switching to a profile without
  // triggers and we don't want them to run on the lines of text above
  // _triggerLine later on when switching to a profile that does have triggers.
  _lastPartialLineTriggerCheck = 0;
  [self clearTriggerLine];

  NSString *theName = [[self profile] objectForKey:KEY_NAME];
  NSMutableDictionary *dict =
      [NSMutableDictionary dictionaryWithDictionary:newProfile];
  if (preserveName) {
...
- (void)screenSetPasteboard:(NSString *)value {
  if ([iTermPreferences
          boolForKey:kPreferenceKeyAllowClipboardAccessFromTerminal]) {
...
- (void)screenAppendDataToPasteboard:(NSData *)data {
  // Don't allow more than 100MB to be added to the pasteboard queue in case
  // someone forgets to send the EndCopy command.
...
- (void)screenWillReceiveFileNamed:(NSString *)filename
                            ofSize:(NSInteger)size
                      preconfirmed:(BOOL)preconfirmed {
  [self.download stop];
  [self.download endOfData];
  self.download =
      [[[TerminalFileDownload alloc] initWithName:filename
...
- (void)screenDidReceiveBase64FileData:(NSString *)data {
    ...
    iTermAnnouncementViewController *announcement =
        [iTermAnnouncementViewController
            announcementWithTitle:
                @"A file transfer was aborted for exceeding its declared size."
                            style:kiTermAnnouncementViewStyleWarning
                      withActions:@[]
                       completion:^(int selection){
                       }];
    [self queueAnnouncement:announcement
                 identifier:@"FileTransferAbortedOversize"];
  ...
  if (!self.download.preconfirmed) {
    [_screen confirmBigDownloadWithBeforeSize:lengthBefore
                                    afterSize:lengthAfter
                                         name:self.download.shortName];
  }
}
...
- (void)screenRequestUpload:(NSString *)args {
  ...
  [panel
      beginSheetModalForWindow:_textview.window
             completionHandler:^(NSInteger result) {
               if (result == NSModalResponseOK) {
                 ...
                 // Get the directories for all the URLs. If a URL was a file,
                 // convert it to the containing directory, otherwise leave it
                 // alone.
                 __block BOOL anyFiles = NO;
                 NSArray<NSURL *> *directories =
                     [panel.URLs mapWithBlock:^id(NSURL *anObject) {
                       BOOL isDirectory = NO;
                       if ([fileManager fileExistsAtPath:anObject.path
                           ...
                           [pathComponents
                               subarrayWithRange:NSMakeRange(
                                                     ...
                                                     pathComponents.count -
                                                         baseComponents.count)];
                       NSString *relativePath = [relativePathComponents
                           componentsJoinedByString:@"/"];
                       // Start every path with "./" to deal with filenames
                       // beginning with -.
                       return
                 ...
                 if (!data && error) {
                   ...
                   if (message) {
                     ...
                     alert.informativeText = [NSString
                         stringWithFormat:@"tar failed with this message: %@",
                                          message];
                     [alert runModal];
                     return;
                   }
                 ...
                 if (relativePaths.count == 1) {
                   ...
                   label = [NSString stringWithFormat:@"%@ plus %ld more",
                                                      relativePaths.firstObject
                                                          .lastPathComponent,
                                                      relativePaths.count - 1];
                 }
                 self.upload = [[[TerminalFileUpload alloc]
                     initWithName:label
                             size:base64String.length] autorelease];
                 [self.upload upload];
...
- (void)screenDidTryToUseDECRQCRA {
  ...
  iTermAnnouncementViewController *announcement =
      [iTermAnnouncementViewController
          announcementWithTitle:@"An app tried to read screen contents with "
                                @"DECRQCRA. Enable this feature?"
                     ...
                     completion:^(int selection) {
                       ...
                       case 0: // Enable
                         [iTermAdvancedSettingsModel
                             setNoSyncDisableDECRQCRA:NO];
                         break;

                       case 1: // Disable
                         [iTermAdvancedSettingsModel
                             setNoSyncDisableDECRQCRA:YES];
                         break;
                       }
                     }];
...
- (void)screenSetBackgroundImageFile:(NSString *)originalFilename {
  NSString *const filename = [[originalFilename
      stringByBase64DecodingStringWithEncoding:NSUTF8StringEncoding]
      stringByTrimmingTrailingCharactersFromCharacterSet:
...
- (void)screenSetBadgeFormat:(NSString *)base64Format {
  NSString *theFormat =
      [base64Format stringByBase64DecodingStringWithEncoding:self.encoding];
  iTermParsedExpression *parsedExpression = [iTermExpressionParser
      parsedExpressionWithInterpolatedString:theFormat
                                       scope:self.variablesScope];
  if ([parsedExpression containsAnyFunctionCall]) {
    XLog(@"Rejected control-sequence provided badge format containing function "
         @"calls: %@",
         theFormat);
    [self showSimpleWarningAnnouncment:
              @"The application attempted to set the badge to a value that "
              @"would invoke a function call. For security reasons, this is "
              @"not allowed and the badge was not updated."
...
- (void)screenSetUserVar:(NSString *)kvpString {
  ...
  if (kvp) {
    ...
    NSString *value = [kvp.secondObject
        stringByBase64DecodingStringWithEncoding:NSUTF8StringEncoding];
    ...
    [self.variablesScope
                setValue:nil
        forVariableNamed:[NSString stringWithFormat:@"user.%@", kvpString]];
    if (self.isTmuxClient) {
      [self.tmuxController setUserVariableWithKey:key
                                            value:nil
                                             pane:self.tmuxPane];
...
- (void)screenSetColor:(NSColor *)color forKey:(int)key {
  ...
  if (profileKey) {
    [self setSessionSpecificProfileValues:@{
      profileKey : [color dictionaryValue]
    }];
  } else {
...
- (void)screenCurrentHostDidChange:(VT100RemoteHost *)host {
  ...
  // Ignore changes to username; only update on hostname changes. See issue
  // 8030.
...
- (void)maybeResetTerminalStateOnHostChange:(VT100RemoteHost *)newRemoteHost {
  if (_xtermMouseReporting && self.terminal.mouseMode != MOUSE_REPORTING_NONE) {
    NSNumber *number = [[NSUserDefaults standardUserDefaults]
        objectForKey:kTurnOffMouseReportingOnHostChangeUserDefaultsKey];
    if ([number boolValue]) {
  ...
  if (self.terminal.reportFocus) {
    NSNumber *number = [[NSUserDefaults standardUserDefaults]
        objectForKey:kTurnOffFocusReportingOnHostChangeUserDefaultsKey];
    if ([number boolValue]) {
  ...
  if (self.terminal.bracketedPasteMode &&
      ![self shellIsFishForHost:newRemoteHost]) {
    NSNumber *number = [[NSUserDefaults standardUserDefaults]
        objectForKey:kTurnOffBracketedPasteOnHostChangeUserDefaultsKey];
    if ([number boolValue]) {
...
- (NSArray<iTermCommandHistoryCommandUseMO *> *)commandUses {
  return [[iTermShellHistoryController sharedInstance]
      commandUsesForHost:self.currentHost];
}
...
- (void)offerToTurnOffMouseReportingOnHostChange {
  NSString *title =
      ...
      @"unexpectedly or an app misbehaved. Turn it off?";
                 ...
                 completion:^(int selection) {
                   ...
                   case 1: // Always
                     [[NSUserDefaults standardUserDefaults]
                         setBool:YES
                          forKey:
                              kTurnOffMouseReportingOnHostChangeUserDefaultsKey];
                     self.terminal.mouseMode = MOUSE_REPORTING_NONE;
                     break;
  ...
  [self queueAnnouncement:announcement
               identifier:
                   kTurnOffMouseReportingOnHostChangeAnnouncementIdentifier];
}

- (void)offerToTurnOffFocusReportingOnHostChange {
  NSString *title =
      @"Looks like focus reporting was left on when an ssh session ended "
      @"unexpectedly or an app misbehaved. Turn it off?";
  iTermAnnouncementViewController *announcement = [iTermAnnouncementViewController
      announcementWithTitle:title
                      style:kiTermAnnouncementViewStyleQuestion
                 ...
                 completion:^(int selection) {
                   ...
                   case 1: // Always
                     [[NSUserDefaults standardUserDefaults]
                         setBool:YES
                          forKey:
                              kTurnOffFocusReportingOnHostChangeUserDefaultsKey];
                     self.terminal.reportFocus = NO;
                     break;
  ...
  [self queueAnnouncement:announcement
               identifier:
                   kTurnOffFocusReportingOnHostChangeAnnouncementIdentifier];
}
...
- (void)tryAutoProfileSwitchWithHostname:(NSString *)hostname
                                username:(NSString *)username
                                    path:(NSString *)path
                                     job:(NSString *)job {
  if ([iTermProfilePreferences boolForKey:KEY_PREVENT_APS
                                inProfile:self.profile]) {
    return;
  }
...
- (void)screenDidReceiveCustomEscapeSequenceWithParameters:
  ...
  notification.customEscapeSequenceNotification =
      [[[ITMCustomEscapeSequenceNotification alloc] init] autorelease];
  notification.customEscapeSequenceNotification.session = self.guid;
  notification.customEscapeSequenceNotification.senderIdentity =
      parameters[@"id"];
...
- (BOOL)haveCommandInRange:(VT100GridCoordRange)range {
  ...
  // If semantic history goes nuts and the end-of-command code isn't received
  // (which seems to be a common problem, probably because of buggy old versions
  // of SH scripts) , the command can grow without bound. We'll limit the length
  // of a command to avoid performance problems.
  ...
  iTermTextExtractor *extractor =
      [iTermTextExtractor textExtractorWithDataSource:_screen];
  return [extractor
      haveNonWhitespaceInFirstLineOfRange:VT100GridWindowedRangeMake(range, 0,
                                                                     0)];
}
...
// NOTE: If you change this you probably want to change -haveCommandInRange:,
// too.
- (NSString *)commandInRange:(VT100GridCoordRange)range {
  ...
  iTermTextExtractor *extractor =
      [iTermTextExtractor textExtractorWithDataSource:_screen];
  NSString *command =
      [extractor contentInRange:VT100GridWindowedRangeMake(range, 0, 0)
...
- (NSArray *)autocompleteSuggestionsForCurrentCommand {
  ...
  NSString *trimmedCommand = [command
      stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]];
  return [[iTermShellHistoryController sharedInstance]
      commandHistoryEntriesWithPrefix:trimmedCommand
                               onHost:host];
}

- (void)screenCommandDidChangeWithRange:(VT100GridCoordRange)range {
  DLog(@"FinalTerm: command changed. New range is %@",
       VT100GridCoordRangeDescription(range));
  [self didUpdatePromptLocation];
  BOOL hadCommand =
      _commandRange.start.x >= 0 && [self haveCommandInRange:_commandRange];
  _commandRange = range;
  BOOL haveCommand =
      _commandRange.start.x >= 0 && [self haveCommandInRange:_commandRange];

  if (haveCommand) {
    VT100ScreenMark *mark = [_screen
        markOnLine:_lastPromptLine - [_screen totalScrollbackOverflow]];
    mark.commandRange = VT100GridAbsCoordRangeFromCoordRange(
        range, _screen.totalScrollbackOverflow);
    if (!hadCommand) {
      mark.promptRange = VT100GridAbsCoordRangeMake(
          0, _lastPromptLine, range.start.x, mark.commandRange.end.y);
    }
  }
  if (!haveCommand && hadCommand) {
    ...
    if ([[_delegate realParentWindow]
            wantsCommandHistoryUpdatesFromSession:self]) {
      NSString *command =
          haveCommand ? [self commandInRange:_commandRange] : @"";
      DLog(@"Update command to %@, have=%d, range.start.x=%d", command,
           (int)haveCommand, range.start.x);
...
- (void)screenCommandDidEndWithRange:(VT100GridCoordRange)range {
  ...
  DLog(@"FinalTerm: Command <<%@>> ended with range %@", command,
       VT100GridCoordRangeDescription(range));
  VT100ScreenMark *mark = nil;
  if (command) {
    NSString *trimmedCommand =
        [command stringByTrimmingCharactersInSet:[NSCharacterSet
                                                     whitespaceCharacterSet]];
    if (trimmedCommand.length) {
      mark = [_screen
          markOnLine:_lastPromptLine - [_screen totalScrollbackOverflow]];
      DLog(@"FinalTerm:  Make the mark on lastPromptLine %lld (%@) a command "
           @"mark for command %@",
           _lastPromptLine - [_screen totalScrollbackOverflow], mark, command);
      mark.command = command;
      mark.commandRange = VT100GridAbsCoordRangeFromCoordRange(
          range, _screen.totalScrollbackOverflow);
      mark.outputStart = VT100GridAbsCoordMake(
          _screen.currentGrid.cursor.x, _screen.currentGrid.cursor.y +
                                            _screen.numberOfScrollbackLines +
                                            _screen.totalScrollbackOverflow);
  ...
  [self.variablesScope setValue:command
               forVariableNamed:iTermVariableKeySessionLastCommand];

  // `_commandRange` is from the beginning of command, to the cursor, not
  // necessarily the end of the command. `range` here includes the entire
  // command and a new line.
  _lastOrCurrentlyRunningCommandAbsRange = VT100GridAbsCoordRangeFromCoordRange(
      range, _screen.totalScrollbackOverflow);
  _commandRange = VT100GridCoordRangeMake(-1, -1, -1, -1);
  ...
  [_promptSubscriptions
      enumerateKeysAndObjectsUsingBlock:^(id _Nonnull key,
                                          ITMNotificationRequest *_Nonnull obj,
                                          BOOL *_Nonnull stop) {
        if ([obj.promptMonitorRequest.modesArray
                it_contains:ITMPromptMonitorMode_CommandStart]) {
          ITMNotification *notification =
              [[[ITMNotification alloc] init] autorelease];
          notification.promptNotification =
              [[[ITMPromptNotification alloc] init] autorelease];
...
- (void)screenCommandDidExitWithCode:(int)code
  ...
  [_promptSubscriptions
      enumerateKeysAndObjectsUsingBlock:^(id _Nonnull key,
                                          ...
                                          BOOL *_Nonnull stop) {
        if ([obj.promptMonitorRequest.modesArray
                it_contains:ITMPromptMonitorMode_CommandEnd]) {
          ITMNotification *notification =
              [[[ITMNotification alloc] init] autorelease];
          notification.promptNotification =
              [[[ITMPromptNotification alloc] init] autorelease];
...
- (void)resumeOutputIfNeeded {
  if (_suppressAllOutput) {
    // If all output was being suppressed and you hit a key, stop it but ignore
    // bells for a few seconds until we can process any that are in the
    // pipeline.
...
- (BOOL)screenShouldIgnoreBellWhichIsAudible:(BOOL)audible
  ...
  self.variablesScope.bellCount =
      @(self.variablesScope.bellCount.integerValue + 1);
  NSTimeInterval now = [NSDate timeIntervalSinceReferenceDate];
  ...
  // If the bell rings more often than once every X seconds, you will eventually
  // get an offer to silence it.
  static const NSTimeInterval kThresholdForBellMovingAverageToInferAnnoyance =
      0.02;

  // Initial value that will require a reasonable amount of bell-ringing to
  // overcome. This value was chosen so that one bell per second will cause the
  // moving average's value to fall below 4 after 3 seconds.
  ...
  if ([_bellRate value] < kThresholdForBellMovingAverageToInferAnnoyance &&
      [[NSUserDefaults standardUserDefaults]
          boolForKey:kSilenceAnnoyingBellAutomatically]) {
  ...
  if ([_bellRate value] < kThresholdForBellMovingAverageToInferAnnoyance &&
      ...
      ![[NSUserDefaults standardUserDefaults]
          boolForKey:kSuppressAnnoyingBellOffer]) {
    ...
    if (audible) {
      ...
      announcement = [iTermAnnouncementViewController
          announcementWithTitle:@"The bell is ringing a lot. Silence it?"
                          style:kiTermAnnouncementViewStyleQuestion
                    withActions:@[
                      @"_Silence Bell Temporarily", @"Suppress _All Output",
                      @"Don't Offer Again", @"Silence Automatically"
                    ]
                     completion:^(int selection) {
                       // Release the moving average so the count will restart
                       // after the announcement goes away.
                       [_bellRate release];
                       _bellRate = nil;
                       switch (selection) {
                       case -2: // Dismiss programmatically
      ...
      DLog(@"Want to show a bell announcement. The bell is visible but "
           @"inaudible.");
      // Neither audible nor visible.
      announcement = [iTermAnnouncementViewController
          announcementWithTitle:@"The bell is ringing a lot. Want to suppress "
                                @"all output until things calm down?"
                          style:kiTermAnnouncementViewStyleQuestion
                    withActions:@[
                      @"Suppress _All Output", @"Don't Offer Again"
                    ]
                     completion:^(int selection) {
                       // Release the moving average so the count will restart
                       // after the announcement goes away.
...
- (void)trimCommandsIfNeeded {
  if (_commands.count > kMaxCommands) {
    [_commands
        removeObjectsInRange:NSMakeRange(0, _commands.count - kMaxCommands)];
  }
}

- (void)trimDirectoriesIfNeeded {
  if (_directories.count > kMaxDirectories) {
    [_directories removeObjectsInRange:NSMakeRange(0, _directories.count -
                                                          kMaxDirectories)];
  }
}

- (void)setLastDirectory:(NSString *)lastDirectory
                  remote:(BOOL)directoryIsRemote
                  pushed:(BOOL)pushed {
  DLog(@"setLastDirectory:%@ remote:%@ pushed:%@\n%@", lastDirectory,
       @(directoryIsRemote), @(pushed), [NSThread callStackSymbols]);
...
- (void)asyncCurrentLocalWorkingDirectoryOrInitialDirectory:
    (void (^)(NSString *pwd))completion {
  NSString *envPwd = self.environment[@"PWD"];
  DLog(@"asyncCurrentLocalWorkingDirectoryOrInitialDirectory "
       @"environment[pwd]=%@",
       envPwd);
  [self asyncCurrentLocalWorkingDirectory:^(NSString *pwd) {
...
- (NSString *)currentLocalWorkingDirectory {
  ...
  if (self.lastLocalDirectory != nil) {
    // If a shell integration-provided working directory is available, prefer to
    // use it because it has unresolved symlinks. The path provided by
    // -getWorkingDirectory has expanded symlinks and isn't what the user
    // expects to see. This was raised in issue 3383. My first fix was to expand
    // symlinks on _lastDirectory and use it if it matches what the kernel
    // reports. That was a bad idea because expanding symlinks is slow on
    // network file systems (Issue 4901). Instead, we'll use _lastDirectory if
    // we believe it's on localhost. Furthermore, getWorkingDirectory is slow
    // and blocking and it would be better never to call it.
...
// We trust push more than pull because pulls don't include hostname and are
// done unnecessarily all the time.
- (void)screenLogWorkingDirectoryAtLine:(int)line
                          withDirectory:(NSString *)directory
                                 pushed:(BOOL)pushed
                                 timely:(BOOL)timely {
  DLog(@"screenLogWorkingDirectoryAtLine:%@ withDirectory:%@ pushed:%@ "
       @"timely:%@",
  ...
  if (timely) {
    ...
    const BOOL directoryIsRemote =
        pushed && remoteHost && !remoteHost.isLocalhost;

    // Update lastDirectory, lastLocalDirectory (maybe), proxy icon, "path"
    // variable.
...
- (NSString *)shellIntegrationUpgradeUserDefaultsKeyForHost:
    (VT100RemoteHost *)host {
  return
      [NSString stringWithFormat:
                    @"SuppressShellIntegrationUpgradeAnnouncementForHost_%@@%@",
...
- (void)tryToRunShellIntegrationInstallerWithPromptCheck:(BOOL)promptCheck {
  ...
  if (!promptCheck || currentCommand != nil) {
    ...
    iTermWarningSelection selection = [iTermWarning
        showWarningWithTitle:@"It looks like you're not at a command prompt."
...
- (void)screenSuggestShellIntegrationUpgrade {
  ...
  NSString *theKey =
      [self shellIntegrationUpgradeUserDefaultsKeyForHost:currentRemoteHost];
  ...
  iTermAnnouncementViewController *announcement =
      [iTermAnnouncementViewController
          announcementWithTitle:
              @"This account’s Shell Integration scripts are out of date."
                          style:kiTermAnnouncementViewStyleWarning
                    withActions:@[ @"Upgrade", @"Silence Warning" ]
                     completion:^(int selection) {
                       ...
                       case 0: // Yes
                         [self tryToRunShellIntegrationInstallerWithPromptCheck:
                                   YES];
                         break;
  ...
  [self queueAnnouncement:announcement
               identifier:kShellIntegrationOutOfDateAnnouncementIdentifier];
}

- (BOOL)screenShouldReduceFlicker {
  return [iTermProfilePreferences boolForKey:KEY_REDUCE_FLICKER
                                   inProfile:self.profile];
}
...
- (void)screenSetUnicodeVersion:(NSInteger)unicodeVersion {
  if (unicodeVersion == 0) {
    ...
    unicodeVersion = [[iTermProfilePreferences
        defaultObjectForKey:KEY_UNICODE_VERSION] integerValue];
  }
  if (unicodeVersion >= kMinimumUnicodeVersion &&
      ...
      unicodeVersion != [iTermProfilePreferences
                            integerForKey:KEY_UNICODE_VERSION
                                inProfile:self.profile]) {
    [self setSessionSpecificProfileValues:@{
      KEY_UNICODE_VERSION : @(unicodeVersion)
    }];
  }
}

- (void)updateStatusChangedLine {
  _statusChangedAbsLine = _screen.cursorY - 1 +
                          _screen.numberOfScrollbackLines +
                          _screen.totalScrollbackOverflow;
}

- (void)restoreKeyLabels:(NSDictionary *)labels
    updateStatusChangedLine:(BOOL)updateStatusChangedLine {
  if (labels.count == 0) {
    return;
  }
  if (!_keyLabels) {
  ...
  [labels enumerateKeysAndObjectsUsingBlock:^(NSString *_Nonnull name,
...
- (void)screenSendModifiersDidChange {
  const BOOL allowed =
      [iTermProfilePreferences boolForKey:KEY_ALLOW_MODIFY_OTHER_KEYS
                                inProfile:self.profile];
...
- (void)screenTerminalAttemptedPasteboardAccess {
  ...
  NSString *notice =
      @"The terminal attempted to access the clipboard but it was denied. "
      @"Enable clipboard access in “Prefs > General > Selection > Applications "
                    ...
                    withActions:@[ @"_Open Prefs", @"Don't Show This Again" ]
                     completion:^(int selection) {
                       if (selection == 0) {
                         ...
                         [iTermAdvancedSettingsModel
                             setNoSyncSuppressClipboardAccessDeniedWarning:YES];
                       }
                     }];
  [self queueAnnouncement:announcement identifier:identifier];
}
...
- (void)screenReportPasteBracketingWillChangeTo:(BOOL)bracket {
  [self dismissAnnouncementWithIdentifier:
            kTurnOffBracketedPasteOnHostChangeAnnouncementIdentifier];
}
...
- (iTermAnnouncementViewController *)announcementWithIdentifier:
    (NSString *)identifier {
...
- (BOOL)screenConfirmDownloadNamed:(NSString *)name
  ...
  const iTermWarningSelection selection = [iTermWarning
      showWarningWithTitle:
          [NSString stringWithFormat:
                        @"The download “%@” is larger than %@. Continue?", name,
                        [NSString it_formatBytes:limit]]
                   actions:@[ @"Allow", @"Deny" ]
                 accessory:nil
                identifier:identifier
               silenceable:kiTermWarningTypePermanentlySilenceable
...
- (BOOL)screenConfirmDownloadAllowed:(NSString *)name
  ...
  *promptIfBig = YES;
  ...
  if (displayInline) {
    title =
        [NSString stringWithFormat:@"The terminal has initiated display of a "
                                   @"file named “%@” of size %@. Allow it?",
                                   name, [NSString it_formatBytes:size]];
    heading = @"Allow Terminal-Initiated Display?";
  } else {
    title =
        [NSString stringWithFormat:@"The terminal has initiated transfer of a "
                                   @"file named “%@” of size %@. Download it?",
                                   name, [NSString it_formatBytes:size]];
  ...
  if (allow && wasSilenced) {
    if (size > VT100ScreenBigFileDownloadThreshold) {
      *promptIfBig = NO;
      return
          [self screenConfirmDownloadNamed:name
...
- (BOOL)screenShouldClearScrollbackBuffer {
  ...
  const BOOL *boolPtr =
      iTermAdvancedSettingsModel.preventEscapeSequenceFromClearingHistory;
  if (!boolPtr) {
    return NO;
  }
  return !*boolPtr;
    ...
    [_textview
        keyDown:[NSEvent keyEventWithType:NSEventTypeKeyDown
                    ...
                    charactersIgnoringModifiers:@"\x7f"
                                      isARepeat:NO
                                        keyCode:51]]; // 51 is the keycode for
                                                      // delete; not in any
                                                      // header file :(
    return YES;
  }
...
- (void)pasteHelperWriteString:(NSString *)string {
  ...
  if (_pasteHelper.pasteContext.bytesWritten == 0 &&
    ...
    [self watchForPasteBracketingOopsieWithPrefix:[_pasteHelper.pasteContext
                                                          .pasteEvent
                                                          .originalString
                                                      it_substringToIndex:4]];
  }
}
...
- (iTermSavedProfile *)automaticProfileSwitcherCurrentSavedProfile {
  iTermSavedProfile *savedProfile =
      [[[iTermSavedProfile alloc] init] autorelease];
...
- (void)automaticProfileSwitcherLoadProfile:(iTermSavedProfile *)savedProfile {
  Profile *underlyingProfile = [[ProfileModel sharedInstance]
      bookmarkWithGuid:savedProfile.originalProfile[KEY_GUID]];
  Profile *replacementProfile =
      underlyingProfile ?: savedProfile.originalProfile;
  ...
  if ([iTermAdvancedSettingsModel showAutomaticProfileSwitchingBanner]) {
    [_view showUnobtrusiveMessage:
               [NSString stringWithFormat:@"Switched to profile “%@”.",
...
- (NSDragOperation)sessionViewDraggingEntered:(id<NSDraggingInfo>)sender {
  ...
  if (!([[[sender draggingPasteboard] types]
            indexOfObject:@"com.iterm2.psm.controlitem"] != NSNotFound)) {
...
- (BOOL)sessionViewShouldSplitSelectionAfterDragUpdate:
    (id<NSDraggingInfo>)sender {
  if ([[[sender draggingPasteboard] types]
          indexOfObject:iTermMovePaneDragType] != NSNotFound &&
...
- (BOOL)sessionViewTerminalIsFirstResponder {
  return (_textview.window.firstResponder == _textview && [NSApp isActive] &&
...
- (CGFloat)sessionViewDesiredHeightOfDocumentView {
  return _textview.desiredHeight +
         [iTermPreferences intForKey:kPreferenceKeyTopBottomMargins];
}
...
- (NSSize)sessionViewScrollViewWillResize:(NSSize)proposedSize {
  if ([self isTmuxClient] &&
      ![_delegate sessionBelongsToTabWhoseSplitsAreBeingDragged]) {
    NSSize idealSize =
        [self idealScrollViewSizeWithStyle:_view.scrollview.scrollerStyle];
    NSSize maximumSize =
        NSMakeSize(idealSize.width + _textview.charWidth - 1,
                   idealSize.height + _textview.lineHeight - 1);
    DLog(@"is a tmux client, so tweaking the proposed size. idealSize=%@ "
         @"maximumSize=%@",
...
- (CGFloat)backingScaleFactor {
  return self.delegate.realParentWindow.window.backingScaleFactor
...
- (void)drawFrameAndRemoveTemporarilyDisablementOfMetalForToken:(id)token
  ...
  if (!_useMetal) {
    DLog(@"drawFrameAndRemoveTemporarilyDisablementOfMetal returning early "
         @"because useMetal is off");
    return;
  }
  if ([_metalDisabledTokens containsObject:token]) {
    DLog(@"drawFrameAndRemoveTemporarilyDisablementOfMetal: Found token %@",
         token);
    if (_metalDisabledTokens.count > 1) {
      [_metalDisabledTokens removeObject:token];
      DLog(@"drawFrameAndRemoveTemporarilyDisablementOfMetal: There are still "
           @"other tokens remaining: %@",
           _metalDisabledTokens);
      return;
    }
  } else {
    DLog(@"drawFrameAndRemoveTemporarilyDisablementOfMetal: Bogus token %@",
         token);
    return;
  }
  ...
  [_view.driver
      drawAsynchronouslyInView:_view.metalView
                    completion:^(BOOL ok) {
                      ...
                      if (![_metalDisabledTokens containsObject:token]) {
                        DLog(@"drawFrameAndRemoveTemporarilyDisablementOfMetal:"
                             @" Token %@ is gone, not proceeding.",
                             token);
                        return;
                      }
                      if (_exited) {
                        DLog(@"drawFrameAndRemoveTemporarilyDisablementOfMetal:"
                             @" Returning because the session is dead");
                        return;
                      }
                      if (!_useMetal) {
                        DLog(@"drawFrameAndRemoveTemporarilyDisablementOfMetal:"
                             @" Returning because useMetal is off");
                        return;
                      }
                      if (!ok) {
                        DLog(@"drawFrameAndRemoveTemporarilyDisablementOfMetal:"
                             @" Schedule "
                             @"drawFrameAndRemoveTemporarilyDisablementOfMetal "
                             @"to run after a spin of the mainloop");
                        if (!_delegate) {
                          [self setUseMetal:NO];
                          return;
                        }
                        dispatch_async(dispatch_get_main_queue(), ^{
                          if (![_metalDisabledTokens containsObject:token]) {
                            DLog(@"drawFrameAndRemoveTemporarilyDisablementOfMe"
                                 @"tal: [after a spin of the runloop] Token %@ "
                                 @"is gone, not proceeding.",
                                 token);
                            return;
                          }
                          [self
                      ...
                      [_metalDisabledTokens removeObject:token];
                      DLog(@"drawFrameAndRemoveTemporarilyDisablementOfMetal: "
                           @"Remove temporarily disablement. Tokens are now %@",
                           _metalDisabledTokens);
...
- (void)sessionViewNeedsMetalFrameUpdate {
  ...
  if (@available(macOS 10.11, *)) {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
      ...
      DLog(@"sessionViewNeedsMetalFrameUpdate will draw farme and remove "
           @"disablement");
...
- (void)coprocess:(Coprocess *)coprocess
    didTerminateWithErrorOutput:(NSString *)errors {
      ...
      [iTermAnnouncementViewController
          announcementWithTitle:
              [NSString stringWithFormat:
                          ...
                          style:kiTermAnnouncementViewStyleWarning
                    withActions:@[
                      @"_View Errors", @"Ignore Errors from This Command"
                    ]
                     completion:^(int selection) {
                       if (selection == 0) {
                         NSString *filename = [[NSWorkspace sharedWorkspace]
                             temporaryFileNameWithPrefix:@"coprocess-stderr."
                                                  suffix:@".txt"];
                         [errors writeToFile:filename
                                  atomically:NO
                                    encoding:NSUTF8StringEncoding
                                       error:nil];
                         [[NSWorkspace sharedWorkspace] openFile:filename];
                       } else if (selection == 1) {
                         [Coprocess setSilentlyIgnoreErrors:YES
                                                fromCommand:command];
                       }
                     }];
...
- (iTermUpdateCadenceState)updateCadenceControllerState {
  ...
  if (self.useMetal) {
    ...
    if ([iTermAdvancedSettingsModel
            disableAdaptiveFrameRateInInteractiveApps] &&
        _terminal.softAlternateScreenMode) {
      state.useAdaptiveFrameRate = NO;
    } else {
  ...
  state.adaptiveFrameRateThroughputThreshold =
      _adaptiveFrameRateThroughputThreshold;
  state.slowFrameRate = self.useMetal
...
- (NSString *)stringForLine:(screen_char_t *)screenChars
                     length:(int)length
                  cppsArray:
                      (NSMutableArray<ITMCodePointsPerCell *> *)cppsArray {
  unichar *characters = iTermMalloc(sizeof(unichar) * length * kMaxParts + 1);
  ITMCodePointsPerCell *cpps =
      [[[ITMCodePointsPerCell alloc] init] autorelease];
  ...
  for (int i = 0; i < length; ++i) {
    ...
    if (!screenChars[i].complexChar && c >= ITERM2_PRIVATE_BEGIN &&
        c <= ITERM2_PRIVATE_END) {
      numCodePoints = 0;
  ...
  NSString *string = [[[NSString alloc] initWithCharacters:characters
                                                    length:o] autorelease];
  free(characters);
  return string;
}

- (VT100GridAbsWindowedRange)absoluteWindowedCoordRangeFromLineRange:
    (ITMLineRange *)lineRange {
  if (lineRange.hasWindowedCoordRange) {
    return VT100GridAbsWindowedRangeMake(
        VT100GridAbsCoordRangeMake(
            lineRange.windowedCoordRange.coordRange.start.x,
  ...
  if (n != 1) {
    return VT100GridAbsWindowedRangeMake(
        VT100GridAbsCoordRangeMake(-1, -1, -1, -1), -1, -1);
  }

  NSRange range;
  if (lineRange.hasScreenContentsOnly) {
    range.location =
        [_screen numberOfScrollbackLines] + _screen.totalScrollbackOverflow;
    ...
    int64_t length =
        MIN(1000000, MIN(lineRange.trailingLines, _screen.numberOfLines));
    range.location =
        _screen.numberOfLines + _screen.totalScrollbackOverflow - length;
    range.length = length;
  } else {
    range = NSMakeRange(NSNotFound, 0);
  }
  return VT100GridAbsWindowedRangeMake(
      VT100GridAbsCoordRangeMake(0, range.location, 0, NSMaxRange(range)), 0,
      0);
}

- (ITMGetBufferResponse *)handleGetBufferRequest:
    (ITMGetBufferRequest *)request {
  ITMGetBufferResponse *response =
      [[[ITMGetBufferResponse alloc] init] autorelease];

  const VT100GridAbsWindowedRange windowedRange =
      [self absoluteWindowedCoordRangeFromLineRange:request.lineRange];
  ...
  const VT100GridWindowedRange range =
      VT100GridWindowedRangeFromVT100GridAbsWindowedRange(
          windowedRange, _screen.totalScrollbackOverflow);
  iTermTextExtractor *extractor =
      [iTermTextExtractor textExtractorWithDataSource:_screen];
  __block int firstIndex = -1;
  __block int lastIndex = -1;
  __block screen_char_t *line = nil;
  BOOL (^handleEol)(unichar, int, int) =
      ^BOOL(unichar code, int numPreceedingNulls, int linenumber) {
        ITMLineContents *lineContents =
            [[[ITMLineContents alloc] init] autorelease];
        lineContents.text =
            [self stringForLine:line + firstIndex
  ...
  [extractor enumerateCharsInRange:range
      charBlock:^BOOL(screen_char_t *currentLine, screen_char_t theChar,
  ...
  response.cursor.y = _screen.currentGrid.cursor.y +
                      _screen.numberOfScrollbackLines +
                      _screen.totalScrollbackOverflow;

  response.status = ITMGetBufferResponse_Status_Ok;
  response.windowedCoordRange.coordRange.start.x =
      windowedRange.coordRange.start.x;
  response.windowedCoordRange.coordRange.start.y =
      windowedRange.coordRange.start.y;
  ...
  response.windowedCoordRange.columns.location =
      windowedRange.columnWindow.location;
  response.windowedCoordRange.columns.length =
      windowedRange.columnWindow.length;
...
- (void)handleListPromptsRequest:(ITMListPromptsRequest *)request
                      completion:
                          (void (^)(ITMListPromptsResponse *))completion {
  ITMListPromptsResponse *response =
      [[[ITMListPromptsResponse alloc] init] autorelease];
  [_screen
      enumeratePromptsFrom:request.hasFirstUniqueId ? request.firstUniqueId
                                                    : nil
...
- (void)handleGetPromptRequest:(ITMGetPromptRequest *)request
                    completion:
                        (void (^)(ITMGetPromptResponse *response))completion {
  ...
  ITMGetPromptResponse *response =
      [[[ITMGetPromptResponse alloc] init] autorelease];
  if (!mark) {
  ...
  if (mark.outputStart.x >= 0) {
    ...
    response.outputRange.end.y = _screen.currentGrid.cursor.y +
                                 _screen.numberOfScrollbackLines +
                                 _screen.totalScrollbackOverflow;
  }
  ...
  response.workingDirectory =
      [_screen workingDirectoryOnLine:mark.promptRange.end.y]
          ?: self.lastDirectory;
  if (mark.hasCode) {
...
- (ITMSetProfilePropertyResponse_Status)
    handleSetProfilePropertyForAssignments:
        (NSArray<iTermTuple<NSString *, id> *> *)tuples
                        scriptHistoryEntry:
                            (iTermScriptHistoryEntry *)scriptHistoryEntry {
    ...
    if (![iTermProfilePreferences valueIsLegal:value forKey:key]) {
      ...
      [scriptHistoryEntry
          addOutput:[NSString stringWithFormat:
                                  @"Value %@ is not legal type for key %@\n",
                                  value, key]];
...
- (ITMGetProfilePropertyResponse *)handleGetProfilePropertyForKeys:
    (NSArray<NSString *> *)keys {
  ITMGetProfilePropertyResponse *response =
      [[[ITMGetProfilePropertyResponse alloc] init] autorelease];
  if (!keys.count) {
    return [self
        handleGetProfilePropertyForKeys:[iTermProfilePreferences allKeys]];
  }

  for (NSString *key in keys) {
    id value = [iTermProfilePreferences objectForKey:key
                                           inProfile:self.profile];
    if (value) {
      NSString *jsonString =
          [iTermProfilePreferences jsonEncodedValueForKey:key
                                                inProfile:self.profile];
      if (jsonString) {
        ITMProfileProperty *property =
            [[[ITMProfileProperty alloc] init] autorelease];
        property.key = key;
...
- (NSString *)sessionNameControllerUniqueIdentifier {
  ...
  iTermTuple<NSString *, NSString *> *tuple = [iTermTuple
      fromPlistValue:[iTermProfilePreferences stringForKey:KEY_TITLE_FUNC
                                                 inProfile:_profile]];
...
- (void)sessionNameControllerNameWillChangeTo:(NSString *)newName {
  [self.variablesScope setValue:newName
               forVariableNamed:iTermVariableKeySessionName];
}

- (void)sessionNameControllerPresentationNameDidChangeTo:
  ...
  [self.variablesScope setValue:presentationName
...
- (iTermSessionFormattingDescriptor *)
    sessionNameControllerFormattingDescriptor {
  iTermSessionFormattingDescriptor *descriptor =
      [[[iTermSessionFormattingDescriptor alloc] init] autorelease];
...
- (void)jobPidDidChange {
  // Avoid requesting an update before we know the name because doing so delays
  // updating it when we finally get the name since it's rate-limited.
  if (self.shell.pid > 0 ||
      [[[self variablesScope] valueForVariableName:@"jobName"] length] > 0) {
    [[iTermProcessCache sharedInstance] setNeedsUpdate:YES];
  }
  if ([_graphicSource updateImageForProcessID:self.shell.pid
    ...
    [self.delegate sessionDidChangeGraphic:self
                                shouldShow:self.shouldShowTabGraphic
                                     image:self.tabGraphic];
  }
...
- (void)echoProbeDidFail:(iTermEchoProbe *)echoProbe {
  BOOL ok =
      ([iTermWarning
           showWarningWithTitle:
               @"Are you really at a password prompt? It looks "
...
- (NSColor *)textColorForStatusBar {
  return [[iTermTheme sharedInstance]
      statusBarTextColorForEffectiveAppearance:_view.effectiveAppearance
                                      colorMap:_colorMap
                                      tabStyle:[self.view.window
                                                       .ptyWindow it_tabStyle]
                                 mainAndActive:(self.view.window.isMainWindow &&
                                                NSApp.isActive)];
}
...
- (BOOL)statusBarHasDarkBackground {
  if (self.view.window.ptyWindow.it_terminalWindowUseMinimalStyle) {
    NSColor *color =
        self.view.window.ptyWindow.it_terminalWindowDecorationControlColor;
    return [color isDark];
  }
  // This is called early in the appearance change process and subviews of the
  // contentview aren't up to date yet.
...
- (NSColor *)statusBarSeparatorColor {
  ...
  NSColor *color =
      _statusBarViewController.layout.advancedConfiguration.separatorColor;
  if (color) {
    return color;
  }
  ...
  if (@available(macOS 10.14, *)) {
    ...
    return [[[self textColorForStatusBar] it_colorWithAppearance:appearance]
...
- (void)statusBarOpenPreferencesToComponent:
  ...
  NSString *guid;
  if (self.isDivorced &&
      ([_overriddenFields containsObject:KEY_STATUS_BAR_LAYOUT] ||
...
- (void)maybeOfferToSetOptionAsEscForLeft:(BOOL)left {
  ...
  if ([[NSUserDefaults standardUserDefaults]
          boolForKey:neverPromptUserDefaultsKey]) {
  ...
  if ([iTermProfilePreferences integerForKey:profileKey
                                   inProfile:self.profile] != OPT_NORMAL) {
  ...
  if ([[[ProfileModel sharedInstance] bookmarks] count] == 1) {
    ...
    actions =
        @[ @"Change This Profile", @"Change All Profiles", @"Stop Asking" ];
    allProfiles = 1;
  }

  Profile *profileToChange =
      [[ProfileModel sharedInstance] bookmarkWithGuid:self.profile[KEY_GUID]];
  if (!profileToChange) {
    return;
  }
  ...
  iTermAnnouncementViewController *announcement =
      [iTermAnnouncementViewController
          announcementWithTitle:
              [NSString
                  stringWithFormat:@"You seem frustrated. Would you like the "
                                   @"%@ option key to send esc+keystroke?",
                                   leftOrRight]
                          style:kiTermAnnouncementViewStyleWarning
                    withActions:actions
                     completion:^(int selection) {
                       ...
                       if (selection == thisProfile) {
                         ...
                         for (Profile *profile in
                              [[[[ProfileModel sharedInstance] bookmarks] copy]
                                  autorelease]) {
                           [iTermProfilePreferences
                                  setInt:OPT_ESC
                                  forKey:profileKey
                         ...
                         [[NSUserDefaults standardUserDefaults]
                             setBool:YES
                              forKey:neverPromptUserDefaultsKey];
                       }
                     }];
...
- (BOOL)useLocalDirectoryPollerResult {
  ...
  if (_shouldExpectCurrentDirUpdates &&
      ![iTermAdvancedSettingsModel disablePotentiallyInsecureEscapeSequences]) {
...
- (void)workingDirectoryPollerDidFindWorkingDirectory:(NSString *)pwd
  ...
  DLog(@"workingDirectoryPollerDidFindWorkingDirectory:%@ invalidated:%@", pwd,
       @(invalidated));
  if (invalidated || ![self useLocalDirectoryPollerResult]) {
    DLog(@"Not creating a mark. invalidated=%@", @(invalidated));
    // This is definitely a local directory. It may have been invalidated
    // because we got a push for a remote directory, but it's still useful to
    // know the local directory for the purposes of session restoration.
    self.lastLocalDirectory = pwd;

    // Do not call setLastDirectory:remote:pushed: because there's no sense
    // updating the path variable for an invalidated update when we might have a
    // better remote working directory.
    //
...
- (void)standardKeyMapperWillMapKey:
    (iTermStandardKeyMapper *)standardKeyMapper {
...
- (void)copyModeHandlerDidChangeEnabledState:(iTermCopyModeHandler *)handler
    NOT_COPY_FAMILY {
  [_textview setNeedsDisplay:YES];
  if (!handler.enabled) {
...
- (iTermCopyModeState *)copyModeHandlerCreateState:
    (iTermCopyModeHandler *)handler NOT_COPY_FAMILY {
  iTermCopyModeState *state = [[[iTermCopyModeState alloc] init] autorelease];
  state.coord =
      VT100GridCoordMake(_screen.cursorX - 1,
  ...
  if (_textview.selection.allSubSelections.count == 1) {
    ...
    VT100GridAbsCoordRangeTryMakeRelative(
        sub.absRange.coordRange, _screen.totalScrollbackOverflow,
  ...
  [_textview
      scrollLineNumberRangeIntoView:VT100GridRangeMake(state.coord.y, 1)];
  return state;
}

- (void)copyModeHandler:(iTermCopyModeHandler *)handler
             redrawLine:(int)line NOT_COPY_FAMILY {
...
- (void)copyModeHandler:(iTermCopyModeHandler *)handler
             revealLine:(int)line NOT_COPY_FAMILY {
  [_textview scrollLineNumberRangeIntoView:VT100GridRangeMake(line, 1)];
}

- (void)copyModeHandlerCopySelection:(iTermCopyModeHandler *)handler
    NOT_COPY_FAMILY {
...
- (iTermBuiltInFunctions *)objectMethodRegistry {
  if (!_methods) {
    ...
    method = [[iTermBuiltInMethod alloc]
        ...
        optionalArguments:[NSSet set]
                  context:iTermVariablesSuggestionContextSession
                   target:self
                   action:@selector
                   (setStatusBarComponentUnreadCountWithCompletion:
                                                        identifier:count:)];
    [_methods registerFunction:method namespace:@"iterm2"];

    method = [[iTermBuiltInMethod alloc]
             initWithName:@"stop_coprocess"
            defaultValues:@{}
                    types:@{}
        optionalArguments:[NSSet set]
                  context:iTermVariablesSuggestionContextSession
    ...
    method = [[iTermBuiltInMethod alloc]
             initWithName:@"run_coprocess"
            defaultValues:@{}
                    types:@{
                      @"commandLine" : [NSString class],
                      @"mute" : [NSNumber class]
                    }
        optionalArguments:[NSSet setWithArray:@[ @"mute" ]]
                  context:iTermVariablesSuggestionContextSession
                   target:self
                   action:@selector(runCoprocessWithCompletion:
                                                   commandLine:mute:)];
    [_methods registerFunction:method namespace:@"iterm2"];
    ...
    method = [[iTermBuiltInMethod alloc]
        ...
        optionalArguments:[NSSet set]
                  context:iTermVariablesSuggestionContextSession
                   target:self
                   action:@selector
                   (addAnnotationWithCompletion:startX:startY:endX:endY:text:)];
    [_methods registerFunction:method namespace:@"iterm2"];
  }
  return _methods;
}
...
- (void)addAnnotationWithCompletion:(void (^)(id, NSError *))completion
                             ...
                             startY:(NSNumber *)startYNumber
                               ...
                               text:(NSString *)text {
  const VT100GridAbsCoordRange range = VT100GridAbsCoordRangeMake(
      startXNumber.intValue, startYNumber.longLongValue, endXNumber.intValue,
      endYNumber.longLongValue);
  const long long maxY =
      _screen.totalScrollbackOverflow + _screen.numberOfLines;
  if (startYNumber.integerValue > endYNumber.integerValue ||
      startYNumber.integerValue < 0 || startYNumber.integerValue > maxY ||
      endYNumber.integerValue < 0 || endYNumber.integerValue > maxY ||
      (startYNumber.integerValue == endYNumber.integerValue &&
       startXNumber.integerValue > endXNumber.integerValue)) {
    NSError *error = [NSError
        errorWithDomain:@"com.iterm2.add-annotation-command"
                   code:0
...
- (void)setStatusBarComponentUnreadCountWithCompletion:
            (void (^)(id, NSError *))completion
                                            identifier:(NSString *)identifier
                                                 count:(NSNumber *)count {
  [[iTermStatusBarUnreadCountController sharedInstance]
      setUnreadCountForComponentWithIdentifier:identifier
...
- (void)sendTmuxCommandWithCompletion:(void (^)(id, NSError *))completion
  ...
  if (self.tmuxMode == TMUX_NONE || _tmuxController == nil) {
    NSError *error = [NSError
        errorWithDomain:@"com.iterm2.tmux-command"
                   code:0
               userInfo:@{
                 NSLocalizedDescriptionKey : @"Not a tmux integration session"
               }];
    completion(nil, error);
  }

  [_tmuxController.gateway
           sendCommand:command
        responseTarget:self
...
- (void)sendTmuxCommandMethodDidComplete:(NSString *)result
  ...
  NSError *error =
      [NSError errorWithDomain:@"com.iterm2.tmux-command"
                          code:1
...
- (ITMNotificationResponse *)
  ...
  ITMNotificationResponse *response =
      [[[ITMNotificationResponse alloc] init] autorelease];
  ...
  case ITMNotificationType_NotifyOnVariableChange: // Gets special handling
...
- (void)naggingControllerShowMessage:(NSString *)message
  ...
  iTermAnnouncementViewController *announcement =
      [iTermAnnouncementViewController
          announcementWithTitle:message
                          style:isQuestion ? kiTermAnnouncementViewStyleQuestion
...
- (void)naggingControllerRepairSavedArrangement:(NSString *)savedArrangementName
                            missingProfileNamed:(NSString *)missingProfileName
                                           guid:(NSString *)guid {
  Profile *similarlyNamedProfile =
      [[ProfileModel sharedInstance] bookmarkWithName:missingProfileName];
  [[iTermController sharedInstance]
      repairSavedArrangementNamed:savedArrangementName
             replacingMissingGUID:guid
                         withGUID:similarlyNamedProfile[KEY_GUID]];
  [[NSNotificationCenter defaultCenter]
      postNotificationName:PTYSessionDidRepairSavedArrangement
                    object:guid
...
- (void)naggingControllerSetBackgroundImageToFileWithName:(NSString *)filename {
  [self setSessionSpecificProfileValues:@{
    KEY_BACKGROUND_IMAGE_LOCATION : filename.length ? filename : [NSNull null]
  }];
}
...
- (void)naggingControllerRepairInitialWorkingDirectoryOfSessionWithGUID:
            (NSString *)guid
                                                  inArrangementWithName:
                                                      (NSString *)
                                                          arrangementName {
  NSOpenPanel *panel = [NSOpenPanel openPanel];
  ...
  [[iTermController sharedInstance]
                    repairSavedArrangementNamed:arrangementName
...
- (NSAppearance *)composerManagerAppearance:
    (iTermComposerManager *)composerManager {
...
- (void)intervalTreeDidReset {
  ...
  if (@available(macOS 10.14, *)) {
    ...
    [_screen enumerateObservableMarks:^(iTermIntervalTreeObjectType type,
                                        NSInteger line) {
...
- (void)tmuxControllerSessionSetTTL:(NSTimeInterval)ttl redzone:(BOOL)redzone {
  ...
  NSString *title = [NSString
      stringWithFormat:@"This session will pause in about %@ second%@ because "
                       @"it is buffering too much data.",
                       @(safeTTL), safeTTL == 1 ? @"" : @"s"];
  iTermAnnouncementViewController *announcement = [self
      announcementWithIdentifier:PTYSessionAnnouncementIdentifierTmuxPaused];
  if (announcement) {
