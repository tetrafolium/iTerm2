...
// The virtual key code is not used in ordering or comparison. Its only purpose
// is to improve the quality of the formatted string. See
// iTermKeystrokeFormatter.
...
- (NSString *_Nullable)keyInBindingDictionary:
    (NSDictionary<NSString *, NSDictionary *> *)dict;
- (NSDictionary *_Nullable)valueInBindingDictionary:
    (NSDictionary<NSString *, NSDictionary *> *)dict;
...
// self and other should have serialized keystroke keys. Result will have
// serialized keystroke keys.
...
typedef iTermOr<iTermKeystroke *, iTermTouchbarItem *>
    iTermKeystrokeOrTouchbarItem;
