...
- (NSAppleEventDescriptor *)scriptingRGBColorDescriptor {
  ...
  RGBColor rgbColor = {
      ...
      .green =
          (unsigned short)([theColor greenComponent] * kRGBColorCoefficient),
      .blue =
          (unsigned short)([theColor blueComponent] * kRGBColorCoefficient)};
...
+ (NSColor *)scriptingRGBColorWithDescriptor:
  ...
  return [NSColor
      colorWithCalibratedRed:(CGFloat)rgbColor->red / kRGBColorCoefficient
