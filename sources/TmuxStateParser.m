...
// These are the cursor coords in the primary screen, valid only when in the alt
// screen. CSI ? 1049 h saves to this, CSI ? 1049 h restores from it. CSI ? 1048
// h/l is not supported by tmux.
...
+ (NSString *)format {
  ...
  NSArray *theModes = [NSArray
      arrayWithObjects:kStateDictPaneId, kStateDictSavedGrid,
                       kStateDictAltSavedCX, kStateDictAltSavedCY,
                       kStateDictCursorX, kStateDictCursorY,
                       kStateDictScrollRegionUpper, kStateDictScrollRegionLower,
                       kStateDictTabstops, kStateDictCursorMode,
                       kStateDictInsertMode, kStateDictKCursorMode,
...
+ (NSMutableDictionary *)dictionaryForState:(NSString *)state {
  ...
  NSDictionary *fieldTypes = [NSDictionary
      dictionaryWithObjectsAndKeys:intType, kStateDictSavedGrid, intType,
                                   kStateDictCursorX, intType,
                                   kStateDictCursorY, intType,
                                   kStateDictAltSavedCX, intType,
                                   kStateDictAltSavedCY, uintType,
                                   kStateDictCursorMode, uintType,
                                   kStateDictInsertMode, uintType,
                                   kStateDictKCursorMode, uintType,
                                   kStateDictKKeypadMode, uintType,
                                   kStateDictMouseStandardMode, uintType,
                                   kStateDictMouseButtonMode, uintType,
                                   kStateDictMouseAnyMode, uintType,
                                   kStateDictMouseUTF8Mode, uintType,
                                   kStateDictWrapMode, uintType,
                                   kStateDictScrollRegionUpper, uintType,
                                   kStateDictScrollRegionLower,
                                   paneIdNumberType, kStateDictPaneId,
                                   intlistType, kStateDictTabstops, nil];
