...
static int ParseHandshakeRequest(iTermClientServerProtocolMessageParser *parser,
  ...
  if (iTermClientServerProtocolParseTaggedInt(
          parser, &out->maximumProtocolVersion,
          sizeof(out->maximumProtocolVersion),
...
static int
EncodeHandshakeRequest(iTermClientServerProtocolMessageEncoder *encoder,
                       iTermMultiServerRequestHandshake *handshake) {
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &handshake->maximumProtocolVersion,
          sizeof(handshake->maximumProtocolVersion),
          iTermMultiServerTagHandshakeRequestClientMaximumProtocolVersion)) {
...
static int
ParseHandshakeResponse(iTermClientServerProtocolMessageParser *parser,
                       iTermMultiServerResponseHandshake *out) {
  if (iTermClientServerProtocolParseTaggedInt(
          parser, &out->protocolVersion, sizeof(out->protocolVersion),
          iTermMultiServerTagHandshakeResponseProtocolVersion)) {
    return iTermMultiServerProtocolErrorHandshakeResponseMissingVersion;
  }
  if (iTermClientServerProtocolParseTaggedInt(
          parser, &out->numChildren, sizeof(out->numChildren),
...
static int
EncodeHandshakeResponse(iTermClientServerProtocolMessageEncoder *encoder,
                        iTermMultiServerResponseHandshake *handshake) {
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &handshake->protocolVersion,
          sizeof(handshake->protocolVersion),
          iTermMultiServerTagHandshakeResponseProtocolVersion)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &handshake->numChildren, sizeof(handshake->numChildren),
          iTermMultiServerTagHandshakeResponseChildReportsNumChildren)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &handshake->pid, sizeof(handshake->pid),
          iTermMultiServerTagHandshakeResponseProcessID)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  return 0;
...
static int EncodeLaunchRequest(iTermClientServerProtocolMessageEncoder *encoder,
  ...
  if (iTermClientServerProtocolEncodeTaggedString(
          encoder, launch->path, iTermMultiServerTagLaunchRequestPath)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedStringArray(
          encoder, (char **)launch->argv, launch->argc,
          iTermMultiServerTagLaunchRequestArgv)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedStringArray(
          encoder, (char **)launch->envp, launch->envc,
          iTermMultiServerTagLaunchRequestEnvironment)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &launch->columns, sizeof(launch->columns),
          iTermMultiServerTagLaunchRequestColumns)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &launch->rows, sizeof(launch->rows),
          iTermMultiServerTagLaunchRequestRows)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &launch->pixel_width, sizeof(launch->pixel_width),
          iTermMultiServerTagLaunchRequestPixelWidth)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &launch->pixel_height, sizeof(launch->pixel_height),
          iTermMultiServerTagLaunchRequestPixelHeight)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &launch->isUTF8, sizeof(launch->isUTF8),
          iTermMultiServerTagLaunchRequestIsUTF8)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedString(
          encoder, launch->pwd, iTermMultiServerTagLaunchRequestPwd)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &launch->uniqueId, sizeof(launch->uniqueId),
          iTermMultiServerTagLaunchRequestUniqueId)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  return 0;
...
static int ParseLaunchResponse(iTermClientServerProtocolMessageParser *parser,
  ...
  if (iTermClientServerProtocolParseTaggedInt(
          parser, &out->status, sizeof(out->status),
  ...
  if (iTermClientServerProtocolParseTaggedString(
          parser, (char **)&out->tty, iTermMultiServerTagLaunchResponseTty)) {
...
static int
EncodeLaunchResponse(iTermClientServerProtocolMessageEncoder *encoder,
                     iTermMultiServerResponseLaunch *launch) {
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &launch->status, sizeof(launch->status),
          iTermMultiServerTagLaunchResponseStatus)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &launch->pid, sizeof(launch->pid),
          iTermMultiServerTagLaunchResponsePid)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedInt(
  ...
  if (iTermClientServerProtocolEncodeTaggedString(
          encoder, launch->tty, iTermMultiServerTagLaunchResponseTty)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  return 0;
}
...
static int ParseWaitRequest(iTermClientServerProtocolMessageParser *parser,
  ...
  if (iTermClientServerProtocolParseTaggedInt(
          parser, &out->removePreemptively, sizeof(out->removePreemptively),
...
static int EncodeWaitRequest(iTermClientServerProtocolMessageEncoder *encoder,
  ...
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &wait->pid, sizeof(wait->pid),
          iTermMultiServerTagWaitRequestPid)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &wait->removePreemptively, sizeof(wait->removePreemptively),
          iTermMultiServerTagWaitRequestRemovePreemptively)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  return 0;
...
static int ParseWaitResponse(iTermClientServerProtocolMessageParser *parser,
  ...
  if (iTermClientServerProtocolParseTaggedInt(
          parser, &out->resultType, sizeof(out->resultType),
...
static int EncodeWaitResponse(iTermClientServerProtocolMessageEncoder *encoder,
  ...
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &wait->status, sizeof(wait->status),
          iTermMultiServerTagWaitResponseStatus)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &wait->resultType, sizeof(wait->resultType),
          iTermMultiServerTagWaitResponseResultType)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  return 0;
...
static int ParseReportChild(iTermClientServerProtocolMessageParser *parser,
  ...
  if (iTermClientServerProtocolParseTaggedInt(
          parser, &out->isLast, sizeof(out->isLast),
  ...
  if (iTermClientServerProtocolParseTaggedString(
          parser, (char **)&out->path, iTermMultiServerTagReportChildPath)) {
...
static int EncodeReportChild(iTermClientServerProtocolMessageEncoder *encoder,
  ...
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &obj->isLast, sizeof(obj->isLast),
          iTermMultiServerTagReportChildIsLast)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &obj->pid, sizeof(obj->pid),
          iTermMultiServerTagReportChildPid)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedString(
          encoder, obj->path, iTermMultiServerTagReportChildPath)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedStringArray(
          encoder, (char **)obj->argv, obj->argc,
          iTermMultiServerTagReportChildArgs)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedStringArray(
          encoder, (char **)obj->envp, obj->envc,
          iTermMultiServerTagReportChildEnv)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &obj->isUTF8, sizeof(obj->isUTF8),
          iTermMultiServerTagReportChildIsUTF8)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedString(
          encoder, obj->pwd, iTermMultiServerTagReportChildPwd)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedInt(
          encoder, &obj->terminated, sizeof(obj->terminated),
          iTermMultiServerTagReportChildTerminated)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  if (iTermClientServerProtocolEncodeTaggedString(
          encoder, obj->tty, iTermMultiServerTagReportChildTTY)) {
    return iTermMultiServerProtocolErrorEncodingFailed;
  }
  return 0;
}
...
int iTermMultiServerProtocolParseMessageFromClient(
    iTermClientServerProtocolMessage *message,
    iTermMultiServerClientOriginatedMessage *out) {
  memset(out, 0, sizeof(*out));
  iTermClientServerProtocolMessageParser parser = {.offset = 0,
                                                   .message = message};

  if (iTermClientServerProtocolParseTaggedInt(
          &parser, &out->type, sizeof(out->type), iTermMultiServerTagType)) {
...
int iTermMultiServerProtocolGetFileDescriptor(
    iTermClientServerProtocolMessage *message, int *receivedFileDescriptorPtr) {
  // Should be this:
...
int iTermMultiServerProtocolParseMessageFromServer(
    iTermClientServerProtocolMessage *message,
    iTermMultiServerServerOriginatedMessage *out) {
  memset(out, 0, sizeof(*out));
  iTermClientServerProtocolMessage temp = *message;
  // This pointer can dangle if the struct gets copied, so ensure it's a legit
  // internal pointer.
  ...
  case iTermMultiServerRPCTypeLaunch: { // Server-originated response to
                                        // client-originated request
    int rc = ParseLaunchResponse(&parser, &out->payload.launch);
    if (rc) {
      return rc;
    }
    return iTermMultiServerProtocolGetFileDescriptor(message,
                                                     &out->payload.launch.fd);
  }
  case iTermMultiServerRPCTypeReportChild: { // Server-originated, no response.
    ...
    return iTermMultiServerProtocolGetFileDescriptor(
        message, &out->payload.reportChild.fd);
  }
  case iTermMultiServerRPCTypeWait:
...
int iTermMultiServerProtocolEncodeMessageFromClient(
    iTermMultiServerClientOriginatedMessage *obj,
    iTermClientServerProtocolMessage *message) {
  iTermClientServerProtocolMessageEncoder encoder = {.offset = 0,
                                                     .message = message};

  int status = iTermClientServerProtocolEncodeTaggedInt(
      &encoder, &obj->type, sizeof(obj->type), iTermMultiServerTagType);
  if (status) {
    return status;
  }
  switch (obj->type) {
...
int iTermMultiServerProtocolEncodeMessageFromServer(
...
static void
FreeHandshakeResponse(iTermMultiServerResponseHandshake *handshake) {}

static void FreeLaunchResponse(iTermMultiServerResponseLaunch *launch) {
  free((void *)launch->tty);
}

void iTermMultiServerClientOriginatedMessageFree(
    iTermMultiServerClientOriginatedMessage *obj) {
  switch (obj->type) {
  case iTermMultiServerRPCTypeHandshake:
...
void iTermMultiServerServerOriginatedMessageFree(
    iTermMultiServerServerOriginatedMessage *obj) {
  switch (obj->type) {
  case iTermMultiServerRPCTypeHandshake:
...
static ssize_t RecvMsg(int fd, iTermClientServerProtocolMessage *message) {
...
static ssize_t Read(int fd, char *buffer, size_t length) {
  assert(length > 0);
  ssize_t n = -1;
  ssize_t offset = 0;
  while (offset < length) {
    ...
    if (n <= 0) {
      FDLog(LOG_DEBUG, "read returned %d: %s", n,
            errno ? strerror(errno) : "EOF");
      return n;
    }
    offset += n;
    FDLog(LOG_DEBUG, "read returned %d. Have read %d/%d", n, (int)offset,
          (int)length);
  }
...
ssize_t iTermMultiServerReadMessage(int fd,
                                    iTermClientServerProtocolMessage *message,
                                    ssize_t bufferSize) {
  assert(bufferSize >= 0);
...
int iTermMultiServerRead(int fd, iTermClientServerProtocolMessage *message) {
  ...
  if (actuallyRead < sizeof(length)) {
    FDLog(LOG_DEBUG, "While reading length: short read %d/%d",
          (int)actuallyRead, (int)length);
    goto done;
  }
  ...
  if (length <= 0 || length > MAX_MESSAGE_SIZE) {
    FDLog(LOG_DEBUG,
          "While reading length: Negative or oversize read of %d (%s)",
  ...
  if (actuallyRead < length) {
    FDLog(LOG_DEBUG, "While reading payload: actuallyRead=%d (%s)",
          (int)actuallyRead, strerror(errno));
    goto done;
  }
  FDLog(LOG_DEBUG, "Finished reading rc=%d %s", (int)actuallyRead,
        strerror(errno));
...
static void LogLaunchRequest(iTermMultiServerRequestLaunch *message) {
  FDLog(LOG_DEBUG,
        "Launch request [path=%s columns=%d rows=%d pixel_width=%d "
        "pixel_height=%d isUTF8=%d pwd=%s uniqueId=%lld argc=%d envc=%d]",
        message->path, message->columns, message->rows, message->pixel_width,
        message->pixel_height, message->isUTF8, message->pwd, message->uniqueId,
        message->argc, message->envc);
  for (int i = 0; i < message->argc; i++) {
    FDLog(LOG_DEBUG, "  Arg %d for launch request %lld: %s", i,
          message->uniqueId, message->argv[i]);
  }
  for (int i = 0; i < message->envc; i++) {
    FDLog(LOG_DEBUG, "  Env %d for launch request %lld: %s", i,
          message->uniqueId, message->envp[i]);
  }
}

static void LogWaitRequest(iTermMultiServerRequestWait *message) {
  FDLog(LOG_DEBUG, "Wait Request [pid=%d removePreemptively=%d]", message->pid,
        message->removePreemptively);
}

void iTermMultiServerProtocolLogMessageFromClient(
...
static void LogHandshakeResponse(iTermMultiServerResponseHandshake *message) {
  FDLog(LOG_DEBUG,
        "Handshake response [protocolVersion=%d numChildren=%d pid=%d]",
        message->protocolVersion, message->numChildren, message->pid);
}

static void LogLaunchResponse(iTermMultiServerResponseLaunch *message) {
  FDLog(LOG_DEBUG,
        "Launch response [status=%d pid=%d fd=%d uniqueId=%lld tty=%s]",
        message->status, message->pid, message->fd, message->uniqueId,
        message->tty);
}

static void LogReportChild(iTermMultiServerReportChild *message) {
  FDLog(LOG_DEBUG,
        "Report child [isLast=%d pid=%d path=%s isUTF8=%d pwd=%s terminated=%d "
        "tty=%s fd=%d argc=%d envc=%d]",
        message->isLast, message->pid, message->path, message->isUTF8,
        message->pwd, message->terminated, message->tty, message->fd,
        message->argc, message->envc);
  for (int i = 0; i < message->argc; i++) {
    FDLog(LOG_DEBUG, "  Arg %d of child with pid %d: %s", i, message->pid,
          message->argv[i]);
  }
  for (int i = 0; i < message->envc; i++) {
    FDLog(LOG_DEBUG, "  Env %d of child with pid %d: %s", i, message->pid,
          message->envp[i]);
  }
}
...
static void LogTermination(iTermMultiServerReportTermination *message) {
  FDLog(LOG_DEBUG, "Report termination [pid=%d]", message->pid);
}
...
void iTermMultiServerProtocolLogMessageFromServer(
