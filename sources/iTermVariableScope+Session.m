...
+ (instancetype)newSessionScopeWithVariables:(iTermVariables *)variables {
  ...
  [scope addVariables:[iTermVariables globalInstance]
         toScopeNamed:iTermVariableKeyGlobalScopeName];
  return scope;
}
...
- (void)setTmuxStatusLeft:(NSString *)newValue {
  [self setValue:newValue
      forVariableNamed:iTermVariableKeySessionTmuxStatusLeft];
}
...
- (void)setTmuxStatusRight:(NSString *)newValue {
  [self setValue:newValue
      forVariableNamed:iTermVariableKeySessionTmuxStatusRight];
}
...
- (iTermVariableScope<iTermTabScope> *)tab {
  return [iTermVariableScope
      newTabScopeWithVariables:
          [self valueForVariableName:iTermVariableKeySessionTab]];
}
