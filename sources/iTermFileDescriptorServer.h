...
// Spin up a new server. |connectionFd| comes from
// iTermFileDescriptorServerAcceptAndClose(), which should be run prior to
// fork()ing.
...
// iTermFileDescriptorServerSocketBindListen(). Returns a connection file
// descriptor, suitable to pass to iTermFileDescriptorServerRun() in
// |connectionFd|.
