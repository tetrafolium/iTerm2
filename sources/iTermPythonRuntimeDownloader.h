...
extern NSString
    *const iTermPythonRuntimeDownloaderDidInstallRuntimeNotification;
...
// When busy, lots of filesystem operations are going and watching paths under
// the Scripts folder is a bad idea.
...
// This downloads if any version is already installed and there's a newer
// version available.
...
// Installs the environment somewhere and shows a please wait window. Higher
// level API.
...
// Given a path to an iterm2env-metadata.json, what version number does it
// contain? Returns 0 if something goes wrong.
