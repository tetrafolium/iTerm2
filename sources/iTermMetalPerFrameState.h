...
// Used to remember the last time the cursor moved to avoid drawing a
// blinked-out cursor while it's moving.
...
@interface iTermMetalPerFrameState
    : NSObject <iTermMetalDriverDataSourcePerFrameState,
