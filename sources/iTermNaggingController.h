...
- (void)naggingControllerSetBackgroundImageToFileWithName:
...
// If we have complained that the saved arrangement is missing a profile, this
// is the GUID of the missing profile.
@property(nonatomic, copy, readonly)
    NSString *missingSavedArrangementProfileGUID;
