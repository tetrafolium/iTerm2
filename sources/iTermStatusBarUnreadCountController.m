...
NSString *const iTermStatusBarUnreadCountDidChange =
    @"iTermStatusBarUnreadCountDidChange";

@implementation iTermStatusBarUnreadCountController {
  NSMutableDictionary<iTermTuple<NSString *, NSString *> *, NSNumber *>
      *_sessionAndIdentifierToCount;
...
- (void)setUnreadCountForComponentWithIdentifier:(NSString *)identifier
  ...
  [[NSNotificationCenter defaultCenter]
      postNotificationName:iTermStatusBarUnreadCountDidChange
                    object:identifier];
}
...
- (void)setUnreadCountForComponentWithIdentifier:(NSString *)identifier
  ...
  _sessionAndIdentifierToCount[[iTermTuple tupleWithObject:sessionID
