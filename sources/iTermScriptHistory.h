...
extern NSString
    *const iTermScriptHistoryEntryDelta; // User info key giving next log/call
extern NSString
    *const iTermScriptHistoryEntryFieldKey; // User info key giving what changed
...
@property(nonatomic, readonly)
    pid_t onlyPid; // Returns the pid if there's only one, otherwise 0
...
@property(nonatomic, readonly, nullable)
    NSString *fullPath; // This can be passed to launchScriptWithAbsolutePath:
