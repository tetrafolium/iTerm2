...
+ (NSArray<NSString *> *)keysWithoutDefaultValues {
  return @[
    KEY_GUID, KEY_TRIGGERS, KEY_SMART_SELECTION_RULES, KEY_SEMANTIC_HISTORY,
    KEY_BOUND_HOSTS, KEY_ORIGINAL_GUID, KEY_AWDS_WIN_OPTION,
    KEY_AWDS_WIN_DIRECTORY, KEY_AWDS_TAB_OPTION, KEY_AWDS_TAB_DIRECTORY,
    KEY_AWDS_PANE_OPTION, KEY_AWDS_PANE_DIRECTORY, KEY_NORMAL_FONT,
    KEY_NON_ASCII_FONT, KEY_BACKGROUND_IMAGE_LOCATION, KEY_KEYBOARD_MAP,
    KEY_TOUCHBAR_MAP, KEY_DYNAMIC_PROFILE_PARENT_NAME,
    KEY_DYNAMIC_PROFILE_FILENAME
  ];
}
+ (NSArray<NSString *> *)allKeys {
  return [self.defaultValueMap.allKeys
      arrayByAddingObjectsFromArray:self.keysWithoutDefaultValues];
}

+ (NSString *)jsonEncodedValueForKey:(NSString *)key
                           inProfile:(Profile *)profile {
...
+ (NSDictionary<NSString *, BOOL (^)(id)> *)validationBlocks {
  ...
  dispatch_once(&onceToken, ^{
    ...
    NSArray *color = @[
      KEY_FOREGROUND_COLOR,   KEY_BACKGROUND_COLOR,  KEY_BOLD_COLOR,
      KEY_LINK_COLOR,         KEY_SELECTION_COLOR,   KEY_SELECTED_TEXT_COLOR,
      KEY_CURSOR_COLOR,       KEY_CURSOR_TEXT_COLOR, KEY_ANSI_0_COLOR,
      KEY_ANSI_1_COLOR,       KEY_ANSI_2_COLOR,      KEY_ANSI_3_COLOR,
      KEY_ANSI_4_COLOR,       KEY_ANSI_5_COLOR,      KEY_ANSI_6_COLOR,
      KEY_ANSI_7_COLOR,       KEY_ANSI_8_COLOR,      KEY_ANSI_9_COLOR,
      KEY_ANSI_10_COLOR,      KEY_ANSI_11_COLOR,     KEY_ANSI_12_COLOR,
    ...
    NSArray *number = @[
      ...
      KEY_XTERM_MOUSE_REPORTING_ALLOW_MOUSE_WHEEL,
      ...
      KEY_SILENCE_BELL,
      KEY_BOOKMARK_USER_NOTIFICATIONS,
      KEY_SEND_BELL_ALERT,
      KEY_SEND_IDLE_ALERT,
      KEY_SEND_NEW_OUTPUT_ALERT,
      KEY_SEND_SESSION_ENDED_ALERT,
      KEY_SEND_TERMINAL_GENERATED_ALERT,
      KEY_FLASHING_BELL,
      KEY_VISUAL_BELL,
      KEY_SESSION_END_ACTION,
      KEY_PROMPT_CLOSE,
      KEY_UNDO_TIMEOUT,
      KEY_REDUCE_FLICKER,
      KEY_SHOW_STATUS_BAR,
      ...
      KEY_ALLOW_MODIFY_OTHER_KEYS,
      KEY_PLACE_PROMPT_AT_FIRST_COLUMN,
      KEY_SHOW_MARK_INDICATORS,
      KEY_POWERLINE,
      ...
      KEY_USE_CUSTOM_TAB_TITLE,
      KEY_USE_LIBTICKIT_PROTOCOL,
      KEY_WINDOW_TYPE,
      KEY_ALLOW_PASTE_BRACKETING,
      KEY_PREVENT_APS
    ];
    ...
    NSArray *dict = @[
      KEY_STATUS_BAR_LAYOUT, KEY_SESSION_HOTKEY, KEY_SEMANTIC_HISTORY,
...
+ (NSDictionary *)defaultValueMap {
  ...
  if (!dict) {
    dict = @{
      ...
      // Note: these defaults aren't used, except for link color and cursor
      // guide color, because they are always specified.
      KEY_FOREGROUND_COLOR :
          [[NSColor colorWithCalibratedRed:0.733 green:0.733 blue:0.733
                                     alpha:1] dictionaryValue],
      KEY_BACKGROUND_COLOR :
          [[NSColor colorWithCalibratedRed:0.000 green:0.000 blue:0.000
                                     alpha:1] dictionaryValue],
      KEY_BOLD_COLOR : [[NSColor colorWithCalibratedRed:1.000
                                                  green:1.000
                                                   blue:1.000
                                                  alpha:1] dictionaryValue],
      KEY_LINK_COLOR : [[NSColor colorWithCalibratedRed:0.023
                                                  green:0.270
                                                   blue:0.678
                                                  alpha:1] dictionaryValue],
      KEY_SELECTION_COLOR :
          [[NSColor colorWithCalibratedRed:0.709 green:0.835 blue:1.000
                                     alpha:1] dictionaryValue],
      KEY_SELECTED_TEXT_COLOR :
          [[NSColor colorWithCalibratedRed:0.000 green:0.000 blue:0.000
                                     alpha:1] dictionaryValue],
      KEY_CURSOR_COLOR : [[NSColor colorWithCalibratedRed:0.733
                                                    green:0.733
                                                     blue:0.733
                                                    alpha:1] dictionaryValue],
      KEY_CURSOR_TEXT_COLOR :
          [[NSColor colorWithCalibratedRed:1.000 green:1.000 blue:1.000
                                     alpha:1] dictionaryValue],
      KEY_ANSI_0_COLOR : [[NSColor colorWithCalibratedRed:0.000
                                                    green:0.000
                                                     blue:0.000
                                                    alpha:1] dictionaryValue],
      KEY_ANSI_1_COLOR : [[NSColor colorWithCalibratedRed:0.733
                                                    green:0.000
                                                     blue:0.000
                                                    alpha:1] dictionaryValue],
      KEY_ANSI_2_COLOR : [[NSColor colorWithCalibratedRed:0.000
                                                    green:0.733
                                                     blue:0.000
                                                    alpha:1] dictionaryValue],
      KEY_ANSI_3_COLOR : [[NSColor colorWithCalibratedRed:0.733
                                                    green:0.733
                                                     blue:0.000
                                                    alpha:1] dictionaryValue],
      KEY_ANSI_4_COLOR : [[NSColor colorWithCalibratedRed:0.000
                                                    green:0.000
                                                     blue:0.733
                                                    alpha:1] dictionaryValue],
      KEY_ANSI_5_COLOR : [[NSColor colorWithCalibratedRed:0.733
                                                    green:0.000
                                                     blue:0.733
                                                    alpha:1] dictionaryValue],
      KEY_ANSI_6_COLOR : [[NSColor colorWithCalibratedRed:0.000
                                                    green:0.733
                                                     blue:0.733
                                                    alpha:1] dictionaryValue],
      KEY_ANSI_7_COLOR : [[NSColor colorWithCalibratedRed:0.733
                                                    green:0.733
                                                     blue:0.733
                                                    alpha:1] dictionaryValue],
      KEY_ANSI_8_COLOR : [[NSColor colorWithCalibratedRed:0.333
                                                    green:0.333
                                                     blue:0.333
                                                    alpha:1] dictionaryValue],
      KEY_ANSI_9_COLOR : [[NSColor colorWithCalibratedRed:1.000
                                                    green:0.333
                                                     blue:0.333
                                                    alpha:1] dictionaryValue],
      KEY_ANSI_10_COLOR : [[NSColor colorWithCalibratedRed:0.333
                                                     green:1.000
                                                      blue:0.333
                                                     alpha:1] dictionaryValue],
      KEY_ANSI_11_COLOR : [[NSColor colorWithCalibratedRed:1.000
                                                     green:1.000
                                                      blue:0.333
                                                     alpha:1] dictionaryValue],
      KEY_ANSI_12_COLOR : [[NSColor colorWithCalibratedRed:0.333
                                                     green:0.333
                                                      blue:1.000
                                                     alpha:1] dictionaryValue],
      KEY_ANSI_13_COLOR : [[NSColor colorWithCalibratedRed:0.000
                                                     green:0.000
                                                      blue:0.733
                                                     alpha:1] dictionaryValue],
      KEY_ANSI_14_COLOR : [[NSColor colorWithCalibratedRed:0.333
                                                     green:1.000
                                                      blue:1.000
                                                     alpha:1] dictionaryValue],
      KEY_ANSI_15_COLOR : [[NSColor colorWithCalibratedRed:1.000
                                                     green:1.000
                                                      blue:1.000
                                                     alpha:1] dictionaryValue],
      KEY_CURSOR_GUIDE_COLOR :
          [[NSColor colorWithCalibratedRed:0.650
                                     green:0.910
                                      blue:1.000
                                     alpha:0.25] dictionaryValue],
      KEY_BADGE_COLOR : [[NSColor colorWithCalibratedRed:1.0
                                                   green:0.000
                                                    blue:0.000
                                                   alpha:0.5] dictionaryValue],
    ...
    NSSet<NSString *> *validatedKeys = [NSSet
        setWithArray:[[iTermProfilePreferences validationBlocks] allKeys]];
    NSSet<NSString *> *allKnownKeys =
        [NSSet setWithArray:[dict.allKeys arrayByAddingObjectsFromArray:
                                              [iTermProfilePreferences
                                                  keysWithoutDefaultValues]]];
...
+ (void)setObject:(id)object
  ...
  if (withSideEffects) {
    ...
    [[NSNotificationCenter defaultCenter]
        postNotificationName:kReloadAllProfiles
                      object:nil
                    userInfo:nil];
  }
}
...
+ (NSDictionary *)computedObjectDictionary {
  ...
  if (!dict) {
    dict = @{
      KEY_IDLE_PERIOD : PROFILE_BLOCK(antiIdlePeriodWithLegacyDefaultInProfile),
...
+ (id)antiIdlePeriodWithLegacyDefaultInProfile:(Profile *)profile {
  ...
  NSNumber *legacyDefault = [[NSUserDefaults standardUserDefaults]
      objectForKey:@"AntiIdleTimerPeriod"];
  if (legacyDefault) {
...
+ (id)unicodeNormalizationForm:(Profile *)profile {
  ...
  if (value) {
    return value.boolValue ? @(iTermUnicodeNormalizationHFSPlus)
...
+ (id)unicodeVersion:(Profile *)profile {
  ...
  if (@available(macOS 10.13, *)) {
    // macOS 10.13 has switched to unicode 9 widths. If you're sshing somewhere
    // then you're going to have a bad time. My hope is that this makes people
    // happier on balance.
    return @9;
  } else {
    // Fall back to the default from the dictionary.
...
+ (id)brightenBoldText:(Profile *)profile {
  ...
  // Migration path. This used to be one and the same as "use bold color". If
  // you've never tweaked this setting directly, fall back to the "use bold
  // color" setting.
...
+ (id)badgeFont:(Profile *)profile {
  ...
  if ([iTermAdvancedSettingsModel badgeFontIsBold]) {
    NSFont *font =
        [NSFont fontWithName:baseFontName size:12]
...
+ (id)titleComponents:(Profile *)profile {
  ...
  // Default to showing session name in tmux profile for backward compatibility
  // with 3.3.0-3.3.2 and earlier (issue 8255).
  ...
  NSNumber *stickyNumber = [[NSUserDefaults standardUserDefaults]
      objectForKey:KEY_SYNC_TITLE_DEPRECATED];
  NSNumber *showJobNumber = [[NSUserDefaults standardUserDefaults]
      objectForKey:kPreferenceKeyShowJobName_Deprecated];
  NSNumber *showProfileNameNumber = [[NSUserDefaults standardUserDefaults]
      objectForKey:kPreferenceKeyShowProfileName_Deprecated];
