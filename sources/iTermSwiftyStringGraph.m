...
- (void)addSwiftyString:(iTermSwiftyString *)swiftyString
  ...
  [swiftyString.refs
      enumerateObjectsUsingBlock:^(iTermVariableReference *_Nonnull ref,
...
- (BOOL)containsCycle {
  return [[[iTermDirectedGraphCycleDetector alloc] initWithDirectedGraph:_graph]
      containsCycle];
}
...
- (void)addEdgeFrom:(iTermVariableDesignator *)source
                 to:(iTermVariableDesignator *)dest {
