...
- (instancetype)initWithAttributedString:
  ...
  if (self) {
    ...
    _hash = iTermCombineHash(iTermCombineHash(self.string.hash, _ligature),
                             _font.hash);
    _ligature = [attributes[(__bridge NSString *)kCTLigatureAttributeName]
...
- (BOOL)isEqual:(id)object {
  ...
  iTermAttributedStringProxy *other =
      [iTermAttributedStringProxy castFrom:object];
  return ([other.string isEqual:self.string] && other->_ligature == _ligature &&
