...
- (NSString *)description {
  return [NSString
      stringWithFormat:
          @"<%@: %p windowRestorationComplete=%@ disableInitialWindow=%@ "
          @"initializationComplete=%@ wantsWindow=%@>",
          self.class, self, @(_windowRestorationComplete),
          @(_disableInitialWindow), @(_initializationComplete),
          @(_wantsWindow)];
}
