...
static NSString *const iTermStatusBarFunctionInvocationKey =
    @"function invocation";
...
- (NSArray<iTermStatusBarComponentKnob *> *)statusBarComponentKnobs {
  iTermStatusBarComponentKnob *labelKnob = [[iTermStatusBarComponentKnob alloc]
      initWithLabelText:@"Label:"
  ...
  iTermStatusBarComponentKnob *invocationKnob =
      [[iTermStatusBarComponentKnob alloc]
          initWithLabelText:@"Function call:"
  ...
  return [@[
    labelKnob, invocationKnob, timeoutKnob, backgroundColorKnob, textColorKnob
...
+ (NSDictionary *)statusBarComponentDefaultKnobs {
  ...
  return [fromSuper
      dictionaryByMergingDictionary:@{iTermStatusBarTimeoutKey : @5}];
}
...
- (NSAttributedString *)attributedString {
  ...
  NSDictionary *attributes = @{
    NSForegroundColorAttributeName : self.textColor ?: [NSNull null],
    NSParagraphStyleAttributeName : style
  };
  return [[NSAttributedString alloc]
      initWithString:self.configuration
                             [iTermStatusBarComponentConfigurationKeyKnobValues]
                             [iTermStatusBarLabelKey]
                         ?: @""
...
- (NSString *)statusBarComponentDetailedDescription {
  return @"Adds a button that invokes a script function with a user-provided "
         @"invocation.";
}
...
- (void)buttonPushed:(id)sender {
  NSString *invocation =
      self.configuration[iTermStatusBarComponentConfigurationKeyKnobValues]
                        [iTermStatusBarFunctionInvocationKey];
  double timeout =
      [self.configuration[iTermStatusBarComponentConfigurationKeyKnobValues]
                         [iTermStatusBarTimeoutKey] doubleValue];
          ...
          if (error) {
            NSString *label =
                self.configuration
                        ...
                        [iTermStatusBarLabelKey]
                    ?: @"";
            [weakSelf.delegate statusBarComponent:self
                             reportScriptingError:error
