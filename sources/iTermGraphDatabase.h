...
// Manages a SQLite database that holds an encoded graph. Loads it and updates
// it incrementally.
...
// Returns NO if the completion block will never be called. Otherwise it will be
// called after the method returns (guaranteed!).
- (BOOL)
