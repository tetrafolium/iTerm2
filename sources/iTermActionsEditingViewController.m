...
static NSString *const iTermActionsEditingPasteboardType =
    @"iTermActionsEditingPasteboardType";
...
@interface iTermActionsEditingViewController () <NSTableViewDataSource,
                                                 NSTableViewDelegate>
@end
...
- (NSView *)viewForTitleColumnOnRow:(NSInteger)row {
  ...
  NSTextField *result = [_tableView makeViewWithIdentifier:identifier
                                                     owner:self];
  if (result == nil) {
...
- (BOOL)tableView:(NSTableView *)tableView
  ...
  [pboard declareTypes:@[ iTermActionsEditingPasteboardType ] owner:self];
  ...
  [pboard setPropertyList:plist forType:iTermActionsEditingPasteboardType];
  return YES;
}
...
- (BOOL)tableView:(NSTableView *)aTableView
  ...
  NSArray<NSNumber *> *identifiers =
      [pboard propertyListForType:iTermActionsEditingPasteboardType];
