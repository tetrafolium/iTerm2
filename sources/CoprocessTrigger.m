...
static NSString *const kSuppressCoprocessTriggerWarning =
    @"NoSyncSuppressCoprocessTriggerWarning";
...
+ (void)showCoprocessAnnouncementInSession:(PTYSession *)aSession {
  if (![[NSUserDefaults standardUserDefaults]
          boolForKey:kSuppressCoprocessTriggerWarning]) {
    ...
    NSString *title = @"A Coprocess trigger fired but could not run because a "
                      @"coprocess is already running.";
