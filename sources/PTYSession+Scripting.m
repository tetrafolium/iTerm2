...
- (NSScriptObjectSpecifier *)objectSpecifier {
  ...
  id classDescription =
      [NSClassDescription classDescriptionForClass:[PTYTab class]];
...
- (void)handleWriteScriptCommand:(NSScriptCommand *)command {
  ...
  BOOL newline = ([args objectForKey:@"newline"]
                      ? [[args objectForKey:@"newline"] boolValue]
                      : YES);
  ...
  if (text && contentsOfFile) {
    ...
    [command setScriptErrorString:
                 @"Only one of text or contents of file should be specified."];
    return;
  }
  if (!text && !contentsOfFile) {
    [command setScriptErrorNumber:2];
    [command setScriptErrorString:
                 @"Neither text nor contents of file was specified."];
    return;
  }
  ...
  if (![name hasPrefix:@"user."]) {
    ...
    [command
        setScriptErrorString:
            @"Only user variables may be set. Name must start with “user.”."];
    return nil;
  }
...
- (void)splitVertically:(BOOL)vertically
  ...
  // NOTE: This will return nil for tmux tabs. I could fix it by using the async
  // version of the split function, but this is Applescript and I hate it.
  [[self.delegate realParentWindow]
      asyncSplitVertically:vertically
                    before:NO
                   profile:profile
...
- (id)handleSplitVertically:(NSScriptCommand *)scriptCommand {
  ...
  Profile *profile =
      [[ProfileModel sharedInstance] bookmarkWithName:profileName];
  if (profile) {
    PTYSession *formerSession = [self activateSessionAndTab];
        ...
        splitVertically:YES
            withProfile:profile
             ...
             completion:^(PTYSession *session) {
               ...
               dispatch_async(dispatch_get_main_queue(), ^{
                 [scriptCommand
                     resumeExecutionWithResult:session.objectSpecifier ? session
                                                                       : nil];
               });
             }];
    return nil;
    ...
    [scriptCommand
        setScriptErrorString:[NSString stringWithFormat:@"No profile named %@",
                                                        profileName]];
    return nil;
  }
}
...
- (id)handleSplitHorizontallyWithDefaultProfile:
...
- (void)setBackgroundColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_BACKGROUND_COLOR : [color dictionaryValue]
  }];
}
...
- (void)setBoldColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_BOLD_COLOR : [color dictionaryValue]
  }];
}
...
- (void)setCursorColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_CURSOR_COLOR : [color dictionaryValue]
  }];
}
...
- (void)setCursorTextColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_CURSOR_TEXT_COLOR : [color dictionaryValue]
  }];
}
...
- (void)setForegroundColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_FOREGROUND_COLOR : [color dictionaryValue]
  }];
}
...
- (void)setUnderlineColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_UNDERLINE_COLOR : [color dictionaryValue]
  }];
}
...
- (void)setSelectedTextColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_SELECTED_TEXT_COLOR : [color dictionaryValue]
  }];
}
...
- (void)setSelectionColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_SELECTION_COLOR : [color dictionaryValue]
  }];
}
...
- (void)setAnswerBackString:(NSString *)string {
  [self
      setSessionSpecificProfileValues:@{KEY_ANSWERBACK_STRING : string ?: @""}];
}
...
- (void)setAnsiBlackColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_ANSI_0_COLOR : [color dictionaryValue]
  }];
}
...
- (void)setAnsiRedColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_ANSI_1_COLOR : [color dictionaryValue]
  }];
}
...
- (void)setAnsiGreenColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_ANSI_2_COLOR : [color dictionaryValue]
  }];
}
...
- (void)setAnsiYellowColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_ANSI_3_COLOR : [color dictionaryValue]
  }];
}
...
- (void)setAnsiBlueColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_ANSI_4_COLOR : [color dictionaryValue]
  }];
}
...
- (void)setAnsiMagentaColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_ANSI_5_COLOR : [color dictionaryValue]
  }];
}
...
- (void)setAnsiCyanColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_ANSI_6_COLOR : [color dictionaryValue]
  }];
}
...
- (void)setAnsiWhiteColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_ANSI_7_COLOR : [color dictionaryValue]
  }];
}
...
- (NSColor *)ansiBrightBlackColor {
  return [self.colorMap
      colorForKey:kColorMapAnsiBrightModifier + kColorMapAnsiBlack];
}

- (void)setAnsiBrightBlackColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_ANSI_8_COLOR : [color dictionaryValue]
  }];
}

- (NSColor *)ansiBrightRedColor {
  return [self.colorMap
      colorForKey:kColorMapAnsiBrightModifier + kColorMapAnsiRed];
}

- (void)setAnsiBrightRedColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_ANSI_9_COLOR : [color dictionaryValue]
  }];
}

- (NSColor *)ansiBrightGreenColor {
  return [self.colorMap
      colorForKey:kColorMapAnsiBrightModifier + kColorMapAnsiGreen];
}

- (void)setAnsiBrightGreenColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_ANSI_10_COLOR : [color dictionaryValue]
  }];
}

- (NSColor *)ansiBrightYellowColor {
  return [self.colorMap
      colorForKey:kColorMapAnsiBrightModifier + kColorMapAnsiYellow];
}

- (void)setAnsiBrightYellowColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_ANSI_11_COLOR : [color dictionaryValue]
  }];
}

- (NSColor *)ansiBrightBlueColor {
  return [self.colorMap
      colorForKey:kColorMapAnsiBrightModifier + kColorMapAnsiBlue];
}

- (void)setAnsiBrightBlueColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_ANSI_12_COLOR : [color dictionaryValue]
  }];
}

- (NSColor *)ansiBrightMagentaColor {
  return [self.colorMap
      colorForKey:kColorMapAnsiBrightModifier + kColorMapAnsiMagenta];
}

- (void)setAnsiBrightMagentaColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_ANSI_13_COLOR : [color dictionaryValue]
  }];
}

- (NSColor *)ansiBrightCyanColor {
  return [self.colorMap
      colorForKey:kColorMapAnsiBrightModifier + kColorMapAnsiCyan];
}

- (void)setAnsiBrightCyanColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_ANSI_14_COLOR : [color dictionaryValue]
  }];
}

- (NSColor *)ansiBrightWhiteColor {
  return [self.colorMap
      colorForKey:kColorMapAnsiBrightModifier + kColorMapAnsiWhite];
}

- (void)setAnsiBrightWhiteColor:(NSColor *)color {
  [self setSessionSpecificProfileValues:@{
    KEY_ANSI_15_COLOR : [color dictionaryValue]
  }];
}
...
- (NSString *)colorPresetName {
  return [ProfilesColorsPreferencesViewController
      nameOfPresetUsedByProfile:self.profile];
}
