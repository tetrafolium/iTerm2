...
- (double)
  ...
  [views
      enumerateObjectsUsingBlock:^(iTermStatusBarContainerView *_Nonnull view,
        ...
        const double weight = view.component.statusBarComponentSpringConstant /
                              sumOfSpringConstants;
        ...
        const double maximum = view.component.statusBarComponentPreferredWidth +
                               (view.component.statusBarComponentIcon
                                    ? iTermStatusBarViewControllerIconWidth
                                    : 0);
        ...
        DLog(@"  grow %@ by %@ to %@. Its preferred width is %@",
             view.component, @(delta), @(view.desiredWidth),
