...
// This guid will always appear in the model even if it doesn't match the
// filter.
...
// Sort the local representation according to sort descriptors set with
// setSortDescriptors.
- (void)sort;

// These functions take the filter (set with setFilter) into account with
// respect to indices.
