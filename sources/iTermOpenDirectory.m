...
// This is (I hope) the equivalent of the command "dscl . read /Users/$USER
// UserShell", which appears to be how you get the user's shell nowadays.
// Returns nil if it can't be gotten.
+ (NSString *)userShell {
  ...
  NSArray *shells = [record valuesForAttribute:kODAttributeTypeUserShell
                                         error:&error];
  if (!shells) {
