...
- (NSArray<iTermStatusBarComponentKnob *> *)statusBarComponentKnobs {
  ...
  NSArray<iTermStatusBarComponentKnob *> *knobs = [@[ backgroundColorKnob ]
...
- (BOOL)shouldUpdateValue:(NSObject *)proposed {
  ...
  if (hasValue || haveProposedvalue) {
    return !([NSObject object:existing isEqualToObject:proposed] &&
             [NSObject object:view.backgroundColor
                 isEqualToObject:self.backgroundColor]);
  }
...
- (void)updateViewIfNeededAnimated:(BOOL)animated {
  ...
  if ([self shouldUpdateValue:proposedForCurrentWidth] ||
      viewWidth != _renderedWidth) {
...
- (NSObject *)modelForWidth:(CGFloat)maximumWidth
