...
extern NSString
    *const kPasteSpecialViewControllerUnicodePunctuationRegularExpression;
extern NSString
    *const kPasteSpecialViewControllerUnicodeDashesRegularExpression;
extern NSString
...
@property(nonatomic, assign) id<iTermPasteSpecialViewControllerDelegate>
    delegate;

@property(nonatomic, assign) int numberOfSpacesPerTab;
@property(nonatomic, assign, getter=areTabTransformsEnabled)
    BOOL enableTabTransforms;
@property(nonatomic, assign) NSInteger selectedTabTransform;
@property(nonatomic, assign, getter=isConvertNewlinesEnabled)
    BOOL enableConvertNewlines;
@property(nonatomic, assign) BOOL shouldConvertNewlines;
@property(nonatomic, assign, getter=isRemoveNewlinesEnabled)
    BOOL enableRemoveNewlines;
@property(nonatomic, assign) BOOL shouldRemoveNewlines;
@property(nonatomic, assign, getter=isEscapeShellCharsWithBackslashEnabled)
    BOOL enableEscapeShellCharsWithBackslash;
@property(nonatomic, assign) BOOL shouldEscapeShellCharsWithBackslash;
@property(nonatomic, assign, getter=isRemoveControlCodesEnabled)
    BOOL enableRemoveControlCodes;
@property(nonatomic, assign) BOOL shouldRemoveControlCodes;
@property(nonatomic, assign, getter=isBracketedPasteEnabled)
...
@property(nonatomic, assign, getter=isUseRegexSubstitutionEnabled)
    BOOL enableUseRegexSubstitution;
@property(nonatomic, assign) BOOL shouldUseRegexSubstitution;
@property(nonatomic, assign, getter=isWaitForPromptEnabled)
    BOOL enableWaitForPrompt;
@property(nonatomic, assign) BOOL shouldWaitForPrompt;
@property(nonatomic, assign, getter=isConvertUnicodePunctuationEnabled)
