...
extern NSString
    *const kEncodedColorDictionaryAlphaComponent; // Optional, defaults to 1.0
extern NSString *const
    kEncodedColorDictionaryColorSpace; // Optional, defaults to calibrated
...
// Note: these are in 0…1. These represent LINEAR values. NSColor has sRGB
// values which are not linear.
typedef struct {
  CGFloat r;
  CGFloat g;
  CGFloat b;
...
// ((l=15.6, a=29.6, b=24.0) = srgb (.31,.05,0) has a distance from pure black
// of .41
...
// Modify r,g,b to have brightness t, placing the values in result which should
// hold 4 CGFloats.
...
// Returns colors for the standard 8-bit ansi color codes. Only indices between
// 16 and 255 are supported.
