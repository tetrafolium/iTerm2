...
- (BOOL)performActionWithCapturedStrings:(NSString *const *)capturedStrings
  ...
  const NSRange rangeInScreenChars =
  ...
  VT100GridAbsCoordRange absRange = VT100GridAbsCoordRangeMake(
      rangeInScreenChars.location, lineNumber,
  ...
  [self paramWithBackreferencesReplacedWithValues:capturedStrings
                                 ...
                                 useInterpolation:useInterpolation
                                       completion:^(NSString *annotation) {
                                         ...
                                         [aSession addNoteWithText:annotation
                                                   inAbsoluteRange:absRange];
                                       }];
  return YES;
}
