...
- (instancetype)initWithDictionary:(NSDictionary *)dict {
  ...
  if (self) {
    ...
    if (start > 0) {
      _startDate =
          [[NSDate dateWithTimeIntervalSinceReferenceDate:start] retain];
    }
    ...
    for (NSDictionary *capturedOutputDict in dict[kMarkCapturedOutputKey]) {
      [array addObject:[CapturedOutput
                           capturedOutputWithDictionary:capturedOutputDict]];
    }
...
- (NSDictionary *)dictionaryValue {
  NSMutableDictionary *dict =
      [[[super dictionaryValue] mutableCopy] autorelease];
  ...
  dict[kMarkPromptRange] =
      [NSDictionary dictionaryWithGridAbsCoordRange:_promptRange];
  dict[kMarkCommandRange] =
      [NSDictionary dictionaryWithGridAbsCoordRange:_commandRange];
  dict[kMarkOutputStart] =
      [NSDictionary dictionaryWithGridAbsCoord:_outputStart];
