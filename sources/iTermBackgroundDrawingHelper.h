...
- (iTermBackgroundImageMode)
    backgroundDrawingHelperBackgroundImageMode; // _backgroundImageMode
- (NSColor *)
    backgroundDrawingHelperDefaultBackgroundColor; // [self
...
// imageSize is the size of the source image, which may have a different aspect
// ratio than the area it's being drawn into. destinationRect is the frame of
// the area to draw into. dirty rect is the region that needs to be redrawn.
// drawRect is filled with the destination rect to draw into. It will be within
// dirtyRect. boxRect1,2 are the frames of the column/pillar boxes. They will be
// within dirtyRect.
