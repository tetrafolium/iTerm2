...
- (void)close {
  if (shutdown_) {
    ...
    // all spaces. Make it key before closing. This has to be done later because
    // if you do it here the OS gets confused and two windows are key.
...
- (void)twiddleKeyWindow {
  iTermApplicationDelegate *theDelegate =
