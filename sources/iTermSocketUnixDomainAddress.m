...
- (instancetype)initWithPath:(NSString *)path {
  ...
  if (self) {
    ...
    snprintf(_sockaddr.sun_path, sizeof(_sockaddr.sun_path), "%s",
             path.UTF8String);
  }
  return self;
}
...
- (id)copyWithZone:(NSZone *)zone {
  return [[iTermSocketUnixDomainAddress alloc]
      initWithPath:[NSString stringWithUTF8String:_sockaddr.sun_path]];
}
...
- (BOOL)isEqualToSockAddr:(struct sockaddr *)other {
  ...
  return !strncmp(other_un->sun_path, _sockaddr.sun_path,
