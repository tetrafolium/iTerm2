...
// This is responsible for the logic involving the NSTextInput insanity,
// including dealing with marked text special cases, routing around Cocoa bugs,
// emulating key bindings, and various other ugly little warts. It is all
// wrapped up in this pandora's box so the toxic shit doesn't touch anything
// else.
//
// Various NSTextInput methods (declared below) should be sent straight here.
// Awful things will happen and then it will turn around and call various
// delegate methods as needed, whose implementations are straight-forward enough
