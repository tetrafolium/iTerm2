...
- (NSArray<NSString *> *)allKeys {
  return @[
    KEY_AWDS_WIN_OPTION, KEY_AWDS_WIN_DIRECTORY, KEY_AWDS_TAB_OPTION,
...
- (IBAction)ok:(id)sender {
  ...
  dict[KEY_AWDS_WIN_OPTION] =
      [self valueForTag:_windowDirectoryType.selectedTag];
  dict[KEY_AWDS_TAB_OPTION] = [self valueForTag:_tabDirectoryType.selectedTag];
  dict[KEY_AWDS_PANE_OPTION] =
      [self valueForTag:_paneDirectoryType.selectedTag];
...
- (void)setAdvancedBookmarkMatrix:(NSMatrix *)matrix
