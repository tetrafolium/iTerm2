...
- (void)openTab:(NSPasteboard *)pasteboard
       userData:(NSString *)userData
          error:(NSError **)error {
  [self
      openFilesFromPasteboard:pasteboard
           inWindowController:[[iTermController sharedInstance] currentTerminal]
                    allowTabs:YES];
}
...
- (void)openFilesFromPasteboard:(NSPasteboard *)pasteboard
             inWindowController:(PseudoTerminal *)windowController
                      allowTabs:(BOOL)allowTabs {
...
- (PseudoTerminal *)openTab:(BOOL)allowTabs
                 inTerminal:(PseudoTerminal *)windowController
  ...
  [iTermSessionLauncher
      ...
      respectTabbingMode:NO
             ...
             makeSession:^(Profile *profile, PseudoTerminal *term,
               ...
               profile =
                   [profile dictionaryBySettingObject:@"Yes"
                                               forKey:KEY_CUSTOM_DIRECTORY];
               profile =
                   [profile dictionaryBySettingObject:path
                                               forKey:KEY_WORKING_DIRECTORY];
