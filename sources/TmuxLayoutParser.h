...
// Trees consist of arrays of dictionaries. The dictionaries have these keys
// defined: All nodes:
extern NSString
    *kLayoutDictNodeType; // Node type from enum LayoutNodeType. NSNumber.
...
extern NSString
    *kLayoutDictWindowPaneKey; // window pane number (leaf nodes only)
...
extern NSString
    *kLayoutDictMaximumPixelWidthKey; // Largest size with same number of cells
extern NSString
    *kLayoutDictMaximumPixelHeightKey; // Largest size with same number of cells
...
// Children of leaf:
extern NSString *kLayoutDictTabOpenedManually; // Was this tab opened by a
                                               // user-initiated action?
extern NSString *
    kLayoutDictTabIndex; // Which index the tab should have in the native window
