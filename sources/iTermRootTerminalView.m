...
const CGFloat iTermStoplightHotboxWidth =
    iTermStandardButtonsViewWidth + 28 + 24;
...
@interface iTermRootTerminalView () <
    iTermTabBarControlViewDelegate, iTermDragHandleViewDelegate,
...
- (void)addWindowColorView {
  ...
  windowColorView.layer.backgroundColor =
...
- (instancetype)
  ...
  if (self) {
    ...
    self.autoresizesSubviews = YES;
    _leftTabBarPreferredWidth =
        round([iTermPreferences doubleForKey:kPreferenceKeyLeftTabBarWidth]);
    ...
    if (@available(macOS 10.14, *)) {
      ...
      _backgroundImage.autoresizingMask =
    ...
    if (@available(macOS 10.14, *)) {
      ...
      _tabBarBacking.hidesWhenTabBarHidden =
          [delegate rootTerminalViewShouldHideTabBarBackingWhenTabBarIsHidden];
      _tabBarBacking.autoresizesSubviews = YES;
    }

    self.tabBarControl =
        [[iTermTabBarControlView alloc] initWithFrame:tabBarFrame];
    self.tabBarControl.height = [delegate rootTerminalViewHeightOfTabBar:self];

    _tabBarControl.itermTabBarDelegate = self;

    NSRect stoplightFrame =
        NSMakeRect(0, 0, iTermStoplightHotboxWidth, iTermStoplightHotboxHeight);
    _stoplightHotbox =
        [[iTermStoplightHotbox alloc] initWithFrame:stoplightFrame];
    [self addSubview:_stoplightHotbox];
    _stoplightHotbox.hidden = YES;
    _stoplightHotbox.delegate = self;

    NSUInteger theModifier = [iTermPreferences
        maskForModifierTag:[iTermPreferences
                               intForKey:kPreferenceKeySwitchTabModifier]];
    ...
    case PSMTab_BottomTab:
      ...
      [self setTabBarControlAutoresizingMask:(NSViewWidthSizable |
                                              NSViewMinYMargin)];
      break;
    ...
    case PSMTab_LeftTab:
      ...
      [self setTabBarControlAutoresizingMask:(NSViewHeightSizable |
                                              NSViewMaxXMargin)];
      break;
    }
    if (@available(macOS 10.14, *)) {
    ...
    _toolbeltWidth =
        [iTermPreferences floatForKey:kPreferenceKeyDefaultToolbeltWidth];

    self.toolbelt = [[iTermToolbeltView alloc]
        initWithFrame:[self toolbeltFrameInWindow:nil]
             delegate:(id)_delegate];
    // Wait until whoever is creating the window sets it to its proper size
    // before laying out the toolbelt. The hope is that the window controller
    // will call updateToolbeltProportionsIfNeeded during this spin of the
    // runloop, but if not we'll get it next time 'round.
    ...
    if (@available(macOS 10.14, *)) {
      NSColor *borderColor = [NSColor colorWithWhite:0.5 alpha:0.75];
      {
        ...
        dispatch_once(&onceToken, ^{
          ...
          gTopLeftCornerHalfImage =
              [[NSImage it_imageNamed:halfName
                             forClass:self.class] it_verticallyFlippedImage];
          gTopRightCornerHalfImage =
              [gTopLeftCornerHalfImage it_horizontallyFlippedImage];
          gBottomLeftCornerHalfImage = [NSImage it_imageNamed:halfName
                                                     forClass:self.class];
          gBottomRightCornerHalfImage =
              [gBottomLeftCornerHalfImage it_horizontallyFlippedImage];
          ...
          gTopLeftCornerFullImage =
              [[NSImage it_imageNamed:fullName
                             forClass:self.class] it_verticallyFlippedImage];
          gTopRightCornerFullImage =
              [gTopLeftCornerFullImage it_horizontallyFlippedImage];
          gBottomLeftCornerFullImage = [NSImage it_imageNamed:fullName
                                                     forClass:self.class];
          gBottomRightCornerFullImage =
              [gBottomLeftCornerFullImage it_horizontallyFlippedImage];
        });
        // Half
        ...
        _topLeftCornerHalfRoundImageView =
            [NSImageView imageViewWithImage:topLeftCornerHalfImage];
        _topLeftCornerHalfRoundImageView.autoresizingMask =
            NSViewMinYMargin | NSViewMaxXMargin;
        _topLeftCornerHalfRoundImageView.alphaValue = 0.75;

        _topRightCornerHalfRoundImageView =
            [NSImageView imageViewWithImage:topRightCornerHalfImage];
        _topRightCornerHalfRoundImageView.alphaValue = 0.75;
        _topRightCornerHalfRoundImageView.autoresizingMask =
            NSViewMinYMargin | NSViewMinXMargin;

        _bottomLeftCornerHalfRoundImageView =
            [NSImageView imageViewWithImage:bottomLeftCornerHalfImage];
        _bottomLeftCornerHalfRoundImageView.alphaValue = 0.75;
        _bottomLeftCornerHalfRoundImageView.autoresizingMask =
            NSViewMaxYMargin | NSViewMaxXMargin;

        _bottomRightCornerHalfRoundImageView =
            [NSImageView imageViewWithImage:bottomRightCornerHalfImage];
        _bottomRightCornerHalfRoundImageView.alphaValue = 0.75;
        _bottomRightCornerHalfRoundImageView.autoresizingMask =
        ...
        _topLeftCornerFullRoundImageView =
            [NSImageView imageViewWithImage:topLeftCornerFullImage];
        _topLeftCornerFullRoundImageView.autoresizingMask =
            NSViewMinYMargin | NSViewMaxXMargin;
        _topLeftCornerFullRoundImageView.alphaValue = 0.75;

        _topRightCornerFullRoundImageView =
            [NSImageView imageViewWithImage:topRightCornerFullImage];
        _topRightCornerFullRoundImageView.alphaValue = 0.75;
        _topRightCornerFullRoundImageView.autoresizingMask =
            NSViewMinYMargin | NSViewMinXMargin;

        _bottomLeftCornerFullRoundImageView =
            [NSImageView imageViewWithImage:bottomLeftCornerFullImage];
        _bottomLeftCornerFullRoundImageView.alphaValue = 0.75;
        _bottomLeftCornerFullRoundImageView.autoresizingMask =
            NSViewMaxYMargin | NSViewMaxXMargin;

        _bottomRightCornerFullRoundImageView =
            [NSImageView imageViewWithImage:bottomRightCornerFullImage];
        _bottomRightCornerFullRoundImageView.alphaValue = 0.75;
        _bottomRightCornerFullRoundImageView.autoresizingMask =
            NSViewMaxYMargin | NSViewMinXMargin;
      ...
      }
      {
        ...
        _leftBorderView.autoresizingMask =
        ...
        _rightBorderView.autoresizingMask =
        ...
        _bottomBorderView.autoresizingMask =
    ...
    if (@available(macOS 10.15, *)) {
      ...
      // 10.14 only
      _workaroundView =
          [[SolidColorView alloc] initWithFrame:NSMakeRect(0, 0, 1, 1)
...
- (void)invalidateAutomaticTabBarBackingHiding {
  _tabBarBacking.hidesWhenTabBarHidden =
      [self.delegate rootTerminalViewShouldHideTabBarBackingWhenTabBarIsHidden];
...
- (NSView *)hitTest:(NSPoint)point {
  ...
  if (!_tabBarControlOnLoan && !_windowNumberLabel.hidden &&
      view == _windowNumberLabel && !_tabBarControl.isHidden) {
...
- (void)mouseUp:(NSEvent *)event {
  if (!_windowTitleLabel.hidden && event.clickCount == 2) {
    ...
    NSRect rect = NSMakeRect(0, self.bounds.size.height - titleBarHeight,
...
- (NSEdgeInsets)insetsForStoplightHotbox {
  if (![self.delegate enableStoplightHotbox]) {
    ...
    insets.bottom =
        -[self.delegate rootTerminalViewStoplightButtonsOffset:self];
  ...
  const CGFloat hotboxSideInset =
      (iTermStoplightHotboxWidth - iTermStandardButtonsViewWidth) / 2.0;
  const CGFloat hotboxVerticalInset =
      (iTermStoplightHotboxHeight - iTermStandardButtonsViewHeight) / 2.0;
  return NSEdgeInsetsMake(hotboxVerticalInset, hotboxSideInset,
                          hotboxVerticalInset, hotboxSideInset);
}
...
- (NSRect)frameForStandardWindowButtons {
  ...
  NSRect frame = NSMakeRect(
      insets.left, self.frame.size.height - height + insets.bottom + 1,
...
- (NSRect)frameForWindowNumberLabel {
  ...
  NSRect rect = NSMakeRect(
      NSMaxX(standardButtonsFrame) +
          iTermRootTerminalViewWindowNumberLabelMargin,
      myHeight - tabBarHeight + (tabBarHeight - capHeight) / 2.0 -
...
- (NSRect)frameForWindowTitleLabel {
  return [self frameForWindowTitleLabel:_windowTitleLabel getLeftAligned:nil];
}
...
- (NSRect)frameForWindowTitleLabel:(NSTextField *)textField
  ...
  const CGFloat mostGenerousInset =
      MAX(MAX(insets.left, insets.right),
          iTermRootTerminalViewWindowNumberLabelMargin);
  const CGFloat containerWidth =
      NSWidth(self.frame) -
      ([self shouldShowToolbelt] ? NSWidth(_toolbelt.frame) : 0);
  ...
  if (overage > 0) {
    ...
    if (leftAlignedPtr) {
      DLog(@"Use left alignment with text “%@” desiredWidth %@, proposedWidth "
           @"%@, containerWidth %@",
           textField.stringValue, @(desiredWidth), @(proposedWidth),
           @(containerWidth));
      *leftAlignedPtr = YES;
    }
  }
  NSRect rect = NSMakeRect(
      [self retinaRound:leftInset],
      [self retinaRound:myHeight - tabBarHeight +
                        (tabBarHeight - capHeight) / 2.0 - baselineOffset],
...
- (void)didChangeCompactness {
  ...
  const BOOL needCustomButtons =
      (ptyWindow.isCompact &&
       [self.delegate rootTerminalViewShouldDrawStoplightButtons]);
  if (!needCustomButtons) {
    ...
    if ([self.delegate rootTerminalViewShouldRevealStandardWindowButtons]) {
      for (int i = 0; i < self.numberOfWindowButtons; i++) {
        [[self.window standardWindowButton:self.windowButtonTypes[i]]
            setHidden:NO];
      }
    }
    return;
  ...
  // This is a compact window that gets special handling for the stoplights
  // buttons.
  CGFloat x = self.leftInsetForWindowButtons;
  const CGFloat stride = self.strideForWindowButtons;
  _standardWindowButtonsView = [[iTermStandardWindowButtonsView alloc]
      initWithFrame:[self frameForStandardWindowButtons]];
  _standardWindowButtonsView.autoresizingMask =
  ...
  for (int i = 0; i < self.numberOfWindowButtons; i++) {
    ...
    if (self.windowButtonTypes[i] == NSWindowZoomButton) {
      // 😠
      // In issue 8401 a user reported that option-clicking the zoom button
      // doesn't work after exiting full screen.
      //
      // A disassembly of -[NSWindow _setNeedsZoom:] shows that option-clicking
      // only works if
      // -[NSWindow _lastLeftHit] == -[NSWindow standardWindowButton:2]. So for
      // some reason, Apple intended option+zoom to only work with their own
      // zoom button.
      //
      ...
      //
      // Their analysis is different than mine. I see that _lastLeftHit is
      // actually MY button, which is not what they saw. I suspect a different
      // etiology.
      //
      // I don't recall why I implemented zoomButtonEvent: in the first place; I
      // suspect it was a less well-informed attempt to work around this issue
      // when I added compact windows originally. Since I can't use the "real"
      // button for this window, this seems like the only reasonable fix.
      //
...
- (NSRect)frameForTitleBackgroundView {
  ...
  return NSMakeRect(0, self.frame.size.height - height, self.frame.size.width,
                    height);
}
...
- (void)updateTitleAndBorderViews NS_AVAILABLE_MAC(10_14) {
  const BOOL wantsTitleBackgroundView =
      [_delegate rootTerminalViewShouldDrawWindowTitleInPlaceOfTabBar];
  if (wantsTitleBackgroundView) {
    if (!_titleBackgroundView) {
      _titleBackgroundView = [[iTermLayerBackedSolidColorView alloc]
          initWithFrame:self.frameForTitleBackgroundView];
      _titleBackgroundView.autoresizingMask =
          NSViewWidthSizable | NSViewMinYMargin;
    }
    _titleBackgroundView.color =
        [_delegate rootTerminalViewTabBarBackgroundColorIgnoringTabColor:NO];
...
- (void)updateBorderViews NS_AVAILABLE_MAC(10_14) {
  ...
  const BOOL fullThickness = self.effectiveAppearance.it_isDark ||
  ...
  const CGFloat radius = iTermWindowBorderRadius;
  {
    ...
    _topRightCornerHalfRoundImageView.frame =
        NSMakeRect(right, top, radius, radius);
    _bottomLeftCornerHalfRoundImageView.frame =
        NSMakeRect(0, bottom, radius, radius);
    _bottomRightCornerHalfRoundImageView.frame =
        NSMakeRect(right, bottom, radius, radius);

    _topLeftCornerFullRoundImageView.frame = NSMakeRect(0, top, radius, radius);
    _topRightCornerFullRoundImageView.frame =
        NSMakeRect(right, top, radius, radius);
    _bottomLeftCornerFullRoundImageView.frame =
        NSMakeRect(0, bottom, radius, radius);
    _bottomRightCornerFullRoundImageView.frame =
        NSMakeRect(right, bottom, radius, radius);
  }

  {
    ...
    _leftBorderView.frame =
        NSMakeRect(0, bottomInset, thickness,
                   self.bounds.size.height - topInset - bottomInset);

    _rightBorderView.frame =
        NSMakeRect(self.bounds.size.width - thickness, bottomInset, thickness,
                   self.bounds.size.height - topInset - bottomInset);
    _bottomBorderView.frame =
        NSMakeRect(leftInset, 0,
                   self.bounds.size.width - leftInset - rightInset, thickness);

    _topBorderView.frame =
        NSMakeRect(leftInset, self.bounds.size.height - thickness,
                   self.bounds.size.width - leftInset - rightInset, thickness);
  }

  _bottomLeftCornerHalfRoundImageView.hidden =
      !(haveLeft && haveBottom && !fullThickness);
  _bottomRightCornerHalfRoundImageView.hidden =
      !(haveRight && haveBottom && !fullThickness);
  _topLeftCornerHalfRoundImageView.hidden =
      !(haveLeft && haveTop && !fullThickness);
  _topRightCornerHalfRoundImageView.hidden =
      !(haveRight && haveTop && !fullThickness);

  _bottomLeftCornerFullRoundImageView.hidden =
      !(haveLeft && haveBottom && fullThickness);
  _bottomRightCornerFullRoundImageView.hidden =
      !(haveRight && haveBottom && fullThickness);
  _topLeftCornerFullRoundImageView.hidden =
      !(haveLeft && haveTop && fullThickness);
  _topRightCornerFullRoundImageView.hidden =
      !(haveRight && haveTop && fullThickness);
}
...
- (void)windowTitleDidChangeTo:(NSString *)title {
  ...
  [self setWindowTitleLabelToString:_windowTitle
                               icon:[self.delegate
                                            rootTerminalViewCurrentTabIcon]];
  if (!_windowTitleLabel.hidden) {
...
- (iTermTabBarControlView *)borrowTabBarControl {
  ...
  if (@available(macOS 10.14, *)) {
    ...
    // Fix size in case we just went from left-of to top-of since it's now going
    // full-width.
    [self.tabBarControl
        setTabLocation:[iTermPreferences intForKey:kPreferenceKeyTabPosition]];
    const CGFloat desiredHeight =
        [self.delegate rootTerminalViewHeightOfTabBar:self];
    _tabBarControl.height = desiredHeight;
    _tabBarControl.frame =
        NSMakeRect(0, 0, _tabBarControl.frame.size.width, desiredHeight);
...
- (void)windowNumberDidChangeTo:(NSNumber *)number {
  ...
  _windowNumberLabel.stringValue =
      [iTermWindowShortcutLabelTitlebarAccessoryViewController
          stringForOrdinal:number.intValue
...
- (void)setShowsWindowSize:(BOOL)showsWindowSize {
  ...
  _windowSizeView = [[iTermWindowSizeView alloc]
      initWithDetail:[self.delegate
                             rootTerminalViewWindowSizeViewDetailString]];
  [self addSubview:_windowSizeView];
  NSRect myBounds = self.bounds;
  _windowSizeView.frame = NSMakeRect(NSMidX(myBounds), NSMidY(myBounds), 0, 0);
  _windowSizeView.autoresizingMask = (NSViewMinXMargin | NSViewMaxXMargin |
                                      NSViewMinYMargin | NSViewMaxYMargin);
  [_windowSizeView
      setWindowSize:[self.delegate rootTerminalViewCurrentSessionSize]];
}
...
- (void)updateDivisionViewAndWindowNumberLabel {
  ...
  if (shouldBeVisible) {
    ...
    NSRect divisionViewFrame = NSMakeRect(
        0, NSMaxY(tabViewFrame), self.bounds.size.width, kDivisionViewHeight);
    if ([_delegate rootTerminalViewSharedStatusBarViewController] &&
        [iTermPreferences boolForKey:kPreferenceKeyStatusBarPosition] ==
    ...
    if (!_divisionView) {
      Class theClass = _useMetal ? [iTermLayerBackedSolidColorView class]
                                 : [SolidColorView class];
    ...
    case TAB_STYLE_LIGHT_HIGH_CONTRAST:
      if (@available(macOS 10.14, *)) {
        _divisionView.color =
            (self.window.isKeyWindow ? [NSColor colorWithCalibratedHue:1
                                                            saturation:0
                                                            brightness:0.70
                                                                 alpha:1]
                                     : [NSColor colorWithCalibratedHue:1
                                                            saturation:0
                                                            brightness:0.86
                                                                 alpha:1]);
      } else {
...
- (void)constrainToolbeltWidth {
  _toolbeltWidth =
      [self maximumToolbeltWidthForViewWidth:self.frame.size.width];
}
...
- (CGFloat)maximumToolbeltWidthForViewWidth:(CGFloat)viewWidth {
  ...
  return MAX(
      MIN(_toolbeltWidth, viewWidth * kMaximumToolbeltSizeAsFractionOfWindow),
      minSize);
}
...
- (NSRect)toolbeltFrameInWindow:(NSWindow *)thisWindow {
  ...
  NSRect toolbeltFrame =
      NSMakeRect(self.bounds.size.width - width - right, bottom, width,
...
- (BOOL)tabBarShouldBeVisibleWithAdditionalTabs:(int)numberOfAdditionalTabs {
  ...
  if ([_delegate tabBarAlwaysVisible]) {
    DLog(@"Tabbar should be visible because it is configured to always be "
         @"visible");
    return YES;
  }
  const BOOL result =
      [self.tabView numberOfTabViewItems] + numberOfAdditionalTabs > 1;
  DLog(@"returning %@", @(result));
  return result;
}

- (CGFloat)tabviewWidth {
  assert([iTermPreferences intForKey:kPreferenceKeyTabPosition] !=
             PSMTab_LeftTab ||
...
- (void)updateWindowNumberFont {
  if ([self tabBarShouldBeVisible]) {
    if (@available(macOS 10.16, *)) {
      _windowNumberLabel.font =
          [NSFont titleBarFontOfSize:[NSFont smallSystemFontSize]];
    } else {
      _windowNumberLabel.font =
...
- (void)layoutSubviewsWithVisibleTabBarForWindow:(NSWindow *)thisWindow
                                  inlineToolbelt:(BOOL)showToolbeltInline {
  assert(!_tabBarControlOnLoan);
  ...
  case PSMTab_LeftTab: {
    [self
        layoutSubviewsWithVisibleLeftTabBarAndInlineToolbelt:showToolbeltInline
                                                   forWindow:thisWindow];
  }
  }
}
...
- (void)layoutSubviewsWithHiddenTabBarForWindow:(NSWindow *)thisWindow {
  ...
  if ([self shouldLeaveEmptyAreaAtTop]) {
    DLog(@"Add tabbar control height to decoration height to leave an empty "
         @"area at the top.");
  ...
  const NSRect frame = NSMakeRect(
      [self leftBorderInset], decorationHeights.bottom, [self tabviewWidth],
      [[thisWindow contentView] frame].size.height - decorationHeights.top -
          decorationHeights.bottom);
  [self layoutStatusBar:&decorationHeights window:thisWindow frame:frame];
  NSRect tabViewFrame = NSMakeRect(
      [self leftBorderInset], decorationHeights.bottom, [self tabviewWidth],
      [[thisWindow contentView] frame].size.height - decorationHeights.top -
          decorationHeights.bottom);
  ...
  DLog(@"repositionWidgets - Set tab view frame to %@",
       NSStringFromRect(tabViewFrame));
  [self.tabView setFrame:tabViewFrame];
  [self updateDivisionViewAndWindowNumberLabel];

  // Even though it's not visible it needs an accurate number so we can compute
  // the proper window size when it appears.
  [self setLeftTabBarWidthFromPreferredWidth];

  if ([_delegate iTermTabBarWindowIsFullScreen]) {
    // When in full screen the insets must be reset even though the tab bar is
    // not visible.
    self.tabBarControl.insets = [self.delegate tabBarInsets];
  }
}

- (void)layoutSubviewsTopTabBarVisible:(BOOL)topTabBarVisible
                             forWindow:(NSWindow *)thisWindow {
  [self removeLeftTabBarDragHandle];
  iTermDecorationHeights decorationHeights = {
      .bottom = [self bottomBorderInset], .top = 0};
  if (!_tabBarControlOnLoan) {
    if (!self.tabBarControl.flashing) {
      decorationHeights.top += _tabBarControl.height;
    }
  ...
  const NSRect frame = NSMakeRect(
      [self leftBorderInset], decorationHeights.bottom, [self tabviewWidth],
      [[thisWindow contentView] frame].size.height - decorationHeights.bottom -
  ...
  NSRect tabViewFrame = NSMakeRect(
      [self leftBorderInset], temp.bottom, [self tabviewWidth],
  ...
  NSRect tabBarFrame =
      NSMakeRect(tabViewFrame.origin.x, NSMaxY(frame) - tabBarOffset,
                 tabViewFrame.size.width, _tabBarControl.height);
...
- (void)layoutSubviewsWithVisibleBottomTabBarForWindow:(NSWindow *)thisWindow {
  ...
  NSRect tabBarFrame =
      NSMakeRect([self leftBorderInset], [self bottomBorderInset],
                 [self tabviewWidth], _tabBarControl.height);
  self.tabBarControl.insets = [self.delegate tabBarInsets];
  [self setTabBarFrame:tabBarFrame];
  [self
      setTabBarControlAutoresizingMask:(NSViewWidthSizable | NSViewMaxYMargin)];
  iTermDecorationHeights decorationHeights = {.top = 0,
  ...
  NSRect frame = NSMakeRect(
      tabBarFrame.origin.x, decorationHeights.bottom, tabBarFrame.size.width,
      [thisWindow.contentView frame].size.height - decorationHeights.top -
          decorationHeights.bottom);
  [self layoutStatusBar:&decorationHeights window:thisWindow frame:frame];
  NSRect tabViewFrame = NSMakeRect(
  ...
  DLog(@"repositionWidgets - Set tab view frame to %@",
       NSStringFromRect(tabViewFrame));
  self.tabView.frame =
      [self tabViewFrameByShrinkingForFullScreenTabBar:tabViewFrame
                                                window:thisWindow];
  [self updateDivisionViewAndWindowNumberLabel];
}
...
- (NSRect)tabViewFrameByShrinkingForFullScreenTabBar:(NSRect)frame
  ...
  if ((thisWindow.styleMask & NSWindowStyleMaskFullSizeContentView) !=
...
- (void)setTabBarControlAutoresizingMask:(NSAutoresizingMaskOptions)mask {
  if (@available(macOS 10.14, *)) {
    if (_tabBarBacking) {
      ...
      _tabBarControl.autoresizingMask =
          (NSViewWidthSizable | NSViewHeightSizable);
      return;
    }
  }
...
- (void)layoutSubviewsWithVisibleLeftTabBarAndInlineToolbelt:
            (BOOL)showToolbeltInline
                                                   forWindow:
                                                       (NSWindow *)thisWindow {
  assert(!_tabBarControlOnLoan);
  [self setLeftTabBarWidthFromPreferredWidth];
  iTermDecorationHeights decorationHeights = {.top = 0, .bottom = 0};
  decorationHeights.bottom += [self bottomBorderInset];
  decorationHeights.top += [self topBorderInset];
  if (_delegate.divisionViewShouldBeVisible) {
    decorationHeights.top += kDivisionViewHeight;
  }
  NSRect tabBarFrame = NSMakeRect(
      [self leftBorderInset], decorationHeights.bottom, _leftTabBarWidth,
      [thisWindow.contentView frame].size.height - decorationHeights.bottom -
          decorationHeights.top);
  self.tabBarControl.insets = [self.delegate tabBarInsets];
  [self setTabBarFrame:tabBarFrame];
  ...
  const NSRect frame =
      NSMakeRect(NSMaxX(tabBarFrame) + xOffset, decorationHeights.bottom,
                 [thisWindow.contentView frame].size.width -
                     NSWidth(tabBarFrame) - widthAdjustment,
                 [thisWindow.contentView frame].size.height -
                     decorationHeights.bottom - decorationHeights.top);
  [self layoutStatusBar:&decorationHeights window:thisWindow frame:frame];
  NSRect tabViewFrame =
      NSMakeRect(NSMaxX(tabBarFrame) + xOffset, decorationHeights.bottom,
                 [thisWindow.contentView frame].size.width -
  ...
  NSRect leftTabBarDragHandleFrame =
      NSMakeRect(NSMaxX(self.tabBarControl.frame) - dragHandleWidth, 0,
                 dragHandleWidth, NSHeight(self.tabBarControl.frame));
  if (!self.leftTabBarDragHandle) {
    self.leftTabBarDragHandle =
        [[iTermDragHandleView alloc] initWithFrame:leftTabBarDragHandleFrame];
...
- (void)layoutWindowPaneDecorations {
  _windowNumberLabel.textColor =
      [_delegate rootTerminalViewTabBarTextColorForWindowNumber];
  _windowTitleLabel.textColor =
      [self.delegate rootTerminalViewTabBarTextColorForTitle];
  if (_windowTitleLabel.windowIcon) {
    [self setWindowTitleLabelToString:_windowTitleLabel.windowTitle
  ...
  if ([self.delegate enableStoplightHotbox]) {
    ...
    [_stoplightHotbox
        setFrameOrigin:NSMakePoint(0, self.frame.size.height -
                                          _stoplightHotbox.frame.size.height)];
  ...
  const BOOL hideWindowTitleLabel =
      ![self.delegate rootTerminalViewShouldDrawWindowTitleInPlaceOfTabBar];
...
- (void)layoutSubviews {
  ...
  // The tab view frame (calculated below) is based on the toolbelt's width. If
  // the toolbelt is too big for the current window size, you could end up with
  // a negative-width tab view frame.
  ...
  if (![self tabBarShouldBeVisible]) {
    ...
    [self layoutSubviewsWithVisibleTabBarForWindow:thisWindow
                                    inlineToolbelt:showToolbeltInline];
  }
  ...
  if ([iTermPreferences boolForKey:kPreferenceKeyHideTabNumber]) {
    [self.tabBarControl
        setCellMinWidth:[iTermAdvancedSettingsModel minCompactTabWidth]];
  } else {
    [self.tabBarControl
        setCellMinWidth:[iTermAdvancedSettingsModel minTabWidth]];
  }
  [self.tabBarControl
      setSizeCellsToFit:[iTermAdvancedSettingsModel useUnevenTabs]];
  [self.tabBarControl
      setStretchCellsToFit:[iTermPreferences
                               boolForKey:kPreferenceKeyStretchTabsToFillBar]];
  [self.tabBarControl
      setCellOptimumWidth:[iTermAdvancedSettingsModel optimumTabWidth]];
  self.tabBarControl.smartTruncation =
      [iTermAdvancedSettingsModel tabTitlesUseSmartTruncation];
...
- (CGFloat)leftTabBarWidthForPreferredWidth:(CGFloat)preferredWidth
  ...
  const CGFloat maximumWidth = MAX(
      1, contentWidth -
             [iTermPreferences intForKey:kPreferenceKeySideMargins] * 2 - 10);
  return MAX(MIN(maximumWidth, preferredWidth), minimumWidth);
}

- (CGFloat)leftTabBarWidthForPreferredWidth:(CGFloat)preferredWidth {
  return [self leftTabBarWidthForPreferredWidth:preferredWidth
                                   contentWidth:self.bounds.size.width];
}

- (void)setLeftTabBarWidthFromPreferredWidth {
  _leftTabBarWidth =
      [self leftTabBarWidthForPreferredWidth:_leftTabBarPreferredWidth];
}
...
- (NSRect)frameForStatusBarInContainingFrame:(NSRect)containingFrame {
  ...
  case iTermStatusBarPositionBottom:
    return NSMakeRect(NSMinX(containingFrame), NSMinY(containingFrame),
                      NSWidth(containingFrame), iTermGetStatusBarHeight());
  }
  return NSZeroRect;
}
...
- (void)updateDecorationHeightsForStatusBar:
    (iTermDecorationHeights *)decorationHeights {
  switch ([iTermPreferences
      unsignedIntegerForKey:kPreferenceKeyStatusBarPosition]) {
  case iTermStatusBarPositionTop: {
...
- (void)layoutIfStatusBarChanged {
  iTermStatusBarViewController *statusBarViewController =
      [_delegate rootTerminalViewSharedStatusBarViewController];
...
- (void)layoutStatusBar:(iTermDecorationHeights *)decorationHeights
  ...
  iTermStatusBarViewController *statusBarViewController =
      [_delegate rootTerminalViewSharedStatusBarViewController];
  NSRect statusBarFrame =
      [self frameForStatusBarInContainingFrame:containingFrame];
  ...
  if (_statusBarViewController.view != statusBarViewController.view ||
    ...
    if (!_statusBarContainer) {
      _statusBarContainer =
          [[iTermGenericStatusBarContainer alloc] initWithFrame:statusBarFrame];
    ...
    if (statusBarViewController.view.superview != _statusBarContainer) {
      ...
      statusBarViewController.view.autoresizingMask =
          (NSViewWidthSizable | NSViewHeightSizable);
      statusBarViewController.view.frame = _statusBarContainer.bounds;
    }
  }
  _statusBarContainer.autoresizingMask =
      [self statusBarContainerAutoresizingMask];
...
- (BOOL)iTermTabBarShouldHideBacking {
  ...
  if ([_delegate lionFullScreen] || [_delegate enteringLionFullscreen]) {
    if (isTop) {
      return
          [iTermPreferences boolForKey:kPreferenceKeyFlashTabBarInFullscreen];
    } else {
      return NO;
    }
  }
...
- (CGFloat)dragHandleView:(iTermDragHandleView *)dragHandle
  ...
  _leftTabBarPreferredWidth = round([self
      leftTabBarWidthForPreferredWidth:_leftTabBarPreferredWidth + delta]);
  [self layoutSubviews]; // This may modify _leftTabBarWidth if it's too big or
                         // too small.
  [[NSUserDefaults standardUserDefaults]
      setDouble:_leftTabBarPreferredWidth
...
- (BOOL)shouldRevealHotbox {
  ...
  const NSRect firstResponderFrame =
      [firstResponder convertRect:firstResponder.bounds toView:nil];
  const NSRect hotboxFrame =
      [_stoplightHotbox convertRect:_stoplightHotbox.bounds toView:nil];
...
- (NSColor *)genericStatusBarContainerBackgroundColor {
  return
      [self.delegate rootTerminalViewTabBarBackgroundColorIgnoringTabColor:YES];
}
