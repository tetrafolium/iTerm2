...
//
//  This test driver was used before XCTest was mature. It hangs around stll
//  because AppleScript tests aren't compatible with XCTest (they fail to get
//  the path to the iTerm2ForAppleScript app).
...
NSArray *AllTestClasses() { return @[ [AppleScriptTest class] ]; }
...
int main(int argc, const char *argv[]) {
  [[NSApplication sharedApplication]
      setDelegate:[[iTermApplicationDelegate alloc] init]];

  // Up to one of |include| or |exclude| may be non-nil. Set it to an array of
  // test Class objects. If include is set, exactly the listed tests will be
  // run. If exclude is set, all but the listed tests will run.
