...
// An opaque representation of a binding of (keyCode, modifiers) -> (target,
// selector, userData).
@class iTermHotKey;
...
// Start calling [target selector:userData:siblings:] when the hotkey is
// pressed. More than one hotkey may use the same keycode and modifiers. The
// siblings argument gives an array of other iTermHotKey*s that take the same
// keypress. The selector returns an array of iTermHotKey*s that were handled,
// and they won't have their actions invoked.
