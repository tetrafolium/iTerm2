...
NS_INLINE BOOL iseuccn(unsigned char c) { return (c >= 0x81 && c <= 0xfe); }

NS_INLINE BOOL isbig5(unsigned char c) { return (c >= 0xa1 && c <= 0xfe); }

NS_INLINE BOOL issjiskanji(unsigned char c) {
  return ((c >= 0x81 && c <= 0x9f) || (c >= 0xe0 && c <= 0xef));
}

NS_INLINE BOOL iseuckr(unsigned char c) { return (c >= 0xa1 && c <= 0xfe); }

NS_INLINE BOOL iscp949(unsigned char c) { return (c >= 0x81 && c <= 0xfe); }
