...
NSString *const kTmuxControllerRegistryDidChange =
    @"kTmuxControllerRegistryDidChange";
...
- (void)setController:(TmuxController *)controller
  ...
  [[NSNotificationCenter defaultCenter]
      postNotificationName:kTmuxControllerRegistryDidChange
                    object:client];
}
