...
+ (instancetype)newPleaseWaitWindowController {
  iTermBuildingScriptWindowController *pleaseWait = [[self alloc]
      initWithWindowNibName:@"iTermBuildingScriptWindowController"];
  ...
  NSPoint screenCenter =
      NSMakePoint(NSMinX(screenFrame) + NSWidth(screenFrame) / 2,
