...
extern NSString
    *const iTermVariableKeySessionName; // Registers the computed title
...
extern NSString
    *const iTermVariableKeySessionProfileName; // current profile name
extern NSString
    *const iTermVariableKeySessionAutoNameFormat; // Defaults to profile name.
                                                  // Then, most recent of
                                                  // manually set or icon name.
                                                  // Is an interpolated string.
extern NSString
    *const iTermVariableKeySessionAutoName; // Evaluated value of autoNameFormat
...
extern NSString *const
    iTermVariableKeySessionJob; // job name, not affected by modifying argv[0]
extern NSString *const
    iTermVariableKeySessionProcessTitle; // process title, affected by modifying
                                         // argv[0]. see issue 4214 for details.
extern NSString *const
    iTermVariableKeySessionCommandLine; // Current foreground job with arguments
extern NSString
    *const iTermVariableKeySessionPresentationName; // What's shown in the
                                                    // session title view
extern NSString
    *const iTermVariableKeySessionTmuxPaneTitle; // Evaluation of 'show-options
                                                 // -v -g set-titles-string'
extern NSString *const
    iTermVariableKeySessionTmuxRole; // Unset (normal session), "gateway" (where
                                     // you ran tmux -CC), or "client".
extern NSString *const
    iTermVariableKeySessionTmuxClientName; // Set on tmux gateways. Gives a name
                                           // for the tmux session.
extern NSString *const
    iTermVariableKeySessionTmuxWindowPane; // NSNumber. Window pane number. Set
                                           // if the session is a tmux session;
extern NSString *const
    iTermVariableKeySessionJobPid; // NSNumber. Process id of foreground job.
extern NSString
    *const iTermVariableKeySessionChildPid; // NSNumber. Process id of child of
                                            // session task.
extern NSString
    *const iTermVariableKeySessionTmuxStatusLeft; // String. Only set when in
                                                  // tmux integration mode.
extern NSString
    *const iTermVariableKeySessionTmuxStatusRight; // String. Only set when in
                                                   // tmux integration mode.
extern NSString
    *const iTermVariableKeySessionMouseReportingMode; // NSNumber (MouseMode)
extern NSString *const
    iTermVariableKeySessionBadge; // NSString. Evaluated badge swifty string.
extern NSString *const iTermVariableKeySessionTab; // NString. Containing tab.
extern NSString *const
    iTermVariableKeySessionSelection; // NSString. Containing selected text.
extern NSString
    *const iTermVariableKeySessionSelectionLength; // NSNumber. Contains length
                                                   // of selected text.
extern NSString
    *const iTermVariableKeySessionParent; // Session that was active when this
                                          // one was created, if any.
extern NSString
    *const iTermVariableKeySessionBellCount; // NSNumber. Number of times the
                                             // bell has tried to ring.
...
// WARNING: You almost never want to use this. It is useful if you need to get a
// known child out, as open quickly does to find the names of all user
// variables.
