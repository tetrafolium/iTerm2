...
- (void)setObjectsFromDictionary:(NSDictionary *)dictionary {
  for (NSString *key in dictionary.allKeys) {
    [self.delegate profilePreferencesViewController:self
                               willSetObjectWithKey:key];
  }
  Profile *profile = [_delegate profilePreferencesCurrentProfile];
  ProfileModel *model = [_delegate profilePreferencesCurrentModel];
  [iTermProfilePreferences setObjectsFromDictionary:dictionary
                                          inProfile:profile
                                              model:model];
}
...
- (void)setObject:(NSObject *)value forKey:(NSString *)key {
  ...
  Profile *profile = [_delegate profilePreferencesCurrentProfile];
  ProfileModel *model = [_delegate profilePreferencesCurrentModel];
  [iTermProfilePreferences setObject:value
                              forKey:key
                           inProfile:profile
                               model:model];
}
...
- (void)setBool:(BOOL)value forKey:(NSString *)key {
  ...
  Profile *profile = [_delegate profilePreferencesCurrentProfile];
  ProfileModel *model = [_delegate profilePreferencesCurrentModel];
  [iTermProfilePreferences setBool:value
                            forKey:key
                         inProfile:profile
                             model:model];
}
...
- (void)setInt:(int)value forKey:(NSString *)key {
  ...
  Profile *profile = [_delegate profilePreferencesCurrentProfile];
  ProfileModel *model = [_delegate profilePreferencesCurrentModel];
  [iTermProfilePreferences setInt:value
                           forKey:key
                        inProfile:profile
                            model:model];
}
...
- (void)setInteger:(NSInteger)value forKey:(NSString *)key {
  ...
  Profile *profile = [_delegate profilePreferencesCurrentProfile];
  ProfileModel *model = [_delegate profilePreferencesCurrentModel];
  [iTermProfilePreferences setInteger:value
                               forKey:key
                            inProfile:profile
                                model:model];
}
...
- (void)setUnsignedInteger:(NSUInteger)value forKey:(NSString *)key {
  ...
  Profile *profile = [_delegate profilePreferencesCurrentProfile];
  ProfileModel *model = [_delegate profilePreferencesCurrentModel];
  [iTermProfilePreferences setUnsignedInteger:value
                                       forKey:key
                                    inProfile:profile
                                        model:model];
}
...
- (void)setFloat:(double)value forKey:(NSString *)key {
  ...
  Profile *profile = [_delegate profilePreferencesCurrentProfile];
  ProfileModel *model = [_delegate profilePreferencesCurrentModel];
  [iTermProfilePreferences setFloat:value
                             forKey:key
                          inProfile:profile
                              model:model];
}
...
- (void)setDouble:(double)value forKey:(NSString *)key {
  ...
  Profile *profile = [_delegate profilePreferencesCurrentProfile];
  ProfileModel *model = [_delegate profilePreferencesCurrentModel];
  [iTermProfilePreferences setDouble:value
                              forKey:key
                           inProfile:profile
                               model:model];
}
...
- (void)setString:(NSString *)value forKey:(NSString *)key {
  ...
  Profile *profile = [_delegate profilePreferencesCurrentProfile];
  ProfileModel *model = [_delegate profilePreferencesCurrentModel];
  [iTermProfilePreferences setString:value
                              forKey:key
                           inProfile:profile
                               model:model];
}
...
- (BOOL)shouldUpdateOtherPanels {
  return [self.delegate profilePreferencesCurrentModel] ==
...
- (BOOL)defaultValueForKey:(NSString *)key
  ...
  return [iTermProfilePreferences defaultValueForKey:key
...
- (void)scrollViewToVisible:(NSView *)view {
  ...
  // Decide whether we're scrolling view or its enclosing scrollview to visible.
  // This happens when view is a tableview.
  NSView *viewToScroll;
