...
//
// Optionally, it may have a function that computes its value (set in
// +computedObjectDictionary) and the view controller may customize how its
// control's appearance changes dynamically.
...
NSString *const kPreferenceKeyOpenArrangementAtStartup =
    @"OpenArrangementAtStartup";
NSString *const kPreferenceKeyOpenNoWindowsAtStartup =
    @"OpenNoWindowsAtStartup";
NSString *const kPreferenceKeyQuitWhenAllWindowsClosed =
    @"QuitWhenAllWindowsClosed";
NSString *const kPreferenceKeyConfirmClosingMultipleTabs =
    @"OnlyWhenMoreTabs"; // The key predates split panes
NSString *const kPreferenceKeyPromptOnQuit = @"PromptOnQuit";
NSString *const kPreferenceKeyPromptOnQuitEvenIfThereAreNoWindows =
    @"PromptOnQuitEvenIfThereAreNoWindows";
NSString *const kPreferenceKeyInstantReplayMemoryMegabytes = @"IRMemory";
NSString *const kPreferenceKeySavePasteAndCommandHistory =
    @"SavePasteHistory"; // The key predates command history
NSString *const kPreferenceKeyAddBonjourHostsToProfiles =
    @"EnableRendezvous"; // The key predates the name Bonjour
NSString *const kPreferenceKeyCheckForUpdatesAutomatically =
    @"SUEnableAutomaticChecks"; // Key defined by Sparkle
NSString *const kPreferenceKeyCheckForTestReleases = @"CheckTestRelease";
NSString *const kPreferenceKeyLoadPrefsFromCustomFolder =
    @"LoadPrefsFromCustomFolder";

// This pref was originally a suppressable warning plus a user default, which is
// why it's in two parts.

// 0 = Save, 1 = Lose changes
NSString *const kPreferenceKeyNeverRemindPrefsChangesLostForFileSelection =
    @"NoSyncNeverRemindPrefsChangesLostForFile_selection";

// YES = apply preference from above key, NO = ask on exit if changes exist
NSString *const kPreferenceKeyNeverRemindPrefsChangesLostForFileHaveSelection =
    @"NoSyncNeverRemindPrefsChangesLostForFile";

NSString *const iTermMetalSettingsDidChangeNotification =
    @"iTermMetalSettingsDidChangeNotification";
...
NSString *const kPreferenceKeyAllowClipboardAccessFromTerminal =
    @"AllowClipboardAccess";
NSString *const kPreferenceKeyCharactersConsideredPartOfAWordForSelection =
    @"WordCharacters";
NSString *const kPreferenceKeySmartWindowPlacement = @"SmartPlacement";
NSString *const kPreferenceKeyAdjustWindowForFontSizeChange =
    @"AdjustWindowForFontSizeChange";
...
NSString *const kPreferenceKeySeparateWindowTitlePerTab =
...
NSString *const kPreferenceKeyAutoHideTmuxClientSession =
...
NSString *const kPreferenceKeyTmuxUnpauseAutomatically =
    @"TmuxUnpauseAutomatically";
NSString *const kPreferenceKeyTmuxWarnBeforePausing = @"TmuxWarnBeforePausing";

NSString *const kPreferenceKeyUseMetal = @"UseMetal";
NSString *const kPreferenceKeyDisableMetalWhenUnplugged =
    @"disableMetalWhenUnplugged";
NSString *const kPreferenceKeyPreferIntegratedGPU = @"preferIntegratedGPU";
NSString *const kPreferenceKeyMetalMaximizeThroughput =
...
NSString *const kPreferenceKeyTabStyle =
    @"TabStyleWithAutomaticOption"; // Pre-10.14
...
NSString *const kPreferenceKeyPreserveWindowSizeWhenTabBarVisibilityChanges =
    @"PreserveWindowSizeWhenTabBarVisibilityChanges";
NSString *const kPreferenceKeyHideTabCloseButton =
    @"HideTabCloseButton"; // Deprecated
NSString *const kPreferenceKeyTabsHaveCloseButton = @"TabsHaveCloseButton";
NSString *const kPreferenceKeyHideTabActivityIndicator =
    @"HideActivityIndicator";
NSString *const kPreferenceKeyShowNewOutputIndicator =
    @"ShowNewOutputIndicator";
NSString *const kPreferenceKeyShowPaneTitles = @"ShowPaneTitles";
NSString *const kPreferenceKeyPerPaneBackgroundImage =
    @"PerPaneBackgroundImage";
NSString *const kPreferenceKeyStretchTabsToFillBar = @"StretchTabsToFillBar";
NSString *const kPreferenceKeyHideMenuBarInFullscreen =
    @"HideMenuBarInFullscreen";
NSString *const kPreferenceKeyUIElement = @"HideFromDockAndAppSwitcher";
NSString *const kPreferenceKeyUIElementRequiresHotkeys =
    @"UIElementRequiresHotkeys";
NSString *const kPreferenceKeyFlashTabBarInFullscreen =
...
NSString *const kPreferenceKeyShowProfileName_Deprecated =
    @"ShowBookmarkName"; // The key predates bookmarks being renamed to profiles
...
NSString *const kPreferenceKeyDisableFullscreenTransparencyByDefault =
...
NSString *const kPreferenceKeySeparateStatusBarsPerPane =
...
NSString *const kPreferenceKeyEmulateUSKeyboard =
    @"UseVirtualKeyCodesForDetectingDigits";

NSString *const kPreferenceKeyHotkeyEnabled = @"Hotkey";
NSString *const kPreferenceKeyHotKeyCode = @"HotkeyCode";
NSString *const kPreferenceKeyHotkeyCharacter =
    @"HotkeyChar"; // Nonzero if hotkey char is set.
NSString *const kPreferenceKeyHotkeyModifiers = @"HotkeyModifiers";
NSString *const kPreferenceKeyEnableHapticFeedbackForEsc =
...
NSString *const kPreferenceKeyHotKeyTogglesWindow_Deprecated =
    @"HotKeyTogglesWindow"; // deprecated
NSString *const kPreferenceKeyHotkeyProfileGuid_Deprecated =
    @"HotKeyBookmark"; // deprecated
NSString *const kPreferenceKeyHotkeyAutoHides_Deprecated =
    @"HotkeyAutoHides"; // deprecated

NSString *const kPreferenceKeyCmdClickOpensURLs = @"CommandSelection";
NSString *const kPreferenceKeyControlLeftClickBypassesContextMenu =
    @"PassOnControlClick";
NSString *const kPreferenceKeyOptionClickMovesCursor =
    @"OptionClickMovesCursor";
NSString *const kPreferenceKeyThreeFingerEmulatesMiddle =
    @"ThreeFingerEmulates";
NSString *const kPreferenceKeyFocusFollowsMouse = @"FocusFollowsMouse";
NSString *const kPreferenceKeyTripleClickSelectsFullWrappedLines =
    @"TripleClickSelectsFullWrappedLines";
NSString *const kPreferenceKeyDoubleClickPerformsSmartSelection =
    @"DoubleClickPerformsSmartSelection";
NSString *const kPreferenceKeyEnterCopyModeAutomatically =
    @"EnterCopyModeAutomatically";
NSString *const kPreferenceKeyFocusOnRightOrMiddleClick =
    @"FocusOnRightOrMiddleClick";

NSString *const kPreferenceKeyAppVersion =
    @"iTerm Version"; // Excluded from syncing
NSString *const kPreferenceKeyAllAppVersions =
    @"NoSyncAllAppVersions"; // Array of known iTerm2 versions this user has
...
NSString *const kPreferenceKeyPasteSpecialChunkDelay =
    @"PasteSpecialChunkDelay";
NSString *const kPreferenceKeyPasteSpecialSpacesPerTab =
    @"NumberOfSpacesPerTab";
NSString *const kPreferenceKeyPasteSpecialTabTransform = @"TabTransform";
NSString *const kPreferenceKeyPasteSpecialEscapeShellCharsWithBackslash =
    @"EscapeShellCharsWithBackslash";
NSString *const kPreferenceKeyPasteSpecialConvertUnicodePunctuation =
    @"ConvertUnicodePunctuation";
NSString *const kPreferenceKeyPasteSpecialConvertDosNewlines =
    @"ConvertDosNewlines";
NSString *const kPreferenceKeyPasteSpecialRemoveControlCodes =
    @"RemoveControlCodes";
NSString *const kPreferenceKeyPasteSpecialBracketedPasteMode =
    @"BracketedPasteMode";
NSString *const kPreferencesKeyPasteSpecialUseRegexSubstitution =
    @"PasteSpecialUseRegexSubstitution";
NSString *const kPreferencesKeyPasteSpecialRegex = @"PasteSpecialRegex";
NSString *const kPreferencesKeyPasteSpecialSubstitution =
    @"PasteSpecialSubstitution";
NSString *const kPreferenceKeyLeftTabBarWidth = @"LeftTabBarWidth";

NSString *const kPreferenceKeyPasteWarningNumberOfSpacesPerTab =
    @"PasteTabToStringTabStopSize";

NSString *const kPreferenceKeyShowFullscreenTabBar = @"ShowFullScreenTabBar";
NSString *const kPreferenceKeyHotkeyMigratedFromSingleToMulti =
    @"HotkeyMigratedFromSingleToMulti";
NSString *const kPreferenceKeyDefaultToolbeltWidth = @"Default Toolbelt Width";
NSString *const kPreferenceKeySizeChangesAffectProfile =
    @"Size Changes Affect Profile";
...
+ (NSString *)appVersionBeforeThisLaunch {
  if (!sPreviousVersion) {
    ...
    sPreviousVersion =
        [[userDefaults objectForKey:kPreferenceKeyAppVersion] copy];
  }
...
+ (NSSet<NSString *> *)allAppVersionsUsedOnThisMachine {
  ...
  dispatch_once(&onceToken, ^{
    versions =
        [NSSet setWithArray:[[NSUserDefaults standardUserDefaults]
                                objectForKey:kPreferenceKeyAllAppVersions]
                                ?: @[]];
  });
  return versions;
}
...
+ (void)initializeAppVersionBeforeThisLaunch:(NSString *)thisVersion {
  ...
  [[NSUserDefaults standardUserDefaults] setObject:thisVersion
                                            forKey:kPreferenceKeyAppVersion];
  NSProcessInfo *processInfo = [NSProcessInfo processInfo];
  [[NSUserDefaults standardUserDefaults]
      setObject:processInfo.operatingSystemVersionString
...
+ (void)initializeAllAppVersionsUsedOnThisMachine:(NSString *)thisVersion {
  ...
  NSMutableSet *allVersions =
      [NSMutableSet setWithArray:[[NSUserDefaults standardUserDefaults]
                                     objectForKey:kPreferenceKeyAllAppVersions]
                                     ?: @[]];
  ...
  [[NSUserDefaults standardUserDefaults]
      setObject:allVersions.allObjects
         forKey:kPreferenceKeyAllAppVersions];
}
...
+ (NSDictionary *)systemPreferenceOverrides {
  return @{
    ...
    // -[PTYScrollView _makeUnderTitlebarView] and have it return nil. That
    // works
    // in testing but could break things pretty badly.
    //
    // I found this undocumented setting while disassembling the caller to
    ...
    // macOS does an insane thing and looks for views that might possibly be
    // trying to do something
    // clever with scrollers and then if it finds them changes to legacy
    // scrollers. Quothe the
    // mailing list
    // https://lists.apple.com/archives/cocoa-dev/2012/Mar/msg00939.html
    //  NSScrollView does various checks to see if the App is trying to put
    //  placards in the
    //  scroller area. If NSScrollView thinks there are placards, then it
    //  reverts back to legacy
    //  scrollers for compatibility. Some apps have been known to do this via a
    //  sibling view
    //  instead of a subview. This is why it intermittently happens during your
    //  animation as
    //  your sibling views momentarily overlap
    //
    // In addition to being a bad idea, it is poorly implemented and the
    // scrollers randomly
    // have the wrong light/dark appearance, in addition to other visual
    // glitches that words
    // can't describe.
    //
    // Well, I am trying to do something clever and I damn well want it to work.
    // With a bit of
    // the old disassembler, I found this user default which seems to turn off
    // the stupid.
...
+ (void)initializeUserDefaults {
  NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
  [[self systemPreferenceOverrides]
  ...
  [[iTermRemotePreferences sharedInstance]
      copyRemotePrefsToLocalUserDefaultsPreserving:
          self.systemPreferenceOverrides.allKeys];
}
...
+ (BOOL)defaultValueForKey:(NSString *)key
      isCompatibleWithType:(PreferenceInfoType)type {
  ...
  case kPreferenceInfoTypeInvertedCheckbox:
    return ([defaultValue isKindOfClass:[NSNumber class]] &&
            ([defaultValue intValue] == YES || [defaultValue intValue] == NO));
...
// Returns a dictionary from key to a ^id() block. The block will return an
// object value for the preference or nil if the normal path (of taking the
// NSUserDefaults value or +defaultObjectForKey) should be used.
...
+ (void)setObject:(id)object forKey:(NSString *)key {
  ...
  [[iTermPreferenceDidChangeNotification notificationWithKey:key
                                                       value:object] post];
}
...
+ (void)addObserverForKey:(NSString *)key
                    block:(void (^)(id before, id after))block {
  if (!gObservers) {
...
+ (NSString *)computedCustomFolder {
  NSString *prefsCustomFolder =
      [self uncomputedObjectForKey:kPreferenceKeyCustomFolder];
...
+ (NSString *)computedWordChars {
  NSString *wordChars =
      [self uncomputedObjectForKey:
                kPreferenceKeyCharactersConsideredPartOfAWordForSelection];
  return wordChars ?: @"";
}

// Migrates all pre-10.14 users now on 10.14 to automatic, since anything else
// looks bad.
+ (NSNumber *)computedTabStyle {
  NSNumber *value;
  value = [[NSUserDefaults standardUserDefaults]
      objectForKey:kPreferenceKeyTabStyle];
  if (value) {
    return value;
  }
  ...
  value = [[NSUserDefaults standardUserDefaults]
      objectForKey:kPreferenceKeyTabStyle_Deprecated];
  if (value) {
    return value;
  } else {
...
+ (NSNumber *)computedTabsHaveCloseButton {
  NSNumber *value;
  value = [[NSUserDefaults standardUserDefaults]
      objectForKey:kPreferenceKeyTabsHaveCloseButton];
  if (value) {
    return value;
  }

  value = [[NSUserDefaults standardUserDefaults]
      objectForKey:@"eliminateCloseButtons"];
  if (value) {
...
+ (NSNumber *)computedUseMetal {
  NSNumber *value;
  value = [[NSUserDefaults standardUserDefaults]
      objectForKey:kPreferenceKeyUseMetal];
  if (value) {
    return value;
  }
...
#define FAST_BOOL_ACCESSOR(accessorName, userDefaultsKey)                      \
  +(BOOL)accessorName {                                                        \
    static iTermPreferencesBoolCache cache = {                                 \
        .key = userDefaultsKey, .value = NO, .onceToken = 0};                  \
...
+ (BOOL)boolWithCache:(iTermPreferencesBoolCache *)cache {
  dispatch_once(&cache->onceToken, ^{
    ...
    [[self sharedObserver] observeKey:cache->key
                                block:^{
                                  cache->value = [self boolForKey:cache->key];
                                }];
  });
...
FAST_BOOL_ACCESSOR(hideTabActivityIndicator,
                   kPreferenceKeyHideTabActivityIndicator)
FAST_BOOL_ACCESSOR(maximizeMetalThroughput,
