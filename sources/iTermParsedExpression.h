...
typedef NS_ENUM(NSUInteger, iTermParsedExpressionType) {
  ...
  iTermParsedExpressionTypeString, // This only occurs inside interpolated
                                   // string parts arrays.
  ...
  // These two are only produced if you request an AST from the expression
  // parser
...
@interface iTermExpressionParserArrayDereferencePlaceholder
    : NSObject <iTermExpressionParserPlaceholder>
@property(nonatomic, readonly) NSInteger index;
- (instancetype)initWithPath:(NSString *)path index:(NSInteger)index;
@end

@interface iTermExpressionParserVariableReferencePlaceholder
    : NSObject <iTermExpressionParserPlaceholder>
...
@property(nonatomic, strong, readonly)
    NSArray<iTermParsedExpression *> *arrayOfExpressions;
...
@property(nonatomic, strong, readonly) id<iTermExpressionParserPlaceholder>
    placeholder;
...
- (instancetype)initWithInterpolatedStringParts:
    (NSArray<iTermParsedExpression *> *)parts;
