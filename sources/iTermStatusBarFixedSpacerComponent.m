...
static NSString *const iTermStatusBarFixedSpacerComponentWidthKnob =
    @"iTermStatusBarFixedSpacerComponentWidthKnob";
...
- (CGFloat)widthInDictionary:(NSDictionary *)knobValues {
  return [knobValues[iTermStatusBarFixedSpacerComponentWidthKnob] doubleValue]
             ?: 5;
}
...
- (NSArray<iTermStatusBarComponentKnob *> *)statusBarComponentKnobs {
  ...
  iTermStatusBarComponentKnob *widthKnob = [[iTermStatusBarComponentKnob alloc]
      initWithLabelText:@"Width"
...
+ (NSDictionary *)statusBarComponentDefaultKnobs {
  ...
  knobs = [knobs
      dictionaryBySettingObject:@(iTermStatusBarBaseComponentDefaultPriority)
