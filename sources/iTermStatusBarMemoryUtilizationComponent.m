...
- (instancetype)
  ...
  if (self) {
    ...
    [[iTermMemoryUtilization sharedInstance] addSubscriber:self
                                                     block:^(double value) {
...
- (NSImage *)statusBarComponentIcon {
  return [NSImage it_cacheableImageNamed:@"StatusBarIconRAM"
                                forClass:[self class]];
}
...
- (iTermStatusBarSparklinesModel *)sparklinesModel {
  NSArray<NSNumber *> *values =
      [[iTermMemoryUtilization sharedInstance] samples];
...
- (long long)currentEstimate {
  ...
  return last.doubleValue *
         [[iTermMemoryUtilization sharedInstance] availableMemory];
}
