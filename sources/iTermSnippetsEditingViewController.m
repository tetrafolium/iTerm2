...
static NSString *const iTermSnippetsEditingPasteboardType =
    @"iTermSnippetsEditingPasteboardType";
...
@interface iTermSnippetsEditingViewController () <NSTableViewDataSource,
                                                  NSTableViewDelegate>
@end
...
- (BOOL)tableView:(NSTableView *)tableView
  ...
  [pboard declareTypes:@[ iTermSnippetsEditingPasteboardType ] owner:self];
  ...
  [pboard setPropertyList:plist forType:iTermSnippetsEditingPasteboardType];
  return YES;
}
...
- (BOOL)tableView:(NSTableView *)aTableView
  ...
  NSArray<NSNumber *> *identifiers =
      [pboard propertyListForType:iTermSnippetsEditingPasteboardType];
