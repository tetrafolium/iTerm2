...
- (CPToken *)recogniseTokenInString:(NSString *)tokenString
  ...
  iTermSwiftyStringParser *parser =
      [[iTermSwiftyStringParser alloc] initWithString:substring];
  ...
  *tokenPosition += end + self.startQuote.length + self.endQuote.length;
  iTermSwiftyStringToken *token = [[iTermSwiftyStringToken alloc]
      initWithContent:[substring substringToIndex:end]
