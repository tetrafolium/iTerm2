...
- (instancetype)init {
  return [super initWithNibName:@"NumberOfSpacesAccessoryView"
                         bundle:[NSBundle bundleForClass:self.class]];
}

- (void)awakeFromNib {
  self.numberOfSpaces = [iTermPreferences
      intForKey:kPreferenceKeyPasteWarningNumberOfSpacesPerTab];
}

- (void)saveToUserDefaults {
  [iTermPreferences setInt:_numberOfSpaces
                    forKey:kPreferenceKeyPasteWarningNumberOfSpacesPerTab];
}
