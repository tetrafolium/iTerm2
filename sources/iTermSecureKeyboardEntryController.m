...
NSString *const iTermDidToggleSecureInputNotification =
    @"iTermDidToggleSecureInputNotification";
...
- (BOOL)currentSessionAtPasswordPrompt {
  ...
  if (![firstResponder
          conformsToProtocol:@protocol(iTermSecureInputRequesting)]) {
    return NO;
  }
  id<iTermSecureInputRequesting> requesting =
      (id<iTermSecureInputRequesting>)firstResponder;
...
- (void)update {
  ...
  [[NSNotificationCenter defaultCenter]
      postNotificationName:iTermDidToggleSecureInputNotification
                    object:nil];
