...
static iTermLABColor BackgroundLAB(LightnessAndAngle laa) {
  const iTermLABColor lab = {.l = 100.0 - laa.l,
...
- (instancetype)initWithDefaultTextColor:(NSColor *)defaultTextColor
  ...
  self = [super init];
  if (self) {
    const iTermLABColor defaultBackgroundLAB =
        [defaultBackgroundColor labColor];
    ...
    } while (fabs(backgroundLAB.l / 100.0 - defaultBackgroundLAB.l / 100.0) <
             minimumDifference);
