...
static NSMutableDictionary<NSString *, NSMutableArray<iTermUserDefaultsBlock> *>
  ...
  static NSMutableDictionary<NSString *,
                             NSMutableArray<iTermUserDefaultsBlock> *> *blocks;
...
- (void)it_addObserverForKey:(NSString *)key
  ...
  [iTermUserDefaultsObserverBlocks() it_addObject:block
                             toMutableArrayForKey:key];
...
- (void)observeValueForKeyPath:(NSString *)keyPath
  ...
  if (context == &iTermUserDefaultsKVOKey) {
    NSMutableDictionary<NSString *, NSMutableArray<iTermUserDefaultsBlock> *>
        *blocks = iTermUserDefaultsObserverBlocks();
