...
- (void)contextMenu:(iTermTextViewContextMenuHelper *)contextMenu
          saveImage:(iTermImageInfo *)image;
- (void)contextMenu:(iTermTextViewContextMenuHelper *)contextMenu
          copyImage:(iTermImageInfo *)image;
- (void)contextMenu:(iTermTextViewContextMenuHelper *)contextMenu
          openImage:(iTermImageInfo *)image;
- (void)contextMenu:(iTermTextViewContextMenuHelper *)contextMenu
       inspectImage:(iTermImageInfo *)image;
- (void)contextMenu:(iTermTextViewContextMenuHelper *)contextMenu
    toggleAnimationOfImage:(iTermImageInfo *)image;
...
// Set when a context menu opens, nilled when it closes. If the data source
// changes between when we ask the context menu to open and when the main thread
// enters a tracking runloop, the text under the selection can change. We want
// to respect what we show while the context menu is open. See issue 4048.
@property(nullable, nonatomic, readonly) NSString *savedSelectedText;
@property(nonatomic, readonly) NSDictionary<NSNumber *, NSString *>
