...
- (BOOL)isEqual:(id)object {
  ...
  return [NSObject object:_first isEqualToObject:other->_first] &&
         [NSObject object:_second isEqualToObject:other->_second];
}
...
- (instancetype)initPrivate:(void (^NS_NOESCAPE)(id<iTermPromiseSeal>))block {
  ...
  iTermPromiseSeal *seal = [[iTermPromiseSeal alloc]
      initWithObserver:^(iTermOr<id, NSError *> * or) {
        [or
            whenFirst:^(id object) {
