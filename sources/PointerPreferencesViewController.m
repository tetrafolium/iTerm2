...
NSString *const kPointerPrefsChangedNotification =
    @"kPointerPrefsChangedNotification";
NSString *const kPointerPrefsSemanticHistoryEnabledChangedNotification =
    @"kPointerPrefsSemanticHistoryEnabledChangedNotification";
...
@implementation PointerPreferencesViewController {
  ...
  // Control-click doesn't open the context menu, is mouse-reported as right
  // click.
