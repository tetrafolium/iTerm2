...
/*!
 * @abstract				Initializes the node using the specified
 *data and binds this node to the specified key.
 * @discussion				The node will have level 1, which is the
 *default when adding a node to the AA tree.
 *
...
/*!
 * @abstract				Adds the node in-order to the specified
 * array.
 */
 ...
 * @discussion				First display the right child, using a
 *bigger indent, then display the node itself, using the specified indent, and
 *lastly display the left node, using a bigger indent.
 *
