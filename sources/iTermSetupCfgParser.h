...
// This thing is a hack to avoid running executable code while installing a
// script. The user has to have a chance to inspect what they installed before
// it has the chance to do any damage. It wants a install_requires=[...] all one
// one line containing a list of strings quoted with ' or " and delimited by
// commas. Version numbers aren't supported, but that could be added later.
