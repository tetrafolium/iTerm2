...
- (void)loadView {
  self.view = [[[TransferrableFileMenuItemView alloc]
...
- (void)update {
  TransferrableFileMenuItemView *view =
      (TransferrableFileMenuItemView *)[self view];
...
- (NSString *)stringForStatus:(TransferrableFileStatus)status {
  ...
  case kTransferrableFileStatusFinishedWithError:
    return [NSString
        stringWithFormat:@"Failed with error “%@”", [_transferrableFile error]];
  case kTransferrableFileStatusCancelling:
...
- (NSTimeInterval)timeSinceLastStatusChange {
  return [NSDate timeIntervalSinceReferenceDate] -
         [_transferrableFile timeOfLastStatusChange];
}
