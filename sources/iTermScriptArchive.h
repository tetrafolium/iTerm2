...
// Trusted scripts may specify that they prefer to be in autolaunch and user
// will be prompted. If offerAutoLaunch is set, then even non-trusted scripts
// will prompt to move to autolaunch.
