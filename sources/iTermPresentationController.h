...
// Show or hide the dock and menu bar by checking the state of the app and all
// managed windows and determining what the state ought to be, and then updating
// the application presentation options.
- (void)update;
