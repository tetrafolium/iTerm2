 ...
 *
 * Syntax trees carry the rule that was matched to create the tree and the child
 * elements that in order match up with the right hand side of the rule.
 */
 ...
 * -syntaxTreeWithRule:children:tagValues: instead.
 * @see syntaxTreeWithRule:children:tagValues
 */
+ (id)syntaxTreeWithRule:(CPRule *)nonTerminal
                children:(NSArray *)children
    __attribute__((
        deprecated("use +syntaxTreeWithRule:children:tagValues: instead.")));
 ...
 */
- (id)initWithRule:(CPRule *)nonTerminal
          children:(NSArray *)children __attribute__((deprecated(
                       "use +initWithRule:children:tagValues: instead.")));
