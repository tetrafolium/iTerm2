 ...
 */
- (void)channel:(nonnull NMSSHChannel *)channel
    didReadData:(nonnull NSString *)message;
 ...
 */
- (void)channel:(nonnull NMSSHChannel *)channel
    didReadError:(nonnull NSString *)error;
 ...
 */
- (void)channel:(nonnull NMSSHChannel *)channel
    didReadRawData:(nonnull NSData *)data;
 ...
 */
- (void)channel:(nonnull NMSSHChannel *)channel
    didReadRawError:(nonnull NSData *)error;
