...
typedef enum {
  ...
  // 729, 730 seem to be process deactivated / activated - but only for this
  // process 731 seems to be this process hidden or shown
...
//! The data sent with kCGSNotificationAppUnresponsive and
//! kCGSNotificationAppResponsive.
typedef struct {
#if __BIG_ENDIAN__
...
CG_EXTERN CGError CGSRemoveNotifyProc(CGSNotifyProcPtr proc,
                                      CGSNotificationType type, void *userData);
