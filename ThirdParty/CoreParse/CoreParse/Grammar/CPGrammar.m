...
@interface CPBNFParserDelegate
    : NSObject <CPTokeniserDelegate, CPParserDelegate>
...
- (id)parser:(CPParser *)parser
  ...
  case 2: {
    ...
    for (CPRule *r in rules) {
      [r setTag:[[(CPNumberToken *)[children objectAtIndex:0] number]
                    intValue]];
    }
    return rules;
  }
  ...
  case 4: {
    ...
    for (NSArray *rhs in arrs) {
      NSString *name =
          [(CPIdentifierToken *)[children objectAtIndex:0] identifier];
      Class c = NSClassFromString(name);
      CPRule *rule =
          nil == c || ![c conformsToProtocol:@protocol(CPParseResult)]
              ? [CPRule ruleWithName:name rightHandSideElements:rhs]
              : [CPRule ruleWithName:name
                    rightHandSideElements:rhs
                      representitiveClass:c];
  ...
  case 11: {
    ...
    if ([i isRHSItem]) {
      ...
      [newI setAlternatives:[NSArray
                                arrayWithObject:[NSArray arrayWithObject:i]]];
      [newI setRepeats:NO];
  ...
  case 13: {
    ...
    [i setAlternatives:[NSArray
                           arrayWithObject:
                               [NSArray arrayWithObject:[children
                                                            objectAtIndex:0]]]];
  ...
  case 20:
    ...
    return [children objectAtIndex:0];
  case 21:
    return [CPGrammarSymbol
        nonTerminalWithName:[(CPIdentifierToken *)[children objectAtIndex:1]
                                identifier]];
  case 22:
    return [CPGrammarSymbol
        terminalWithName:[(CPQuotedToken *)[children objectAtIndex:0] content]];
  default:
    return syntaxTree;
  }
}
...
- (CPRecoveryAction *)parser:(CPParser *)parser
  ...
  [self setErr:[NSError
                   errorWithDomain:CPEBNFParserErrorDomain
                              code:CPErrorCodeCouldNotParseEBNF
                          userInfo:[NSDictionary
                                       dictionaryWithObjectsAndKeys:
                                           [NSString
                                               stringWithFormat:
                                                   @"Could not parse EBNF for "
                                                   @"grammar.  %ld:%ld: Found "
                                                   @"%@, Expected %@.",
                                                   (long)[t lineNumber] + 1,
                                                   (long)[t columnNumber] + 1,
                                                   t, acceptableTokens],
...
+ (id)grammarWithStart:(NSString *)start
        backusNaurForm:(NSString *)bnf
                 error:(NSError **)error {
...
- (id)initWithStart:(NSString *)initStart
     backusNaurForm:(NSString *)bnf
              error:(NSError **)error {
  ...
  CPRule *ruleset1 = [CPRule
               ruleWithName:@"ruleset"
      rightHandSideElements:
          [NSArray
              arrayWithObjects:[CPGrammarSymbol nonTerminalWithName:@"ruleset"],
                               [CPGrammarSymbol nonTerminalWithName:@"rule"],
                               nil]
                        tag:0];
  CPRule *ruleset2 = [CPRule
               ruleWithName:@"ruleset"
      rightHandSideElements:
          [NSArray
              arrayWithObjects:[CPGrammarSymbol nonTerminalWithName:@"rule"],
                               nil]
                        tag:1];

  CPRule *rule1 =
      [CPRule ruleWithName:@"rule"
          rightHandSideElements:
              [NSArray
                  arrayWithObjects:[CPGrammarSymbol terminalWithName:@"Number"],
                                   [CPGrammarSymbol
                                       nonTerminalWithName:@"unNumbered"],
                                   nil]
                            tag:2];
  CPRule *rule2 =
      [CPRule ruleWithName:@"rule"
  ...
  CPRule *unNumbered = [CPRule
               ruleWithName:@"unNumbered"
      rightHandSideElements:
          [NSArray
              arrayWithObjects:[CPGrammarSymbol terminalWithName:@"Identifier"],
                               [CPGrammarSymbol terminalWithName:@"::="],
                               [CPGrammarSymbol
                                   nonTerminalWithName:@"rightHandSide"],
                               [CPGrammarSymbol terminalWithName:@";"], nil]
                        tag:4];

  CPRule *rightHandSide1 = [CPRule
               ruleWithName:@"rightHandSide"
      rightHandSideElements:
          [NSArray
              arrayWithObjects:[CPGrammarSymbol
                                   nonTerminalWithName:@"rightHandSide"],
                               [CPGrammarSymbol terminalWithName:@"|"],
                               [CPGrammarSymbol nonTerminalWithName:@"sumset"],
                               nil]
                        tag:5];
  CPRule *rightHandSide2 = [CPRule
               ruleWithName:@"rightHandSide"
      rightHandSideElements:
          [NSArray arrayWithObjects:[CPGrammarSymbol
                                        nonTerminalWithName:@"rightHandSide"],
                                    ...
                                    nil]
                        tag:6];
  CPRule *rightHandSide3 = [CPRule
               ruleWithName:@"rightHandSide"
      rightHandSideElements:
          [NSArray
              arrayWithObjects:[CPGrammarSymbol nonTerminalWithName:@"sumset"],
                               nil]
                        tag:7];

  CPRule *sumset1 =
      [CPRule ruleWithName:@"sumset"
          rightHandSideElements:
              [NSArray arrayWithObjects:
                           [CPGrammarSymbol nonTerminalWithName:@"sumset"],
                           [CPGrammarSymbol
                               nonTerminalWithName:@"taggedRightHandSideItem"],
                           nil]
                            tag:8];
  CPRule *sumset2 =
      [CPRule ruleWithName:@"sumset"
  ...
  CPRule *taggedRightHandSideItem1 = [CPRule
               ruleWithName:@"taggedRightHandSideItem"
      rightHandSideElements:
          [NSArray
              arrayWithObjects:[CPGrammarSymbol
                                   nonTerminalWithName:@"rightHandSideItem"],
                               nil]
                        tag:10];
  CPRule *taggedRightHandSideItem2 =
      [CPRule ruleWithName:@"taggedRightHandSideItem"
          rightHandSideElements:
              [NSArray arrayWithObjects:
                           [CPGrammarSymbol terminalWithName:@"Identifier"],
                           [CPGrammarSymbol terminalWithName:@"@"],
                           [CPGrammarSymbol
                               nonTerminalWithName:@"taggedRightHandSideItem"],
                           nil]
  ...
  CPRule *rightHandSideItem1 =
      [CPRule ruleWithName:@"rightHandSideItem"
          rightHandSideElements:
              [NSArray
                  arrayWithObject:[CPGrammarSymbol nonTerminalWithName:@"unit"]]
                            tag:12];
  CPRule *rightHandSideItem2 = [CPRule
               ruleWithName:@"rightHandSideItem"
      rightHandSideElements:
          [NSArray
              arrayWithObjects:[CPGrammarSymbol nonTerminalWithName:@"unit"],
                               [CPGrammarSymbol
                                   nonTerminalWithName:@"repeatSymbol"],
                               nil]
                        tag:13];
  ...
  CPRule *unit1 = [CPRule
               ruleWithName:@"unit"
      rightHandSideElements:
          [NSArray arrayWithObject:[CPGrammarSymbol
                                       nonTerminalWithName:@"grammarSymbol"]]
                        tag:14];
  CPRule *unit2 = [CPRule
               ruleWithName:@"unit"
      rightHandSideElements:
          [NSArray arrayWithObjects:[CPGrammarSymbol terminalWithName:@"("],
                                    [CPGrammarSymbol
                                        nonTerminalWithName:@"rightHandSide"],
                                    [CPGrammarSymbol terminalWithName:@")"],
                                    nil]
  ...
  CPRule *repeatSymbol1 = [CPRule
               ruleWithName:@"repeatSymbol"
      rightHandSideElements:[NSArray arrayWithObject:[CPGrammarSymbol
                                                         terminalWithName:@"*"]]
                        tag:16];
  CPRule *repeatSymbol2 = [CPRule
               ruleWithName:@"repeatSymbol"
      rightHandSideElements:[NSArray arrayWithObject:[CPGrammarSymbol
                                                         terminalWithName:@"+"]]
                        tag:17];
  CPRule *repeatSymbol3 = [CPRule
               ruleWithName:@"repeatSymbol"
      rightHandSideElements:[NSArray arrayWithObject:[CPGrammarSymbol
                                                         terminalWithName:@"?"]]
                        tag:18];

  CPRule *grammarSymbol1 =
      [CPRule ruleWithName:@"grammarSymbol"
          rightHandSideElements:
              [NSArray arrayWithObjects:[CPGrammarSymbol
                                            nonTerminalWithName:@"nonterminal"],
                                        nil]
                            tag:19];
  CPRule *grammarSymbol2 =
      [CPRule ruleWithName:@"grammarSymbol"
          rightHandSideElements:
              [NSArray arrayWithObjects:[CPGrammarSymbol
                                            nonTerminalWithName:@"terminal"],
                                        nil]
                            tag:20];

  CPRule *nonterminal = [CPRule
               ruleWithName:@"nonterminal"
      rightHandSideElements:
          [NSArray
              arrayWithObjects:[CPGrammarSymbol terminalWithName:@"<"],
                               [CPGrammarSymbol terminalWithName:@"Identifier"],
                               [CPGrammarSymbol terminalWithName:@">"], nil]
                        tag:21];

  CPRule *terminal =
      [CPRule ruleWithName:@"terminal"
          rightHandSideElements:
              [NSArray
                  arrayWithObjects:[CPGrammarSymbol terminalWithName:@"String"],
                                   nil]
                            tag:22];

  CPGrammar *bnfGrammar = [CPGrammar
      grammarWithStart:@"ruleset"
                 rules:[NSArray arrayWithObjects:ruleset1, ruleset2, rule1,
                                                 rule2, unNumbered,
                                                 rightHandSide1, rightHandSide2,
                                                 rightHandSide3, sumset1,
                                                 sumset2,
                                                 taggedRightHandSideItem1,
                                                 taggedRightHandSideItem2,
                                                 rightHandSideItem1,
                                                 rightHandSideItem2, unit1,
                                                 unit2, repeatSymbol1,
                                                 repeatSymbol2, repeatSymbol3,
                                                 grammarSymbol1, grammarSymbol2,
                                                 nonterminal, terminal, nil]];
...
- (NSError *)checkForMissingNonTerminalsInRules:(NSArray *)rules {
  NSMutableSet *definedNonTerminals =
      [NSMutableSet setWithCapacity:[rules count]];
  ...
  for (CPRule *rule in rules) {
    for (id item in [rule rightHandSideElements]) {
      if ([item isGrammarSymbol] && ![(CPGrammarSymbol *)item isTerminal] &&
          ![definedNonTerminals
              containsObject:[(CPGrammarSymbol *)item name]]) {
        return [NSError
            errorWithDomain:CPEBNFParserErrorDomain
        ...
        if (![usedNonTerminals isSubsetOfSet:definedNonTerminals]) {
          NSMutableSet *mutableUsedNonTerminals =
              [[usedNonTerminals mutableCopy] autorelease];
