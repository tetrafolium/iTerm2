...
+ (id)lr1ItemWithRule:(CPRule *)rule
  ...
  return [[[self alloc] initWithRule:rule position:position
                            terminal:terminal] autorelease];
}

- (id)initWithRule:(CPRule *)rule
          position:(NSUInteger)position
          terminal:(CPGrammarSymbol *)initTerminal {
...
- (id)copyWithZone:(NSZone *)zone {
  return [[CPLR1Item allocWithZone:zone] initWithRule:[self rule]
...
- (BOOL)isEqual:(id)object {
  return ([object isLR1Item] && [super isEqualToItem:(CPLR1Item *)object] &&
...
- (NSString *)description {
  return [[super description]
      stringByAppendingFormat:@", %@", [[self terminal] name]];
}
