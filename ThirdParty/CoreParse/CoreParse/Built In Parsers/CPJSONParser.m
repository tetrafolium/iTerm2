...
- (id)init {
  ...
  if (nil != self) {
    ...
    [jsonTokeniser
        addTokenRecogniser:[CPKeywordRecogniser recogniserForKeyword:@","]];
    [jsonTokeniser
        addTokenRecogniser:[CPKeywordRecogniser recogniserForKeyword:@"true"]];
    [jsonTokeniser
        addTokenRecogniser:[CPKeywordRecogniser recogniserForKeyword:@"false"]];
    [jsonTokeniser
        addTokenRecogniser:[CPKeywordRecogniser recogniserForKeyword:@"null"]];
    ...
    CPGrammar *jsonGrammar =
        [CPGrammar grammarWithStart:@"value"
                     backusNaurForm:@"0  value    ::= 'String';"
                                    @"1  value    ::= 'Number';"
                                    @"2  value    ::= <object>;"
                                    @"3  value    ::= <array>;"
                                    @"4  value    ::= <boolean>;"
...
- (id)parser:(CPParser *)parser
  ...
  case 8: {
    ...
    return [NSMutableDictionary dictionaryWithObject:[p objectForKey:@"v"]
                                              forKey:[p objectForKey:@"k"]];
  }
  case 9: {
    NSDictionary *p = [children objectAtIndex:0];
  ...
  case 10: {
    return [NSDictionary
        dictionaryWithObjectsAndKeys:[(CPQuotedToken *)[children
                                         objectAtIndex:0] content],
                                     @"k", [children objectAtIndex:2], @"v",
                                     nil];
  }
  case 11:
    return [NSArray array];
