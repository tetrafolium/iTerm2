...
- (BOOL)tokeniser:(CPTokeniser *)tokeniser shouldConsumeToken:(CPToken *)token {
  ...
  if ([name isEqualToString:@"{"] || [name isEqualToString:@"["]) {
    ...
    return 0 == nestingDepth ||
           ...
           [name isEqualToString:@"eval"] || [name isEqualToString:@"url"] ||
           [name isEqualToString:@"set"] || [name isEqualToString:@"pt"] ||
...
- (void)tokeniser:(CPTokeniser *)tokeniser
  ...
  if ([token isWhiteSpaceToken]) {
    ...
    NSString *name = [token name];
    justTokenisedObject =
        ([name isEqualToString:@"node"] || [name isEqualToString:@"way"] ||
         [name isEqualToString:@"relation"] || [name isEqualToString:@"area"] ||
         [name isEqualToString:@"line"] || [name isEqualToString:@"canvas"] ||
         [name isEqualToString:@"*"]);
