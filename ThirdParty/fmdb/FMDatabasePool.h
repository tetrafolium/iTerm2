...
/** Pool of @c FMDatabase  objects.
 ...
 @warning Before using @c FMDatabasePool , please consider using @c
 FMDatabaseQueue  instead.

 If you really really really know what you're doing and @c FMDatabasePool  is
 what you really really need (ie, you're using a read only database), OK you can
 use it.  But just be careful not to deadlock!
...
/** Synchronously perform database operations in pool using exclusive
 transaction.
...
/** Synchronously perform database operations in pool using save point.
 ...
 out of the pool and you'll get a deadlock. If you need to nest, use @c
