...
GPBEnumDescriptor *GPBNullValue_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    static const char *valueNames = "NullValue\000";
    static const int32_t values[] = {
        GPBNullValue_NullValue,
    };
    GPBEnumDescriptor *worker = [GPBEnumDescriptor
        allocDescriptorForName:GPBNSStringifySymbol(GPBNullValue)
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor = [GPBDescriptor
        allocDescriptorForClass:[GPBStruct class]
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor = [GPBDescriptor
        allocDescriptorForClass:[GPBValue class]
                      rootClass:[GPBStructRoot class]
                           file:GPBStructRoot_FileDescriptor()
                         fields:fields
                     fieldCount:(uint32_t)(sizeof(fields) /
...
int32_t GPBValue_NullValue_RawValue(GPBValue *message) {
  ...
  GPBFieldDescriptor *field =
      [descriptor fieldWithNumber:GPBValue_FieldNumber_NullValue];
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor = [GPBDescriptor
        allocDescriptorForClass:[GPBListValue class]
                      rootClass:[GPBStructRoot class]
                           file:GPBStructRoot_FileDescriptor()
                         fields:fields
                     fieldCount:(uint32_t)(sizeof(fields) /
