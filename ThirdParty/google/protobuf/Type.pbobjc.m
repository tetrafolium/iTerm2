...
GPBEnumDescriptor *GPBSyntax_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    static const char *valueNames = "SyntaxProto2\000SyntaxProto3\000";
    static const int32_t values[] = {
        GPBSyntax_SyntaxProto2,
        GPBSyntax_SyntaxProto3,
    };
    GPBEnumDescriptor *worker = [GPBEnumDescriptor
        allocDescriptorForName:GPBNSStringifySymbol(GPBSyntax)
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor = [GPBDescriptor
        allocDescriptorForClass:[GPBType class]
...
int32_t GPBType_Syntax_RawValue(GPBType *message) {
  ...
  GPBFieldDescriptor *field =
      [descriptor fieldWithNumber:GPBType_FieldNumber_Syntax];
...
void SetGPBType_Syntax_RawValue(GPBType *message, int32_t value) {
  ...
  GPBFieldDescriptor *field =
      [descriptor fieldWithNumber:GPBType_FieldNumber_Syntax];
  GPBSetInt32IvarWithFieldInternal(message, field, value,
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor = [GPBDescriptor
        allocDescriptorForClass:[GPBField class]
                      rootClass:[GPBTypeRoot class]
                           file:GPBTypeRoot_FileDescriptor()
                         fields:fields
                     fieldCount:(uint32_t)(sizeof(fields) /
...
int32_t GPBField_Kind_RawValue(GPBField *message) {
  ...
  GPBFieldDescriptor *field =
      [descriptor fieldWithNumber:GPBField_FieldNumber_Kind];
  return GPBGetMessageInt32Field(message, field);
}
...
int32_t GPBField_Cardinality_RawValue(GPBField *message) {
  GPBDescriptor *descriptor = [GPBField descriptor];
  GPBFieldDescriptor *field =
      [descriptor fieldWithNumber:GPBField_FieldNumber_Cardinality];
  return GPBGetMessageInt32Field(message, field);
}
...
GPBEnumDescriptor *GPBField_Kind_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    static const char *valueNames =
        ...
        "eSint64\000";
    static const int32_t values[] = {
        GPBField_Kind_TypeUnknown,  GPBField_Kind_TypeDouble,
        GPBField_Kind_TypeFloat,    GPBField_Kind_TypeInt64,
        GPBField_Kind_TypeUint64,   GPBField_Kind_TypeInt32,
        GPBField_Kind_TypeFixed64,  GPBField_Kind_TypeFixed32,
        GPBField_Kind_TypeBool,     GPBField_Kind_TypeString,
        GPBField_Kind_TypeGroup,    GPBField_Kind_TypeMessage,
        GPBField_Kind_TypeBytes,    GPBField_Kind_TypeUint32,
        GPBField_Kind_TypeEnum,     GPBField_Kind_TypeSfixed32,
        GPBField_Kind_TypeSfixed64, GPBField_Kind_TypeSint32,
        GPBField_Kind_TypeSint64,
    };
    GPBEnumDescriptor *worker = [GPBEnumDescriptor
        allocDescriptorForName:GPBNSStringifySymbol(GPBField_Kind)
                    valueNames:valueNames
                        values:values
                         count:(uint32_t)(sizeof(values) / sizeof(int32_t))
...
GPBEnumDescriptor *GPBField_Cardinality_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBEnumDescriptor *worker = [GPBEnumDescriptor
        allocDescriptorForName:GPBNSStringifySymbol(GPBField_Cardinality)
                    valueNames:valueNames
                        values:values
                         count:(uint32_t)(sizeof(values) / sizeof(int32_t))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor = [GPBDescriptor
        allocDescriptorForClass:[GPBEnum class]
                      rootClass:[GPBTypeRoot class]
                           file:GPBTypeRoot_FileDescriptor()
                         fields:fields
                     fieldCount:(uint32_t)(sizeof(fields) /
...
int32_t GPBEnum_Syntax_RawValue(GPBEnum *message) {
  ...
  GPBFieldDescriptor *field =
      [descriptor fieldWithNumber:GPBEnum_FieldNumber_Syntax];
  return GPBGetMessageInt32Field(message, field);
}
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor = [GPBDescriptor
        allocDescriptorForClass:[GPBEnumValue class]
                      rootClass:[GPBTypeRoot class]
                           file:GPBTypeRoot_FileDescriptor()
                         fields:fields
                     fieldCount:(uint32_t)(sizeof(fields) /
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor = [GPBDescriptor
        allocDescriptorForClass:[GPBOption class]
                      rootClass:[GPBTypeRoot class]
                           file:GPBTypeRoot_FileDescriptor()
                         fields:fields
                     fieldCount:(uint32_t)(sizeof(fields) /
