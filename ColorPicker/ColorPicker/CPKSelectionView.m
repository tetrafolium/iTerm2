...
- (void)createSubviews {
  ...
  self.gradientView = [[CPKGradientView alloc]
  ...
  self.colorComponentSliderView = [[CPKColorComponentSliderView alloc]
      initWithFrame:NSZeroRect
  ...
  if (_alphaAllowed) {
    self.alphaSliderView =
        [[CPKAlphaSliderView alloc] initWithFrame:NSZeroRect
  ...
  self.subviews = @[
    self.modeButton, self.hsbSliders, self.rgbSliders, self.gradientView,
    self.colorComponentSliderView, self.hexTextField, self.rgbTextFields,
    self.hsbTextFields, self.hslRgbTextFieldSwitch
  ];
  if (_alphaAllowed) {
  ...
  self.rgbHexTextFieldLabel = [self addLabel:@"RGB Hex"
                                   belowView:self.hexTextField
                                 toContainer:self];
  [self setTextFieldsRGB:![[NSUserDefaults standardUserDefaults]
                             boolForKey:kCPKSelectionViewShowHSBTextFieldsKey]];
...
- (void)createModeButton {
  ...
  if ([[NSUserDefaults standardUserDefaults]
          objectForKey:kCPKSelectionViewPreferredModeKey]) {
    [self.modeButton
        selectItemWithTag:[[NSUserDefaults standardUserDefaults]
                              integerForKey:kCPKSelectionViewPreferredModeKey]];
  }
}
...
- (void)createSlidersWithColor:(CPKColor *)color {
  ...
  // Create HSB sliders
  self.hueSliderView = [[CPKColorComponentSliderView alloc]
      initWithFrame:NSZeroRect
              color:color
               type:kCPKColorComponentSliderTypeHue
              block:^(CGFloat newValue) {
  ...
  self.saturationSliderView = [[CPKColorComponentSliderView alloc]
      initWithFrame:NSZeroRect
              color:color
  ...
  self.brightnessSliderView = [[CPKColorComponentSliderView alloc]
      initWithFrame:NSZeroRect
              color:color
  ...
  // Create RGB sliders
  self.redSliderView = [[CPKColorComponentSliderView alloc]
      initWithFrame:NSZeroRect
              color:color
  ...
  self.greenSliderView = [[CPKColorComponentSliderView alloc]
      initWithFrame:NSZeroRect
              color:color
  ...
  self.blueSliderView = [[CPKColorComponentSliderView alloc]
      initWithFrame:NSZeroRect
              color:color
...
- (void)createTextFieldsIncludingAlpha:(BOOL)alphaAllowed {
  ...
  self.hsbTextFields.subviews = @[
    self.hueTextField, self.brightnessTextField, self.saturationTextField
  ];
  self.rgbTextFields.subviews =
      @[ self.redTextField, self.greenTextField, self.blueTextField ];

  self.redTextFieldLabel = [self addLabel:@"R"
                                belowView:self.redTextField
                              toContainer:self.rgbTextFields];
  self.greenTextFieldLabel = [self addLabel:@"G"
                                  belowView:self.greenTextField
                                toContainer:self.rgbTextFields];
  self.blueTextFieldLabel = [self addLabel:@"B"
                                 belowView:self.blueTextField
                               toContainer:self.rgbTextFields];
  self.hueTextFieldLabel = [self addLabel:@"H"
                                belowView:self.hueTextField
                              toContainer:self.hsbTextFields];
  self.saturationTextFieldLabel = [self addLabel:@"S"
                                       belowView:self.saturationTextField
                                     toContainer:self.hsbTextFields];
  self.brightnessTextFieldLabel = [self addLabel:@"B"
                                       belowView:self.brightnessTextField
                                     toContainer:self.hsbTextFields];
  if (self.alphaAllowed) {
    self.alphaTextFieldLabel = [self addLabel:@"A"
                                    belowView:self.alphaTextField
                                  toContainer:self];
  }
...
- (void)layoutSubviews {
  ...
  NSRect frame;
  frame = NSMakeRect(kLeftMargin, kTopMargin,
                     NSWidth(frameRect) - kRightMargin - kLeftMargin, 0);
  ...
  frame = NSMakeRect(
      ...
      NSWidth(frameRect) - kRightMargin - kLeftMargin, kGradientHeight);
  self.gradientView.frame = frame;

  frame = NSMakeRect(kLeftMargin,
                     NSMaxY(self.gradientView.frame) +
                         kMarginBetweenGradientAndColorComponentSlider,
...
- (void)layoutSliders {
  ...
  frame = NSMakeRect(kLeftMargin,
                     NSMaxY(self.modeButton.frame) +
                         kMarginBetweenPopupButtonAndSliders,
                     NSWidth(frameRect) - kRightMargin - kLeftMargin,
                     kColorComponentSliderHeight * 3 + labelHeight * 3 +
  ...
  frame = NSMakeRect(0, NSMaxY(frame) + kMarginBetweenComponentSliders,
                     NSWidth(frameRect) - kRightMargin - kLeftMargin,
                     kColorComponentSliderHeight);
  ...
  // Lay out RGB sliders
  frame = NSMakeRect(0, 0, NSWidth(frameRect) - kRightMargin - kLeftMargin,
                     kColorComponentSliderHeight);
  ...
  if (self.alphaAllowed) {
    ...
    case kCPKRGBViewModeRGBWithBlueSliderTag:
      frame = NSMakeRect(kLeftMargin,
                         NSMaxY(self.colorComponentSliderView.frame) +
                             kMarginBetweenLastSliderAndTextFields,
                         NSWidth(frameRect) - kRightMargin - kLeftMargin,
                         kAlphaSliderHeight);
      break;
    ...
    case kCPKRGBViewModeRGBSliders:
      frame = NSMakeRect(
          ...
          NSWidth(frameRect) - kRightMargin - kLeftMargin, kAlphaSliderHeight);
      break;
    }
...
- (void)layoutLabel:(NSTextField *)label belowView:(NSView *)view {
  ...
  label.frame = NSMakeRect(NSMinX(view.frame),
                           ...
                           NSWidth(view.frame), NSHeight(label.frame));
}
...
- (void)layoutTextFields {
  ...
  if (self.alphaAllowed) {
    y = NSMaxY(self.alphaSliderView.frame) +
        kMarginBetweenLastSliderAndTextFields;
    self.alphaTextField.frame =
        NSMakeRect(x - kColorTextFieldWidth, y, kColorTextFieldWidth, 0);
    ...
    case kCPKRGBViewModeRGBWithGreenSliderTag:
    case kCPKRGBViewModeRGBWithBlueSliderTag:
      y = NSMaxY(self.colorComponentSliderView.frame) +
          kMarginBetweenLastSliderAndTextFields;
      break;
  ...
  [self layoutLabel:self.saturationTextFieldLabel
          belowView:self.saturationTextField];
  [self layoutLabel:self.brightnessTextFieldLabel
          belowView:self.brightnessTextField];
  if (self.alphaAllowed) {
  ...
  frame = NSMakeRect(NSMaxX(self.frame) - rgbImage.size.width - kRightMargin +
                         kMarginBetweenTextFields -
                         kExtraRightMarginForTextFieldSwitch,
                     y, rgbImage.size.width, rgbImage.size.height);
...
- (NSTextField *)labelWithTitle:(NSString *)string origin:(NSPoint)origin {
  NSTextField *label =
      [[NSTextField alloc] initWithFrame:NSMakeRect(origin.x, origin.y, 0, 0)];
  label.bezeled = NO;
...
- (void)updateSelectedColorFromHSBSliders {
  self.selectedColor =
      [[CPKColor alloc] initWithHue:self.hueSliderView.selectedValue
...
- (void)updateSliderGradients {
  [self.hueSliderView
      setGradientColor:[[CPKColor alloc]
                           initWithHue:0
                            saturation:self.saturationSliderView.selectedValue
                            brightness:self.brightnessSliderView.selectedValue
                                 alpha:1]];
  [self.saturationSliderView
      setGradientColor:[[CPKColor alloc]
                           initWithHue:self.hueSliderView.selectedValue
                            saturation:1
                            brightness:self.brightnessSliderView.selectedValue
                                 alpha:1]];
  ...
  [self.greenSliderView
      setGradientColor:[[CPKColor alloc]
                           initWithRed:self.redSliderView.selectedValue
                                 green:0
                                  blue:self.blueSliderView.selectedValue
                                 alpha:1]];
  [self.blueSliderView
...
- (void)updateSelectedColorFromRGBSliders {
  self.selectedColor =
      [[CPKColor alloc] initWithRed:self.redSliderView.selectedValue
                              green:self.greenSliderView.selectedValue
                               blue:self.blueSliderView.selectedValue
                              alpha:self.selectedColor.alphaComponent];
  [self updateSliderGradients];
...
- (void)setSliderValue:(CGFloat)newValue {
  ...
  case kCPKRGBViewModeHSBWithHueSliderTag:
    _selectedColor =
        [[CPKColor alloc] initWithHue:newValue
  ...
  case kCPKRGBViewModeHSBWithSaturationSliderTag:
    _selectedColor =
        [[CPKColor alloc] initWithHue:self.selectedColor.hueComponent
                           saturation:newValue
                           brightness:self.selectedColor.brightnessComponent
                                alpha:self.selectedColor.alphaComponent];
  ...
  case kCPKRGBViewModeRGBWithRedSliderTag:
    _selectedColor =
        [[CPKColor alloc] initWithRed:newValue
  ...
  case kCPKRGBViewModeRGBWithGreenSliderTag:
    _selectedColor =
        [[CPKColor alloc] initWithRed:self.selectedColor.redComponent
                                green:newValue
                                 blue:self.selectedColor.blueComponent
                                alpha:self.selectedColor.alphaComponent];
...
- (void)updateTextFieldsForColor:(CPKColor *)color {
  self.hexTextField.stringValue = [NSString
      stringWithFormat:@"%02x%02x%02x", (int)floor(color.redComponent * 255),
  ...
  self.saturationTextField.stringValue = [NSString
      stringWithFormat:@"%d", (int)floor(color.saturationComponent * 255)];
  self.brightnessTextField.stringValue = [NSString
      stringWithFormat:@"%d", (int)floor(color.brightnessComponent * 255)];

  if (self.alphaAllowed) {
    self.alphaTextField.stringValue = [NSString
        stringWithFormat:@"%d", (int)floor(color.alphaComponent * 255)];
  }
}

- (void)sizeToFit {
  [self layoutSubviews];
  NSRect frame = NSMakeRect(NSMinX(self.frame), NSMinY(self.frame),
                            NSWidth(self.bounds), [self desiredHeight]);
  self.frame = frame;
}
...
- (void)controlTextDidChange:(NSNotification *)obj {
  ...
  if (textField == self.hexTextField) {
    ...
    if (isInteger) {
      self.selectedColor =
          [[CPKColor alloc] initWithRed:i / 255.0
    ...
    if (isInteger) {
      self.selectedColor =
          [[CPKColor alloc] initWithRed:_selectedColor.redComponent
                                  green:i / 255.0
                                   blue:_selectedColor.blueComponent
                                  alpha:_selectedColor.alphaComponent];
    }
    ...
    if (isInteger) {
      self.selectedColor =
          [[CPKColor alloc] initWithHue:i / 255.0
    ...
    if (isInteger) {
      self.selectedColor =
          [[CPKColor alloc] initWithHue:_selectedColor.hueComponent
                             saturation:i / 255.0
                             brightness:_selectedColor.brightnessComponent
                                  alpha:_selectedColor.alphaComponent];
    }
...
- (void)modeDidChange:(id)sender {
  [[NSUserDefaults standardUserDefaults]
      setInteger:self.modeButton.selectedTag
  ...
  case kCPKRGBViewModeHSBSliders:
    ...
    self.saturationSliderView.selectedValue =
        self.selectedColor.saturationComponent;
    self.brightnessSliderView.selectedValue =
        self.selectedColor.brightnessComponent;
