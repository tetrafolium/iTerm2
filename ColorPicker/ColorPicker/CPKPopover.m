...
+ (instancetype)presentRelativeToRect:(NSRect)positioningRect
  ...
  return [self
      presentRelativeToRect:positioningRect
                     ofView:positioningView
              preferredEdge:preferredEdge
               initialColor:color
                    options:(alphaAllowed ? CPKMainViewControllerOptionsAlpha
                                          : 0)selectionDidChange:block
...
+ (instancetype)presentRelativeToRect:(NSRect)positioningRect
  ...
  popover.mainViewController =
      [[CPKMainViewController alloc] initWithBlock:block
