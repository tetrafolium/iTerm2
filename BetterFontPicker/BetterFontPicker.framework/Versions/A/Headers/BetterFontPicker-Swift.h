...
// Generated by Apple Swift version 5.3.1 (swiftlang-1200.0.35
// clang-1200.0.32.4)
...
- (void)mainViewController:(BFPMainViewController *_Nonnull)mainViewController
     didSelectFontWithName:(NSString *_Nonnull)name;
@end
...
- (nonnull instancetype)initWithFrame:(NSRect)buttonFrame
                            pullsDown:(BOOL)flag OBJC_DESIGNATED_INITIALIZER;
...
@protocol BFPAffordanceDelegate
- (void)affordance:(BFPAffordance *_Nonnull)affordance
    didSelectFontFamily:(NSString *_Nonnull)fontFamily;
@end
...
@property(nonatomic, weak)
    id<BFPFontFamilyMemberPickerViewDelegate> _Nullable delegate;
- (nonnull instancetype)initWithFrame:(NSRect)buttonFrame
                            pullsDown:(BOOL)flag OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect SWIFT_UNAVAILABLE;
- (nullable instancetype)initWithCoder:(NSCoder *_Nonnull)coder
...
- (void)fontFamilyMemberPickerView:
            (BFPFontFamilyMemberPickerView *_Nonnull)fontFamilyMemberPickerView
                 didSelectFontName:(NSString *_Nonnull)name;
@end
...
- (void)sizePickerView:(BFPSizePickerView *_Nonnull)sizePickerView
...
@interface BFPCompositeView
    : NSView <BFPAffordanceDelegate, BFPFontFamilyMemberPickerViewDelegate,
...
@property(nonatomic, readonly, strong)
    BFPSizePickerView *_Nullable horizontalSpacing;
@property(nonatomic, readonly, strong)
    BFPSizePickerView *_Nullable verticalSpacing;
...
- (BFPSizePickerView *_Nonnull)addHorizontalSpacingAccessoryWithInitialValue:
    (double)initialValue SWIFT_WARN_UNUSED_RESULT;
- (BFPSizePickerView *_Nonnull)addVerticalSpacingAccessoryWithInitialValue:
    (double)initialValue SWIFT_WARN_UNUSED_RESULT;
- (void)affordance:(BFPAffordance *_Nonnull)affordance
    didSelectFontFamily:(NSString *_Nonnull)fontFamily;
- (void)fontFamilyMemberPickerView:
...
- (void)fontPickerCompositeView:(BFPCompositeView *_Nonnull)view
                  didSelectFont:(NSFont *_Nonnull)font;
@end
...
@property(nonatomic, weak)
    IBOutlet BFPFontListTableView *_Null_unspecified tableView;
@property(nonatomic, weak)
    IBOutlet NSSearchField *_Null_unspecified searchField;
@property(nonatomic, weak)
    IBOutlet id<BFPMainViewControllerDelegate> _Nullable delegate;
@property(nonatomic, copy)
    NSArray<id<BFPFontListDataSource>> *_Nonnull systemFontDataSources;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nonnull instancetype)initWithNibName:(NSNibName _Nullable)nibNameOrNil
...
@interface BFPTableViewController
...
- (NSTableRowView *_Nullable)tableView:(NSTableView *_Nonnull)tableView
                         rowViewForRow:(NSInteger)row SWIFT_WARN_UNUSED_RESULT;
- (NSView *_Nullable)tableView:(NSTableView *_Nonnull)tableView
            viewForTableColumn:(NSTableColumn *_Nullable)tableColumn
                           row:(NSInteger)row SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)tableView:(NSTableView *_Nonnull)tableView
         heightOfRow:(NSInteger)row SWIFT_WARN_UNUSED_RESULT;
- (BOOL)tableView:(NSTableView *_Nonnull)tableView
    shouldSelectRow:(NSInteger)row SWIFT_WARN_UNUSED_RESULT;
