...
class YaccErrorWarningTests(unittest.TestCase):
    ...
    def test_yacc_badprec3(self):
        ...
        self.assert_(
            check_expected(
                result, "Precedence already specified for terminal 'MINUS'\n"
    ...
    def test_yacc_badrule(self):
        ...
        self.assert_(
            check_expected(
                result, "yacc_badrule.py:24: Syntax error. Expected ':'\n"
    ...
    def test_yacc_inf(self):
        ...
        self.assert_(
            check_expected(
                result, "Token 'NUMBER' defined, but not used\n"
                "There is 1 unused token\n"
    ...
    def test_yacc_noerror(self):
        ...
        self.assert_(
            check_expected(
                result, "no p_error() function is defined\n"
                "Generating LALR tables\n"))
    ...
    def test_yacc_notfunc(self):
        ...
        self.assert_(
            check_expected(
                result, "'p_statement_assign' not defined as a function\n"
                "Token 'EQUALS' defined, but not used\n"
                "There is 1 unused token\n"
                "Generating LALR tables\n"))
